...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Len6;->a:Ljava/io/ByteArrayOutputStream;

    new-instance v1, Ljava/io/DataOutputStream;

    invoke-direct {v1, v0}, Ljava/io/DataOutputStream;-><init>(Ljava/io/OutputStream;)V

    iput-object v1, p0, Len6;->b:Ljava/io/DataOutputStream;
...
.method public a(Lcom/google/android/exoplayer2/metadata/emsg/EventMessage;)[B
    ...
    iget-object v0, p0, Len6;->a:Ljava/io/ByteArrayOutputStream;

    invoke-virtual {v0}, Ljava/io/ByteArrayOutputStream;->reset()V

    :try_start_0
    iget-object v0, p0, Len6;->b:Ljava/io/DataOutputStream;

    iget-object v1, p1, Lcom/google/android/exoplayer2/metadata/emsg/EventMessage;->schemeIdUri:Ljava/lang/String;

    invoke-static {v0, v1}, Len6;->b(Ljava/io/DataOutputStream;Ljava/lang/String;)V
    ...
    :goto_0
    iget-object v1, p0, Len6;->b:Ljava/io/DataOutputStream;

    invoke-static {v1, v0}, Len6;->b(Ljava/io/DataOutputStream;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Len6;->b:Ljava/io/DataOutputStream;

    invoke-virtual {p1}, Ljava/io/DataOutputStream;->flush()V

    iget-object p1, p0, Len6;->a:Ljava/io/ByteArrayOutputStream;
