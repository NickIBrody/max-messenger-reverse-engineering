...
.method public static commonBytes([BIII)I
    ...
    invoke-static {p0, p2}, Lolk;->g([BI)J

    move-result-wide v1

    invoke-static {p0, p1}, Lolk;->g([BI)J
    ...
    :cond_0
    sget-object p3, Lcxk;->NATIVE_BYTE_ORDER:Ljava/nio/ByteOrder;
    ...
    invoke-static {p0, p1}, Lolk;->c([BI)B

    move-result p1

    add-int/lit8 v2, p2, 0x1

    invoke-static {p0, p2}, Lolk;->c([BI)B
...
.method public static readIntEquals([BII)Z
    ...
    invoke-static {p0, p1}, Lolk;->e([BI)I

    move-result p1

    invoke-static {p0, p2}, Lolk;->e([BI)I
...
.method public static safeArraycopy([BI[BII)V
    ...
    invoke-static {p0, v3}, Lolk;->c([BI)B

    move-result v3

    invoke-static {p2, v2, v3}, Lolk;->k([BIB)V
...
.method public static safeIncrementalCopy([BIII)V
    ...
    invoke-static {p0, v2}, Lolk;->c([BI)B

    move-result v2

    invoke-static {p0, v1, v2}, Lolk;->k([BIB)V
...
.method public static wildArraycopy([BI[BII)V
    ...
    invoke-static {p0, v2}, Lolk;->g([BI)J

    move-result-wide v2

    invoke-static {p2, v1, v2, v3}, Lolk;->o([BIJ)V
...
.method public static wildIncrementalCopy([BIII)V
    ...
    invoke-static {p0, v5}, Lolk;->c([BI)B

    move-result v5

    invoke-static {p0, v4, v5}, Lolk;->k([BIB)V
    ...
    :goto_1
    invoke-static {p0, v3}, Lolk;->e([BI)I

    move-result p1

    invoke-static {p0, v2, p1}, Lolk;->m([BII)V
    ...
    invoke-static {p0, p2, v2, v3}, Lolk;->o([BIJ)V
...
.method public static writeLen(I[BI)I
    ...
    invoke-static {p1, p2, v0}, Lolk;->l([BII)V
    ...
    invoke-static {p1, p2, p0}, Lolk;->l([BII)V
...
.method public static writeShortLittleEndian([BII)V
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lolk;->p([BIS)V
