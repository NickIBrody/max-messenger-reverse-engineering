...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lwbk;->a:Landroid/graphics/RectF;

    return-void
.end method

.method public static synthetic a(Landroid/graphics/RectF;Lru4;)Lru4;
    .locals 0

    invoke-static {p0, p1}, Loag;->b(Landroid/graphics/RectF;Lru4;)Loag;
...
.method public static c(Lcom/google/android/material/shape/a;Landroid/graphics/RectF;)Lcom/google/android/material/shape/a;
    ...
    invoke-direct {v0, p1}, Lvbk;-><init>(Landroid/graphics/RectF;)V
...
.method public static g(Landroid/view/View;I)Landroid/view/View;
    ...
    :cond_0
    invoke-static {p0, p1}, Lwbk;->f(Landroid/view/View;I)Landroid/view/View;
...
.method public static k(Lcom/google/android/material/shape/a;Landroid/graphics/RectF;)Z
    ...
    invoke-interface {v0, p1}, Lru4;->a(Landroid/graphics/RectF;)F
    ...
    invoke-interface {p0, p1}, Lru4;->a(Landroid/graphics/RectF;)F
...
.method public static n(FFFFFZ)F
    ...
    :cond_0
    invoke-static {p0, p1, p4}, Lwbk;->l(FFF)F
...
.method public static p(Lcom/google/android/material/shape/a;Lcom/google/android/material/shape/a;Landroid/graphics/RectF;Landroid/graphics/RectF;FFF)Lcom/google/android/material/shape/a;
    ...
    invoke-direct/range {v1 .. v6}, Lwbk$a;-><init>(Landroid/graphics/RectF;Landroid/graphics/RectF;FFF)V

    invoke-static {p0, p1, v2, v1}, Lwbk;->w(Lcom/google/android/material/shape/a;Lcom/google/android/material/shape/a;Landroid/graphics/RectF;Lwbk$b;)Lcom/google/android/material/shape/a;
...
.method public static q(Landroid/transition/Transition;Landroid/content/Context;I)Z
    ...
    invoke-static {p1, p2, v0}, Lxtb;->f(Landroid/content/Context;II)I
...
.method public static s(Landroid/transition/Transition;Landroid/content/Context;I)Z
    ...
    invoke-static {p1, p2}, Lwbk;->t(Landroid/content/Context;I)Landroid/transition/PathMotion;
...
.method public static t(Landroid/content/Context;I)Landroid/transition/PathMotion;
    ...
    invoke-static {p0}, Ldtd;->e(Ljava/lang/String;)Landroid/graphics/Path;
...
.method public static u(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)I
    ...
    sget-object v0, Lwbk;->a:Landroid/graphics/RectF;
...
.method public static v(Landroid/graphics/Canvas;Landroid/graphics/Rect;FFFILgo2$a;)V
    .locals 1
    ...
    invoke-static {p0, p1, p5}, Lwbk;->u(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)I

    :cond_1
    invoke-interface {p6, p0}, Lgo2$a;->a(Landroid/graphics/Canvas;)V
...
.method public static w(Lcom/google/android/material/shape/a;Lcom/google/android/material/shape/a;Landroid/graphics/RectF;Lwbk$b;)Lcom/google/android/material/shape/a;
    .locals 2

    invoke-static {p0, p2}, Lwbk;->k(Lcom/google/android/material/shape/a;Landroid/graphics/RectF;)Z
    ...
    invoke-interface {p3, v0, v1}, Lwbk$b;->a(Lru4;Lru4;)Lru4;

    move-result-object v0

    invoke-virtual {p2, v0}, Lcom/google/android/material/shape/a$b;->F(Lru4;)Lcom/google/android/material/shape/a$b;
    ...
    invoke-virtual {p1}, Lcom/google/android/material/shape/a;->t()Lru4;
    ...
    invoke-virtual {p2, v0}, Lcom/google/android/material/shape/a$b;->J(Lru4;)Lcom/google/android/material/shape/a$b;
    ...
    invoke-virtual {p1}, Lcom/google/android/material/shape/a;->j()Lru4;
    ...
    invoke-virtual {p2, v0}, Lcom/google/android/material/shape/a$b;->w(Lru4;)Lcom/google/android/material/shape/a$b;
    ...
    invoke-virtual {p1}, Lcom/google/android/material/shape/a;->l()Lru4;

    move-result-object p1

    invoke-interface {p3, p0, p1}, Lwbk$b;->a(Lru4;Lru4;)Lru4;

    move-result-object p0

    invoke-virtual {p2, p0}, Lcom/google/android/material/shape/a$b;->A(Lru4;)Lcom/google/android/material/shape/a$b;
