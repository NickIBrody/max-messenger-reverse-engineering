...
# direct methods
.method public constructor <init>(Lcom/google/android/gms/common/api/internal/GoogleApiManager;ILss;JJLjava/lang/String;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lm3n;->a:Lcom/google/android/gms/common/api/internal/GoogleApiManager;

    iput p2, p0, Lm3n;->b:I

    iput-object p3, p0, Lm3n;->c:Lss;

    iput-wide p4, p0, Lm3n;->d:J

    iput-wide p6, p0, Lm3n;->e:J

    return-void
.end method

.method public static b(Lcom/google/android/gms/common/api/internal/GoogleApiManager;ILss;)Lm3n;
    .locals 11
    ...
    invoke-virtual {p0, p2}, Lcom/google/android/gms/common/api/internal/GoogleApiManager;->zai(Lss;)Lcom/google/android/gms/common/api/internal/h;

    move-result-object v1

    if-eqz v1, :cond_3

    invoke-virtual {v1}, Lcom/google/android/gms/common/api/internal/h;->t()Lcom/google/android/gms/common/api/a$f;
    ...
    invoke-static {v1, v2, p1}, Lm3n;->c(Lcom/google/android/gms/common/api/internal/h;Lcom/google/android/gms/common/internal/a;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    ...
    invoke-direct/range {v1 .. v10}, Lm3n;-><init>(Lcom/google/android/gms/common/api/internal/GoogleApiManager;ILss;JJLjava/lang/String;Ljava/lang/String;)V

    return-object v1
.end method

.method public static c(Lcom/google/android/gms/common/api/internal/h;Lcom/google/android/gms/common/internal/a;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    .locals 2
    ...
    :cond_0
    invoke-static {v1, p2}, Lmy;->a([II)Z
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/internal/h;->q()I
...
.method public final a(Lnnj;)V
    ...
    iget-object v1, v0, Lm3n;->a:Lcom/google/android/gms/common/api/internal/GoogleApiManager;
    ...
    invoke-virtual {v1}, Lfng;->a()Lcom/google/android/gms/common/internal/RootTelemetryConfiguration;
    ...
    :cond_1
    iget-object v2, v0, Lm3n;->a:Lcom/google/android/gms/common/api/internal/GoogleApiManager;

    iget-object v3, v0, Lm3n;->c:Lss;

    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/api/internal/GoogleApiManager;->zai(Lss;)Lcom/google/android/gms/common/api/internal/h;

    move-result-object v2

    if-eqz v2, :cond_b

    invoke-virtual {v2}, Lcom/google/android/gms/common/api/internal/h;->t()Lcom/google/android/gms/common/api/a$f;
    ...
    invoke-static {v2, v3, v4}, Lm3n;->c(Lcom/google/android/gms/common/api/internal/h;Lcom/google/android/gms/common/internal/a;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    ...
    :goto_2
    iget-object v5, v0, Lm3n;->a:Lcom/google/android/gms/common/api/internal/GoogleApiManager;

    invoke-virtual/range {p1 .. p1}, Lnnj;->l()Z
    ...
    :cond_6
    invoke-virtual/range {p1 .. p1}, Lnnj;->j()Z
    ...
    :cond_7
    invoke-virtual/range {p1 .. p1}, Lnnj;->h()Ljava/lang/Exception;
    ...
    iget-wide v6, v0, Lm3n;->d:J

    iget-wide v9, v0, Lm3n;->e:J
