...
.method private ensureContainerAndBehavior()V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/sidesheet/SheetDialog;->getBehaviorFromSheet(Landroid/widget/FrameLayout;)Lg2i;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/sidesheet/SheetDialog;->behavior:Lg2i;

    invoke-virtual {p0, v0}, Lcom/google/android/material/sidesheet/SheetDialog;->addSheetCancelOnHideCallback(Lg2i;)V

    new-instance v0, Lcom/google/android/material/motion/MaterialBackOrchestrator;

    iget-object v1, p0, Lcom/google/android/material/sidesheet/SheetDialog;->behavior:Lg2i;
...
.method private maybeUpdateWindowAnimationsBasedOnLayoutDirection()V
    ...
    invoke-static {v1, v2}, Lo28;->b(II)I
    ...
    sget v1, Lxtf;->Animation_Material3_SideSheetDialog_Left:I

    goto :goto_0

    :cond_0
    sget v1, Lxtf;->Animation_Material3_SideSheetDialog_Right:I
...
# virtual methods
.method public abstract addSheetCancelOnHideCallback(Lg2i;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lg2i;",
...
.method public cancel()V
    ...
    invoke-virtual {p0}, Lcom/google/android/material/sidesheet/SheetDialog;->getBehavior()Lg2i;
    ...
    invoke-interface {v0}, Lg2i;->getState()I
    ...
    :cond_0
    invoke-interface {v0, v2}, Lg2i;->setState(I)V
...
.method public getBehavior()Lg2i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/android/material/sidesheet/SheetDialog;->behavior:Lg2i;
...
.method public abstract getBehaviorFromSheet(Landroid/widget/FrameLayout;)Lg2i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public onStart()V
    ...
    invoke-interface {v0, v1}, Lg2i;->setState(I)V
