...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p2, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->textDrawableHelper:Lnrj;
...
.method private calculateTextCenterFromBaseline()F
    ...
    iget-object v0, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->textDrawableHelper:Lnrj;
...
.method private createMarkerEdge()Ly86;
    .locals 7
    ...
    invoke-direct {v2, v3}, Li3a;-><init>(F)V

    invoke-direct {v1, v2, v0}, Lanc;-><init>(Ly86;F)V
...
.method private drawText(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->textDrawableHelper:Lnrj;

    invoke-virtual {v2}, Lnrj;->e()Ldrj;
    ...
    invoke-virtual {v2, v3}, Lnrj;->n(Landroid/content/Context;)V
...
.method private getTextWidth()F
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->textDrawableHelper:Lnrj;

    invoke-interface {v0}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0}, Lnrj;->h(Ljava/lang/String;)F
...
.method private loadFromAttributes(Landroid/util/AttributeSet;II)V
    ...
    sget p3, Lzif;->mtrl_tooltip_arrowSize:I
    ...
    sget p2, Lnuf;->Tooltip_showMarker:I
    ...
    invoke-direct {p0}, Lcom/google/android/material/tooltip/TooltipDrawable;->createMarkerEdge()Ly86;

    move-result-object p3

    invoke-virtual {p2, p3}, Lcom/google/android/material/shape/a$b;->s(Ly86;)Lcom/google/android/material/shape/a$b;
    ...
    :goto_0
    sget p2, Lnuf;->Tooltip_android_text:I
    ...
    sget p3, Lnuf;->Tooltip_android_textAppearance:I

    invoke-static {p2, p1, p3}, Li4a;->h(Landroid/content/Context;Landroid/content/res/TypedArray;I)Ldrj;

    move-result-object p2

    if-eqz p2, :cond_1

    sget p3, Lnuf;->Tooltip_android_textColor:I
    ...
    sget v0, Lnuf;->Tooltip_android_textColor:I

    invoke-static {p3, p1, v0}, Li4a;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p3

    invoke-virtual {p2, p3}, Ldrj;->k(Landroid/content/res/ColorStateList;)V

    :cond_1
    invoke-virtual {p0, p2}, Lcom/google/android/material/tooltip/TooltipDrawable;->setTextAppearance(Ldrj;)V

    iget-object p2, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->context:Landroid/content/Context;

    sget p3, Lzhf;->colorOnBackground:I
    ...
    invoke-static {p2, p3, v1}, Ld4a;->c(Landroid/content/Context;ILjava/lang/String;)I
    ...
    invoke-static {p3, v1, v2}, Ld4a;->c(Landroid/content/Context;ILjava/lang/String;)I

    move-result p3

    const/16 v1, 0xe5

    invoke-static {p3, v1}, Lgw3;->p(II)I

    move-result p3

    const/16 v1, 0x99

    invoke-static {p2, v1}, Lgw3;->p(II)I

    move-result p2

    invoke-static {p3, p2}, Ld4a;->i(II)I

    move-result p2

    sget p3, Lnuf;->Tooltip_backgroundTint:I
    ...
    sget p3, Lzhf;->colorSurface:I

    invoke-virtual {v0}, Ljava/lang/Class;->getCanonicalName()Ljava/lang/String;

    move-result-object v0

    invoke-static {p2, p3, v0}, Ld4a;->c(Landroid/content/Context;ILjava/lang/String;)I
    ...
    sget p2, Lnuf;->Tooltip_android_padding:I
    ...
    sget p2, Lnuf;->Tooltip_android_minWidth:I
    ...
    sget p2, Lnuf;->Tooltip_android_minHeight:I
    ...
    sget p2, Lnuf;->Tooltip_android_layout_margin:I
...
.method public onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, v0}, Lcom/google/android/material/shape/a$b;->s(Ly86;)Lcom/google/android/material/shape/a$b;
...
.method public setRevealFraction(F)V
    ...
    invoke-static {v2, v0, v1, v0, p1}, Ldl;->b(FFFFF)F
...
.method public setText(Ljava/lang/CharSequence;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->textDrawableHelper:Lnrj;
...
.method public setTextAppearanceResource(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/tooltip/TooltipDrawable;->setTextAppearance(Ldrj;)V
