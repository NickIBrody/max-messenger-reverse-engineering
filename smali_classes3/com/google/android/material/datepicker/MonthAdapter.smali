...
.method private getDayContentDescription(Landroid/content/Context;J)Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v5}, Ly55;->e(Landroid/content/Context;JZZZ)Ljava/lang/String;
...
.method private initializeStyles(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/datepicker/MonthAdapter;->calendarStyle:Lb81;

    if-nez v0, :cond_0

    new-instance v0, Lb81;

    invoke-direct {v0, p1}, Lb81;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/android/material/datepicker/MonthAdapter;->calendarStyle:Lb81;
...
.method private isSelected(J)Z
    ...
    invoke-static {p1, p2}, Lyvk;->a(J)J

    move-result-wide v3

    invoke-static {v1, v2}, Lyvk;->a(J)J
...
.method private updateSelectedState(Landroid/widget/TextView;JI)V
    ...
    iget-object p2, p0, Lcom/google/android/material/datepicker/MonthAdapter;->calendarStyle:Lb81;

    iget-object p2, p2, Lb81;->b:La81;
    ...
    invoke-virtual {p2, p1, p3, p4}, La81;->e(Landroid/widget/TextView;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;)V
    ...
    :cond_4
    invoke-virtual {p2, p1}, La81;->d(Landroid/widget/TextView;)V
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/widget/TextView;
    ...
    .line 5
    sget v0, Lgpf;->mtrl_calendar_day:I
