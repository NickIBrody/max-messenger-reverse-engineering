...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/android/material/datepicker/MaterialCalendar$j;,
        Lcom/google/android/material/datepicker/MaterialCalendar$i;
    }
.end annotation
...
.field private calendarSelector:Lcom/google/android/material/datepicker/MaterialCalendar$i;

.field private calendarStyle:Lb81;
...
.method public static synthetic access$400(Lcom/google/android/material/datepicker/MaterialCalendar;)Lb81;
    .locals 0

    iget-object p0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->calendarStyle:Lb81;
...
.method private addActionsToMonthNavigation(Landroid/view/View;Lcom/google/android/material/datepicker/MonthsPagerAdapter;)V
    ...
    sget v0, Lhlf;->month_navigation_fragment_toggle:I
    ...
    sget v1, Lhlf;->month_navigation_previous:I
    ...
    sget v1, Lhlf;->month_navigation_next:I
    ...
    sget v1, Lhlf;->mtrl_calendar_year_selector_frame:I
    ...
    sget v1, Lhlf;->mtrl_calendar_day_selector_frame:I
    ...
    sget-object p1, Lcom/google/android/material/datepicker/MaterialCalendar$i;->DAY:Lcom/google/android/material/datepicker/MaterialCalendar$i;

    invoke-virtual {p0, p1}, Lcom/google/android/material/datepicker/MaterialCalendar;->setSelector(Lcom/google/android/material/datepicker/MaterialCalendar$i;)V
    ...
    invoke-direct {v1, p0, p2, v0}, Lcom/google/android/material/datepicker/MaterialCalendar$h;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;Lcom/google/android/material/datepicker/MonthsPagerAdapter;Lcom/google/android/material/button/MaterialButton;)V
...
.method public static getDayHeight(Landroid/content/Context;)I
    ...
    sget v0, Lzif;->mtrl_calendar_day_height:I
...
.method private static getDialogPickerHeight(Landroid/content/Context;)I
    ...
    sget v0, Lzif;->mtrl_calendar_navigation_height:I

    invoke-virtual {p0, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    sget v1, Lzif;->mtrl_calendar_navigation_top_padding:I
    ...
    sget v1, Lzif;->mtrl_calendar_navigation_bottom_padding:I
    ...
    sget v1, Lzif;->mtrl_calendar_days_of_week_height:I
    ...
    sget v3, Lzif;->mtrl_calendar_day_height:I
    ...
    sget v4, Lzif;->mtrl_calendar_month_vertical_padding:I
    ...
    sget v2, Lzif;->mtrl_calendar_bottom_padding:I
...
# virtual methods
.method public addOnSelectionChangedListener(Ldpc;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-super {p0, p1}, Lcom/google/android/material/datepicker/PickerFragment;->addOnSelectionChangedListener(Ldpc;)Z
...
.method public getCalendarStyle()Lb81;
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->calendarStyle:Lb81;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {v0, v6}, Lb81;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->calendarStyle:Lb81;
    ...
    sget v3, Lgpf;->mtrl_calendar_vertical:I
    ...
    :cond_0
    sget v3, Lgpf;->mtrl_calendar_horizontal:I
    ...
    sget v0, Lhlf;->mtrl_calendar_days_of_week:I
    ...
    new-instance v3, Lcom/google/android/material/datepicker/MaterialCalendar$b;

    invoke-direct {v3, p0}, Lcom/google/android/material/datepicker/MaterialCalendar$b;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;)V

    invoke-static {v0, v3}, Landroidx/core/view/ViewCompat;->n0(Landroid/view/View;Landroidx/core/view/AccessibilityDelegateCompat;)V
    ...
    sget v0, Lhlf;->mtrl_calendar_months:I
    ...
    new-instance v0, Lcom/google/android/material/datepicker/MaterialCalendar$c;
    ...
    sget v3, Lwof;->mtrl_calendar_year_selector_span:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v2

    sget v3, Lhlf;->mtrl_calendar_year_selector_frame:I
    ...
    :cond_2
    sget v2, Lhlf;->month_navigation_fragment_toggle:I
    ...
    invoke-virtual {v0, v2}, Lcom/google/android/material/datepicker/MonthsPagerAdapter;->f0(Lcom/google/android/material/datepicker/Month;)I
...
.method public setCurrentMonth(Lcom/google/android/material/datepicker/Month;)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/datepicker/MonthsPagerAdapter;->f0(Lcom/google/android/material/datepicker/Month;)I
...
.method public setSelector(Lcom/google/android/material/datepicker/MaterialCalendar$i;)V
    .locals 4

    iput-object p1, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->calendarSelector:Lcom/google/android/material/datepicker/MaterialCalendar$i;

    sget-object v0, Lcom/google/android/material/datepicker/MaterialCalendar$i;->YEAR:Lcom/google/android/material/datepicker/MaterialCalendar$i;
    ...
    invoke-virtual {v0, v3}, Lcom/google/android/material/datepicker/YearGridAdapter;->e0(I)I

    move-result v0

    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView$n;->A1(I)V
    ...
    :cond_0
    sget-object v0, Lcom/google/android/material/datepicker/MaterialCalendar$i;->DAY:Lcom/google/android/material/datepicker/MaterialCalendar$i;
...
.method public toggleVisibleSelector()V
    ...
    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->calendarSelector:Lcom/google/android/material/datepicker/MaterialCalendar$i;

    sget-object v1, Lcom/google/android/material/datepicker/MaterialCalendar$i;->YEAR:Lcom/google/android/material/datepicker/MaterialCalendar$i;

    if-ne v0, v1, :cond_0

    sget-object v0, Lcom/google/android/material/datepicker/MaterialCalendar$i;->DAY:Lcom/google/android/material/datepicker/MaterialCalendar$i;

    invoke-virtual {p0, v0}, Lcom/google/android/material/datepicker/MaterialCalendar;->setSelector(Lcom/google/android/material/datepicker/MaterialCalendar$i;)V

    return-void

    :cond_0
    sget-object v2, Lcom/google/android/material/datepicker/MaterialCalendar$i;->DAY:Lcom/google/android/material/datepicker/MaterialCalendar$i;

    if-ne v0, v2, :cond_1

    invoke-virtual {p0, v1}, Lcom/google/android/material/datepicker/MaterialCalendar;->setSelector(Lcom/google/android/material/datepicker/MaterialCalendar$i;)V
