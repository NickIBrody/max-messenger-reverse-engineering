...
.method public constructor <init>(Lcom/google/android/material/datepicker/MaterialCalendar;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/datepicker/MaterialCalendar$f;->y:Lcom/google/android/material/datepicker/MaterialCalendar;
    ...
    iput-object p1, p0, Lcom/google/android/material/datepicker/MaterialCalendar$f;->w:Ljava/util/Calendar;

    invoke-static {}, Lyvk;->n()Ljava/util/Calendar;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/datepicker/MaterialCalendar$f;->x:Ljava/util/Calendar;
...
.method public i(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    iget-object v3, v0, Lcom/google/android/material/datepicker/MaterialCalendar$f;->y:Lcom/google/android/material/datepicker/MaterialCalendar;
    ...
    iget-object v5, v4, Lzpd;->a:Ljava/lang/Object;

    if-eqz v5, :cond_1

    iget-object v6, v4, Lzpd;->b:Ljava/lang/Object;
    ...
    :cond_2
    iget-object v6, v0, Lcom/google/android/material/datepicker/MaterialCalendar$f;->w:Ljava/util/Calendar;
    ...
    iget-object v5, v0, Lcom/google/android/material/datepicker/MaterialCalendar$f;->x:Ljava/util/Calendar;
    ...
    iget-object v4, v0, Lcom/google/android/material/datepicker/MaterialCalendar$f;->w:Ljava/util/Calendar;
    ...
    invoke-virtual {v1, v4}, Lcom/google/android/material/datepicker/YearGridAdapter;->e0(I)I

    move-result v4

    iget-object v6, v0, Lcom/google/android/material/datepicker/MaterialCalendar$f;->x:Ljava/util/Calendar;

    invoke-virtual {v6, v5}, Ljava/util/Calendar;->get(I)I

    move-result v5

    invoke-virtual {v1, v5}, Lcom/google/android/material/datepicker/YearGridAdapter;->e0(I)I
    ...
    iget-object v11, v0, Lcom/google/android/material/datepicker/MaterialCalendar$f;->y:Lcom/google/android/material/datepicker/MaterialCalendar;

    invoke-static {v11}, Lcom/google/android/material/datepicker/MaterialCalendar;->access$400(Lcom/google/android/material/datepicker/MaterialCalendar;)Lb81;

    move-result-object v11

    iget-object v11, v11, Lb81;->d:La81;

    invoke-virtual {v11}, La81;->c()I
    ...
    iget-object v11, v11, Lb81;->h:Landroid/graphics/Paint;
