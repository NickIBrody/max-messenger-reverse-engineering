...
.field private final itemPool:Lqqe;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lqqe;"
        }
...
.field private final set:Landroidx/transition/c;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p1, v0}, Luqe;-><init>(I)V

    iput-object p1, p0, Lcom/google/android/material/navigation/NavigationBarMenuView;->itemPool:Lqqe;
    ...
    iput-object p1, p0, Lcom/google/android/material/navigation/NavigationBarMenuView;->set:Landroidx/transition/c;
    ...
    iput-object v0, p0, Lcom/google/android/material/navigation/NavigationBarMenuView;->set:Landroidx/transition/c;

    invoke-virtual {v0, p1}, Landroidx/transition/c;->B0(I)Landroidx/transition/c;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    sget v1, Lzhf;->motionDurationMedium4:I
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/transition/c;->z0(J)Landroidx/transition/c;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    sget v1, Lzhf;->motionEasingStandard:I

    sget-object v2, Ldl;->b:Landroid/animation/TimeInterpolator;

    invoke-static {p1, v1, v2}, Lxtb;->g(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;

    move-result-object p1

    invoke-virtual {v0, p1}, Landroidx/transition/c;->A0(Landroid/animation/TimeInterpolator;)Landroidx/transition/c;
...
.method private getNewItem()Lcom/google/android/material/navigation/NavigationBarItemView;
    ...
    iget-object v0, p0, Lcom/google/android/material/navigation/NavigationBarMenuView;->itemPool:Lqqe;
...
.method public buildMenuView()V
    ...
    iget-object v5, p0, Lcom/google/android/material/navigation/NavigationBarMenuView;->itemPool:Lqqe;

    invoke-interface {v5, v4}, Lqqe;->a(Ljava/lang/Object;)Z
...
.method public updateMenuView()V
    ...
    iget-object v1, p0, Lcom/google/android/material/navigation/NavigationBarMenuView;->set:Landroidx/transition/c;
