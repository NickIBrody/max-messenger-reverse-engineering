...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p1, p2, p3, p4}, Ll4a;->c(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    sget-object v2, Lnuf;->NavigationBarView:[I

    sget v1, Lnuf;->NavigationBarView_itemTextAppearanceInactive:I

    sget v3, Lnuf;->NavigationBarView_itemTextAppearanceActive:I
    ...
    invoke-static/range {v0 .. v5}, Lxvj;->j(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Lh1k;
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/view/menu/MenuBuilder;->addMenuPresenter(Landroidx/appcompat/view/menu/c;)V
    ...
    sget p1, Lnuf;->NavigationBarView_itemIconTint:I
    ...
    invoke-virtual {p2, p1}, Lh1k;->c(I)Landroid/content/res/ColorStateList;
    ...
    :goto_0
    sget p1, Lnuf;->NavigationBarView_itemIconSize:I

    invoke-virtual {p0}, Landroid/view/View;->getResources()Landroid/content/res/Resources;

    move-result-object v5

    sget v6, Lzif;->mtrl_navigation_bar_item_default_icon_size:I

    invoke-virtual {v5, v6}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v5

    invoke-virtual {p2, p1, v5}, Lh1k;->f(II)I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/navigation/NavigationBarView;->setItemIconSize(I)V

    sget p1, Lnuf;->NavigationBarView_itemTextAppearanceInactive:I
    ...
    invoke-virtual {p2, p1, v5}, Lh1k;->n(II)I
    ...
    :cond_1
    sget p1, Lnuf;->NavigationBarView_itemTextAppearanceActive:I
    ...
    :cond_2
    sget p1, Lnuf;->NavigationBarView_itemTextAppearanceActiveBoldEnabled:I

    invoke-virtual {p2, p1, v2}, Lh1k;->a(IZ)Z
    ...
    sget p1, Lnuf;->NavigationBarView_itemTextColor:I
    ...
    invoke-static {p1}, Lq26;->g(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    invoke-static {v0, v1, v3, v4}, Lcom/google/android/material/shape/a;->e(Landroid/content/Context;Landroid/util/AttributeSet;II)Lcom/google/android/material/shape/a$b;
    ...
    :cond_6
    sget p1, Lnuf;->NavigationBarView_itemPaddingTop:I
    ...
    :cond_7
    sget p1, Lnuf;->NavigationBarView_itemPaddingBottom:I
    ...
    :cond_8
    sget p1, Lnuf;->NavigationBarView_activeIndicatorLabelPadding:I
    ...
    :cond_9
    sget p1, Lnuf;->NavigationBarView_elevation:I
    ...
    :cond_a
    sget p1, Lnuf;->NavigationBarView_backgroundTint:I

    invoke-static {v0, p2, p1}, Li4a;->a(Landroid/content/Context;Lh1k;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, p1}, La26;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    sget p1, Lnuf;->NavigationBarView_labelVisibilityMode:I

    const/4 v1, -0x1

    invoke-virtual {p2, p1, v1}, Lh1k;->l(II)I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/navigation/NavigationBarView;->setLabelVisibilityMode(I)V

    sget p1, Lnuf;->NavigationBarView_itemBackground:I
    ...
    :cond_b
    sget p1, Lnuf;->NavigationBarView_itemRippleColor:I
    ...
    :goto_1
    sget p1, Lnuf;->NavigationBarView_itemActiveIndicatorStyle:I
    ...
    sget-object v1, Lnuf;->NavigationBarActiveIndicator:[I

    invoke-virtual {v0, p1, v1}, Landroid/content/Context;->obtainStyledAttributes(I[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget v1, Lnuf;->NavigationBarActiveIndicator_android_width:I
    ...
    sget v1, Lnuf;->NavigationBarActiveIndicator_android_height:I
    ...
    sget v1, Lnuf;->NavigationBarActiveIndicator_marginHorizontal:I
    ...
    sget v1, Lnuf;->NavigationBarActiveIndicator_android_color:I
    ...
    sget v1, Lnuf;->NavigationBarActiveIndicator_shapeAppearance:I

    invoke-virtual {p1, v1, v5}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    invoke-static {v0, v1, v5}, Lcom/google/android/material/shape/a;->b(Landroid/content/Context;II)Lcom/google/android/material/shape/a$b;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/navigation/NavigationBarView;->setItemActiveIndicatorShapeAppearance(Lcom/google/android/material/shape/a;)V

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    :cond_c
    sget p1, Lnuf;->NavigationBarView_menu:I
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/view/menu/MenuBuilder;->setCallback(Landroidx/appcompat/view/menu/MenuBuilder$a;)V

    return-void
.end method

.method public static synthetic access$000(Lcom/google/android/material/navigation/NavigationBarView;)Lcom/google/android/material/navigation/NavigationBarView$b;
    .locals 0
...
.method public static synthetic access$100(Lcom/google/android/material/navigation/NavigationBarView;)Lcom/google/android/material/navigation/NavigationBarView$c;
    .locals 0
...
.method public getItemActiveIndicatorShapeAppearance()Lcom/google/android/material/shape/a;
    ...
    invoke-virtual {v0}, Lcom/google/android/material/navigation/NavigationBarMenuView;->getItemActiveIndicatorShapeAppearance()Lcom/google/android/material/shape/a;
...
.method public getMenuView()Landroidx/appcompat/view/menu/d;
    .locals 1
...
.method public setItemActiveIndicatorShapeAppearance(Lcom/google/android/material/shape/a;)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/navigation/NavigationBarMenuView;->setItemActiveIndicatorShapeAppearance(Lcom/google/android/material/shape/a;)V
...
.method public setSelectedItemId(I)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroidx/appcompat/view/menu/MenuBuilder;->performItemAction(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/c;I)Z
