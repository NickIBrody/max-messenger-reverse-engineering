...
.field public static final f:Lcom/google/android/gms/common/a;
...
.method public l(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/google/android/gms/common/a;->q(Landroid/content/Context;ILcom/google/android/gms/common/internal/zag;Landroid/content/DialogInterface$OnCancelListener;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
...
.method public final q(Landroid/content/Context;ILcom/google/android/gms/common/internal/zag;Landroid/content/DialogInterface$OnCancelListener;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p1, p2}, Lh3n;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Lh3n;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1, p2}, Lh3n;->f(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final r(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0}, Lh3n;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final s(Landroid/content/Context;Le3n;)Lcom/google/android/gms/common/api/internal/zabx;
    .locals 2
    ...
    invoke-direct {v1, p2}, Lcom/google/android/gms/common/api/internal/zabx;-><init>(Le3n;)V

    invoke-static {p1, v1, v0}, Lz4n;->r(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method public final u(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Lh3n;->e(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object p3

    invoke-static {p1, p2}, Lh3n;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    new-instance v3, Lofc$d;

    invoke-direct {v3, p1}, Lofc$d;-><init>(Landroid/content/Context;)V

    const/4 v4, 0x1

    invoke-virtual {v3, v4}, Lofc$d;->z(Z)Lofc$d;

    move-result-object v3

    invoke-virtual {v3, v4}, Lofc$d;->h(Z)Lofc$d;

    move-result-object v3

    invoke-virtual {v3, p3}, Lofc$d;->o(Ljava/lang/CharSequence;)Lofc$d;

    move-result-object p3

    new-instance v3, Lofc$b;

    invoke-direct {v3}, Lofc$b;-><init>()V

    invoke-virtual {v3, v0}, Lofc$b;->h(Ljava/lang/CharSequence;)Lofc$b;

    move-result-object v3

    invoke-virtual {p3, v3}, Lofc$d;->K(Lofc$i;)Lofc$d;

    move-result-object p3

    invoke-static {p1}, Lfs5;->b(Landroid/content/Context;)Z
    ...
    invoke-virtual {p3, v0}, Lofc$d;->H(I)Lofc$d;

    move-result-object v0

    invoke-virtual {v0, v5}, Lofc$d;->C(I)Lofc$d;

    invoke-static {p1}, Lfs5;->c(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_3

    sget v0, Lskf;->common_full_open_on_phone:I

    sget v3, Lqtf;->common_open_on_phone:I

    invoke-virtual {v1, v3}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p3, v0, v1, p4}, Lofc$d;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Lofc$d;

    goto :goto_0

    :cond_3
    invoke-virtual {p3, p4}, Lofc$d;->m(Landroid/app/PendingIntent;)Lofc$d;
    ...
    invoke-virtual {p3, v3}, Lofc$d;->H(I)Lofc$d;

    move-result-object v3

    sget v6, Lqtf;->common_google_play_services_notification_ticker:I

    invoke-virtual {v1, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v3, v1}, Lofc$d;->L(Ljava/lang/CharSequence;)Lofc$d;
    ...
    invoke-virtual {v1, v6, v7}, Lofc$d;->P(J)Lofc$d;

    move-result-object v1

    invoke-virtual {v1, p4}, Lofc$d;->m(Landroid/app/PendingIntent;)Lofc$d;

    move-result-object p4

    invoke-virtual {p4, v0}, Lofc$d;->n(Ljava/lang/CharSequence;)Lofc$d;
    ...
    sget v1, Lqtf;->common_google_play_services_notification_channel_name:I
    ...
    :cond_7
    :goto_1
    invoke-virtual {p3, v0}, Lofc$d;->k(Ljava/lang/String;)Lofc$d;

    :goto_2
    invoke-virtual {p3}, Lofc$d;->c()Landroid/app/Notification;
    ...
    :cond_8
    sget-object p2, Lv08;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final v(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/gms/common/zad;-><init>(Lcom/google/android/gms/common/a;Landroid/content/Context;)V
...
.method public final w(Landroid/app/Activity;Lwf9;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 7
    ...
    invoke-static {p2, p4, v0}, Lcom/google/android/gms/common/internal/zag;->zad(Lwf9;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/zag;
    ...
    invoke-virtual {p0, v2, p1, p2, v5}, Lcom/google/android/gms/common/a;->t(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final x(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    invoke-static {p1}, Lxu8;->a(Landroid/content/Context;)Z
