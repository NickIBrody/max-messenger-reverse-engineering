...
# direct methods
.method public constructor <init>(Ljava/lang/String;IIZLcom/google/android/exoplayer2/upstream/HttpDataSource$b;Lrte;Z)V
    .locals 1

    const/4 v0, 0x1

    .line 2
    invoke-direct {p0, v0}, Lxn0;-><init>(Z)V
    ...
    .line 8
    iput-object p6, p0, Lcom/google/android/exoplayer2/upstream/c;->l:Lrte;
...
.method public synthetic constructor <init>(Ljava/lang/String;IIZLcom/google/android/exoplayer2/upstream/HttpDataSource$b;Lrte;ZLcom/google/android/exoplayer2/upstream/c$a;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p7}, Lcom/google/android/exoplayer2/upstream/c;-><init>(Ljava/lang/String;IIZLcom/google/android/exoplayer2/upstream/HttpDataSource$b;Lrte;Z)V
...
.method public final A([BII)I
    ...
    invoke-virtual {p0, p1}, Lxn0;->p(I)V

    return p1
.end method

.method public final B(JLcom/google/android/exoplayer2/upstream/b;)V
    .locals 7
    ...
    invoke-virtual {p0, v4}, Lxn0;->p(I)V
...
.method public close()V
    ...
    invoke-static {v3, v5, v6}, Lcom/google/android/exoplayer2/upstream/c;->y(Ljava/net/HttpURLConnection;J)V
    :try_end_0
    ...
    iget-object v4, p0, Lcom/google/android/exoplayer2/upstream/c;->m:Lcom/google/android/exoplayer2/upstream/b;

    invoke-static {v4}, Lrwk;->j(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/upstream/c;->t()V
...
.method public o(Lcom/google/android/exoplayer2/upstream/b;)J
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/c;->m:Lcom/google/android/exoplayer2/upstream/b;
    ...
    invoke-virtual {p0, p1}, Lxn0;->r(Lcom/google/android/exoplayer2/upstream/b;)V

    const/4 v2, 0x1

    :try_start_0
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/upstream/c;->w(Lcom/google/android/exoplayer2/upstream/b;)Ljava/net/HttpURLConnection;
    ...
    iget-object v7, p0, Lcom/google/android/exoplayer2/upstream/c;->l:Lrte;
    ...
    :cond_4
    invoke-static {v3}, Lcom/google/android/exoplayer2/upstream/c;->v(Ljava/net/HttpURLConnection;)Z
    ...
    invoke-static {v6, v5}, Llf8;->b(Ljava/lang/String;Ljava/lang/String;)J
    ...
    invoke-virtual {p0, p1}, Lxn0;->s(Lcom/google/android/exoplayer2/upstream/b;)V

    :try_start_2
    invoke-virtual {p0, v0, v1, p1}, Lcom/google/android/exoplayer2/upstream/c;->B(JLcom/google/android/exoplayer2/upstream/b;)V
    :try_end_2
    ...
    invoke-static {v4}, Llf8;->c(Ljava/lang/String;)J

    move-result-wide v4

    iget-wide v12, p1, Lcom/google/android/exoplayer2/upstream/b;->g:J
    ...
    :try_start_3
    invoke-static {v0}, Lrwk;->s0(Ljava/io/InputStream;)[B
    ...
    invoke-static {p1, v10, v2}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;->c(Ljava/io/IOException;Lcom/google/android/exoplayer2/upstream/b;I)Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;
...
.method public read([BII)I
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/exoplayer2/upstream/c;->A([BII)I
    ...
    iget-object p2, p0, Lcom/google/android/exoplayer2/upstream/c;->m:Lcom/google/android/exoplayer2/upstream/b;

    invoke-static {p2}, Lrwk;->j(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final u(Ljava/net/URL;Ljava/lang/String;Lcom/google/android/exoplayer2/upstream/b;)Ljava/net/URL;
    .locals 5
...
.method public final w(Lcom/google/android/exoplayer2/upstream/b;)Ljava/net/HttpURLConnection;
    .locals 16
    ...
    iget-object v2, v11, Lcom/google/android/exoplayer2/upstream/b;->a:Landroid/net/Uri;
    ...
    iget v2, v11, Lcom/google/android/exoplayer2/upstream/b;->c:I

    iget-object v3, v11, Lcom/google/android/exoplayer2/upstream/b;->d:[B

    iget-wide v4, v11, Lcom/google/android/exoplayer2/upstream/b;->g:J

    iget-wide v6, v11, Lcom/google/android/exoplayer2/upstream/b;->h:J

    const/4 v12, 0x1

    invoke-virtual {v11, v12}, Lcom/google/android/exoplayer2/upstream/b;->d(I)Z

    move-result v8

    iget-boolean v9, v0, Lcom/google/android/exoplayer2/upstream/c;->e:Z

    if-nez v9, :cond_0

    iget-boolean v9, v0, Lcom/google/android/exoplayer2/upstream/c;->k:Z

    if-nez v9, :cond_0

    const/4 v9, 0x1

    iget-object v10, v11, Lcom/google/android/exoplayer2/upstream/b;->e:Ljava/util/Map;

    invoke-virtual/range {v0 .. v10}, Lcom/google/android/exoplayer2/upstream/c;->x(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    :goto_1
    invoke-virtual {v0, v1, v14, v11}, Lcom/google/android/exoplayer2/upstream/c;->u(Ljava/net/URL;Ljava/lang/String;Lcom/google/android/exoplayer2/upstream/b;)Ljava/net/URL;
    ...
    invoke-direct {v1, v2, v11, v3, v4}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/io/IOException;Lcom/google/android/exoplayer2/upstream/b;II)V
...
.method public final x(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/upstream/c;->z(Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    :cond_1
    invoke-static {p4, p5, p6, p7}, Llf8;->a(JJ)Ljava/lang/String;
