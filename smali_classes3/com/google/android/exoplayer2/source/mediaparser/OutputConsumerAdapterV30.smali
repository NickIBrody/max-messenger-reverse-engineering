...
.field private extractorOutput:Lhw6;

.field private lastChunkIndex:Lqp3;
...
.field private final primaryTrackManifestFormat:Lcom/google/android/exoplayer2/i;
...
.field private timestampAdjuster:Lx0k;
...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0, v2, v0, v1}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;-><init>(Lcom/google/android/exoplayer2/i;IZ)V

    return-void
.end method

.method public constructor <init>(Lcom/google/android/exoplayer2/i;IZ)V
    .locals 0
    ...
    .line 4
    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->primaryTrackManifestFormat:Lcom/google/android/exoplayer2/i;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lhw6;
...
.method private static getColorInfo(Landroid/media/MediaFormat;)Luv3;
    .locals 6
    ...
    invoke-static {p0, v2, v3}, Lsmd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I

    move-result v2

    const-string v4, "color-range"

    invoke-static {p0, v4, v3}, Lsmd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I

    move-result v4

    const-string v5, "color-standard"

    invoke-static {p0, v5, v3}, Lsmd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    invoke-direct {v1, p0, v4, v2, v0}, Luv3;-><init>(III[B)V
...
.method private maybeEndTracks()V
    ...
    :cond_2
    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lhw6;

    invoke-interface {v0}, Lhw6;->j()V
...
.method private maybeObtainChunkIndex(Landroid/media/MediaFormat;)Z
    ...
    invoke-direct {p1, v3, v4, v5, v6}, Lqp3;-><init>([I[J[J[J)V

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->lastChunkIndex:Lqp3;

    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lhw6;

    invoke-interface {v0, p1}, Lhw6;->q(Le8h;)V
...
.method private toExoPlayerCryptoData(ILandroid/media/MediaCodec$CryptoInfo;)La7k$a;
    .locals 5
    ...
    invoke-static {v2, v1, v0}, Llp9;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private toExoPlayerFormat(Landroid/media/MediaParser$TrackData;)Lcom/google/android/exoplayer2/i;
    .locals 8
    ...
    invoke-direct {v4}, Lcom/google/android/exoplayer2/i$b;-><init>()V
    ...
    invoke-virtual {v4, p1}, Lcom/google/android/exoplayer2/i$b;->M(Lcom/google/android/exoplayer2/drm/DrmInitData;)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->K(Ljava/lang/String;)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->Z(I)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->H(I)Lcom/google/android/exoplayer2/i$b;

    move-result-object p1

    invoke-static {v0}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->getColorInfo(Landroid/media/MediaFormat;)Luv3;

    move-result-object v4

    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->J(Luv3;)Lcom/google/android/exoplayer2/i$b;

    move-result-object p1

    invoke-virtual {p1, v1}, Lcom/google/android/exoplayer2/i$b;->e0(Ljava/lang/String;)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->I(Ljava/lang/String;)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->P(F)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->j0(I)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->T(Ljava/util/List;)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->V(Ljava/lang/String;)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->W(I)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->Y(I)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/i$b;->d0(I)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/i$b;->N(I)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/i$b;->O(I)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/i$b;->a0(F)Lcom/google/android/exoplayer2/i$b;
    ...
    invoke-virtual {p1, v3, v4}, Lcom/google/android/exoplayer2/i$b;->i0(J)Lcom/google/android/exoplayer2/i$b;

    move-result-object p1

    invoke-virtual {p1, v2}, Lcom/google/android/exoplayer2/i$b;->F(I)Lcom/google/android/exoplayer2/i$b;
    ...
    iget-object v3, v0, Lcom/google/android/exoplayer2/i;->H:Ljava/lang/String;

    invoke-static {v3, v1}, Lrwk;->c(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_0

    iget v3, v0, Lcom/google/android/exoplayer2/i;->Z:I

    if-ne v3, v2, :cond_0

    iget-object v1, v0, Lcom/google/android/exoplayer2/i;->y:Ljava/lang/String;

    invoke-virtual {p1, v1}, Lcom/google/android/exoplayer2/i$b;->V(Ljava/lang/String;)Lcom/google/android/exoplayer2/i$b;

    move-result-object v1

    iget v2, v0, Lcom/google/android/exoplayer2/i;->A:I

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/i$b;->c0(I)Lcom/google/android/exoplayer2/i$b;

    move-result-object v1

    iget v2, v0, Lcom/google/android/exoplayer2/i;->z:I

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/i$b;->g0(I)Lcom/google/android/exoplayer2/i$b;

    move-result-object v1

    iget-object v2, v0, Lcom/google/android/exoplayer2/i;->x:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/i$b;->U(Ljava/lang/String;)Lcom/google/android/exoplayer2/i$b;

    move-result-object v1

    iget-object v0, v0, Lcom/google/android/exoplayer2/i;->F:Lcom/google/android/exoplayer2/metadata/Metadata;

    invoke-virtual {v1, v0}, Lcom/google/android/exoplayer2/i$b;->X(Lcom/google/android/exoplayer2/metadata/Metadata;)Lcom/google/android/exoplayer2/i$b;
...
.method private static toTrackTypeConstant(Ljava/lang/String;)I
    ...
    invoke-static {p0}, Lqrb;->k(Ljava/lang/String;)I
...
.method public getChunkIndex()Lqp3;
    .locals 1

    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->lastChunkIndex:Lqp3;
...
.method public getSampleFormats()[Lcom/google/android/exoplayer2/i;
    .locals 3
...
.method public onSampleCompleted(IJIIILandroid/media/MediaCodec$CryptoInfo;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->timestampAdjuster:Lx0k;

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2, p3}, Lx0k;->a(J)J
    ...
    invoke-direct {p0, p1, p7}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->toExoPlayerCryptoData(ILandroid/media/MediaCodec$CryptoInfo;)La7k$a;
...
.method public onSampleDataFound(ILandroid/media/MediaParser$InputReader;)V
    ...
    invoke-interface {v0, p1, v1}, Lhw6;->b(II)La7k;
    ...
    invoke-interface {v0, p1, p2, v1}, La7k;->f(Lo45;IZ)I
...
.method public onSeekMapFound(Landroid/media/MediaParser$SeekMap;)V
    ...
    iget-object v2, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lhw6;

    iget-boolean v3, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->seekingDisabled:Z

    if-eqz v3, :cond_2

    new-instance p1, Le8h$b;
    ...
    :goto_0
    invoke-direct {p1, v0, v1}, Le8h$b;-><init>(J)V
    ...
    :goto_1
    invoke-interface {v2, p1}, Lhw6;->q(Le8h;)V
...
.method public onTrackDataFound(ILandroid/media/MediaParser$TrackData;)V
    ...
    invoke-interface {v2, p1, v1}, Lhw6;->b(II)La7k;
    ...
    :cond_4
    invoke-direct {p0, p2}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->toExoPlayerFormat(Landroid/media/MediaParser$TrackData;)Lcom/google/android/exoplayer2/i;

    move-result-object p2

    iget-object v1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->primaryTrackManifestFormat:Lcom/google/android/exoplayer2/i;
    ...
    invoke-virtual {p2, v1}, Lcom/google/android/exoplayer2/i;->i(Lcom/google/android/exoplayer2/i;)Lcom/google/android/exoplayer2/i;
...
.method public setExtractorOutput(Lhw6;)V
    .locals 0
...
.method public setTimestampAdjuster(Lx0k;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->timestampAdjuster:Lx0k;
