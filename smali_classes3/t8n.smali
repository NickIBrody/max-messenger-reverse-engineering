...
.method public static declared-synchronized a()Ljava/lang/ClassLoader;
    ...
    :try_start_0
    sget-object v1, Lt8n;->a:Ljava/lang/ClassLoader;

    if-nez v1, :cond_8

    const-string v1, "Failed to get thread context classloader "

    sget-object v2, Lt8n;->b:Ljava/lang/Thread;
    ...
    invoke-direct {v2, v10, v6}, Lj5n;-><init>(Ljava/lang/ThreadGroup;Ljava/lang/String;)V
    :try_end_2
    ...
    :goto_7
    :try_start_5
    sput-object v2, Lt8n;->b:Ljava/lang/Thread;
    :try_end_5
    ...
    :try_start_8
    sget-object v4, Lt8n;->b:Ljava/lang/Thread;
    ...
    :goto_a
    :try_start_a
    sput-object v3, Lt8n;->a:Ljava/lang/ClassLoader;
    :try_end_a
