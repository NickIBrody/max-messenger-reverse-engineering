...
# direct methods
.method public static final handleUncaughtCoroutineException(Lcv4;Ljava/lang/Throwable;)V
    .locals 2
    ...
    :try_start_0
    invoke-interface {v1, p0, p1}, Lkv4;->q0(Lcv4;Ljava/lang/Throwable;)V
    :try_end_0
    ...
    invoke-static {p1, v1}, Lmv4;->b(Ljava/lang/Throwable;Ljava/lang/Throwable;)Ljava/lang/Throwable;
    ...
    invoke-direct {v0, p0}, Lkotlinx/coroutines/internal/DiagnosticCoroutineContextException;-><init>(Lcv4;)V
