...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, v0, v0}, Lq26;->b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
...
.method public static b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1}, Lq26;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-static {p0, p1}, Lq26;->h(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
...
.method public static c(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2, v0}, Lq26;->e(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
...
.method public static e(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p2}, La26;->p(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public static g(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0}, Lg26;->a(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, Li26;->a(Ljava/lang/Object;)Landroid/graphics/drawable/ColorStateListDrawable;

    move-result-object p0

    invoke-static {p0}, Lk26;->a(Landroid/graphics/drawable/ColorStateListDrawable;)Landroid/content/res/ColorStateList;
...
.method public static l(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    invoke-static {p0, p1}, Lq26$b;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    :try_start_0
    invoke-static {p0, p1}, Lq26$a;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    :try_end_0
