...
# direct methods
.method public static a(Landroid/content/Context;Lh1k;I)Landroid/content/res/ColorStateList;
    .locals 1

    invoke-virtual {p1, p2}, Lh1k;->s(I)Z
    ...
    invoke-virtual {p1, p2, v0}, Lh1k;->n(II)I

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0, v0}, Lwu;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public static h(Landroid/content/Context;Landroid/content/res/TypedArray;I)Ldrj;
    .locals 1
    ...
    invoke-direct {p2, p0, p1}, Ldrj;-><init>(Landroid/content/Context;I)V
...
.method public static i(Landroid/content/Context;II)I
    ...
    :cond_0
    sget-object v0, Lnuf;->TextAppearance:[I
    ...
    sget v1, Lnuf;->TextAppearance_android_textSize:I
    ...
    :cond_1
    invoke-static {v0}, Li4a;->c(Landroid/util/TypedValue;)I
