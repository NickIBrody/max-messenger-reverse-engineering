...
.method public static b(Ljava/util/Iterator;Lrte;)Z
    .locals 0

    invoke-static {p0, p1}, Lo19;->p(Ljava/util/Iterator;Lrte;)I
...
.method public static d(Ljava/util/Iterator;)Ljava/util/Iterator;
    ...
    new-instance v0, Lo19$d;

    invoke-direct {v0, p0}, Lo19$d;-><init>(Ljava/util/Iterator;)V
...
.method public static f(Ljava/util/Iterator;Ljava/util/Iterator;)Z
    ...
    invoke-static {v0, v2}, Lmkc;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public static g()Lelk;
    .locals 1

    invoke-static {}, Lo19;->h()Lflk;
...
.method public static h()Lflk;
    .locals 1

    sget-object v0, Lo19$c;->z:Lflk;
...
.method public static j(Ljava/util/Iterator;Lrte;)Lelk;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lo19$a;-><init>(Ljava/util/Iterator;Lrte;)V

    return-object v0
.end method

.method public static k(Ljava/util/Iterator;Lrte;)Ljava/lang/Object;
    .locals 2
    ...
    invoke-interface {p1, v0}, Lrte;->apply(Ljava/lang/Object;)Z
...
.method public static p(Ljava/util/Iterator;Lrte;)I
    .locals 2
...
.method public static s(Ljava/util/Iterator;Lrte;)Z
    .locals 2
...
.method public static t(Ljava/lang/Object;)Lelk;
    .locals 1

    new-instance v0, Lo19$f;

    invoke-direct {v0, p0}, Lo19$f;-><init>(Ljava/lang/Object;)V
...
.method public static w(Ljava/util/Iterator;Ltt7;)Ljava/util/Iterator;
    .locals 1

    invoke-static {p1}, Llte;->p(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v0, Lo19$b;

    invoke-direct {v0, p0, p1}, Lo19$b;-><init>(Ljava/util/Iterator;Ltt7;)V
