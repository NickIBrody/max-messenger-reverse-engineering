...
.method public constructor <init>()V
    ...
    sget-object v0, Lvrm;->a:[Lvrm$a;

    if-nez v0, :cond_1

    sget v0, Lvrm;->b:I

    new-array v0, v0, [Lvrm$a;

    sput-object v0, Lvrm;->a:[Lvrm$a;
    ...
    invoke-direct {v1, p0}, Lsrm;-><init>(Lvrm;)V
...
.method public static synthetic a(Lvrm;Ljava/util/Map$Entry;)V
    .locals 0

    invoke-virtual {p0, p1}, Lvrm;->h(Ljava/util/Map$Entry;)V
...
.method public static synthetic b(II)I
    ...
    invoke-static {p0, p1}, Lvrm;->d(II)I
...
.method public static synthetic c([Lvrm$a;Lvrm$a;I)V
    .locals 0

    invoke-static {p0, p1, p2}, Lvrm;->i([Lvrm$a;Lvrm$a;I)V
...
.method public static synthetic i([Lvrm$a;Lvrm$a;I)V
    .locals 0
...
# virtual methods
.method public final f([Lvrm$a;Lnrm;)Lvrm$a;
    .locals 2

    :goto_0
    invoke-virtual {p2}, Lnrm;->a()B
    ...
    invoke-virtual {p1}, Lvrm$a;->a()Z

    move-result v0

    if-eqz v0, :cond_0

    iget v0, p1, Lvrm$a;->b:I

    invoke-virtual {p2, v0}, Lnrm;->b(I)V

    return-object p1

    :cond_0
    invoke-virtual {p2}, Lnrm;->d()I
    ...
    iget-object v0, p1, Lvrm$a;->c:[Lvrm$a;

    if-eqz v0, :cond_1

    invoke-virtual {p2, v1}, Lnrm;->b(I)V

    iget-object p1, p1, Lvrm$a;->c:[Lvrm$a;
    ...
    invoke-virtual {p2, p1}, Lnrm;->b(I)V
...
.method public final g([B)Ljava/lang/String;
    ...
    invoke-direct {v1, p1}, Lnrm;-><init>([B)V

    :cond_0
    :goto_0
    invoke-virtual {v1}, Lnrm;->c()Z

    move-result p1

    if-eqz p1, :cond_1

    sget-object p1, Lvrm;->a:[Lvrm$a;

    invoke-virtual {p0, p1, v1}, Lvrm;->f([Lvrm$a;Lnrm;)Lvrm$a;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-char p1, p1, Lvrm$a;->a:C
...
.method public final synthetic h(Ljava/util/Map$Entry;)V
    .locals 2
    ...
    invoke-virtual {p0, v0, v1, p1}, Lvrm;->j([Lvrm$a;Ljava/lang/String;I)V

    return-void
.end method

.method public final j([Lvrm$a;Ljava/lang/String;I)V
    .locals 5
    ...
    invoke-static {p2, v0}, Lvrm;->e(Ljava/lang/String;I)I

    move-result v0

    new-instance v2, Lvrm$a;

    invoke-virtual {p2}, Ljava/lang/String;->length()I

    move-result v3

    invoke-direct {v2, p3, v3}, Lvrm$a;-><init>(II)V
    ...
    invoke-direct {v0, p2}, Ltrm;-><init>(I)V
    ...
    new-instance p3, Lurm;

    invoke-direct {p3, p1, v2}, Lurm;-><init>([Lvrm$a;Lvrm$a;)V
    ...
    :cond_0
    invoke-static {p2, v1}, Lvrm;->e(Ljava/lang/String;I)I
    ...
    new-instance v1, Lvrm$a;

    invoke-direct {v1}, Lvrm$a;-><init>()V
