...
.method private doAudioRecordInit(II)Z
    ...
    iput v2, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->initBufferSize:I
    ...
    invoke-static {v6, p1, v1, v7, v3}, Lorg/webrtc/audio/WebRtcAudioRecord;->createAudioRecordOnMOrHigher(IIIII)Landroid/media/AudioRecord;

    move-result-object v1

    iput-object v1, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->voiceAudioRecord:Landroid/media/AudioRecord;

    iget-object v1, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->audioSourceMatchesRecordingSessionRef:Ljava/util/concurrent/atomic/AtomicReference;

    const/4 v3, 0x0

    invoke-virtual {v1, v3}, Ljava/util/concurrent/atomic/AtomicReference;->set(Ljava/lang/Object;)V

    iget-object v1, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->preferredDevice:Landroid/media/AudioDeviceInfo;

    if-eqz v1, :cond_2

    invoke-virtual {p0, v1}, Lorg/webrtc/audio/WebRtcAudioRecord;->setPreferredDevice(Landroid/media/AudioDeviceInfo;)V
    :try_end_1
    ...
    invoke-direct {p0, v1}, Lorg/webrtc/audio/WebRtcAudioRecord;->reportWebRtcAudioRecordInitError(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5}, Lorg/webrtc/audio/WebRtcAudioRecord;->releaseAudioResources(Z)V
    ...
    const-string v6, "Creation or initialization of audio recorder failed. Buffer size="
    ...
    const-string v5, "AudioRecord.getMinBufferSize failed: "
...
.method public static bridge synthetic m(Lorg/webrtc/audio/WebRtcAudioRecord;I)V
    .locals 0
...
.method private scheduleLogRecordingConfigurationsTask(Landroid/media/AudioRecord;)V
    ...
    invoke-direct {v0, p0, p1}, Lqtl;-><init>(Lorg/webrtc/audio/WebRtcAudioRecord;Landroid/media/AudioRecord;)V
...
.method public initDeviceAudioRecord(Landroid/media/projection/MediaProjection;)V
    ...
    invoke-static {p1}, Lotl;->a(Landroid/media/projection/MediaProjection;)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;

    move-result-object v4

    invoke-static {v4, v3}, Lltl;->a(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;

    const/16 v5, 0xe

    invoke-static {v4, v5}, Lltl;->a(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;

    new-instance v5, Landroid/media/AudioRecord$Builder;

    invoke-direct {v5}, Landroid/media/AudioRecord$Builder;-><init>()V

    invoke-static {v4}, Lmtl;->a(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;)Landroid/media/AudioPlaybackCaptureConfiguration;

    move-result-object v4

    invoke-static {v5, v4}, Lntl;->a(Landroid/media/AudioRecord$Builder;Landroid/media/AudioPlaybackCaptureConfiguration;)Landroid/media/AudioRecord$Builder;
    ...
    const-string v2, "device: AudioRecord.startRecording failed - incorrect state :"
    ...
    const-string v2, "device: AudioRecord.startRecording failed: "
    ...
    const-string v1, "device: device AudioRecord ctor error: "
    ...
    const-string v4, "device: AudioRecord.getMinBufferSize failed: "
...
.method public restartAudioRecording(Z)V
    ...
    :goto_1
    iget-object v4, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->silenceProvider:Lorg/webrtc/audio/WebRtcSilenceProvider;
    ...
    const-string v4, "Audio record is initialized already ("

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v1}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v1, ") or silence provider was not created ("
    ...
    iget-object v2, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->recordState:Lorg/webrtc/audio/WebRtcAudioRecord$RecordState;
    ...
    const-string v4, "Try to restart audio recording (force="
