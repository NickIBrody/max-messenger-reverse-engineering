...
public class HostnameChecker {
    ...
    /* renamed from: a */
    private static final HostnameChecker f97872a = new HostnameChecker((byte) 1);

    /* renamed from: b */
    private static final HostnameChecker f97873b = new HostnameChecker((byte) 2);

    /* renamed from: c */
    private static final int f97874c = 2;

    /* renamed from: d */
    private static final int f97875d = 7;

    /* renamed from: e */
    private final byte f97876e;
    ...
    /* renamed from: a */
    private static void m92624a(String str, X509Certificate x509Certificate) throws CertificateException {
    ...
    /* renamed from: b */
    private void m92627b(String str, X509Certificate x509Certificate) throws CertificateException {
        try {
            new SNIHostName(str);
            Collection<List<?>> subjectAlternativeNames = x509Certificate.getSubjectAlternativeNames();
            if (subjectAlternativeNames != null) {
                ...
                for (List<?> list : subjectAlternativeNames) {
                    if (((Integer) list.get(0)).intValue() == 2) {
                        z = true;
                        if (m92626a(str, (String) list.get(1))) {
                            return;
                        }
                    }
                }
            ...
            if (findMostSpecificAttribute != null) {
                try {
                    if (m92626a(str, findMostSpecificAttribute.getAsString())) {
                        return;
                    }
    ...
    /* renamed from: c */
    private static boolean m92629c(String str, String str2) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            if (!m92631e(stringTokenizer.nextToken(), stringTokenizer2.nextToken())) {
                return false;
            }
        }
        return true;
    ...
    /* renamed from: d */
    private static boolean m92630d(String str, String str2) {
        Locale locale = Locale.ENGLISH;
        String lowerCase = str.toLowerCase(locale);
        String lowerCase2 = str2.toLowerCase(locale);
        ...
        if (m92631e(lowerCase.substring(0, indexOf2), lowerCase2.substring(0, indexOf))) {
    ...
    /* renamed from: e */
    private static boolean m92631e(String str, String str2) {
    ...
    public void match(String str, X509Certificate x509Certificate) throws CertificateException {
        ...
        if (m92625a(str)) {
            m92624a(str, x509Certificate);
        } else {
            m92627b(str, x509Certificate);
        }
    }

    /* renamed from: a */
    private static boolean m92625a(String str) {
        return IPAddressUtil.isIPv4LiteralAddress(str) || IPAddressUtil.isIPv6LiteralAddress(str);
    }

    /* renamed from: b */
    private static boolean m92628b(String str, String str2) {
        StringBuilder sb;
        String str3;
    ...
    /* renamed from: a */
    private boolean m92626a(String str, String str2) {
        byte b;
        if (m92628b(str, str2)) {
            return false;
        }
        ...
        if (b == 1) {
            return m92629c(str, str2);
        }
        if (b == 2) {
            return m92630d(str, str2);
        }
        return false;
    }
}
