...
public class ManifestInstall {
    ...
    public static void main(String[] strArr) throws BackingStoreException, IOException, ArgumentException {
        ShellInstaller.makeAction((URL) AccessController.doPrivileged(new PrivilegedAction() { // from class: ru.CryptoPro.CAdES.installer.ManifestInstall.1
        ...
        }), Install.ALL_INSTALL, Install.ALL_JARS, new String[]{"-install"});
    }
}
