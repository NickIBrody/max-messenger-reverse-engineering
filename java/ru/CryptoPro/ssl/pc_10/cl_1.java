...
public class cl_1 {
    ...
    /* renamed from: a */
    public static Set m92185a(KeyStore keyStore) {
        StringBuilder sb;
        StringBuilder sb2;
            ...
            while (aliases.hasMoreElements()) {
                ...
                if (keyStore.isCertificateEntry(nextElement)) {
                    ...
                    if (Platform.isAndroid) {
                        try {
                            certificate = cl_5.f97244s.generateCertificate(new ByteArrayInputStream(certificate.getEncoded()));
                    ...
                    if (certificate2 instanceof X509Certificate) {
                        if (Platform.isAndroid) {
                            try {
                                certificate2 = cl_5.f97244s.generateCertificate(new ByteArrayInputStream(certificate2.getEncoded()));
