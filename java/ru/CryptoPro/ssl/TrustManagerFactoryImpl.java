...
abstract class TrustManagerFactoryImpl extends TrustManagerFactorySpi {
    ...
    /* renamed from: a */
    private X509TrustManager f96545a = null;

    /* renamed from: b */
    private boolean f96546b = false;

    public final class PKIXFactory extends TrustManagerFactoryImpl {
        @Override // ru.CryptoPro.ssl.TrustManagerFactoryImpl
        /* renamed from: a */
        public X509TrustManager mo91611a(KeyStore keyStore) throws KeyStoreException {
            return new cl_122("PKIX", keyStore);
        }

        @Override // ru.CryptoPro.ssl.TrustManagerFactoryImpl
        /* renamed from: a */
        public X509TrustManager mo91612a(ManagerFactoryParameters managerFactoryParameters) throws InvalidAlgorithmParameterException {
            ...
            if (parameters instanceof PKIXBuilderParameters) {
                return new cl_122("PKIX", (PKIXBuilderParameters) parameters);
            }
    ...
    /* renamed from: a */
    public static FileInputStream m91609a(File file) {
        return (FileInputStream) AccessController.doPrivileged(new cl_113(file));
    }

    /* renamed from: a */
    public abstract X509TrustManager mo91611a(KeyStore keyStore);

    /* renamed from: a */
    public abstract X509TrustManager mo91612a(ManagerFactoryParameters managerFactoryParameters);

    @Override // javax.net.ssl.TrustManagerFactorySpi
    public TrustManager[] engineGetTrustManagers() {
        if (this.f96546b) {
            return new TrustManager[]{this.f96545a};
        }
    ...
    public void engineInit(KeyStore keyStore) throws KeyStoreException {
        ...
        this.f96545a = mo91611a(keyStore);
        this.f96546b = true;
    }
    ...
    */
    public static KeyStore m91610a(String str) throws Exception {
        ...
        try {
            ...
            if (JCP.RAW_PREFIX.equals(str3)) {
                ...
                if (str3 != null) {
                    ...
                    FileInputStream m91609a = m91609a(file2);
                    if (m91609a == null) {
                        try {
                            File file3 = new File(str4 + str2 + "lib" + str2 + BKSTrustStore.STORAGE_DIRECTORY + str2 + "cacerts");
                            fileInputStream = m91609a(file3);
                            file = file3;
                        } catch (Throwable th) {
                            th = th;
                            fileInputStream2 = m91609a;
    ...
    public void engineInit(ManagerFactoryParameters managerFactoryParameters) throws InvalidAlgorithmParameterException {
        this.f96545a = mo91612a(managerFactoryParameters);
        this.f96546b = true;
    }
}
