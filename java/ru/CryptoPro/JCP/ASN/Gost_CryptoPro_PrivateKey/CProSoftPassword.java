...
public class CProSoftPassword extends Asn1Type {
    ...
    /* renamed from: iv */
    public Asn1OctetString f93536iv;
    ...
    public int encode(Asn1BerEncodeBuffer asn1BerEncodeBuffer, boolean z) throws Asn1Exception {
        int encode = this.cmac.encode(asn1BerEncodeBuffer, true) + this.f93536iv.encode(asn1BerEncodeBuffer, true) + this.algorithm.encode(asn1BerEncodeBuffer, true);
    ...
    public CProSoftPassword(AlgorithmIdentifier algorithmIdentifier, byte[] bArr, byte[] bArr2) {
        this.algorithm = algorithmIdentifier;
        this.f93536iv = new Asn1OctetString(bArr);
