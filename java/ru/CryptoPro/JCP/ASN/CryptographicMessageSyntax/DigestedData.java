...
public class DigestedData extends Asn1Type {
    ...
    public int encode(Asn1BerEncodeBuffer asn1BerEncodeBuffer, boolean z) throws Asn1Exception {
        int encode = this.digest.encode(asn1BerEncodeBuffer, true) + this.encapContentInfo.encode(asn1BerEncodeBuffer, true) + this.digestAlgorithm.encode(asn1BerEncodeBuffer, true) + this.version.encode(asn1BerEncodeBuffer, true);
