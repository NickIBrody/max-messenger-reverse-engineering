...
public class PBMParameter extends Asn1Type {
    ...
    public int encode(Asn1BerEncodeBuffer asn1BerEncodeBuffer, boolean z) throws Asn1Exception {
        int encode = this.mac.encode(asn1BerEncodeBuffer, true) + this.iterationCount.encode(asn1BerEncodeBuffer, true) + this.owf.encode(asn1BerEncodeBuffer, true) + this.salt.encode(asn1BerEncodeBuffer, true);
