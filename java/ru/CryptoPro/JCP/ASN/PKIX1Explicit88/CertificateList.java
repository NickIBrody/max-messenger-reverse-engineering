...
public class CertificateList extends Asn1Type {
    ...
    public int encode(Asn1BerEncodeBuffer asn1BerEncodeBuffer, boolean z) throws Asn1Exception {
        int encode = this.signature.encode(asn1BerEncodeBuffer, true) + this.signatureAlgorithm.encode(asn1BerEncodeBuffer, true) + this.tbsCertList.encode(asn1BerEncodeBuffer, true);
