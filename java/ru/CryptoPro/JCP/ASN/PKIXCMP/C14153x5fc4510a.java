...
/* renamed from: ru.CryptoPro.JCP.ASN.PKIXCMP.CertificationRequest_certificationRequestInfo_subjectPublicKeyInfo */
/* loaded from: classes5.dex */
public class C14153x5fc4510a extends Asn1Type {
    public AlgorithmIdentifier algorithm;
    public Asn1BitString subjectPublicKey;

    public C14153x5fc4510a() {
    }
    ...
    public C14153x5fc4510a(AlgorithmIdentifier algorithmIdentifier, Asn1BitString asn1BitString) {
        this.algorithm = algorithmIdentifier;
        this.subjectPublicKey = asn1BitString;
    }
}
