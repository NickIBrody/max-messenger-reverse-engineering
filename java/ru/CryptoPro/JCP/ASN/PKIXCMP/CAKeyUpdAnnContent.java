...
public class CAKeyUpdAnnContent extends Asn1Type {
    ...
    public int encode(Asn1BerEncodeBuffer asn1BerEncodeBuffer, boolean z) throws Asn1Exception {
        int encode = this.newWithNew.encode(asn1BerEncodeBuffer, true) + this.newWithOld.encode(asn1BerEncodeBuffer, true) + this.oldWithNew.encode(asn1BerEncodeBuffer, true);
