...
public class BasicOCSPResponse extends Asn1Type {
    ...
    public int encode(Asn1BerEncodeBuffer asn1BerEncodeBuffer, boolean z) throws Asn1Exception {
        ...
        int encode2 = i + this.signature.encode(asn1BerEncodeBuffer, true) + this.signatureAlgorithm.encode(asn1BerEncodeBuffer, true) + this.tbsResponseData.encode(asn1BerEncodeBuffer, true);
