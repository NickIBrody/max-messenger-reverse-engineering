...
public class ContentReference extends Asn1Type {
    ...
    public int encode(Asn1BerEncodeBuffer asn1BerEncodeBuffer, boolean z) throws Asn1Exception {
        int encode = this.originatorSignatureValue.encode(asn1BerEncodeBuffer, true) + this.signedContentIdentifier.encode(asn1BerEncodeBuffer, true) + this.contentType.encode(asn1BerEncodeBuffer, true);
