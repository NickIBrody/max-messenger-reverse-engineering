package ru.p033ok.android.externcalls.sdk.urlsharing.external;
...
public interface UrlSharingManager {
    static /* synthetic */ void start$default(UrlSharingManager urlSharingManager, String str, bt7 bt7Var, dt7 dt7Var, int i, Object obj) {
        ...
        urlSharingManager.start(str, bt7Var, dt7Var);
    }

    static /* synthetic */ void stop$default(UrlSharingManager urlSharingManager, bt7 bt7Var, dt7 dt7Var, int i, Object obj) {
        if (obj != null) {
        ...
        urlSharingManager.stop(bt7Var, dt7Var);
    }
