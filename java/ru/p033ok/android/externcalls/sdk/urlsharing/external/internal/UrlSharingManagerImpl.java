package ru.p033ok.android.externcalls.sdk.urlsharing.external.internal;
...
public final class UrlSharingManagerImpl implements UrlSharingManager, UrlSharingCommandsExecutor, UrlSharingListenerManager {
    ...
    @Override // ru.p033ok.android.externcalls.sdk.urlsharing.external.UrlSharingManager, ru.p033ok.android.externcalls.sdk.urlsharing.external.internal.listener.UrlSharingListenerManager
    ...
    @Override // ru.p033ok.android.externcalls.sdk.urlsharing.external.UrlSharingManager, ru.p033ok.android.externcalls.sdk.urlsharing.external.internal.commands.UrlSharingCommandsExecutor
    public void start(String url, bt7 onSuccess, dt7 onError) {
        this.commandsExecutor.start(url, onSuccess, onError);
    }

    @Override // ru.p033ok.android.externcalls.sdk.urlsharing.external.UrlSharingManager, ru.p033ok.android.externcalls.sdk.urlsharing.external.internal.commands.UrlSharingCommandsExecutor
    public void stop(bt7 onSuccess, dt7 onError) {
