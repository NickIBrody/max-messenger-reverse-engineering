...
public final class MLDownloadStat$error$1 extends wc9 implements dt7 {
    final /* synthetic */ String $error;
    final /* synthetic */ String $modelId;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MLDownloadStat$error$1(String str, String str2) {
        super(1);
        this.$error = str;
        this.$modelId = str2;
    }
    ...
    public final void invoke(og1 og1Var) {
        ...
        og1Var.mo58035b("ml_error", eventItemValue, eventItemsMap);
    }
}
