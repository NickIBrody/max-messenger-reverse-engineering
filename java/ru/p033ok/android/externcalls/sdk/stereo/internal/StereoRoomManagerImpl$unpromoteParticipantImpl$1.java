...
public final class StereoRoomManagerImpl$unpromoteParticipantImpl$1 extends wc9 implements dt7 {
    final /* synthetic */ dt7 $onError;
    final /* synthetic */ bt7 $onSuccess;
    final /* synthetic */ StereoRoomManagerImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StereoRoomManagerImpl$unpromoteParticipantImpl$1(StereoRoomManagerImpl stereoRoomManagerImpl, bt7 bt7Var, dt7 dt7Var) {
        super(1);
    ...
    public final void invoke(hs1.C5790a c5790a) {
        ...
        stereoRoomCommandExecutor.promoteParticipant(new StereoRoomCommandExecutor.PromoteParticipantParams(c5790a, false), this.$onSuccess, this.$onError);
    }
}
