package ru.p033ok.android.externcalls.sdk.feedback.internal;
...
public final class FeedbackManagerImpl implements FeedbackManager, FeedbackCommandsExecutor, FeedbackListenerManager {
    ...
    @Override // ru.p033ok.android.externcalls.sdk.feedback.FeedbackManager, ru.p033ok.android.externcalls.sdk.feedback.internal.listeners.FeedbackListenerManager
    ...
    public void sendFeedback(String key, dt7 onError, bt7 onSuccess) {
    ...
    @Override // ru.p033ok.android.externcalls.sdk.feedback.FeedbackManager
    public void sendFeedback(String key, ParticipantFeedbackSource source, dt7 onError, bt7 onSuccess) {
        this.commandExecutor.sendFeedback(key, onError, onSuccess);
        this.listenerManager.ownFeedbackSent(key, source);
    }
}
