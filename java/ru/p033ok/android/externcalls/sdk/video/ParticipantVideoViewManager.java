...
public interface ParticipantVideoViewManager<R extends RendererView> {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ParticipantVideoViewManager newInstance$default(Companion companion, bt7 bt7Var, dt7 dt7Var, bt7 bt7Var2, int i, Object obj) {
            if ((i & 4) != 0) {
                bt7Var2 = ParticipantVideoViewManager$Companion$newInstance$1.INSTANCE;
            }
            return companion.newInstance(bt7Var, dt7Var, bt7Var2);
        }

        public final <T extends View & VideoSink & RendererView> ParticipantVideoViewManager<T> newInstance(bt7 conversation, dt7 factory, bt7 ownCameraCallback) {
            return new ParticipantVideoViewManagerImpl(conversation, factory, ownCameraCallback);
        }
    }

    static <T extends View & VideoSink & RendererView> ParticipantVideoViewManager<T> newInstance(bt7 bt7Var, dt7 dt7Var, bt7 bt7Var2) {
        return INSTANCE.newInstance(bt7Var, dt7Var, bt7Var2);
    }
    ...
    R mo117805createVideoViewInstance(Context context);
    ...
    default void setParticipantView(ConversationVideoTrackParticipantKey key, R renderView) {
        setParticipantView(key, renderView, new FrameDecorator() { // from class: prd
