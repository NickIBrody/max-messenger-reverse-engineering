...
public interface RendererView {
    static /* synthetic */ boolean init$default(RendererView rendererView, C14413a c14413a, RendererCommon.RendererEvents rendererEvents, FrameDecorator frameDecorator, int i, Object obj) {
        ...
        return rendererView.init(c14413a, rendererEvents, frameDecorator);
    }
    ...
    boolean init(C14413a renderer, RendererCommon.RendererEvents rendererEvents, RendererCommon.GlDrawer drawer);

    boolean init(C14413a renderer, RendererCommon.RendererEvents rendererEvents, FrameDecorator frameDecorator);

    void release();

    void setFrameDecorator(FrameDecorator decorator);

    void setFrameSizeListener(rt7 listener);
