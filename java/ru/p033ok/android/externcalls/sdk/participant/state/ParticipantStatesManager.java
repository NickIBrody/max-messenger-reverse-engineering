package ru.p033ok.android.externcalls.sdk.participant.state;
...
public interface ParticipantStatesManager {
    ...
    public static final /* data */ class ParticipantStateChange {
        ...
        public boolean equals(Object other) {
            ...
            return jy8.m45881e(this.participantId, participantStateChange.participantId) && this.isOn == participantStateChange.isOn && this.updateTs == participantStateChange.updateTs;
        }
        ...
        public int hashCode() {
            return (((this.participantId.hashCode() * 31) + Boolean.hashCode(this.isOn)) * 31) + Long.hashCode(this.updateTs);
        }
        ...
        public String toString() {
            return "ParticipantStateChange(participantId=" + this.participantId + ", isOn=" + this.isOn + ", updateTs=" + this.updateTs + Extension.C_BRAKE;
        }
    }

    @Metadata(m47686d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u001e\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0086\b\u0018\u00002\u00020\u0001B\u0013\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\u0002\u0010\u0005J\u000f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003HÆ\u0003J\u0019\u0010\t\u001a\u00020\u00002\u000e\b\u0002\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003HÆ\u0001J\u0013\u0010\n\u001a\u00020\u000b2\b\u0010\f\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\r\u001a\u00020\u000eHÖ\u0001J\t\u0010\u000f\u001a\u00020\u0010HÖ\u0001R\u0017\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0011"}, m47687d2 = {"Lru/ok/android/externcalls/sdk/participant/state/ParticipantStatesManager$StateChangedEvent;", "", "changes", "", "Lru/ok/android/externcalls/sdk/participant/state/ParticipantStatesManager$ParticipantStateChange;", "(Ljava/util/Collection;)V", "getChanges", "()Ljava/util/Collection;", "component1", "copy", "equals", "", "other", "hashCode", "", "toString", "", "calls-sdk_release"}, m47688k = 1, m47689mv = {1, 9, 0}, m47691xi = 48)
    public static final /* data */ class StateChangedEvent {
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof StateChangedEvent) && jy8.m45881e(this.changes, ((StateChangedEvent) other).changes);
        }
        ...
        public String toString() {
            return "StateChangedEvent(changes=" + this.changes + Extension.C_BRAKE;
        }
    }

    static /* synthetic */ void lowerHandForAll$default(ParticipantStatesManager participantStatesManager, bt7 bt7Var, dt7 dt7Var, int i, Object obj) {
        if (obj != null) {
        ...
        participantStatesManager.lowerHandForAll(bt7Var, dt7Var);
    }
    ...
    void lowerHandForAll(bt7 onSuccess, dt7 onError);
    ...
    void resetAssistanceRequests(amh.C0253b roomId);
