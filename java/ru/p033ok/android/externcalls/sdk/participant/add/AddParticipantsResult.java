package ru.p033ok.android.externcalls.sdk.participant.add;
...
public final /* data */ class AddParticipantsResult {
    ...
    public boolean equals(Object other) {
        ...
        return jy8.m45881e(this.addedIds, addParticipantsResult.addedIds) && jy8.m45881e(this.accepted, addParticipantsResult.accepted) && jy8.m45881e(this.rejectedParticipantsIds, addParticipantsResult.rejectedParticipantsIds) && jy8.m45881e(this.bannedParticipantIds, addParticipantsResult.bannedParticipantIds);
    }
    ...
    public int hashCode() {
        return (((((this.addedIds.hashCode() * 31) + this.accepted.hashCode()) * 31) + this.rejectedParticipantsIds.hashCode()) * 31) + this.bannedParticipantIds.hashCode();
    }

    public String toString() {
        return "AddParticipantsResult(addedIds=" + this.addedIds + ", accepted=" + this.accepted + ", rejectedParticipantsIds=" + this.rejectedParticipantsIds + ", bannedParticipantIds=" + this.bannedParticipantIds + Extension.C_BRAKE;
    }
}
