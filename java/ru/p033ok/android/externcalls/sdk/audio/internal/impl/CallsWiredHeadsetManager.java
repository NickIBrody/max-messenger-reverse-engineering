...
public final class CallsWiredHeadsetManager {
    ...
    @Metadata(m47686d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\br\u0018\u00002\u00020\u0001:\u0003\u0002\u0003\u0004\u0082\u0001\u0003\u0005\u0006\u0007ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\bÀ\u0006\u0001"}, m47687d2 = {"Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsWiredHeadsetManager$WiredHeadsetState;", "", "None", "Plugged", "Unplugged", "Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsWiredHeadsetManager$WiredHeadsetState$None;", "Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsWiredHeadsetManager$WiredHeadsetState$Plugged;", "Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsWiredHeadsetManager$WiredHeadsetState$Unplugged;", "calls-audiomanager_release"}, m47688k = 1, m47689mv = {1, 9, 0}, m47691xi = 48)
    public interface WiredHeadsetState {

        @Metadata(m47686d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, m47687d2 = {"Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsWiredHeadsetManager$WiredHeadsetState$None;", "Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsWiredHeadsetManager$WiredHeadsetState;", "()V", "toString", "", "calls-audiomanager_release"}, m47688k = 1, m47689mv = {1, 9, 0}, m47691xi = 48)
        ...
        @Metadata(m47686d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\b\u0018\u00002\u00020\u0001B\u000f\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\t\u0010\u0007\u001a\u00020\u0003HÆ\u0003J\u0013\u0010\b\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\fHÖ\u0003J\t\u0010\r\u001a\u00020\u000eHÖ\u0001J\b\u0010\u000f\u001a\u00020\u0003H\u0016R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0010"}, m47687d2 = {"Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsWiredHeadsetManager$WiredHeadsetState$Plugged;", "Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsWiredHeadsetManager$WiredHeadsetState;", SdkMetricStatEvent.NAME_KEY, "", "(Ljava/lang/String;)V", "getName", "()Ljava/lang/String;", "component1", "copy", "equals", "", "other", "", "hashCode", "", "toString", "calls-audiomanager_release"}, m47688k = 1, m47689mv = {1, 9, 0}, m47691xi = 48)
        public static final /* data */ class Plugged implements WiredHeadsetState {
            ...
            public boolean equals(Object other) {
                ...
                return (other instanceof Plugged) && jy8.m45881e(this.name, ((Plugged) other).name);
            }
            ...
            public String toString() {
                return "Plugged(name=" + this.name + Extension.C_BRAKE;
            }
            ...
            public /* synthetic */ Plugged(String str, int i, xd5 xd5Var) {
                this((i & 1) != 0 ? "" : str);
            }
        }

        @Metadata(m47686d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, m47687d2 = {"Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsWiredHeadsetManager$WiredHeadsetState$Unplugged;", "Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsWiredHeadsetManager$WiredHeadsetState;", "()V", "toString", "", "calls-audiomanager_release"}, m47688k = 1, m47689mv = {1, 9, 0}, m47691xi = 48)
    ...
    private final String getDeviceNameByPortName(String pluggedDevicePort, AudioDeviceInfo[] devices) {
        ...
        if (pluggedDevicePort != null) {
            this.logger.mo18514v(LOG_TAG, "Looking for a used wired device using port name " + pluggedDevicePort);
            for (AudioDeviceInfo audioDeviceInfo : devices) {
                if (jy8.m45881e(audioDeviceInfo.getProductName(), pluggedDevicePort)) {
                    ...
                    this.logger.mo18514v(LOG_TAG, "Matching device found " + audioDeviceInfo);
                    return str;
                }
            }
        }
    ...
    */
    private final WiredHeadsetState getWiredHeadsetStateSdk28(String pluggedDevicePort) {
        ...
        try {
            ...
            this.logger.mo18514v(LOG_TAG, "Wired device connectivity check: usb=" + z + " headset=" + z2 + " phones=" + z3);
            if (!z && !z3 && !z2) {
                return WiredHeadsetState.Unplugged.INSTANCE;
            }
            if (z) {
                deviceNameByPortName = getDeviceNameByPortName(pluggedDevicePort, devices);
    ...
    private final void handleHeadsetPlugAction(Intent intent) {
        ...
        if (intExtra == 0 || intExtra == 1) {
            ...
            this.logger.mo18510e(LOG_TAG, "unknown headset state received");
        }
    }
    ...
    public final void onReceiveBroadcast(BroadcastReceiver broadcastReceiver, Intent intent) {
        KeyEvent keyEvent;
        this.logger.mo18514v(LOG_TAG, "CAM got " + intent);
        String action = intent.getAction();
        if (jy8.m45881e("android.intent.action.HEADSET_PLUG", action)) {
            handleHeadsetPlugAction(intent);
            return;
        }
        if (jy8.m45881e("android.intent.action.MEDIA_BUTTON", action) && (keyEvent = (KeyEvent) intent.getParcelableExtra("android.intent.extra.KEY_EVENT")) != null && keyEvent.getAction() == 1) {
            int keyCode = keyEvent.getKeyCode();
            if (keyCode == 5 || keyCode == 6 || keyCode == 79 || keyCode == 126 || keyCode == 127) {
                try {
                    broadcastReceiver.abortBroadcast();
                } catch (Exception e) {
                    this.logger.mo18510e(LOG_TAG, "onReceiveBroadcast: failed to abort broadcast, e: " + e);
                }
            }
        }
    }
    ...
    private final void updateWiredHeadsetState(boolean plugged, Intent action) {
        ...
        if (plugged) {
            this.logger.mo18514v(LOG_TAG, "Wired device plugged: name=" + stringExtra + " port=" + stringExtra2 + " hasMic=" + z);
        } else {
            this.logger.mo18514v(LOG_TAG, "Wired device unplugged: name=" + stringExtra + " port=" + stringExtra2 + " hasMic=" + z);
        }
    ...
    public final void start() {
        this.logger.mo18514v(LOG_TAG, "start tracking headset");
        if (!(this.wiredHeadsetState instanceof WiredHeadsetState.None)) {
            this.logger.mo18510e(LOG_TAG, "already started, ignore");
        } else {
    ...
    public final void stop() {
        this.logger.mo18514v(LOG_TAG, "stop tracking headset");
        if (this.wiredHeadsetState instanceof WiredHeadsetState.None) {
            this.logger.mo18510e(LOG_TAG, "already stopped, ignore");
        } else {
