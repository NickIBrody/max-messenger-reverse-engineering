...
public final class s1n implements iam {
    /* renamed from: b */
    public static int m94994b(String str) {
        Object m115724b;
    ...
    /* JADX WARN: Removed duplicated region for block: B:38:0x0064 A[Catch: all -> 0x006a, TryCatch #5 {all -> 0x006a, blocks: (B:36:0x0060, B:38:0x0064, B:39:0x006c), top: B:35:0x0060 }] */
        ...
        try {
            try {
                ...
                try {
                    ...
                    try {
                        socket.connect(new InetSocketAddress(str, m94994b(str)), (int) j);
                        try {
                            zgg.C17907a c17907a = zgg.f126150x;
                            socket.close();
