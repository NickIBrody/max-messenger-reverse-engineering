...
public abstract class wqk {
    /* renamed from: a */
    public static String m108310a(Uri uri) {
        ...
        if (scheme != null) {
            ...
            if (scheme.equalsIgnoreCase("http") || scheme.equalsIgnoreCase(cl_2.f94940j) || scheme.equalsIgnoreCase("ftp") || scheme.equalsIgnoreCase("rtsp")) {
