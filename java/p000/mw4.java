...
public abstract class mw4 {
    ...
    public static Map m53312a() {
        ...
        arrayList29.add(JCSP.MY_STORE_NAME);
        ...
        arrayList56.add("GN");
        hashMap.put(Integer.valueOf(PortalBlockedEmptyStateView.MAX_WIDTH), arrayList56);
        ...
        arrayList60.add("TG");
        hashMap.put(Integer.valueOf(VideoMessageLayout.INITIAL_WIDTH), arrayList60);
        ...
        arrayList66.add("NG");
        hashMap.put(Integer.valueOf(MSException.ERROR_MORE_DATA), arrayList66);
        ...
        arrayList70.add("CV");
        hashMap.put(Integer.valueOf(cl_10.f94299l), arrayList70);
        ArrayList arrayList71 = new ArrayList(1);
        arrayList71.add("ST");
        hashMap.put(Integer.valueOf(cl_10.f94300m), arrayList71);
        ...
        arrayList82.add("RW");
        hashMap.put(Integer.valueOf(SimpleContextMenuPopupWindow.MENU_CONSTANT_WIDTH), arrayList82);
        ...
        arrayList89.add("BI");
        hashMap.put(Integer.valueOf(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_ADDED), arrayList89);
        ArrayList arrayList90 = new ArrayList(1);
        arrayList90.add("MZ");
        hashMap.put(Integer.valueOf(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_REMOVED), arrayList90);
        ArrayList arrayList91 = new ArrayList(1);
        arrayList91.add("ZM");
        hashMap.put(Integer.valueOf(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_VOLUME_CHANGED), arrayList91);
        ...
        arrayList93.add("RE");
        arrayList93.add("YT");
        hashMap.put(Integer.valueOf(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_SELECTED), arrayList93);
        ArrayList arrayList94 = new ArrayList(1);
        arrayList94.add("ZW");
        hashMap.put(Integer.valueOf(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_UNSELECTED), arrayList94);
        ArrayList arrayList95 = new ArrayList(1);
        arrayList95.add("NA");
        hashMap.put(Integer.valueOf(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_ANOTHER_SELECTED), arrayList95);
        ...
        arrayList133.add("CZ");
        hashMap.put(Integer.valueOf(HttpStatus.SC_METHOD_FAILURE), arrayList133);
        ArrayList arrayList134 = new ArrayList(1);
        arrayList134.add("SK");
        hashMap.put(421, arrayList134);
        ArrayList arrayList135 = new ArrayList(1);
        arrayList135.add("LI");
        hashMap.put(Integer.valueOf(HttpStatus.SC_LOCKED), arrayList135);
        ArrayList arrayList136 = new ArrayList(1);
        arrayList136.add("FK");
        hashMap.put(500, arrayList136);
        ArrayList arrayList137 = new ArrayList(1);
        arrayList137.add("BZ");
        hashMap.put(Integer.valueOf(HttpStatus.SC_NOT_IMPLEMENTED), arrayList137);
        ArrayList arrayList138 = new ArrayList(1);
        arrayList138.add("GT");
        hashMap.put(Integer.valueOf(HttpStatus.SC_BAD_GATEWAY), arrayList138);
        ArrayList arrayList139 = new ArrayList(1);
        arrayList139.add("SV");
        hashMap.put(Integer.valueOf(HttpStatus.SC_SERVICE_UNAVAILABLE), arrayList139);
        ArrayList arrayList140 = new ArrayList(1);
        arrayList140.add("HN");
        hashMap.put(Integer.valueOf(HttpStatus.SC_GATEWAY_TIMEOUT), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("NI");
        hashMap.put(Integer.valueOf(HttpStatus.SC_HTTP_VERSION_NOT_SUPPORTED), arrayList141);
        ArrayList arrayList142 = new ArrayList(1);
        arrayList142.add("CR");
        hashMap.put(506, arrayList142);
        ArrayList arrayList143 = new ArrayList(1);
        arrayList143.add("PA");
        hashMap.put(Integer.valueOf(HttpStatus.SC_INSUFFICIENT_STORAGE), arrayList143);
        ...
        hashMap.put(Integer.valueOf(UploadConfig.DEFAULT_MAX_EVENT_COUNT), arrayList177);
