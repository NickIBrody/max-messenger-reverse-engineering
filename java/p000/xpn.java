...
public enum xpn implements s6n {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_IMAGE_LABEL_LOAD(MasterKeySpec.MASTERHASH_LEN),
    ...
    ON_DEVICE_FACE_MESH_DETECT(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_PROVIDER_ADDED),
