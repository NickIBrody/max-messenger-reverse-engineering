...
public final class FolderWidgetView extends ViewGroup implements ovj {
    ...
    public FolderWidgetView(Context context) {
        super(context);
        ...
        addView(simpleDraweeView, new ViewGroup.LayoutParams(p4a.m82816d(mu5.m53081i().getDisplayMetrics().density * f), p4a.m82816d(f * mu5.m53081i().getDisplayMetrics().density)));
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        sgl.m95974b(this.title, p4a.m82816d(mu5.m53081i().getDisplayMetrics().density * f), m82816d, 0, 0, 12, null);
        sgl.m95974b(this.description, p4a.m82816d(mu5.m53081i().getDisplayMetrics().density * f), m82816d + this.title.getMeasuredHeight() + p4a.m82816d(2 * mu5.m53081i().getDisplayMetrics().density), 0, 0, 12, null);
        this.icon.layout(p4a.m82816d(mu5.m53081i().getDisplayMetrics().density * f), (getMeasuredHeight() - this.icon.getMeasuredHeight()) - p4a.m82816d(mu5.m53081i().getDisplayMetrics().density * f), p4a.m82816d(mu5.m53081i().getDisplayMetrics().density * f) + this.icon.getMeasuredWidth(), getMeasuredHeight() - p4a.m82816d(f * mu5.m53081i().getDisplayMetrics().density));
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        float f = 10;
        this.title.measure(View.MeasureSpec.makeMeasureSpec(size - (p4a.m82816d(mu5.m53081i().getDisplayMetrics().density * f) * 2), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(0, 0));
        this.description.measure(View.MeasureSpec.makeMeasureSpec((size - (p4a.m82816d(f * mu5.m53081i().getDisplayMetrics().density) * 2)) - p4a.m82816d(6 * mu5.m53081i().getDisplayMetrics().density), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(0, 0));
        float f2 = 20;
