...
public class FrameBuffer {
    ...
    private static int createTexture(int i, int i2) {
        ...
        fwm.m34107c("glTexImage2D");
        GLES20.glBindTexture(3553, 0);
        fwm.m34107c("glBindTexture");
        return i3;
    }
    ...
    public void render(mvm mvmVar, Runnable runnable) {
        bind(true);
        runnable.run();
        mvmVar.render();
        unbind();
    ...
    public void unbind() {
        GLES20.glBindFramebuffer(36160, 0);
        fwm.m34107c("glUnBindFramebuffer");
    }
