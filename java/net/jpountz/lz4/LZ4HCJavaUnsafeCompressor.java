...
final class LZ4HCJavaUnsafeCompressor extends LZ4Compressor {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:72:0x01ca, code lost:
        ...
        r4 = net.jpountz.lz4.LZ4UnsafeUtils.encodeSequence(r21, r13.end(), r14.start, r14.ref, r14.len, r24, net.jpountz.lz4.LZ4UnsafeUtils.encodeSequence(r21, r22, r13.start, r13.ref, r13.len, r24, r8, r9), r9);
        r0 = r14.end();
        r3 = r0;
        r8 = r14;
        r14 = r15;
    ...
    */
    public int compress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        ...
        while (i12 < i9) {
            ...
            if (hashTable2.insertAndFindBestMatch(bArr3, i12, i10, match6)) {
                    ...
                    if (match9.start - match6.start >= 3) {
                        while (true) {
                            ...
                            if (match10.start >= match6.end() + 3) {
                                ...
                                int encodeSequence = LZ4UnsafeUtils.encodeSequence(bArr, i20, match6.start, match6.ref, match6.len, bArr2, i23, i8);
                                int end = match6.end();
                                ...
                                int encodeSequence2 = LZ4UnsafeUtils.encodeSequence(bArr, i20, match6.start, match6.ref, match6.len, bArr2, i15, i8);
                                int end2 = match6.end();
                ...
                hashTable = hashTable2;
                i5 = i10;
                i13 = LZ4UnsafeUtils.encodeSequence(bArr, i14, match6.start, match6.ref, match6.len, bArr2, i15, i8);
                i12 = match6.end();
                i11 = i12;
                match7 = match2;
                match8 = match;
        ...
        return LZ4UnsafeUtils.lastLiterals(bArr, i11, i7 - i11, bArr2, i13, i8) - i3;
    }
    ...
    public class HashTable {
        ...
        private void addHash(byte[] bArr, int i) {
            addHash(olk.m58584e(bArr, i), i);
        }

        private int hashPointer(byte[] bArr, int i) {
            return hashPointer(olk.m58584e(bArr, i));
        }
        ...
        public boolean insertAndFindBestMatch(byte[] bArr, int i, int i2, LZ4Utils.Match match) {
            ...
            for (int i5 = 0; i5 < LZ4HCJavaUnsafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, i - 65535) && hashPointer <= i; i5++) {
            ...
            if (i4 != 0) {
                ...
                do {
                    this.chainTable[i & 65535] = (short) i3;
                    this.hashTable[LZ4Utils.hashHC(olk.m58584e(bArr, i))] = i;
                    i++;
                } while (i < i6);
