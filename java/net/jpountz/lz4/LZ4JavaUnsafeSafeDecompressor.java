...
final class LZ4JavaUnsafeSafeDecompressor extends LZ4SafeDecompressor {
    ...
    */
    public int decompress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        ...
        int i10 = i3;
        while (true) {
            byte m58583c = olk.m58583c(bArr, i9);
            int i11 = i9 + i6;
            int i12 = (m58583c & 255) >>> 4;
            if (i12 == 15) {
                byte b = -1;
                while (true) {
                    if (i11 >= i7) {
                    ...
                    int i13 = i11 + 1;
                    byte m58583c2 = olk.m58583c(bArr, i11);
                    if (m58583c2 != -1) {
                        b = m58583c2;
                        i11 = i13;
                        break;
            ...
            int m58589j = olk.m58589j(bArr, i5);
            int i16 = i5 + 2;
            int i17 = i14 - m58589j;
            if (i17 < i3) {
                throw new LZ4Exception("Malformed input at " + i16);
            }
            int i18 = m58583c & PKIBody._CCP;
            if (i18 == 15) {
                byte b2 = -1;
                while (true) {
                    if (i16 >= i7) {
                    ...
                    int i19 = i16 + 1;
                    byte m58583c3 = olk.m58583c(bArr, i16);
                    if (m58583c3 != -1) {
                        i16 = i19;
                        b2 = m58583c3;
                        break;
            ...
            i10 = i14 + i20;
            if (i10 <= i15) {
                LZ4UnsafeUtils.wildIncrementalCopy(bArr2, i17, i14, i10);
            } else {
                if (i10 > i8) {
                    throw new LZ4Exception("Malformed input at " + i16);
                }
                LZ4UnsafeUtils.safeIncrementalCopy(bArr2, i17, i14, i20);
            }
            i9 = i16;
            i6 = 1;
        }
