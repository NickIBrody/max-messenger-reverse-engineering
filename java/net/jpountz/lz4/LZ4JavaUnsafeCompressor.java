...
final class LZ4JavaUnsafeCompressor extends LZ4Compressor {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0078, code lost:
        ...
        p000.olk.m58597r(r20, r11, (short) (r8 - r15));
        r4 = r11 + 2;
        r8 = r8 + 4;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0092, code lost:
        ...
        p000.olk.m58591l(r20, r10, p000.olk.m58583c(r20, r10) | ru.CryptoPro.JCP.ASN.PKIXCMP.PKIBody._CCP);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x00b0, code lost:
        ...
        r4 = r8 - 2;
        p000.olk.m58596q(r2, net.jpountz.lz4.LZ4Utils.hash64k(p000.olk.m58584e(r17, r4)), r4 - r1);
        r4 = net.jpountz.lz4.LZ4Utils.hash64k(p000.olk.m58584e(r17, r8));
        r15 = r1 + p000.olk.m58587h(r2, r4);
        p000.olk.m58596q(r2, r4, r8 - r1);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:35:0x00a2, code lost:
        ...
        p000.olk.m58591l(r20, r10, r9 | p000.olk.m58583c(r20, r10));
     */
    ...
    */
        ...
        if (i2 >= 13) {
            ...
            loop0: while (true) {
                ...
                while (true) {
                    ...
                    int hash64k = LZ4Utils.hash64k(olk.m58584e(bArr, i12));
                    int m58587h = olk.m58587h(sArr, hash64k) + i8;
                    i5 = i9;
                    olk.m58596q(sArr, hash64k, i12 - i8);
                    if (LZ4UnsafeUtils.readIntEquals(bArr, m58587h, i12)) {
                        break;
                    }
                    i12 = i17;
                    i9 = i5;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0065, code lost:
        ...
        r11 = net.jpountz.lz4.LZ4UnsafeUtils.commonBytesBackward(r18, r15, r9, r19, r7);
        r9 = r9 - r11;
        r15 = r15 - r11;
        r11 = r9 - r7;
        r12 = r10 + 1;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0094, code lost:
        ...
        p000.olk.m58597r(r21, r12, r2);
        r2 = r12 + 2;
        r9 = r9 + 4;
        r7 = net.jpountz.lz4.LZ4UnsafeUtils.commonBytes(r18, r15 + 4, r9, r4);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x00ad, code lost:
        ...
        p000.olk.m58591l(r21, r10, p000.olk.m58583c(r21, r10) | ru.CryptoPro.JCP.ASN.PKIXCMP.PKIBody._CCP);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x00d4, code lost:
        ...
        r2 = r9 - 2;
        p000.olk.m58593n(r8, net.jpountz.lz4.LZ4Utils.hash(p000.olk.m58584e(r18, r2)), r2);
        r2 = net.jpountz.lz4.LZ4Utils.hash(p000.olk.m58584e(r18, r9));
        r15 = p000.olk.m58585f(r8, r2);
        p000.olk.m58593n(r8, r2, r9);
        r2 = r9 - r15;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x00fa, code lost:
        ...
        if (net.jpountz.lz4.LZ4UnsafeUtils.readIntEquals(r18, r15, r9) != false) goto L39;
     */
    /* JADX WARN: Code restructure failed: missing block: B:32:0x00fd, code lost:
    
        r12 = r10 + 1;
        p000.olk.m58591l(r21, r10, 0);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x00d3, code lost:
        ...
        return net.jpountz.lz4.LZ4UnsafeUtils.lastLiterals(r18, r1, r20 - r1, r21, r10, r5) - r22;
     */
    /* JADX WARN: Code restructure failed: missing block: B:41:0x00bd, code lost:
    
        p000.olk.m58591l(r21, r10, r7 | p000.olk.m58583c(r21, r10));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:45:0x008b, code lost:
        ...
        p000.olk.m58591l(r21, r10, r11 << 4);
     */
    ...
    */
    public int compress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        int i5;
        int i6;
        olk.m58582b(bArr, i, i2);
        olk.m58582b(bArr2, i3, i4);
        int i7 = i3 + i4;
        if (i2 < 65547) {
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                if (i16 <= i10) {
                    int hash = LZ4Utils.hash(olk.m58584e(bArr, i12));
                    int m58585f = olk.m58585f(iArr, hash);
                    i5 = i8;
                    int i19 = i12 - m58585f;
                    olk.m58593n(iArr, hash, i12);
                    if (i19 < 65536 && LZ4UnsafeUtils.readIntEquals(bArr, m58585f, i12)) {
                        break;
                    }
                    i8 = i5;
                    i12 = i16;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x00b0, code lost:
        ...
        r4 = r8 - 2;
        p000.olk.m58596q(r2, net.jpountz.lz4.LZ4Utils.hash64k(p000.f51.m32206g(r17, r4)), r4 - r1);
    ...
    */
        ...
        if (i2 >= 13) {
            ...
            loop0: while (true) {
                ...
                while (true) {
                    ...
                    i5 = i9;
                    olk.m58596q(sArr, hash64k, i12 - i8);
                    if (LZ4ByteBufferUtils.readIntEquals(byteBuffer, m58587h, i12)) {
                        break;
                    }
                    i12 = i17;
                    i9 = i5;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x0110, code lost:
        ...
        r2 = r10 - 2;
        p000.olk.m58593n(r8, net.jpountz.lz4.LZ4Utils.hash(p000.f51.m32206g(r1, r2)), r2);
        r2 = net.jpountz.lz4.LZ4Utils.hash(p000.f51.m32206g(r1, r10));
        r15 = p000.olk.m58585f(r8, r2);
        p000.olk.m58593n(r8, r2, r10);
        r2 = r10 - r15;
     */
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                if (i17 <= i11) {
                    ...
                    i5 = i9;
                    int i20 = i13 - m58585f;
                    olk.m58593n(iArr, hash, i13);
                    if (i20 < 65536 && LZ4ByteBufferUtils.readIntEquals(m32204e, m58585f, i13)) {
                        break;
                    }
                    i9 = i5;
                    i13 = i17;
