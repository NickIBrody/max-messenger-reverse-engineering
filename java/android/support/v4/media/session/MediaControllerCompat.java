...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public static class MediaControllerCallbackApi21 extends MediaController.Callback {
            ...
            public void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
                ...
                if (callback != null) {
                    callback.onAudioInfoChanged(new PlaybackInfo(playbackInfo.getPlaybackType(), AudioAttributesCompat.m6192d(playbackInfo.getAudioAttributes()), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume()));
                }
            }
    ...
    public static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(v31.m103301a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
                    mediaControllerImplApi21.mSessionToken.setSession2Token(hqd.m39277b(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN));
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            if (playbackInfo != null) {
                return new PlaybackInfo(playbackInfo.getPlaybackType(), AudioAttributesCompat.m6192d(playbackInfo.getAudioAttributes()), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume());
            }
            return null;
        }
    ...
    public static final class PlaybackInfo {
        ...
        public PlaybackInfo(int i, int i2, int i3, int i4, int i5) {
            this(i, new AudioAttributesCompat.C1056a().m6195b(i2).m6194a(), i3, i4, i5);
        }
        ...
        public int getAudioStream() {
            return this.mAudioAttrsCompat.m6193a();
        }
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        Object tag = activity.getWindow().getDecorView().getTag(zkf.media_controller_compat_view_tag);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        activity.getWindow().getDecorView().setTag(zkf.media_controller_compat_view_tag, mediaControllerCompat);
