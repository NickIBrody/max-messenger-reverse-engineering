...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (message.what == 1) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((uta) message.obj);
        ...
        public class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            private void setCurrentControllerInfo(MediaSessionImpl mediaSessionImpl) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(new uta(callingPackage, -1, -1));
            }
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        v31.m103302b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, asBinder);
                        hqd.m39278c(bundle2, MediaSessionCompat.KEY_SESSION2_TOKEN, sessionToken.getSession2Token());
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            uta currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(uta utaVar);
        ...
        void setPlaybackToRemote(yhl yhlVar);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public MediaSessionImplApi18(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, zzk zzkVar, Bundle bundle) {
            super(context, str, componentName, pendingIntent, zzkVar, bundle);
        }
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        public MediaSessionImplApi19(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, zzk zzkVar, Bundle bundle) {
            super(context, str, componentName, pendingIntent, zzkVar, bundle);
        }
    ...
    public static class MediaSessionImplApi22 extends MediaSessionImplApi21 {
        public MediaSessionImplApi22(Context context, String str, zzk zzkVar, Bundle bundle) {
            super(context, str, zzkVar, bundle);
        }
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi22 {
        public MediaSessionImplApi28(Context context, String str, zzk zzkVar, Bundle bundle) {
            super(context, str, zzkVar, bundle);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final uta getCurrentControllerInfo() {
            MediaSessionManager.RemoteUserInfo currentControllerInfo;
            currentControllerInfo = this.mSessionFwk.getCurrentControllerInfo();
            return new uta(currentControllerInfo);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(uta utaVar) {
        }
    ...
    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        public MediaSessionImplApi29(Context context, String str, zzk zzkVar, Bundle bundle) {
            super(context, str, zzkVar, bundle);
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        int mFlags = 3;
        private yhl.AbstractC17580a mVolumeCallback = new yhl.AbstractC17580a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            public void onVolumeChanged(yhl yhlVar) {
        ...
        public static class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                mediaSessionImplBase.mControllerCallbacks.register(iMediaControllerCallback, new uta(mediaSessionImplBase.getPackageNameForUid(callingUid), callingPid, callingUid));
                synchronized (mediaSessionImplBase.mLock) {
                    try {
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new uta(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, zzk zzkVar, Bundle bundle) {
            ...
            this.mToken = new Token(mediaSessionStub, null, zzkVar);
            this.mRatingType = 0;
            this.mVolumeType = 1;
            this.mLocalStream = 3;
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public uta getCurrentControllerInfo() {
            uta utaVar;
            synchronized (this.mLock) {
                utaVar = this.mRemoteUserInfo;
            }
            return utaVar;
        }
        ...
        */
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(yhl yhlVar) {
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(v31.m103301a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
            zzk m39277b = hqd.m39277b(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN);
            Token token = (Token) bundle.getParcelable(MediaSessionCompat.KEY_TOKEN);
            if (token == null) {
                return null;
            }
            return new Token(token.mInner, asInterface, m39277b);
        }
            ...
            synchronized (this.mLock) {
                try {
                    ...
                    if (iMediaSession != null) {
                        v31.m103302b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
                    }
                    zzk zzkVar = this.mSession2Token;
                    if (zzkVar != null) {
                        hqd.m39278c(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN, zzkVar);
                    }
                } catch (Throwable th) {
                    throw th;
                }
        ...
        public Token(Object obj, IMediaSession iMediaSession, zzk zzkVar) {
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, zzk zzkVar) {
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                ...
                int i = Build.VERSION.SDK_INT;
                if (i >= 29) {
                    this.mImpl = new MediaSessionImplApi29(context, str, zzkVar, bundle);
                } else if (i >= 28) {
                    this.mImpl = new MediaSessionImplApi28(context, str, zzkVar, bundle);
                } else {
                    this.mImpl = new MediaSessionImplApi22(context, str, zzkVar, bundle);
                }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public static class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                int callingPid = Binder.getCallingPid();
                int callingUid = Binder.getCallingUid();
                mediaSessionImplApi21.mExtraControllerCallbacks.register(iMediaControllerCallback, new uta("android.media.session.MediaController", callingPid, callingUid));
        ...
        public MediaSessionImplApi21(Context context, String str, zzk zzkVar, Bundle bundle) {
            ...
            this.mToken = new Token(createFwkMediaSession.getSessionToken(), extraSession, zzkVar);
            this.mSessionInfo = bundle;
            setFlags(3);
        }
