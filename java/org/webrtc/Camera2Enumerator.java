...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    private CameraCharacteristics getCameraCharacteristics(String str) {
        try {
            ...
            Logging.m81557e(TAG, "Camera access exception", e);
            return null;
        }
    }
    ...
    public static boolean isSupported(Context context) {
        ...
        try {
            ...
            Logging.m81557e(TAG, "Failed to check if camera2 is supported", e);
            return false;
        }
    }
    ...
    public static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(CameraManager cameraManager, String str) {
        ...
        synchronized (map) {
            try {
                ...
                Logging.m81555d(TAG, "Get supported formats for camera index " + str + Extension.DOT_CHAR);
                ...
                try {
                    ...
                    for (Size size : supportedSizes) {
                        ...
                        Logging.m81555d(TAG, "Format: " + size.width + "x" + size.height + "@" + round);
                    }
                    cachedSupportedFormats.put(str, arrayList);
                    Logging.m81555d(TAG, "Get supported formats for camera index " + str + " done. Time spent: " + (SystemClock.elapsedRealtime() - elapsedRealtime) + " ms.");
                    return arrayList;
                } catch (Exception e) {
                    Logging.m81557e(TAG, "getCameraCharacteristics()", e);
