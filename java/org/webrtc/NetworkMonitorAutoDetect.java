...
public class NetworkMonitorAutoDetect extends BroadcastReceiver implements NetworkChangeDetector {
    ...
    public static class ConnectivityManagerDelegate {
        ...
        public NetworkChangeDetector.NetworkInformation networkToInfo(Network network) {
            ...
            if (linkProperties == null) {
                Logging.m81559w(NetworkMonitorAutoDetect.TAG, "Detected unknown network: " + network.toString());
                return null;
            }
            if (linkProperties.getInterfaceName() == null) {
                Logging.m81559w(NetworkMonitorAutoDetect.TAG, "Null interface name for network " + network.toString());
                return null;
            }
            ...
            if (connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_NONE) {
                Logging.m81555d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " is disconnected");
                return null;
            }
            if (connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN || connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN_CELLULAR) {
                Logging.m81555d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " connection type is " + String.valueOf(connectionType) + " because it has type " + networkState.getNetworkType() + " and subtype " + networkState.getNetworkSubType());
            }
        ...
        public void releaseCallback(ConnectivityManager.NetworkCallback networkCallback) {
            if (supportNetworkCallback()) {
                Logging.m81555d(NetworkMonitorAutoDetect.TAG, "Unregister network callback");
        ...
        public NetworkState getNetworkState(Network network) {
            ...
            if (network != null && (connectivityManager = this.connectivityManager) != null) {
                ...
                if (networkInfo == null) {
                    Logging.m81559w(NetworkMonitorAutoDetect.TAG, "Couldn't retrieve information from network " + network.toString());
    ...
    public class SimpleNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            Logging.m81555d(NetworkMonitorAutoDetect.TAG, "Network handle: " + NetworkMonitorAutoDetect.networkToNetId(network) + " becomes available: " + network.toString());
            synchronized (this.availableNetworks) {
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            Logging.m81555d(NetworkMonitorAutoDetect.TAG, "handle: " + NetworkMonitorAutoDetect.networkToNetId(network) + " capabilities changed: " + networkCapabilities.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            Logging.m81555d(NetworkMonitorAutoDetect.TAG, "handle: " + NetworkMonitorAutoDetect.networkToNetId(network) + " link properties changed");
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLosing(Network network, int i) {
            Logging.m81555d(NetworkMonitorAutoDetect.TAG, "Network handle: " + NetworkMonitorAutoDetect.networkToNetId(network) + Extension.FIX_SPACE + network.toString() + " is about to lose in " + i + "ms");
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLost(Network network) {
            Logging.m81555d(NetworkMonitorAutoDetect.TAG, "Network handle: " + NetworkMonitorAutoDetect.networkToNetId(network) + Extension.FIX_SPACE + network.toString() + " is disconnected");
            synchronized (this.availableNetworks) {
    ...
    public static class WifiDirectManagerDelegate extends BroadcastReceiver {
        ...
        public void lambda$new$0(WifiP2pGroup wifiP2pGroup) {
            ...
            try {
                ...
                Logging.m81557e(NetworkMonitorAutoDetect.TAG, "Unable to get WifiP2p network interface", e);
            }
        }
    ...
    private void connectionTypeChanged(NetworkState networkState) {
        ...
        Logging.m81555d(TAG, "Network connectivity changed, type is: " + String.valueOf(connectionType));
