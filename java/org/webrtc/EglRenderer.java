...
public class EglRenderer implements VideoSink {
    ...
    private void logD(String str) {
        Logging.m81555d(TAG, this.name + str);
    }

    private void logE(String str, Throwable th) {
        Logging.m81557e(TAG, this.name + str, th);
    }
    ...
    private void logW(String str) {
        Logging.m81559w(TAG, this.name + str);
    }
    ...
    private void swapBuffersOnRenderThread(final VideoFrame videoFrame, final long j) {
        synchronized (this.threadLock) {
            try {
                ...
                EglThread.RenderUpdate renderUpdate = new EglThread.RenderUpdate() { // from class: xc6
                    @Override // org.webrtc.EglThread.RenderUpdate
                    public final void update(boolean z) {
                        EglRenderer.this.lambda$swapBuffersOnRenderThread$6(videoFrame, j, z);
                    }
                };
                if (this.f82935id.equals(EMPTY_UUID)) {
                    this.eglThread.scheduleRenderUpdate(renderUpdate);
                } else {
                    this.eglThread.scheduleRenderUpdate(this.f82935id, renderUpdate);
                }
            } catch (Throwable th) {
                throw th;
            }
            ...
            try {
                ...
                synchronized (this.frameLock) {
                    try {
                        ...
                        videoFrame.retain();
                        this.eglThread.getHandler().post(new Runnable() { // from class: zc6
                            @Override // java.lang.Runnable
    ...
    public void release() {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                this.eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: yc6
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                if (eglThread == null) {
                    ...
                    this.eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: uc6
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                postToRenderThread(new Runnable() { // from class: ad6
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void removeRenderListener(final RenderListener renderListener) {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                postToRenderThread(new Runnable() { // from class: bd6
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.threadLock) {
            try {
                ...
                eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: wc6
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: vc6
            @Override // java.lang.Runnable
            public final void run() {
