...
public final class RenderSynchronizer {
    ...
    public RenderSynchronizer(float f) {
        ...
        handler.post(new Runnable() { // from class: mcg
            @Override // java.lang.Runnable
            public final void run() {
                RenderSynchronizer.this.lambda$new$0();
            }
        });
        Logging.m81555d(TAG, "Created");
    }
    ...
    public /* synthetic */ void lambda$registerListener$1() {
        this.choreographer.postFrameCallback(new lcg(this));
    }
        ...
        synchronized (this.lock) {
            try {
                if (this.listeners.isEmpty()) {
                    Logging.m81555d(TAG, "No listeners, unsubscribing to frame callbacks");
    ...
    public void registerListener(Listener listener) {
        ...
        synchronized (this.lock) {
            try {
                if (!this.isListening) {
                    Logging.m81555d(TAG, "First listener, subscribing to frame callbacks");
                    this.isListening = true;
                    this.mainThreadHandler.post(new Runnable() { // from class: kcg
                        @Override // java.lang.Runnable
                        public final void run() {
