...
class RefCountDelegate implements RefCounted {
    ...
    public void release() {
        ...
        if (decrementAndGet < 0) {
            Logging.m81555d("RefCountDelegate", "release() called on an object with refcount < 1");
        }
    ...
    public void retain() {
        if (this.refCount.incrementAndGet() < 2) {
            Logging.m81555d("RefCountDelegate", "retain() called on an object with refcount < 1");
        }
    }
