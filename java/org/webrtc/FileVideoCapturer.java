...
public class FileVideoCapturer implements VideoCapturer {
    ...
    public static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                ...
                if (read == 10) {
                    ...
                    Logging.m81555d(TAG, "Color space: " + str2);
                    ...
                    this.frameWidth = i;
                    this.frameHeight = i2;
                    Logging.m81555d(TAG, "frame dim: (" + i + Extension.FIX_SPACE + i2 + Extension.C_BRAKE);
                    return;
                }
                sb.append((char) read);
            }
        ...
        public void close() {
            try {
                ...
                Logging.m81557e(TAG, "Problem closing file", e);
            }
        }
    ...
    public FileVideoCapturer(String str) throws IOException {
        try {
            ...
            Logging.m81555d(TAG, "Could not open video file: " + str);
            throw e;
        }
    }
