...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        if (iArr[0] == 1) {
            ...
            Logging.m81556e(TAG, "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
    ...
    private static int compileShader(int i, String str) {
        ...
        Logging.m81556e(TAG, "Compile error " + GLES20.glGetShaderInfoLog(glCreateShader) + " in shader:\n" + str);
    ...
    public void release() {
        Logging.m81555d(TAG, "Deleting shader.");
        int i = this.program;
        if (i != -1) {
