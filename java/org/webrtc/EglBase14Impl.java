...
public class EglBase14Impl implements EglBase14 {
    ...
    public static class EglConnection implements EglBase14.EglConnection {
        ...
        /* renamed from: b */
        public static /* synthetic */ void m81524b() {
        }
        ...
        public EglConnection(EGLContext eGLContext, int[] iArr) {
            ...
            Logging.m81555d(EglBase14Impl.TAG, "Using OpenGL ES version " + openGlesVersionFromConfig);
            this.eglContext = EglBase14Impl.createEglContext(eGLContext, eglDisplay, eglConfig, openGlesVersionFromConfig);
            this.refCountDelegate = new RefCountDelegate(new Runnable() { // from class: rc6
        ...
        private EglConnection() {
            ...
            this.eglConfig = null;
            this.refCountDelegate = new RefCountDelegate(new Runnable() { // from class: sc6
                @Override // java.lang.Runnable
                public final void run() {
                    EglBase14Impl.EglConnection.m81524b();
                }
            });
        }
    }
