...
public class EncodedImage implements RefCounted {
    ...
    public static class Builder {
        ...
        /* renamed from: qp */
        private Integer f82937qp;
        private Runnable releaseCallback;
        private int rotation;

        public EncodedImage createEncodedImage() {
            return new EncodedImage(this.buffer, this.releaseCallback, this.encodedWidth, this.encodedHeight, this.captureTimeNs, this.frameType, this.rotation, this.f82937qp);
        }
