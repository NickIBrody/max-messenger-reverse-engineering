...
public class EglBase10Impl implements EglBase10 {
    ...
    public static class EglConnection implements EglBase10.EglConnection {
        ...
        /* renamed from: a */
        public static /* synthetic */ void m81518a() {
        }
        ...
        public EglConnection(EGLContext eGLContext, int[] iArr) {
            ...
            Logging.m81555d(EglBase10Impl.TAG, "Using OpenGL ES version " + openGlesVersionFromConfig);
            this.eglContext = EglBase10Impl.createEglContext(egl10, eGLContext, eglDisplay, eglConfig, openGlesVersionFromConfig);
            this.refCountDelegate = new RefCountDelegate(new Runnable() { // from class: pc6
        ...
        private EglConnection() {
            ...
            this.eglConfig = null;
            this.refCountDelegate = new RefCountDelegate(new Runnable() { // from class: oc6
                @Override // java.lang.Runnable
                public final void run() {
                    EglBase10Impl.EglConnection.m81518a();
                }
            });
        }
    }
