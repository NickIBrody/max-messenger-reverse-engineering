...
public final class WebRtcAudioUtils {
    ...
    public static String deviceTypeToString(int i) {
        switch (i) {
            ...
            case 28:
            default:
                return "TYPE_UNKNOWN(" + i + Extension.C_BRAKE;
            case 29:
    ...
    private static void logAudioDeviceInfo(String str, AudioManager audioManager) {
        ...
        Logging.m81555d(str, "Audio Devices: ");
        for (AudioDeviceInfo audioDeviceInfo : devices) {
            ...
            Logging.m81555d(str, sb.toString());
        }
    }
    ...
    private static void logAudioStateBasic(String str, Context context, AudioManager audioManager) {
        Logging.m81555d(str, "Audio State: audio mode: " + modeToString(audioManager.getMode()) + ", has mic: " + hasMicrophone(context) + ", mic muted: " + audioManager.isMicrophoneMute() + ", music active: " + audioManager.isMusicActive() + ", speakerphone: " + audioManager.isSpeakerphoneOn() + ", BT SCO: " + audioManager.isBluetoothScoOn());
    }

    private static void logAudioStateVolume(String str, AudioManager audioManager) {
        int[] iArr = {0, 3, 2, 4, 5, 1};
        Logging.m81555d(str, "Audio State: ");
        boolean isVolumeFixed = audioManager.isVolumeFixed();
        Logging.m81555d(str, "  fixed volume=" + isVolumeFixed);
        if (isVolumeFixed) {
            return;
        }
        for (int i = 0; i < 6; i++) {
            int i2 = iArr[i];
            StringBuilder sb = new StringBuilder();
            sb.append(cl_5.f93406d + streamTypeToString(i2) + Extension.COLON_SPACE);
            sb.append("volume=");
    ...
    private static void logDeviceInfo(String str) {
        Logging.m81555d(str, "Android SDK: " + Build.VERSION.SDK_INT + ", Release: " + Build.VERSION.RELEASE + ", Brand: " + Build.BRAND + ", Device: " + Build.DEVICE + ", Id: " + Build.ID + ", Hardware: " + Build.HARDWARE + ", Manufacturer: " + Build.MANUFACTURER + ", Model: " + Build.MODEL + ", Product: " + Build.PRODUCT);
    }
