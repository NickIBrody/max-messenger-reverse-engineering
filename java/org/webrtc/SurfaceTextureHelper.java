...
public class SurfaceTextureHelper {
    ...
    public /* synthetic */ void lambda$new$0(SurfaceTexture surfaceTexture) {
        if (this.hasPendingTexture) {
            Logging.m81555d(TAG, "A frame is already pending, dropping frame.");
        }
        this.hasPendingTexture = true;
        tryDeliverTextureFrame();
    }
    ...
    public void returnTextureFrame() {
        this.handler.post(new Runnable() { // from class: ydj
    ...
    private void tryDeliverTextureFrame() {
        ...
        if (this.textureWidth == 0 || this.textureHeight == 0) {
            Logging.m81559w(TAG, "Texture size has not been set.");
            return;
        }
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: xdj
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void forceFrame() {
        this.handler.post(new Runnable() { // from class: bej
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void setFrameRotation(final int i) {
        this.handler.post(new Runnable() { // from class: zdj
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void setTextureSize(final int i, final int i2) {
        ...
        if (i2 > 0) {
            ...
            this.handler.post(new Runnable() { // from class: wdj
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void stopListening() {
        Logging.m81555d(TAG, "stopListening()");
        this.handler.removeCallbacks(this.setListenerRunnable);
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: vdj
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor, FrameGeometryAdjuster frameGeometryAdjuster) {
        ...
        this.setListenerRunnable = new Runnable() { // from class: org.webrtc.SurfaceTextureHelper.3
            @Override // java.lang.Runnable
            public void run() {
                Logging.m81555d(SurfaceTextureHelper.TAG, "Setting listener to " + String.valueOf(SurfaceTextureHelper.this.pendingListener));
        ...
        try {
            ...
            surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: aej
    ...
    public static SurfaceTextureHelper create(final String str, final EglBase.Context context, final boolean z, final YuvConverter yuvConverter, final FrameRefMonitor frameRefMonitor, final FrameGeometryAdjuster frameGeometryAdjuster) {
        ...
        return (SurfaceTextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<SurfaceTextureHelper>() { // from class: org.webrtc.SurfaceTextureHelper.1
            ...
            public SurfaceTextureHelper call() {
                try {
                    return new SurfaceTextureHelper(EglBase.Context.this, handler, z, yuvConverter, frameRefMonitor, frameGeometryAdjuster);
                } catch (RuntimeException e) {
                    Logging.m81557e(SurfaceTextureHelper.TAG, str + " create failure", e);
                    return null;
                }
            }
        });
