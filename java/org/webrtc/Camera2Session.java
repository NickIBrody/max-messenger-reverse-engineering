...
class Camera2Session implements CameraSession {
    ...
    public static class CameraCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            Logging.m81555d(Camera2Session.TAG, "Capture failed: " + String.valueOf(captureFailure));
        }
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onClosed(CameraDevice cameraDevice) {
            ...
            Logging.m81555d(Camera2Session.TAG, "Camera device closed.");
        ...
        public void onOpened(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m81555d(Camera2Session.TAG, "Camera opened.");
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        private void chooseFocusMode(CaptureRequest.Builder builder) {
            for (int i : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) {
                if (i == 3) {
                    ...
                    Logging.m81555d(Camera2Session.TAG, "Using continuous video auto-focus.");
                    return;
                }
            }
            Logging.m81555d(Camera2Session.TAG, "Auto-focus is not available.");
        }
            ...
            if (iArr != null) {
                for (int i : iArr) {
                    if (i == 1) {
                        ...
                        Logging.m81555d(Camera2Session.TAG, "Using optical stabilization.");
                        return;
                    }
                }
            }
            ...
            if (iArr2 != null) {
                for (int i2 : iArr2) {
                    if (i2 == 1) {
                        ...
                        Logging.m81555d(Camera2Session.TAG, "Using video stabilization.");
                        return;
                    }
                }
            }
            Logging.m81555d(Camera2Session.TAG, "Stabilization not available.");
        }
        ...
        public /* synthetic */ void lambda$onConfigured$0(VideoFrame videoFrame) {
            ...
            if (Camera2Session.this.state != SessionState.RUNNING) {
                Logging.m81555d(Camera2Session.TAG, "Texture frame captured but camera is no longer running.");
                return;
            }
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m81555d(Camera2Session.TAG, "Camera capture session configured.");
            ...
            try {
                ...
                Logging.m81555d(Camera2Session.TAG, "Camera device successfully started.");
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, CameraSession.ConfigurationProvider configurationProvider, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, CameraVideoCapturer.CaptureFormatHelper captureFormatHelper, int i, int i2, int i3) {
        Logging.m81555d(TAG, "Create new camera2 session on camera " + str);
    ...
    private void findCaptureFormat() {
        ...
        Logging.m81555d(TAG, "Available preview sizes: " + String.valueOf(supportedSizes));
        ...
        Logging.m81555d(TAG, "Using capture format: " + String.valueOf(captureFormat));
    }
    ...
    private void openCamera() {
        checkIsOnCameraThread();
        Logging.m81555d(TAG, "Opening camera " + this.cameraId);
        ...
        if (this.captureSession != null) {
            try {
                ...
                if (message.startsWith("checkPidStatus")) {
                    message = message + ProcessInfo.diffToString(this.infoOnStart, ProcessInfo.create(null));
                }
    ...
    public void stop() {
        Logging.m81555d(TAG, "Stop camera2 session on camera " + this.cameraId);
        checkIsOnCameraThread();
    ...
    public static final class ProcessInfo {
        ...
        public static String diffToString(ProcessInfo processInfo, ProcessInfo processInfo2) {
            return "ProcessInfoDiff(#" + processInfo.count + " -> " + processInfo2.count + ",\npid:" + processInfo.pid + " -> " + processInfo2.pid + ",\ntid:" + processInfo.tid + " -> " + processInfo2.tid + ",\nuid:" + processInfo.uid + " -> " + processInfo2.uid + ",\nthid:" + processInfo.thid + " -> " + processInfo2.thid + ",\nname:" + processInfo.processName + " -> " + processInfo2.processName + ",\ntime:" + processInfo.timestamp + " -> " + processInfo2.timestamp + ",\n)";
        }
