...
public class QCodec extends RFC1522Codec implements StringEncoder, StringDecoder {
    ...
    static {
        ...
        bitSet4.set(HProv.PP_PASSWD_TERM);
        bitSet4.set(HProv.PP_SAME_MEDIA);
        bitSet4.set(HProv.PP_DELETE_KEYSET);
        bitSet4.set(HProv.PP_DELETE_SAVED_PASSWD);
        BLANK = BlobHeaderStructure.BLOB_VERSION;
        UNDERSCORE = (byte) 95;
    }
    ...
    public String getEncoding() {
        return CA20Status.STATUS_REQUEST_Q;
    }
