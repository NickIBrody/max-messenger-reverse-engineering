...
public class SimpleLog implements Log, Serializable {
    ...
    public SimpleLog(String str) {
        ...
        int lastIndexOf = String.valueOf(str).lastIndexOf(Extension.DOT_CHAR);
        while (stringProperty == null && lastIndexOf > -1) {
            ...
            lastIndexOf = String.valueOf(str).lastIndexOf(Extension.DOT_CHAR);
        }
        ...
        if (ConfigConstants.SECTION_DEBUG.equalsIgnoreCase(stringProperty)) {
            setLevel(2);
            return;
        }
    ...
    private static boolean getBooleanProperty(String str, boolean z) {
        ...
        return stringProperty == null ? z : BioRandomFrame.STR_DIALOG_PROPERTY_VALUE.equalsIgnoreCase(stringProperty);
    }
    ...
    public void log(int i, Object obj, Throwable th) {
        ...
        if (showShortName) {
            if (this.shortLogName == null) {
                ...
                String substring = str.substring(str.lastIndexOf(Extension.DOT_CHAR) + 1);
                this.shortLogName = substring;
                this.shortLogName = substring.substring(substring.lastIndexOf(CSPStore.SLASH) + 1);
            }
