...
public class ResponseProcessCookies implements HttpResponseInterceptor {
    ...
    public void process(HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        processCookies(httpResponse.headerIterator(InterfaceC13057SM.SET_COOKIE), cookieSpec, cookieOrigin, cookieStore);
        if (cookieSpec.getVersion() > 0) {
            processCookies(httpResponse.headerIterator(InterfaceC13057SM.SET_COOKIE2), cookieSpec, cookieOrigin, cookieStore);
        }
    }
}
