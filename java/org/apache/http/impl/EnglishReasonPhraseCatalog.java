...
public class EnglishReasonPhraseCatalog implements ReasonPhraseCatalog {
    ...
    static {
        ...
        setReason(HttpStatus.SC_ACCEPTED, CA20Status.STATUS_REQUEST_DESCRIPTION_A);
    ...
    public String getReason(int i, Locale locale) {
        if (i < 100 || i >= 600) {
            throw new IllegalArgumentException("Unknown category for status code " + i + Extension.DOT_CHAR);
        }
        int i2 = i / 100;
        int i3 = i - (i2 * 100);
