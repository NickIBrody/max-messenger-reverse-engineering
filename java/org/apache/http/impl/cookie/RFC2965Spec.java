...
public class RFC2965Spec extends RFC2109Spec {
    ...
    public Header getVersionHeader() {
        ...
        charArrayBuffer.append(InterfaceC13057SM.COOKIE2);
    ...
    public List<Cookie> parse(Header header, CookieOrigin cookieOrigin) throws MalformedCookieException {
        ...
        for (HeaderElement headerElement : elements) {
            ...
            BasicClientCookie createCookie2 = header.getName().equals(InterfaceC13057SM.SET_COOKIE2) ? createCookie2(name, value, adjustEffectiveHost) : createCookie(name, value, adjustEffectiveHost);
