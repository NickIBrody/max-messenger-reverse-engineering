...
public class DigestScheme extends RFC2617Scheme {
    ...
    /* renamed from: NC */
    private static final String f82917NC = "00000001";
    ...
    private String createDigest(Credentials credentials) throws AuthenticationException {
        ...
        if (this.qopVariant == 1) {
            ...
            str = parameter4 + hag.SEPARATOR_CHAR + parameter;
        }
    ...
    private Header createDigestHeader(Credentials credentials, String str) throws AuthenticationException {
        ...
        if (this.qopVariant != 0) {
            ...
            arrayList.add(new BasicNameValuePair("nc", f82917NC));
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (i > 0) {
                charArrayBuffer.append(Extension.FIX_SPACE);
            }
    ...
    public boolean isComplete() {
        if (BioRandomFrame.STR_DIALOG_PROPERTY_VALUE.equalsIgnoreCase(getParameter("stale"))) {
            return false;
        }
