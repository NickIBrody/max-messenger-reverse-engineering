...
public final class RouteTracker implements RouteInfo, Cloneable {
    ...
    public final boolean equals(Object obj) {
        ...
        boolean z2 = (this.connected == routeTracker.connected && this.secure == routeTracker.secure && this.tunnelled == routeTracker.tunnelled && this.layered == routeTracker.layered) & z & (httpHostArr == httpHostArr2 || !(httpHostArr == null || httpHostArr2 == null || httpHostArr.length != httpHostArr2.length));
        if (z2 && httpHostArr != null) {
            while (z2) {
                ...
                z2 = httpHostArr3[i].equals(routeTracker.proxyChain[i]);
                i++;
            }
        }
        return z2;
    ...
    public final HttpHost getHopTarget(int i) {
        ...
        throw new IllegalArgumentException("Hop index " + i + " exceeds tracked route length " + hopCount + Extension.DOT_CHAR);
    }
