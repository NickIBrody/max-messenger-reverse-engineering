...
class DirectBufferAccess {
    ...
    /* renamed from: org.msgpack.core.buffer.DirectBufferAccess$4 */
    public static /* synthetic */ class C130714 {

        /* renamed from: $SwitchMap$org$msgpack$core$buffer$DirectBufferAccess$DirectBufferConstructorType */
        static final /* synthetic */ int[] f82932x6d3725bd;

        static {
            int[] iArr = new int[DirectBufferConstructorType.values().length];
            f82932x6d3725bd = iArr;
            try {
                iArr[DirectBufferConstructorType.ARGS_LONG_INT_REF.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f82932x6d3725bd[DirectBufferConstructorType.ARGS_LONG_INT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f82932x6d3725bd[DirectBufferConstructorType.ARGS_INT_INT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f82932x6d3725bd[DirectBufferConstructorType.ARGS_MB_INT_INT.ordinal()] = 4;
    ...
    public static ByteBuffer newByteBuffer(long j, int i, int i2, ByteBuffer byteBuffer) {
        try {
            int i3 = C130714.f82932x6d3725bd[directBufferConstructorType.ordinal()];
            if (i3 == 1) {
