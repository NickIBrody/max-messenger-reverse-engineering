...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.foregroundBoundsChanged = false;
        TypedArray m112200i = xvj.m112200i(context, attributeSet, nuf.ForegroundLinearLayout, i, 0, new int[0]);
        this.foregroundGravity = m112200i.getInt(nuf.ForegroundLinearLayout_android_foregroundGravity, this.foregroundGravity);
        Drawable drawable = m112200i.getDrawable(nuf.ForegroundLinearLayout_android_foreground);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.mForegroundInPadding = m112200i.getBoolean(nuf.ForegroundLinearLayout_foregroundInsidePadding, true);
        m112200i.recycle();
    }
}
