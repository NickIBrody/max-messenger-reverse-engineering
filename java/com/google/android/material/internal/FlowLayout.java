...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, nuf.FlowLayout, 0, 0);
        this.lineSpacing = obtainStyledAttributes.getDimensionPixelSize(nuf.FlowLayout_lineSpacing, 0);
        this.itemSpacing = obtainStyledAttributes.getDimensionPixelSize(nuf.FlowLayout_itemSpacing, 0);
    ...
    public int getRowIndex(View view) {
        Object tag = view.getTag(hlf.row_index_key);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.rowCount = 1;
        boolean z2 = ViewCompat.m4919z(this) == 1;
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                childAt.setTag(hlf.row_index_key, -1);
            } else {
                ViewGroup.LayoutParams layoutParams = childAt.getLayoutParams();
                if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                    ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
                    i6 = x2a.m109147b(marginLayoutParams);
                    i5 = x2a.m109146a(marginLayoutParams);
                } else {
                    i5 = 0;
                    i6 = 0;
                }
                ...
                childAt.setTag(hlf.row_index_key, Integer.valueOf(this.rowCount - 1));
                int i11 = i8 + i6;
