...
public abstract class ViewOverlayApi14 implements afl {
    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        public void add(View view) {
            ...
            if (view.getParent() instanceof ViewGroup) {
                ...
                if (viewGroup != this.hostView && viewGroup.getParent() != null && ViewCompat.m4860R(viewGroup)) {
                    int[] iArr = new int[2];
                    int[] iArr2 = new int[2];
                    viewGroup.getLocationOnScreen(iArr);
                    this.hostView.getLocationOnScreen(iArr2);
                    ViewCompat.m4866X(view, iArr[0] - iArr2[0]);
                    ViewCompat.m4867Y(view, iArr[1] - iArr2[1]);
                }
