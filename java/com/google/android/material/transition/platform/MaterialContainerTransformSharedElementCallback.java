...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    private InterfaceC3677a shapeProvider = new C3678b();
    ...
    public interface InterfaceC3677a {
        /* renamed from: a */
        C3548a mo24425a(View view);
    }

    /* renamed from: com.google.android.material.transition.platform.MaterialContainerTransformSharedElementCallback$b */
    public static class C3678b implements InterfaceC3677a {
        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.android.material.transition.platform.MaterialContainerTransformSharedElementCallback.InterfaceC3677a
        /* renamed from: a */
        public C3548a mo24425a(View view) {
            if (view instanceof mxh) {
                return ((mxh) view).getShapeAppearanceModel();
            }
            return null;
        }
    }
    ...
    public static void removeWindowBackground(Window window) {
        ...
        windowBackground.mutate().setColorFilter(kx0.m48228a(0, lx0.CLEAR));
    }
    ...
    public InterfaceC3677a getShapeProvider() {
    ...
    public View onCreateSnapshotView(Context context, Parcelable parcelable) {
        ...
        if (onCreateSnapshotView != null && (weakReference = capturedSharedElement) != null && this.shapeProvider != null && (view = weakReference.get()) != null && (mo24425a = this.shapeProvider.mo24425a(view)) != null) {
            onCreateSnapshotView.setTag(hlf.mtrl_motion_snapshot_view, mo24425a);
        }
    ...
    public void onMapSharedElements(List<String> list, Map<String, View> map) {
        View view;
        Activity m99403a;
        if (list.isEmpty() || map.isEmpty() || (view = map.get(list.get(0))) == null || (m99403a = tq4.m99403a(view.getContext())) == null) {
            return;
        }
        Window window = m99403a.getWindow();
        if (this.entering) {
            setUpEnterTransform(window);
        } else {
            setUpReturnTransform(m99403a, window);
        }
    }

    @Override // android.app.SharedElementCallback
    public void onSharedElementEnd(List<String> list, List<View> list2, List<View> list3) {
        if (!list2.isEmpty() && (list2.get(0).getTag(hlf.mtrl_motion_snapshot_view) instanceof View)) {
            list2.get(0).setTag(hlf.mtrl_motion_snapshot_view, null);
        }
        if (!this.entering && !list2.isEmpty()) {
            this.returnEndBounds = wbk.m107394j(list2.get(0));
        }
        this.entering = false;
    }
    ...
    public void onSharedElementStart(List<String> list, List<View> list2, List<View> list3) {
        if (!list2.isEmpty() && !list3.isEmpty()) {
            list2.get(0).setTag(hlf.mtrl_motion_snapshot_view, list3.get(0));
        }
    ...
    public void setShapeProvider(InterfaceC3677a interfaceC3677a) {
        this.shapeProvider = interfaceC3677a;
    }
