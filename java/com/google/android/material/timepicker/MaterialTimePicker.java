...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.InterfaceC3644a {
    ...
    private C3649c timePickerClockPresenter;
    ...
    public static final class C3634a {
        /* renamed from: a */
        public static /* synthetic */ TimeModel m24343a(C3634a c3634a) {
            throw null;
        }

        /* renamed from: b */
        public static /* synthetic */ Integer m24344b(C3634a c3634a) {
            throw null;
        }

        /* renamed from: c */
        public static /* synthetic */ int m24345c(C3634a c3634a) {
            throw null;
        }

        /* renamed from: d */
        public static /* synthetic */ CharSequence m24346d(C3634a c3634a) {
            throw null;
        }

        /* renamed from: e */
        public static /* synthetic */ int m24347e(C3634a c3634a) {
            throw null;
        }

        /* renamed from: f */
        public static /* synthetic */ CharSequence m24348f(C3634a c3634a) {
            throw null;
        }

        /* renamed from: g */
        public static /* synthetic */ int m24349g(C3634a c3634a) {
            throw null;
        }

        /* renamed from: h */
        public static /* synthetic */ CharSequence m24350h(C3634a c3634a) {
            throw null;
        }

        /* renamed from: i */
        public static /* synthetic */ int m24351i(C3634a c3634a) {
            throw null;
        }
    }

    /* renamed from: b */
    public static /* synthetic */ void m24342b(MaterialTimePicker materialTimePicker) {
        uzj uzjVar = materialTimePicker.activePresenter;
        if (uzjVar instanceof TimePickerTextInputPresenter) {
            ((TimePickerTextInputPresenter) uzjVar).m24359h();
        }
    }

    private Pair<Integer, Integer> dataForMode(int i) {
        if (i == 0) {
            return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(pqf.material_timepicker_text_input_mode_description));
        }
        if (i == 1) {
            return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(pqf.material_timepicker_clock_mode_description));
        }
    ...
    private int getThemeResId() {
        ...
        TypedValue m106037a = w3a.m106037a(requireContext(), zhf.materialTimePickerTheme);
        if (m106037a == null) {
            return 0;
        }
    ...
    private uzj initializeOrRetrieveActivePresenterForMode(int i, TimePickerView timePickerView, ViewStub viewStub) {
        if (i != 0) {
            if (this.timePickerTextInputPresenter == null) {
                this.timePickerTextInputPresenter = new TimePickerTextInputPresenter((LinearLayout) viewStub.inflate(), this.time);
            }
            this.timePickerTextInputPresenter.m24356e();
            return this.timePickerTextInputPresenter;
        }
        C3649c c3649c = this.timePickerClockPresenter;
        if (c3649c == null) {
            c3649c = new C3649c(timePickerView, this.time);
        }
        this.timePickerClockPresenter = c3649c;
        return c3649c;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static MaterialTimePicker newInstance(C3634a c3634a) {
        MaterialTimePicker materialTimePicker = new MaterialTimePicker();
        Bundle bundle = new Bundle();
        bundle.putParcelable(TIME_MODEL_EXTRA, C3634a.m24343a(c3634a));
        if (C3634a.m24344b(c3634a) != null) {
            bundle.putInt(INPUT_MODE_EXTRA, C3634a.m24344b(c3634a).intValue());
        }
        bundle.putInt(TITLE_RES_EXTRA, C3634a.m24345c(c3634a));
        if (C3634a.m24346d(c3634a) != null) {
            bundle.putCharSequence(TITLE_TEXT_EXTRA, C3634a.m24346d(c3634a));
        }
        bundle.putInt(POSITIVE_BUTTON_TEXT_RES_EXTRA, C3634a.m24347e(c3634a));
        if (C3634a.m24348f(c3634a) != null) {
            bundle.putCharSequence(POSITIVE_BUTTON_TEXT_EXTRA, C3634a.m24348f(c3634a));
        }
        bundle.putInt(NEGATIVE_BUTTON_TEXT_RES_EXTRA, C3634a.m24349g(c3634a));
        if (C3634a.m24350h(c3634a) != null) {
            bundle.putCharSequence(NEGATIVE_BUTTON_TEXT_EXTRA, C3634a.m24350h(c3634a));
        }
        bundle.putInt(OVERRIDE_THEME_RES_ID, C3634a.m24351i(c3634a));
    ...
    public void updateInputMode(MaterialButton materialButton) {
        ...
        uzj uzjVar = this.activePresenter;
        if (uzjVar != null) {
            uzjVar.hide();
        }
        uzj initializeOrRetrieveActivePresenterForMode = initializeOrRetrieveActivePresenterForMode(this.inputMode, this.timePickerView, this.textInputStub);
    ...
    public C3649c getTimePickerClockPresenter() {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, zhf.materialTimePickerStyle, xtf.Widget_MaterialComponents_TimePicker);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, nuf.MaterialTimePicker, zhf.materialTimePickerStyle, xtf.Widget_MaterialComponents_TimePicker);
        this.clockIcon = obtainStyledAttributes.getResourceId(nuf.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = obtainStyledAttributes.getResourceId(nuf.MaterialTimePicker_keyboardIcon, 0);
        int color = obtainStyledAttributes.getColor(nuf.MaterialTimePicker_backgroundTint, 0);
        ...
        materialShapeDrawable.setElevation(ViewCompat.m4909u(window.getDecorView()));
        return dialog;
    }

    @Override // androidx.fragment.app.Fragment
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(gpf.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) viewGroup2.findViewById(hlf.material_timepicker_view);
        this.timePickerView = timePickerView;
        timePickerView.setOnDoubleTapListener(this);
        this.textInputStub = (ViewStub) viewGroup2.findViewById(hlf.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(hlf.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(hlf.header_title);
        ...
        Button button = (Button) viewGroup2.findViewById(hlf.material_timepicker_ok_button);
        ...
        Button button2 = (Button) viewGroup2.findViewById(hlf.material_timepicker_cancel_button);
    ...
    @Override // com.google.android.material.timepicker.TimePickerView.InterfaceC3644a
    public void onDoubleTap() {
        this.inputMode = 1;
        updateInputMode(this.modeButton);
        this.timePickerTextInputPresenter.m24359h();
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
            view.postDelayed(new Runnable() { // from class: m4a
                @Override // java.lang.Runnable
                public final void run() {
                    MaterialTimePicker.m24342b(MaterialTimePicker.this);
                }
            }, 100L);
        }
    }
    ...
    public void setActivePresenter(uzj uzjVar) {
        this.activePresenter = uzjVar;
    }
