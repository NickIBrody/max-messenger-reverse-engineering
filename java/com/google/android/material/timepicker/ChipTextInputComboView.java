...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public void setChecked(boolean z) {
        ...
        if (isChecked()) {
            ViewUtils.m23662v(this.editText, false);
        }
    }

    public void setChipDelegate(AccessibilityDelegateCompat accessibilityDelegateCompat) {
        ViewCompat.m4896n0(this.chip, accessibilityDelegateCompat);
    }
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip = (Chip) from.inflate(gpf.material_time_chip, (ViewGroup) this, false);
        this.chip = chip;
        chip.setAccessibilityClassName("android.view.View");
        TextInputLayout textInputLayout = (TextInputLayout) from.inflate(gpf.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(hlf.material_label);
        editText.setId(ViewCompat.m4889k());
        ViewCompat.m4829A0(this.label, editText.getId());
