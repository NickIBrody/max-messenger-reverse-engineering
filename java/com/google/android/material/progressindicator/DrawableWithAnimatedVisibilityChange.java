...
abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    C6537jl animatorDurationScaleProvider = new C6537jl();

    public DrawableWithAnimatedVisibilityChange(Context context, op0 op0Var) {
        this.context = context;
        this.baseSpec = op0Var;
        setAlpha(255);
    }
    ...
    public void dispatchAnimationEnd() {
        ...
        if (animationCallback != null) {
            animationCallback.mo13595b(this);
        }
    ...
    public void dispatchAnimationStart() {
        Animatable2Compat.AnimationCallback animationCallback = this.internalAnimationCallback;
        if (animationCallback != null) {
            animationCallback.mo13596c(this);
        }
        List<Animatable2Compat.AnimationCallback> list = this.animationCallbacks;
        if (list == null || this.ignoreCallbacks) {
            return;
    ...
    private void maybeInitializeAnimators() {
        if (this.showAnimator == null) {
            ...
            this.showAnimator.setInterpolator(AbstractC4053dl.f24338b);
        ...
        if (this.hideAnimator == null) {
            ...
            this.hideAnimator.setInterpolator(AbstractC4053dl.f24338b);
    ...
    public float getGrowFraction() {
        if (this.baseSpec.m81188b() || this.baseSpec.m81187a()) {
    ...
    public boolean setVisibleInternal(boolean z, boolean z2, boolean z3) {
        ...
        if (!(z ? this.baseSpec.m81188b() : this.baseSpec.m81187a())) {
            endAnimatorsWithoutCallbacks(valueAnimator);
            return z4;
        }
    ...
    public boolean setVisible(boolean z, boolean z2, boolean z3) {
        return setVisibleInternal(z, z2, z3 && this.animatorDurationScaleProvider.m45087a(this.context.getContentResolver()) > 0.0f);
    }
}
