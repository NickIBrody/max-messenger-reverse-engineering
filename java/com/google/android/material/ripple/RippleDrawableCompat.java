...
public class RippleDrawableCompat extends Drawable implements mxh {
    ...
    public boolean onStateChange(int[] iArr) {
        ...
        boolean m44973e = jjg.m44973e(iArr);
        RippleDrawableCompatState rippleDrawableCompatState = this.drawableState;
        if (rippleDrawableCompatState.shouldDrawDelegate == m44973e) {
            return onStateChange;
        }
        rippleDrawableCompatState.shouldDrawDelegate = m44973e;
        return true;
    }
    ...
    public void setShapeAppearanceModel(C3548a c3548a) {
        this.drawableState.delegate.setShapeAppearanceModel(c3548a);
    }
    ...
    public RippleDrawableCompat(C3548a c3548a) {
        this(new RippleDrawableCompatState(new MaterialShapeDrawable(c3548a)));
    }
