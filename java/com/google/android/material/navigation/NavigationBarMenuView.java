...
public abstract class NavigationBarMenuView extends ViewGroup implements InterfaceC0383d {
    ...
    private C3548a itemActiveIndicatorShapeAppearance;
    ...
    private final C1998c set;

    public NavigationBarMenuView(Context context) {
        super(context);
        this.itemPool = new uqe(5);
        ...
        if (isInEditMode()) {
            ...
            this.set = cg0Var;
            cg0Var.m13581B0(0);
            cg0Var.mo13508h0(xtb.m111956f(getContext(), zhf.motionDurationMedium4, getResources().getInteger(wof.material_motion_duration_long_1)));
            cg0Var.mo13512j0(xtb.m111957g(getContext(), zhf.motionEasingStandard, AbstractC4053dl.f24338b));
            cg0Var.m13586s0(new TextScale());
        }
    ...
    private NavigationBarItemView getNewItem() {
        NavigationBarItemView navigationBarItemView = (NavigationBarItemView) this.itemPool.mo18642t();
        ...
        if (navigationBarItemViewArr != null) {
            for (NavigationBarItemView navigationBarItemView : navigationBarItemViewArr) {
                if (navigationBarItemView != null) {
                    this.itemPool.mo18639a(navigationBarItemView);
    ...
    public ColorStateList createDefaultColorStateList(int i) {
        ...
        return new ColorStateList(new int[][]{iArr, CHECKED_STATE_SET, ViewGroup.EMPTY_STATE_SET}, new int[]{m108419a.getColorForState(iArr, defaultColor), i2, defaultColor});
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        C4680f4.m32045Q0(accessibilityNodeInfo).m32112l0(C4680f4.e.m32153b(1, this.menu.getVisibleItems().size(), false, 1));
    }
    ...
    public void setItemActiveIndicatorShapeAppearance(C3548a c3548a) {
        this.itemActiveIndicatorShapeAppearance = c3548a;
        NavigationBarItemView[] navigationBarItemViewArr = this.buttons;
        if (navigationBarItemViewArr != null) {
            for (NavigationBarItemView navigationBarItemView : navigationBarItemViewArr) {
                navigationBarItemView.setActiveIndicatorDrawable(createItemActiveIndicatorDrawable());
    ...
    public void updateMenuView() {
        ...
        if (i != this.selectedItemId && (c1998c = this.set) != null) {
            TransitionManager.m13548a(this, c1998c);
        }
        boolean isShifting = isShifting(this.labelVisibilityMode, this.menu.getVisibleItems().size());
