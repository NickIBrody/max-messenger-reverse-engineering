...
public abstract class CircularRevealCompat {
    ...
    /* renamed from: a */
    public static Animator m23401a(CircularRevealWidget circularRevealWidget, float f, float f2, float f3) {
        ObjectAnimator ofObject = ObjectAnimator.ofObject(circularRevealWidget, (Property<CircularRevealWidget, V>) CircularRevealWidget.CircularRevealProperty.CIRCULAR_REVEAL, (TypeEvaluator) CircularRevealWidget.CircularRevealEvaluator.CIRCULAR_REVEAL, (Object[]) new CircularRevealWidget.C3370b[]{new CircularRevealWidget.C3370b(f, f2, f3)});
        CircularRevealWidget.C3370b revealInfo = circularRevealWidget.getRevealInfo();
        if (revealInfo == null) {
            throw new IllegalStateException("Caller must set a non-null RevealInfo before calling this.");
        }
        Animator createCircularReveal = ViewAnimationUtils.createCircularReveal((View) circularRevealWidget, (int) f, (int) f2, revealInfo.f20754c, f3);
    ...
    /* renamed from: b */
    public static Animator.AnimatorListener m23402b(final CircularRevealWidget circularRevealWidget) {
