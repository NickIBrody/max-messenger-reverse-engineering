...
class CutoutDrawable extends MaterialShapeDrawable {
    ...
    public static CutoutDrawable create(C3548a c3548a) {
        if (c3548a == null) {
            c3548a = new C3548a();
        }
        return create(new CutoutDrawableState(c3548a, new RectF()));
    }
    ...
    public static final class CutoutDrawableState extends MaterialShapeDrawable.MaterialShapeDrawableState {
        ...
        private CutoutDrawableState(C3548a c3548a, RectF rectF) {
            super(c3548a, null);
