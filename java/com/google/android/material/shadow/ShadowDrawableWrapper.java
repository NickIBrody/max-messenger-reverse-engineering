...
public class ShadowDrawableWrapper extends DrawableWrapperCompat {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = np4.m55830c(context, uif.design_fab_shadow_start_color);
        this.shadowMiddleColor = np4.m55830c(context, uif.design_fab_shadow_mid_color);
        this.shadowEndColor = np4.m55830c(context, uif.design_fab_shadow_end_color);
