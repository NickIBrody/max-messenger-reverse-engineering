...
public class MaterialShapeDrawable extends Drawable implements mxh {
    ...
    private final C3550c.g[] cornerShadowOperation;
    private MaterialShapeDrawableState drawableState;
    private final C3550c.g[] edgeShadowOperation;
    ...
    private final C3549b pathProvider;
    private final C3549b.b pathShadowListener;
    private final RectF rectF;
    private int resolvedTintColor;
    private final Region scratchRegion;
    private boolean shadowBitmapDrawingEnable;
    private final swh shadowRenderer;
    private final Paint strokePaint;
    private C3548a strokeShapeAppearance;
    private PorterDuffColorFilter strokeTintFilter;
    private PorterDuffColorFilter tintFilter;
    private final Region transparentRegion;

    /* renamed from: com.google.android.material.shape.MaterialShapeDrawable$a */
    public class C3544a implements C3549b.b {
        public C3544a() {
        }

        @Override // com.google.android.material.shape.C3549b.b
        /* renamed from: a */
        public void mo23902a(C3550c c3550c, Matrix matrix, int i) {
            MaterialShapeDrawable.this.containsIncompatibleShadowOp.set(i, c3550c.m23994e());
            MaterialShapeDrawable.this.cornerShadowOperation[i] = c3550c.m23995f(matrix);
        }

        @Override // com.google.android.material.shape.C3549b.b
        /* renamed from: b */
        public void mo23903b(C3550c c3550c, Matrix matrix, int i) {
            MaterialShapeDrawable.this.containsIncompatibleShadowOp.set(i + 4, c3550c.m23994e());
            MaterialShapeDrawable.this.edgeShadowOperation[i] = c3550c.m23995f(matrix);
        }
    }

    /* renamed from: com.google.android.material.shape.MaterialShapeDrawable$b */
    public class C3545b implements C3548a.c {

        /* renamed from: a */
        public final /* synthetic */ float f21063a;

        public C3545b(float f) {
            this.f21063a = f;
        }

        @Override // com.google.android.material.shape.C3548a.c
        /* renamed from: a */
        public ru4 mo23904a(ru4 ru4Var) {
            return ru4Var instanceof oag ? ru4Var : new C7862nc(this.f21063a, ru4Var);
        }
    }
    ...
    private void calculateStrokePath() {
        C3548a m23938y = getShapeAppearanceModel().m23938y(new C3545b(-getStrokeInsetLength()));
        this.strokeShapeAppearance = m23938y;
        this.pathProvider.m23979d(m23938y, this.drawableState.interpolation, getBoundsInsetByStroke(), this.pathInsetByStroke);
    }
    ...
    private void drawCompatShadow(Canvas canvas) {
        ...
        if (this.drawableState.shadowCompatOffset != 0) {
            canvas.drawPath(this.path, this.shadowRenderer.m97122c());
        }
        for (int i = 0; i < 4; i++) {
            this.cornerShadowOperation[i].m24038a(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
            this.edgeShadowOperation[i].m24038a(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
        }
    ...
    private boolean updateTintFilter() {
        ...
        if (materialShapeDrawableState3.useTintColorForShadow) {
            this.shadowRenderer.m97123d(materialShapeDrawableState3.tintList.getColorForState(getState(), 0));
        }
        return (okc.m58457a(porterDuffColorFilter, this.tintFilter) && okc.m58457a(porterDuffColorFilter2, this.strokeTintFilter)) ? false : true;
    }
    ...
    public final void calculatePathForSize(RectF rectF, Path path) {
        C3549b c3549b = this.pathProvider;
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        c3549b.m23980e(materialShapeDrawableState.shapeAppearanceModel, materialShapeDrawableState.interpolation, rectF, this.pathShadowListener, path);
    }

    public int compositeElevationOverlayIfNeeded(int i) {
        float z = getZ() + getParentAbsoluteElevation();
        od6 od6Var = this.drawableState.elevationOverlayProvider;
        return od6Var != null ? od6Var.m57714c(i, z) : i;
    }
    ...
    public float getBottomLeftCornerResolvedSize() {
        return this.drawableState.shapeAppearanceModel.m23924j().mo54899a(getBoundsAsRectF());
    }

    public float getBottomRightCornerResolvedSize() {
        return this.drawableState.shapeAppearanceModel.m23926l().mo54899a(getBoundsAsRectF());
    }
    ...
    public float getTopLeftCornerResolvedSize() {
        return this.drawableState.shapeAppearanceModel.m23931r().mo54899a(getBoundsAsRectF());
    }

    public float getTopRightCornerResolvedSize() {
        return this.drawableState.shapeAppearanceModel.m23933t().mo54899a(getBoundsAsRectF());
    }
    ...
    public void initializeElevationOverlay(Context context) {
        this.drawableState.elevationOverlayProvider = new od6(context);
        updateZ();
    }
    ...
    public boolean isElevationOverlayEnabled() {
        od6 od6Var = this.drawableState.elevationOverlayProvider;
        return od6Var != null && od6Var.m57716e();
    }
    ...
    public boolean isRoundRect() {
        return this.drawableState.shapeAppearanceModel.m23934u(getBoundsAsRectF());
    }
    ...
    public void setCornerSize(float f) {
        setShapeAppearanceModel(this.drawableState.shapeAppearanceModel.m23936w(f));
    }

    public void setEdgeIntersectionCheckEnable(boolean z) {
        this.pathProvider.m23988n(z);
    }
    ...
    public void setShapeAppearanceModel(C3548a c3548a) {
        this.drawableState.shapeAppearanceModel = c3548a;
        invalidateSelf();
    }

    @Deprecated
    public void setShapedViewModel(fxh fxhVar) {
        setShapeAppearanceModel(fxhVar);
    }
    ...
    public MaterialShapeDrawable(Context context, AttributeSet attributeSet, int i, int i2) {
        this(C3548a.m23918e(context, attributeSet, i, i2).m23962m());
    }
    ...
    private void drawShape(Canvas canvas, Paint paint, Path path, C3548a c3548a, RectF rectF) {
        if (!c3548a.m23934u(rectF)) {
            canvas.drawPath(path, paint);
        } else {
            float mo54899a = c3548a.m23933t().mo54899a(rectF) * this.drawableState.interpolation;
            canvas.drawRoundRect(rectF, mo54899a, mo54899a, paint);
        }
    }

    public void setCornerSize(ru4 ru4Var) {
        setShapeAppearanceModel(this.drawableState.shapeAppearanceModel.m23937x(ru4Var));
    }

    @Deprecated
    public MaterialShapeDrawable(fxh fxhVar) {
        this((C3548a) fxhVar);
    }

    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float f, ColorStateList colorStateList) {
        if (colorStateList == null) {
            colorStateList = ColorStateList.valueOf(d4a.m26257c(context, zhf.colorSurface, MaterialShapeDrawable.class.getSimpleName()));
        }
    ...
    public MaterialShapeDrawable(C3548a c3548a) {
        this(new MaterialShapeDrawableState(c3548a, null));
    }
    ...
    public MaterialShapeDrawable(MaterialShapeDrawableState materialShapeDrawableState) {
        C3549b c3549b;
        this.cornerShadowOperation = new C3550c.g[4];
        this.edgeShadowOperation = new C3550c.g[4];
        ...
        this.shadowRenderer = new swh();
        if (Looper.getMainLooper().getThread() == Thread.currentThread()) {
            c3549b = C3549b.m23975k();
        } else {
            c3549b = new C3549b();
        }
        this.pathProvider = c3549b;
        ...
        this.pathShadowListener = new C3544a();
    }
    ...
    public static class MaterialShapeDrawableState extends Drawable.ConstantState {
        ...
        public MaterialShapeDrawableState(C3548a c3548a, od6 od6Var) {
            this.fillColor = null;
            ...
            this.elevationOverlayProvider = od6Var;
        }
