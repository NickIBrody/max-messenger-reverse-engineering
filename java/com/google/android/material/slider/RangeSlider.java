...
public class RangeSlider extends BaseSlider<RangeSlider, Object, Object> {
    ...
    @Override // com.google.android.material.slider.BaseSlider
    public /* bridge */ /* synthetic */ void setLabelFormatter(uc9 uc9Var) {
        super.setLabelFormatter(uc9Var);
    }
    ...
    public RangeSlider(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray m112200i = xvj.m112200i(context, attributeSet, nuf.RangeSlider, i, BaseSlider.DEF_STYLE_RES, new int[0]);
        if (m112200i.hasValue(nuf.RangeSlider_values)) {
            setValues(convertToFloat(m112200i.getResources().obtainTypedArray(m112200i.getResourceId(nuf.RangeSlider_values, 0))));
        }
        this.minSeparation = m112200i.getDimension(nuf.RangeSlider_minSeparation, 0.0f);
        m112200i.recycle();
    }
}
