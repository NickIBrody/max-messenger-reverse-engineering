...
class DaysOfWeekAdapter extends BaseAdapter {
    ...
    public DaysOfWeekAdapter() {
        ...
        this.calendar = m114469n;
        this.daysInWeek = m114469n.getMaximum(7);
        this.firstDayOfWeek = m114469n.getFirstDayOfWeek();
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            textView = (TextView) LayoutInflater.from(viewGroup.getContext()).inflate(gpf.mtrl_calendar_day_of_week, viewGroup, false);
        }
        ...
        textView.setContentDescription(String.format(viewGroup.getContext().getString(pqf.mtrl_picker_day_of_week_column_header), this.calendar.getDisplayName(7, 2, Locale.getDefault())));
        return textView;
    }
