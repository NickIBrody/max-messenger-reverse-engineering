...
public class ShapeableImageView extends AppCompatImageView implements mxh {
    private static final int DEF_STYLE_RES = xtf.Widget_MaterialComponents_ShapeableImageView;
    ...
    private void updateShapeMask(int i, int i2) {
        ...
        this.pathProvider.m23979d(this.shapeAppearanceModel, 1.0f, this.destination, this.path);
    ...
    */
    public ShapeableImageView(Context context, AttributeSet attributeSet, int i) {
        super(l4a.m48844c(context, attributeSet, i, r0), attributeSet, i);
        int i2 = DEF_STYLE_RES;
        this.pathProvider = C3549b.m23975k();
        this.path = new Path();
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, nuf.ShapeableImageView, i, i2);
        setLayerType(2, null);
        this.strokeColor = i4a.m40464b(context2, obtainStyledAttributes, nuf.ShapeableImageView_strokeColor);
        this.strokeWidth = obtainStyledAttributes.getDimensionPixelSize(nuf.ShapeableImageView_strokeWidth, 0);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(nuf.ShapeableImageView_contentPadding, 0);
        ...
        this.leftContentPadding = obtainStyledAttributes.getDimensionPixelSize(nuf.ShapeableImageView_contentPaddingLeft, dimensionPixelSize);
        this.topContentPadding = obtainStyledAttributes.getDimensionPixelSize(nuf.ShapeableImageView_contentPaddingTop, dimensionPixelSize);
        this.rightContentPadding = obtainStyledAttributes.getDimensionPixelSize(nuf.ShapeableImageView_contentPaddingRight, dimensionPixelSize);
        this.bottomContentPadding = obtainStyledAttributes.getDimensionPixelSize(nuf.ShapeableImageView_contentPaddingBottom, dimensionPixelSize);
        this.startContentPadding = obtainStyledAttributes.getDimensionPixelSize(nuf.ShapeableImageView_contentPaddingStart, Integer.MIN_VALUE);
        this.endContentPadding = obtainStyledAttributes.getDimensionPixelSize(nuf.ShapeableImageView_contentPaddingEnd, Integer.MIN_VALUE);
