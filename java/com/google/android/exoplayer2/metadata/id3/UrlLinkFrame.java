...
public final class UrlLinkFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && UrlLinkFrame.class == obj.getClass()) {
            ...
            if (this.f19411id.equals(urlLinkFrame.f19411id) && rwk.m94595c(this.description, urlLinkFrame.description) && rwk.m94595c(this.url, urlLinkFrame.url)) {
                return true;
            }
        }
        return false;
    ...
    public UrlLinkFrame(Parcel parcel) {
        ...
        this.url = (String) rwk.m94609j(parcel.readString());
    }
}
