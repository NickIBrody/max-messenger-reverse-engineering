...
public final class PrivFrame extends Id3Frame {
    ...
    /* renamed from: ID */
    public static final String f19414ID = "PRIV";
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && PrivFrame.class == obj.getClass()) {
            ...
            if (rwk.m94595c(this.owner, privFrame.owner) && Arrays.equals(this.privateData, privFrame.privateData)) {
                return true;
            }
        }
        return false;
    ...
    public PrivFrame(Parcel parcel) {
        super(f19414ID);
        this.owner = (String) rwk.m94609j(parcel.readString());
        this.privateData = (byte[]) rwk.m94609j(parcel.createByteArray());
    }
}
