...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public boolean equals(Object obj) {
            ...
            return rwk.m94595c(this.licenseServerUrl, schemeData.licenseServerUrl) && rwk.m94595c(this.mimeType, schemeData.mimeType) && rwk.m94595c(this.uuid, schemeData.uuid) && Arrays.equals(this.data, schemeData.data);
        }
        ...
        public boolean matches(UUID uuid) {
            return s51.f100509a.equals(this.uuid) || uuid.equals(this.uuid);
        }
        ...
        public SchemeData(UUID uuid, String str, String str2, byte[] bArr) {
            this.uuid = (UUID) l00.m48473d(uuid);
            this.licenseServerUrl = str;
            this.mimeType = (String) l00.m48473d(str2);
            this.data = bArr;
        }
    ...
    public DrmInitData copyWithSchemeType(String str) {
        return rwk.m94595c(this.schemeType, str) ? this : new DrmInitData(str, false, this.schemeDatas);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && DrmInitData.class == obj.getClass()) {
            ...
            if (rwk.m94595c(this.schemeType, drmInitData.schemeType) && Arrays.equals(this.schemeDatas, drmInitData.schemeDatas)) {
                return true;
            }
        }
        return false;
    ...
    public DrmInitData merge(DrmInitData drmInitData) {
        ...
        l00.m48474e(str2 == null || (str = drmInitData.schemeType) == null || TextUtils.equals(str2, str));
        String str3 = this.schemeType;
        if (str3 == null) {
            str3 = drmInitData.schemeType;
        }
        return new DrmInitData(str3, (SchemeData[]) rwk.m94594b0(this.schemeDatas, drmInitData.schemeDatas));
    }
    ...
    public DrmInitData(Parcel parcel) {
        ...
        SchemeData[] schemeDataArr = (SchemeData[]) rwk.m94609j((SchemeData[]) parcel.createTypedArray(SchemeData.CREATOR));
        this.schemeDatas = schemeDataArr;
        this.schemeDataCount = schemeDataArr.length;
    }
}
