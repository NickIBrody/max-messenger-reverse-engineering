...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    private final InterfaceC3185b callback;
    ...
    private static EGLConfig chooseEGLConfig(EGLDisplay eGLDisplay) {
        ...
        if (!eglChooseConfig || iArr[0] <= 0 || (eGLConfig = eGLConfigArr[0]) == null) {
            throw new GlException(rwk.m94565A("eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
        }
        return eGLConfig;
    }
    ...
    public SurfaceTexture getSurfaceTexture() {
        return (SurfaceTexture) l00.m48473d(this.texture);
    }
    ...
    public EGLSurfaceTexture(Handler handler, InterfaceC3185b interfaceC3185b) {
