...
public final class Requirements implements Parcelable {
    ...
    private int getNotMetNetworkRequirements(Context context) {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) l00.m48473d(context.getSystemService("connectivity"));
    ...
    private boolean isDeviceIdle(Context context) {
        PowerManager powerManager = (PowerManager) l00.m48473d(context.getSystemService("power"));
        int i = rwk.f99811a;
