...
final class OrientationListener implements SensorEventListener {
    ...
    private final InterfaceC3194a[] listeners;
    ...
    /* renamed from: com.google.android.exoplayer2.video.spherical.OrientationListener$a */
    public interface InterfaceC3194a {
        void onOrientationChange(float[] fArr, float f);
    }

    public OrientationListener(Display display, InterfaceC3194a... interfaceC3194aArr) {
        this.display = display;
        this.listeners = interfaceC3194aArr;
    }
    ...
    private void notifyListeners(float[] fArr, float f) {
        for (InterfaceC3194a interfaceC3194a : this.listeners) {
            interfaceC3194a.onOrientationChange(fArr, f);
        }
    }

    private void recenter(float[] fArr) {
        if (!this.recenterMatrixComputed) {
            jq7.m45480a(this.recenterMatrix4x4, fArr);
