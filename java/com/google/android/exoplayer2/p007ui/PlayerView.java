...
public class PlayerView extends FrameLayout {
    ...
    private PlayerControlView.InterfaceC3136d controllerVisibilityListener;
    ...
    public final class ComponentListener implements InterfaceC3068q.c, View.OnLayoutChangeListener, View.OnClickListener, PlayerControlView.InterfaceC3136d {
        ...
        @Override // com.google.android.exoplayer2.p007ui.PlayerControlView.InterfaceC3136d
    ...
    public static /* synthetic */ InterfaceC3068q access$300(PlayerView playerView) {
        playerView.getClass();
        return null;
    }
    ...
    public static void switchTargetView(InterfaceC3068q interfaceC3068q, PlayerView playerView, PlayerView playerView2) {
        if (playerView == playerView2) {
            return;
        }
        if (playerView2 != null) {
            playerView2.setPlayer(interfaceC3068q);
        }
        if (playerView != null) {
    ...
    public List<C2350bb> getAdOverlayInfos() {
        ...
        if (playerControlView != null) {
            arrayList.add(new C2350bb(playerControlView, 1));
        }
    ...
    public void setControllerVisibilityListener(PlayerControlView.InterfaceC3136d interfaceC3136d) {
        l00.m48476g(this.controller);
        PlayerControlView.InterfaceC3136d interfaceC3136d2 = this.controllerVisibilityListener;
        if (interfaceC3136d2 == interfaceC3136d) {
            return;
        }
        if (interfaceC3136d2 != null) {
            this.controller.removeVisibilityListener(interfaceC3136d2);
        }
        this.controllerVisibilityListener = interfaceC3136d;
        if (interfaceC3136d != null) {
            this.controller.addVisibilityListener(interfaceC3136d);
        }
    }
    ...
    public PlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        int i9 = fpf.exo_player_view;
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, iuf.PlayerView, i, 0);
            try {
                boolean hasValue = obtainStyledAttributes.hasValue(iuf.PlayerView_shutter_background_color);
                int color = obtainStyledAttributes.getColor(iuf.PlayerView_shutter_background_color, 0);
                int resourceId = obtainStyledAttributes.getResourceId(iuf.PlayerView_player_layout_id, i9);
                boolean z9 = obtainStyledAttributes.getBoolean(iuf.PlayerView_use_artwork, true);
                int resourceId2 = obtainStyledAttributes.getResourceId(iuf.PlayerView_default_artwork, 0);
                boolean z10 = obtainStyledAttributes.getBoolean(iuf.PlayerView_use_controller, true);
                int i10 = obtainStyledAttributes.getInt(iuf.PlayerView_surface_type, 1);
                int i11 = obtainStyledAttributes.getInt(iuf.PlayerView_resize_mode, 0);
                int i12 = obtainStyledAttributes.getInt(iuf.PlayerView_show_timeout, 5000);
                boolean z11 = obtainStyledAttributes.getBoolean(iuf.PlayerView_hide_on_touch, true);
                boolean z12 = obtainStyledAttributes.getBoolean(iuf.PlayerView_auto_show, true);
                i4 = obtainStyledAttributes.getInteger(iuf.PlayerView_show_buffering, 0);
                this.keepContentOnPlayerReset = obtainStyledAttributes.getBoolean(iuf.PlayerView_keep_content_on_player_reset, this.keepContentOnPlayerReset);
                boolean z13 = obtainStyledAttributes.getBoolean(iuf.PlayerView_hide_during_ads, true);
        ...
        PlayerControlView playerControlView = (PlayerControlView) findViewById(glf.exo_controller);
        ...
        if (playerControlView != null) {
            ...
            playerControlView2.setId(glf.exo_controller);
        ...
        this.useController = (!z4 || playerControlView3 == null) ? i8 : 1;
        hideController();
        updateContentDescription();
