...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static final xs3 zaa = od5.m57710b();
    final int zab;
    final List zac;
    ...
    public static GoogleSignInAccount fromAccount(Account account) {
        return zae(account, new C6666jy());
    }
    ...
    public static GoogleSignInAccount zaa(String str, String str2, String str3, String str4, String str5, String str6, Uri uri, Long l, String str7, Set set) {
        return new GoogleSignInAccount(3, str, str2, str3, str4, uri, null, l.longValue(), kte.m48090g(str7), new ArrayList((Collection) kte.m48096m(set)), str5, str6);
    }
    ...
    public boolean isExpired() {
        return zaa.mo57711a() / 1000 >= this.zaj + (-300);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        dug.m28384r(parcel, 1, this.zab);
        dug.m28358B(parcel, 2, getId(), false);
        dug.m28358B(parcel, 3, getIdToken(), false);
        dug.m28358B(parcel, 4, getEmail(), false);
        dug.m28358B(parcel, 5, getDisplayName(), false);
        dug.m28357A(parcel, 6, getPhotoUrl(), i, false);
        dug.m28358B(parcel, 7, getServerAuthCode(), false);
        dug.m28388v(parcel, 8, this.zaj);
        dug.m28358B(parcel, 9, this.zak, false);
        dug.m28362F(parcel, 10, this.zac, false);
        dug.m28358B(parcel, 11, getGivenName(), false);
        dug.m28358B(parcel, 12, getFamilyName(), false);
    ...
    public final String zad() {
        ...
        try {
            ...
            Arrays.sort(scopeArr, new Comparator() { // from class: f2n
