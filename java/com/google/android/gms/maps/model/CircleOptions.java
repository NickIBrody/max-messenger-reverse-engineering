...
public final class CircleOptions extends AbstractSafeParcelable {
    ...
    public CircleOptions center(LatLng latLng) {
        kte.m48097n(latLng, "center must not be null.");
        this.zza = latLng;
        return this;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        dug.m28357A(parcel, 2, getCenter(), i, false);
        dug.m28378l(parcel, 3, getRadius());
        ...
        dug.m28373g(parcel, 9, isClickable());
        dug.m28362F(parcel, 10, getStrokePattern(), false);
