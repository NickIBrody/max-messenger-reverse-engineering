...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    private final void zaa(Context context) {
        ...
        try {
            this.zac = i5n.m40565c(context, this.zaa, this.zab);
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zad = null;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, kuf.SignInButton, 0, 0);
        try {
            this.zaa = obtainStyledAttributes.getInt(kuf.SignInButton_buttonSize, 0);
            this.zab = obtainStyledAttributes.getInt(kuf.SignInButton_colorScheme, 2);
