...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    private final void zab() {
        ...
        if (pendingIntent == null) {
            C3209a.m22626n().m22635o(this, ((Integer) kte.m48096m(num)).intValue(), 2, this);
            this.zaa = 1;
            return;
        }
        try {
            ...
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    ...
                    String str = "Activity not found while launching " + pendingIntent.toString() + Extension.DOT_CHAR;
