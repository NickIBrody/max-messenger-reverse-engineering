...
public final class BackgroundDetector implements Application.ActivityLifecycleCallbacks, ComponentCallbacks2 {
    ...
    /* renamed from: com.google.android.gms.common.api.internal.BackgroundDetector$a */
    public interface InterfaceC3216a {
        /* renamed from: a */
        void mo22676a(boolean z);
    }
    ...
    private final void zza(boolean z) {
        synchronized (zza) {
            try {
                ...
                while (it.hasNext()) {
                    ((InterfaceC3216a) it.next()).mo22676a(z);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void addListener(InterfaceC3216a interfaceC3216a) {
        synchronized (zza) {
            this.zzd.add(interfaceC3216a);
        }
    }
