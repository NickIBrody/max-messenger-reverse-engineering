...
public class BlockingServiceConnection implements ServiceConnection {
    ...
    public IBinder getService() throws InterruptedException {
        kte.m48095l("BlockingServiceConnection.getService() called on main thread");
        if (this.zza) {
    ...
    public IBinder getServiceWithTimeout(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
        kte.m48095l("BlockingServiceConnection.getServiceWithTimeout() called on main thread");
        if (this.zza) {
            throw new IllegalStateException("Cannot call get on this connection more than once");
        }
        this.zza = true;
