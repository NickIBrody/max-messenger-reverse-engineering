...
class GhostViewPort extends ViewGroup {
    ...
    public static void calculateMatrix(View view, ViewGroup viewGroup, Matrix matrix) {
        ...
        matrix.reset();
        ViewUtils.m13565h(viewGroup2, matrix);
        matrix.preTranslate(-viewGroup2.getScrollX(), -viewGroup2.getScrollY());
        ViewUtils.m13566i(viewGroup, matrix);
    }

    public static void copySize(View view, View view2) {
        ViewUtils.m13562e(view2, view2.getLeft(), view2.getTop(), view2.getLeft() + view.getWidth(), view2.getTop() + view.getHeight());
    }

    public static GhostViewPort getGhostView(View view) {
        return (GhostViewPort) view.getTag(elf.ghost_view);
    }
    ...
    public static void setGhostView(View view, GhostViewPort ghostViewPort) {
        view.setTag(elf.ghost_view, ghostViewPort);
    }
    ...
    public void onAttachedToWindow() {
        ...
        ViewUtils.m13564g(this.mView, 4);
    ...
    public void onDraw(Canvas canvas) {
        ko2.m47639a(canvas, true);
        canvas.setMatrix(this.mMatrix);
        ViewUtils.m13564g(this.mView, 0);
        this.mView.invalidate();
        ViewUtils.m13564g(this.mView, 4);
        drawChild(canvas, this.mView, getDrawingTime());
        ko2.m47639a(canvas, false);
    }
    ...
    public void setVisibility(int i) {
        ...
        if (getGhostView(this.mView) == this) {
            ViewUtils.m13564g(this.mView, i == 0 ? 4 : 0);
        }
    }
}
