...
class GhostViewHolder extends FrameLayout {
    ...
    /* renamed from: androidx.transition.GhostViewHolder$a */
    public static class C1980a {
        /* renamed from: a */
        public static float m13470a(View view) {
            return view.getZ();
        }
    }
    ...
    public GhostViewHolder(ViewGroup viewGroup) {
        ...
        viewGroup.setTag(elf.ghost_view_holder, this);
        this.mParent.getOverlay().add(this);
        this.mAttached = true;
    }

    public static GhostViewHolder getHolder(ViewGroup viewGroup) {
        return (GhostViewHolder) viewGroup.getTag(elf.ghost_view_holder);
    }
    ...
    public void onViewRemoved(View view) {
        ...
        if ((getChildCount() == 1 && getChildAt(0) == view) || getChildCount() == 0) {
            this.mParent.setTag(elf.ghost_view_holder, null);
    ...
    private static boolean isOnTop(View view, View view2) {
        ...
        if (C1980a.m13470a(view) != C1980a.m13470a(view2)) {
            return C1980a.m13470a(view) > C1980a.m13470a(view2);
        }
        for (int i = 0; i < childCount; i++) {
            View childAt = viewGroup.getChildAt(eel.m29792a(viewGroup, i));
            if (childAt == view) {
                return false;
            }
            if (childAt == view2) {
