...
public class BrowserActionsFallbackMenuView extends LinearLayout {
    ...
    public BrowserActionsFallbackMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.mBrowserActionsMenuMinPaddingPx = getResources().getDimensionPixelOffset(fjf.browser_actions_context_menu_min_padding);
        this.mBrowserActionsMenuMaxWidthPx = getResources().getDimensionPixelOffset(fjf.browser_actions_context_menu_max_width);
    }
