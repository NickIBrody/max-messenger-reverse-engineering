...
public final class Requirements implements Parcelable {
    ...
    private int getNotMetNetworkRequirements(Context context) {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) lte.m50433p(context.getSystemService("connectivity"));
    ...
    private boolean isDeviceIdle(Context context) {
        return ((PowerManager) lte.m50433p(context.getSystemService("power"))).isDeviceIdleMode();
    }
