...
final class TouchTracker extends GestureDetector.SimpleOnGestureListener implements View.OnTouchListener, OrientationListener.InterfaceC1381a {
    static final float MAX_PITCH_DEGREES = 45.0f;
    private final GestureDetector gestureDetector;
    private final InterfaceC1383a listener;
    private final float pxPerDegrees;
    private final PointF previousTouchPointPx = new PointF();
    private final PointF accumulatedTouchOffsetDegrees = new PointF();
    private volatile float roll = 3.1415927f;

    /* renamed from: androidx.media3.exoplayer.video.spherical.TouchTracker$a */
    ...
    public TouchTracker(Context context, InterfaceC1383a interfaceC1383a, float f) {
        this.listener = interfaceC1383a;
        this.pxPerDegrees = f;
