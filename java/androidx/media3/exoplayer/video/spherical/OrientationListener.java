...
final class OrientationListener implements SensorEventListener {
    ...
    private final InterfaceC1381a[] listeners;
    ...
    /* renamed from: androidx.media3.exoplayer.video.spherical.OrientationListener$a */
    public interface InterfaceC1381a {
        void onOrientationChange(float[] fArr, float f);
    }

    public OrientationListener(Display display, InterfaceC1381a... interfaceC1381aArr) {
        this.display = display;
        this.listeners = interfaceC1381aArr;
    }
    ...
    private void notifyListeners(float[] fArr, float f) {
        for (InterfaceC1381a interfaceC1381a : this.listeners) {
            interfaceC1381a.onOrientationChange(fArr, f);
        }
    }

    private void recenter(float[] fArr) {
        if (!this.recenterMatrixComputed) {
            kq7.m47828a(this.recenterMatrix4x4, fArr);
