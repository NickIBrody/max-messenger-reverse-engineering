...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    private final InterfaceC1102a callback;
    ...
    /* renamed from: androidx.media3.common.util.EGLSurfaceTexture$a */
    ...
    private static EGLConfig chooseEGLConfig(EGLDisplay eGLDisplay) throws GlUtil.GlException {
        ...
        GlUtil.m6480e(eglChooseConfig && iArr[0] > 0 && eGLConfigArr[0] != null, qwk.m87112J("eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    ...
    private static EGLContext createEGLContext(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i) throws GlUtil.GlException {
        ...
        GlUtil.m6480e(eglCreateContext != null, "eglCreateContext failed");
    ...
    private static EGLSurface createEGLSurface(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i) throws GlUtil.GlException {
        ...
        if (i == 1) {
            ...
            GlUtil.m6480e(eglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
        }
        GlUtil.m6480e(EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eGLContext), "eglMakeCurrent failed");
    ...
    private static EGLDisplay getDefaultDisplay() throws GlUtil.GlException {
        ...
        GlUtil.m6480e(eglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        GlUtil.m6480e(EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        return eglGetDisplay;
    }

    public SurfaceTexture getSurfaceTexture() {
        return (SurfaceTexture) lte.m50433p(this.texture);
    }
    ...
    public EGLSurfaceTexture(Handler handler, InterfaceC1102a interfaceC1102a) {
