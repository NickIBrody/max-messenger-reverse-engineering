...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public boolean matches(UUID uuid) {
            return u51.f107554a.equals(this.uuid) || uuid.equals(this.uuid);
        }
        ...
        public SchemeData(UUID uuid, String str, String str2, byte[] bArr) {
            this.uuid = (UUID) lte.m50433p(uuid);
            this.licenseServerUrl = str;
            this.mimeType = prb.m84271v((String) lte.m50433p(str2));
            this.data = bArr;
        }
        ...
        public SchemeData(Parcel parcel) {
            ...
            this.mimeType = (String) qwk.m87182l(parcel.readString());
    ...
    public DrmInitData merge(DrmInitData drmInitData) {
        ...
        lte.m50438u(str2 == null || (str = drmInitData.schemeType) == null || TextUtils.equals(str2, str));
        String str3 = this.schemeType;
        if (str3 == null) {
            str3 = drmInitData.schemeType;
        }
        return new DrmInitData(str3, (SchemeData[]) qwk.m87154b1(this.schemeDatas, drmInitData.schemeDatas));
    }
    ...
    public DrmInitData(Parcel parcel) {
        ...
        SchemeData[] schemeDataArr = (SchemeData[]) qwk.m87182l((SchemeData[]) parcel.createTypedArray(SchemeData.CREATOR));
        this.schemeDatas = schemeDataArr;
        this.schemeDataCount = schemeDataArr.length;
    }
}
