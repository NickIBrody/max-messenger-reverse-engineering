...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat fromRating(Object obj) {
        ...
        if (obj != null) {
            ...
            ((RatingCompat) lte.m50433p(ratingCompat)).ratingObj = obj;
        }
        return ratingCompat;
    }
    ...
    public static RatingCompat newPercentageRating(float f) {
        ...
        kp9.m47780d(TAG, "Invalid percentage-based rating value");
        return null;
    }
    ...
    public static RatingCompat newStarRating(int i, float f) {
        ...
        if (i == 3) {
            ...
            if (i != 5) {
                kp9.m47780d(TAG, "Invalid rating style (" + i + ") for a star rating");
                return null;
            }
            f2 = 5.0f;
        }
        ...
        kp9.m47780d(TAG, "Trying to set out of range star-based rating");
        return null;
    }
