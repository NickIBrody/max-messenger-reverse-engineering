...
public class NestedScrollView extends FrameLayout implements n4c, k4c {
    ...
    private final l4c mChildHelper;
    private View mChildToScrollTo;
    cu5 mDifferentialMotionFlingController;
    final C0883d mDifferentialMotionFlingTarget;
    ...
    private InterfaceC0884e mOnScrollChangeListener;
    private final o4c mParentHelper;
    private final float mPhysicalCoeff;
    private SavedState mSavedState;
    private final int[] mScrollConsumed;
    q2h mScrollFeedbackProvider;
    ...
    private static final C0880a ACCESSIBILITY_DELEGATE = new C0880a();
    ...
    public static class C0880a extends AccessibilityDelegateCompat {
        ...
        public void mo4819f(View view, AccessibilityEvent accessibilityEvent) {
            ...
            AbstractC5090g4.m34619a(accessibilityEvent, nestedScrollView.getScrollX());
            AbstractC5090g4.m34620b(accessibilityEvent, nestedScrollView.getScrollRange());
        }
        ...
        public void mo4820g(View view, C4680f4 c4680f4) {
            ...
            if (nestedScrollView.getScrollY() > 0) {
                ...
                c4680f4.m32092b(C4680f4.a.f29798C);
            }
            if (nestedScrollView.getScrollY() < scrollRange) {
                c4680f4.m32092b(C4680f4.a.f29830q);
                c4680f4.m32092b(C4680f4.a.f29800E);
            }
        }
    ...
    public static class C0881b {
        /* renamed from: a */
        public static boolean m5211a(ViewGroup viewGroup) {
    ...
    public static final class C0882c {
        /* renamed from: a */
        public static void m5212a(View view, float f) {
            try {
    ...
    public class C0883d implements du5 {
        public C0883d() {
        }

        @Override // p000.du5
        /* renamed from: a */
        public boolean mo5213a(float f) {
            if (f == 0.0f) {
                return false;
            }
            mo5215c();
    ...
    public interface InterfaceC0884e {
        /* renamed from: a */
        void mo4478a(NestedScrollView nestedScrollView, int i, int i2, int i3, int i4);
    }
    ...
    private boolean edgeEffectFling(int i) {
        if (m86.m51473b(this.mEdgeGlowTop) != 0.0f) {
        ...
        if (m86.m51473b(this.mEdgeGlowBottom) == 0.0f) {
            return false;
        }
        int i2 = -i;
    ...
    private q2h getScrollFeedbackProvider() {
        if (this.mScrollFeedbackProvider == null) {
            this.mScrollFeedbackProvider = q2h.m84876a(this);
        }
    ...
    private void onNestedScrollInternal(int i, int i2, int[] iArr) {
        ...
        this.mChildHelper.m48849e(0, scrollY2, 0, i - scrollY2, null, i2, iArr);
    }
    ...
    */
    private int releaseVerticalGlow(int i, float f) {
        ...
        if (m86.m51473b(this.mEdgeGlowTop) == 0.0f) {
            if (m86.m51473b(this.mEdgeGlowBottom) != 0.0f) {
                m51475d = m86.m51475d(this.mEdgeGlowBottom, height, 1.0f - width);
                if (m86.m51473b(this.mEdgeGlowBottom) == 0.0f) {
                    this.mEdgeGlowBottom.onRelease();
                }
            }
        ...
        m51475d = -m86.m51475d(this.mEdgeGlowTop, -height, width);
        if (m86.m51473b(this.mEdgeGlowTop) == 0.0f) {
            this.mEdgeGlowTop.onRelease();
        }
        f2 = m51475d;
    ...
    private boolean shouldAbsorb(EdgeEffect edgeEffect, int i) {
        ...
        return getSplineFlingDistance(-i) < m86.m51473b(edgeEffect) * ((float) getHeight());
    }

    private boolean stopGlowAnimations(MotionEvent motionEvent) {
        boolean z;
        if (m86.m51473b(this.mEdgeGlowTop) != 0.0f) {
            m86.m51475d(this.mEdgeGlowTop, 0.0f, motionEvent.getX() / getWidth());
            z = true;
        } else {
            z = false;
        }
        ...
        m86.m51475d(this.mEdgeGlowBottom, 0.0f, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }
    ...
    public void computeScroll() {
        ...
        if (Build.VERSION.SDK_INT >= 35) {
            C0882c.m5212a(this, Math.abs(this.mScroller.getCurrVelocity()));
        }
        if (i2 != 0) {
            int scrollY = getScrollY();
    ...
    public int consumeFlingInVerticalStretch(int i) {
        int height = getHeight();
        if (i > 0 && m86.m51473b(this.mEdgeGlowTop) != 0.0f) {
            int round = Math.round(((-height) / 4.0f) * m86.m51475d(this.mEdgeGlowTop, ((-i) * 4.0f) / height, 0.5f));
            if (round != i) {
                this.mEdgeGlowTop.finish();
            }
            return i - round;
        }
        if (i >= 0 || m86.m51473b(this.mEdgeGlowBottom) == 0.0f) {
            return i;
        }
        float f = height;
        int round2 = Math.round((f / 4.0f) * m86.m51475d(this.mEdgeGlowBottom, (i * 4.0f) / f, 0.5f));
        if (round2 != i) {
    ...
    public boolean dispatchNestedFling(float f, float f2, boolean z) {
        return this.mChildHelper.m48845a(f, f2, z);
    }

    @Override // android.view.View
    public boolean dispatchNestedPreFling(float f, float f2) {
        return this.mChildHelper.m48846b(f, f2);
    }

    public boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        return this.mChildHelper.m48848d(i, i2, iArr, iArr2, i3);
    }

    public void dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        this.mChildHelper.m48849e(i, i2, i3, i4, iArr, i5, iArr2);
    }
    ...
    public boolean hasNestedScrollingParent(int i) {
        return this.mChildHelper.m48856l(i);
    }
    ...
    public boolean isNestedScrollingEnabled() {
        return this.mChildHelper.m48857m();
    }
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            if (ptb.m84333a(motionEvent, 2)) {
                f = motionEvent.getAxisValue(9);
                i = 9;
                i2 = (int) motionEvent.getX();
            } else if (ptb.m84333a(motionEvent, SelfTester_JCP.ENCRYPT_CBC)) {
            ...
            if (f != 0.0f) {
                scrollBy(-((int) (f * getVerticalScrollFactorCompat())), i, motionEvent, i2, 1, ptb.m84333a(motionEvent, 8194));
                if (i == 0) {
                    return true;
                }
                this.mDifferentialMotionFlingController.m25423g(motionEvent, i);
                return true;
            }
        }
        return false;
    ...
    public void onNestedScrollAccepted(View view, View view2, int i, int i2) {
        this.mParentHelper.m57151c(view, view2, i, i2);
    ...
    public void onScrollChanged(int i, int i2, int i3, int i4) {
        ...
        InterfaceC0884e interfaceC0884e = this.mOnScrollChangeListener;
        if (interfaceC0884e != null) {
            interfaceC0884e.mo4478a(this, i, i2, i3, i4);
        }
    }
    ...
    public void onStopNestedScroll(View view, int i) {
        this.mParentHelper.m57153e(view, i);
        stopNestedScroll(i);
    }
    ...
    public void setNestedScrollingEnabled(boolean z) {
        this.mChildHelper.m48858n(z);
    }

    public void setOnScrollChangeListener(InterfaceC0884e interfaceC0884e) {
        this.mOnScrollChangeListener = interfaceC0884e;
    }
    ...
    public final void smoothScrollBy(int i, int i2) {
        smoothScrollBy(i, i2, SimpleContextMenuPopupWindow.MENU_CONSTANT_WIDTH, false);
    }

    public final void smoothScrollTo(int i, int i2) {
        smoothScrollTo(i, i2, SimpleContextMenuPopupWindow.MENU_CONSTANT_WIDTH, false);
    }

    public boolean startNestedScroll(int i, int i2) {
        return this.mChildHelper.m48861q(i, i2);
    }

    public void stopNestedScroll(int i) {
        this.mChildHelper.m48863s(i);
    }

    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, fif.nestedScrollViewStyle);
    }
    ...
    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i5) {
        return this.mChildHelper.m48851g(i, i2, i3, i4, iArr, i5);
    }
    ...
    public int scrollBy(int i, int i2, MotionEvent motionEvent, int i3, int i4, boolean z) {
        ...
        if (motionEvent != null && scrollY2 != 0) {
            getScrollFeedbackProvider().m84878c(motionEvent.getDeviceId(), motionEvent.getSource(), i2, scrollY2);
        }
        int[] iArr = this.mScrollConsumed;
        iArr[1] = 0;
        ...
        if (i11 < 0) {
            if (z3) {
                m86.m51475d(this.mEdgeGlowTop, (-i10) / getHeight(), i3 / getWidth());
                if (motionEvent != null) {
                    getScrollFeedbackProvider().m84877b(motionEvent.getDeviceId(), motionEvent.getSource(), i2, true);
                }
                if (!this.mEdgeGlowBottom.isFinished()) {
                    this.mEdgeGlowBottom.onRelease();
                }
            ...
            m86.m51475d(this.mEdgeGlowBottom, i10 / getHeight(), 1.0f - (i3 / getWidth()));
            if (motionEvent != null) {
                getScrollFeedbackProvider().m84877b(motionEvent.getDeviceId(), motionEvent.getSource(), i2, false);
            }
            if (!this.mEdgeGlowTop.isFinished()) {
                this.mEdgeGlowTop.onRelease();
            }
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mDifferentialMotionFlingTarget = c0883d;
        this.mDifferentialMotionFlingController = new cu5(getContext(), c0883d);
        this.mEdgeGlowTop = m86.m51472a(context, attributeSet);
        this.mEdgeGlowBottom = m86.m51472a(context, attributeSet);
        ...
        this.mChildHelper = new l4c(this);
        setNestedScrollingEnabled(true);
        ViewCompat.m4896n0(this, ACCESSIBILITY_DELEGATE);
    }
    ...
    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return this.mChildHelper.m48850f(i, i2, i3, i4, iArr);
    }
    ...
    public void smoothScrollTo(int i, int i2, boolean z) {
        smoothScrollTo(i, i2, SimpleContextMenuPopupWindow.MENU_CONSTANT_WIDTH, z);
    }
