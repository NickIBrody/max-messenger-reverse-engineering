...
final class FragmentState implements Parcelable {
    ...
    public Fragment instantiate(AbstractC0997b abstractC0997b, ClassLoader classLoader) {
        Fragment mo5773a = abstractC0997b.mo5773a(classLoader, this.mClassName);
        mo5773a.mWho = this.mWho;
        mo5773a.mFromLayout = this.mFromLayout;
        mo5773a.mInDynamicContainer = this.mInDynamicContainer;
        mo5773a.mRestored = true;
        mo5773a.mFragmentId = this.mFragmentId;
        mo5773a.mContainerId = this.mContainerId;
        mo5773a.mTag = this.mTag;
        mo5773a.mRetainInstance = this.mRetainInstance;
        mo5773a.mRemoving = this.mRemoving;
        mo5773a.mDetached = this.mDetached;
        mo5773a.mHidden = this.mHidden;
        mo5773a.mMaxState = AbstractC1033h.b.values()[this.mMaxLifecycleState];
        mo5773a.mTargetWho = this.mTargetWho;
        mo5773a.mTargetRequestCode = this.mTargetRequestCode;
        mo5773a.mUserVisibleHint = this.mUserVisibleHint;
        return mo5773a;
    }
