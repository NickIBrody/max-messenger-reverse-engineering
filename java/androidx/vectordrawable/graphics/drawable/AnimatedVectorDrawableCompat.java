...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
        ...
        public AnimatedVectorDrawableCompatState(Context context, AnimatedVectorDrawableCompatState animatedVectorDrawableCompatState, Drawable.Callback callback, Resources resources) {
            if (animatedVectorDrawableCompatState != null) {
                ...
                if (arrayList != null) {
                    ...
                    this.mTargetNameMap = new C4577ey(size);
    ...
    public static AnimatedVectorDrawableCompat create(Context context, int i) {
        ...
        Drawable m41588e = igg.m41588e(context.getResources(), i, context.getTheme());
        animatedVectorDrawableCompat.mDelegateDrawable = m41588e;
        m41588e.setCallback(animatedVectorDrawableCompat.mCallback);
    ...
    private static void registerPlatformCallback(AnimatedVectorDrawable animatedVectorDrawable, Animatable2Compat.AnimationCallback animationCallback) {
        animatedVectorDrawable.registerAnimationCallback(animationCallback.m13594a());
    }
    ...
    private void setupAnimatorsForTarget(String str, Animator animator) {
        ...
        if (animatedVectorDrawableCompatState.mAnimators == null) {
            ...
            this.mAnimatedVectorState.mTargetNameMap = new C4577ey();
        }
    ...
    private static boolean unregisterPlatformCallback(AnimatedVectorDrawable animatedVectorDrawable, Animatable2Compat.AnimationCallback animationCallback) {
        return animatedVectorDrawable.unregisterAnimationCallback(animationCallback.m13594a());
    }
    ...
    public int getAlpha() {
        Drawable drawable = this.mDelegateDrawable;
        return drawable != null ? a26.m293d(drawable) : this.mAnimatedVectorState.mVectorDrawable.getAlpha();
    }
    ...
    public ColorFilter getColorFilter() {
        Drawable drawable = this.mDelegateDrawable;
        return drawable != null ? a26.m294e(drawable) : this.mAnimatedVectorState.mVectorDrawable.getColorFilter();
    }
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if (ANIMATED_VECTOR.equals(name)) {
                    TypedArray m101579r = uhk.m101579r(resources, theme, attributeSet, AbstractC5654hh.f36762e);
                    int resourceId = m101579r.getResourceId(0, 0);
                    if (resourceId != 0) {
                    ...
                    TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, AbstractC5654hh.f36763f);
                    ...
                    if (resourceId2 != 0) {
                        ...
                        setupAnimatorsForTarget(string, AnimatorInflaterCompat.m13597a(context, resourceId2));
                    }
                    obtainAttributes.recycle();
                } else {
                    continue;
    ...
    public boolean isAutoMirrored() {
        Drawable drawable = this.mDelegateDrawable;
        return drawable != null ? a26.m297h(drawable) : this.mAnimatedVectorState.mVectorDrawable.isAutoMirrored();
    }
        ...
        if (this.mAnimatorListener == null) {
            this.mAnimatorListener = new AnimatorListenerAdapter() { // from class: androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.2
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    int size = arrayList.size();
                    for (int i = 0; i < size; i++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(i)).mo13595b(AnimatedVectorDrawableCompat.this);
                    }
                }
                ...
                public void onAnimationStart(Animator animator) {
                    ...
                    int size = arrayList.size();
                    for (int i = 0; i < size; i++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(i)).mo13596c(AnimatedVectorDrawableCompat.this);
                    }
                }
            };
        }
