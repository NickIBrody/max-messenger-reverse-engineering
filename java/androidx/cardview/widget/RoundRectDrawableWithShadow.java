...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    static InterfaceC0737a sRoundRectHelper;
    ...
    /* renamed from: androidx.cardview.widget.RoundRectDrawableWithShadow$a */
    public interface InterfaceC0737a {
        /* renamed from: a */
        void m4265a(Canvas canvas, RectF rectF, float f, Paint paint);
    }

    public RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(pif.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(pif.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(gjf.cardview_compat_inset_shadow);
    ...
    public void draw(Canvas canvas) {
        ...
        drawShadow(canvas);
        canvas.translate(0.0f, (-this.mRawShadowSize) / 2.0f);
        sRoundRectHelper.m4265a(canvas, this.mCardBounds, this.mCornerRadius, this.mPaint);
    }
