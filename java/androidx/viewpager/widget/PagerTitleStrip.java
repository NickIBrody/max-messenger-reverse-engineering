...
public class PagerTitleStrip extends ViewGroup {
    ...
    private WeakReference<vpd> mWatchingAdapter;
    ...
    public class PageListener extends DataSetObserver implements ViewPager.InterfaceC2021h, ViewPager.InterfaceC2020g {
        ...
        public void onAdapterChanged(ViewPager viewPager, vpd vpdVar, vpd vpdVar2) {
            PagerTitleStrip.this.updateAdapter(vpdVar, vpdVar2);
        }
    ...
    public void onAttachedToWindow() {
        ...
        WeakReference<vpd> weakReference = this.mWatchingAdapter;
        if (weakReference != null) {
            l2k.m48736a(weakReference.get());
        }
    ...
    public void setTextColor(int i) {
        ...
        int i2 = (this.mNonPrimaryAlpha << 24) | (this.mTextColor & FlexItem.MAX_SIZE);
        this.mPrevText.setTextColor(i2);
        this.mNextText.setTextColor(i2);
    }
    ...
    public void updateAdapter(vpd vpdVar, vpd vpdVar2) {
        ViewPager viewPager = this.mPager;
        if (viewPager != null) {
            this.mLastKnownCurrentPage = -1;
            this.mLastKnownPositionOffset = -1.0f;
            updateText(viewPager.getCurrentItem(), vpdVar2);
            requestLayout();
        }
    }

    public void updateText(int i, vpd vpdVar) {
    ...
    public PagerTitleStrip(Context context, AttributeSet attributeSet) {
        ...
        if (resourceId != 0) {
            TextViewCompat.m5231p(this.mPrevText, resourceId);
            TextViewCompat.m5231p(this.mCurrText, resourceId);
            TextViewCompat.m5231p(this.mNextText, resourceId);
        }
