...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.mTabPaint.setColor((this.mTabAlpha << 24) | (this.mIndicatorColor & FlexItem.MAX_SIZE));
        float f = height;
        canvas.drawRect(left, i, right, f, this.mTabPaint);
        if (this.mDrawFullUnderline) {
            this.mTabPaint.setColor((this.mIndicatorColor & FlexItem.MAX_SIZE) | (-16777216));
    ...
    public void setTabIndicatorColorResource(int i) {
        setTabIndicatorColor(np4.m55830c(getContext(), i));
    }
