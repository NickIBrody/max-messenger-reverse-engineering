...
public class MultiSelectListPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (listPreference.m12164I0() == null || listPreference.m12165J0() == null) {
            throw new IllegalStateException("MultiSelectListPreference requires an entries array and an entryValues array.");
        }
        this.mNewValues.clear();
        this.mNewValues.addAll(listPreference.m12166K0());
        this.mPreferenceChanged = false;
        this.mEntries = listPreference.m12164I0();
        this.mEntryValues = listPreference.m12165J0();
    }
    ...
    public void onDialogClosed(boolean z) {
        if (z && this.mPreferenceChanged) {
            MultiSelectListPreference listPreference = getListPreference();
            if (listPreference.m12190b(this.mNewValues)) {
                listPreference.m12167L0(this.mNewValues);
            }
        }
        this.mPreferenceChanged = false;
    }
    ...
    public void onPrepareDialogBuilder(AlertDialog.C0328a c0328a) {
        ...
        c0328a.mo2307f(this.mEntries, zArr, new DialogInterface.OnMultiChoiceClickListener() { // from class: androidx.preference.MultiSelectListPreferenceDialogFragmentCompat.1
