...
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, InterfaceC0382c, View.OnKeyListener {
    private static final int ITEM_LAYOUT = jpf.abc_popup_menu_item_layout;
    ...
    final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.appcompat.view.menu.StandardMenuPopup.1
        ...
        public void onGlobalLayout() {
            if (!StandardMenuPopup.this.isShowing() || StandardMenuPopup.this.mPopup.m2546n()) {
                return;
            }
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i, int i2, boolean z) {
        ...
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(ojf.abc_config_prefDialogWidth));
    ...
    private boolean tryShow() {
        ...
        this.mPopup.m2555w(this);
        this.mPopup.m2556x(this);
        this.mPopup.m2554v(true);
        ...
        this.mPopup.m2548p(view2);
        this.mPopup.m2551s(this.mDropDownGravity);
        if (!this.mHasContentWidth) {
            this.mContentWidth = MenuPopup.measureIndividualMenuWidth(this.mAdapter, null, this.mContext, this.mPopupMaxWidth);
            this.mHasContentWidth = true;
        }
        this.mPopup.m2550r(this.mContentWidth);
        this.mPopup.m2553u(2);
        this.mPopup.m2552t(getEpicenterBounds());
        this.mPopup.show();
        ListView listView = this.mPopup.getListView();
        listView.setOnKeyListener(this);
        if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(jpf.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenuBuilder) {
        if (subMenuBuilder.hasVisibleItems()) {
            ...
            menuPopupHelper.m2455j(this.mPresenterCallback);
            menuPopupHelper.m2452g(MenuPopup.shouldPreserveIconSpacing(subMenuBuilder));
            menuPopupHelper.m2454i(this.mOnDismissListener);
            ...
            if (menuPopupHelper.m2459n(horizontalOffset, verticalOffset)) {
                InterfaceC0382c.a aVar = this.mPresenterCallback;
                if (aVar == null) {
                    return true;
                }
