...
public class MenuBuilder implements SupportMenu {
    ...
    private InterfaceC0374a mCallback;
    ...
    private CopyOnWriteArrayList<WeakReference<InterfaceC0382c>> mPresenters = new CopyOnWriteArrayList<>();
    ...
    private void dispatchPresenterUpdate(boolean z) {
        ...
        Iterator<WeakReference<InterfaceC0382c>> it = this.mPresenters.iterator();
        while (it.hasNext()) {
            WeakReference<InterfaceC0382c> next = it.next();
            InterfaceC0382c interfaceC0382c = next.get();
            if (interfaceC0382c == null) {
                this.mPresenters.remove(next);
            } else {
                interfaceC0382c.updateMenuView(z);
            }
        }
    ...
    private void dispatchRestoreInstanceState(Bundle bundle) {
        ...
        while (it.hasNext()) {
            ...
            if (interfaceC0382c == null) {
                ...
                int id = interfaceC0382c.getId();
                if (id > 0 && (parcelable = (Parcelable) sparseParcelableArray.get(id)) != null) {
                    interfaceC0382c.onRestoreInstanceState(parcelable);
                }
            }
        }
    }
    ...
    private void dispatchSaveInstanceState(Bundle bundle) {
        ...
        while (it.hasNext()) {
            ...
            if (interfaceC0382c == null) {
                ...
                int id = interfaceC0382c.getId();
                if (id > 0 && (onSaveInstanceState = interfaceC0382c.onSaveInstanceState()) != null) {
    ...
    private boolean dispatchSubMenuSelected(SubMenuBuilder subMenuBuilder, InterfaceC0382c interfaceC0382c) {
        if (this.mPresenters.isEmpty()) {
            return false;
        }
        boolean onSubMenuSelected = interfaceC0382c != null ? interfaceC0382c.onSubMenuSelected(subMenuBuilder) : false;
        Iterator<WeakReference<InterfaceC0382c>> it = this.mPresenters.iterator();
        while (it.hasNext()) {
            WeakReference<InterfaceC0382c> next = it.next();
            InterfaceC0382c interfaceC0382c2 = next.get();
            if (interfaceC0382c2 == null) {
                this.mPresenters.remove(next);
            } else if (!onSubMenuSelected) {
                onSubMenuSelected = interfaceC0382c2.onSubMenuSelected(subMenuBuilder);
            }
        }
    ...
    private void setHeaderInternal(int i, CharSequence charSequence, int i2, Drawable drawable, View view) {
        ...
        if (view != null) {
            ...
            if (i2 > 0) {
                this.mHeaderIcon = np4.m55833f(getContext(), i2);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:5:0x0019, code lost:
        ...
        if (p000.rdl.m88298k(android.view.ViewConfiguration.get(r2.mContext), r2.mContext) != false) goto L9;
     */
    /*
    ...
    */
    ...
    public void addMenuPresenter(InterfaceC0382c interfaceC0382c) {
        addMenuPresenter(interfaceC0382c, this.mContext);
    }
    ...
    public void changeMenuMode() {
        InterfaceC0374a interfaceC0374a = this.mCallback;
        if (interfaceC0374a != null) {
            interfaceC0374a.onMenuModeChange(this);
        }
    }
    ...
    public final void close(boolean z) {
        ...
        while (it.hasNext()) {
            ...
            if (interfaceC0382c == null) {
                ...
                interfaceC0382c.onCloseMenu(this, z);
            }
        }
        ...
        if (!this.mPresenters.isEmpty() && this.mExpandedItem == menuItemImpl) {
            ...
            while (it.hasNext()) {
                ...
                if (interfaceC0382c == null) {
                    ...
                    z = interfaceC0382c.collapseItemActionView(this, menuItemImpl);
                    if (z) {
                        break;
                    }
                }
    ...
    public boolean expandItemActionView(MenuItemImpl menuItemImpl) {
        ...
        while (it.hasNext()) {
            ...
            if (interfaceC0382c == null) {
                ...
                z = interfaceC0382c.expandItemActionView(this, menuItemImpl);
                if (z) {
                    break;
                }
            }
        ...
        if (this.mIsActionItemsStale) {
            ...
            while (it.hasNext()) {
                ...
                if (interfaceC0382c == null) {
                    ...
                    z |= interfaceC0382c.flagActionItems();
                }
            }
            if (z) {
    ...
    public void removeMenuPresenter(InterfaceC0382c interfaceC0382c) {
        Iterator<WeakReference<InterfaceC0382c>> it = this.mPresenters.iterator();
        while (it.hasNext()) {
            WeakReference<InterfaceC0382c> next = it.next();
            InterfaceC0382c interfaceC0382c2 = next.get();
            if (interfaceC0382c2 == null || interfaceC0382c2 == interfaceC0382c) {
                this.mPresenters.remove(next);
            }
        }
    }
    ...
    public void setCallback(InterfaceC0374a interfaceC0374a) {
        this.mCallback = interfaceC0374a;
    }
    ...
    public void addMenuPresenter(InterfaceC0382c interfaceC0382c, Context context) {
        this.mPresenters.add(new WeakReference<>(interfaceC0382c));
        interfaceC0382c.initForMenu(context, this);
        this.mIsActionItemsStale = true;
    }
    ...
    public boolean performItemAction(MenuItem menuItem, InterfaceC0382c interfaceC0382c, int i) {
        MenuItemImpl menuItemImpl = (MenuItemImpl) menuItem;
        if (menuItemImpl == null || !menuItemImpl.isEnabled()) {
            return false;
        }
        boolean invoke = menuItemImpl.invoke();
        AbstractC2319b9 supportActionProvider = menuItemImpl.getSupportActionProvider();
        ...
        boolean dispatchSubMenuSelected = dispatchSubMenuSelected(subMenuBuilder, interfaceC0382c) | invoke;
