...
public class MenuItemWrapperICS extends AbstractC0381b implements MenuItem {
    static final String LOG_TAG = "MenuItemWrapper";
    private Method mSetExclusiveCheckableMethod;
    private final SupportMenuItem mWrappedObject;

    public class ActionProviderWrapper extends AbstractC2319b9 implements ActionProvider.VisibilityListener {
        private final ActionProvider mInner;
        private AbstractC2319b9.b mListener;
        ...
        public void onActionProviderVisibilityChanged(boolean z) {
            AbstractC2319b9.b bVar = this.mListener;
            if (bVar != null) {
        ...
        @Override // p000.AbstractC2319b9
        public void setVisibilityListener(AbstractC2319b9.b bVar) {
            this.mListener = bVar;
    ...
    public static class CollapsibleActionViewWrapper extends FrameLayout implements su3 {
    ...
    public ActionProvider getActionProvider() {
        AbstractC2319b9 supportActionProvider = this.mWrappedObject.getSupportActionProvider();
