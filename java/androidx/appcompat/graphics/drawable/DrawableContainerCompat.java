...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        private Drawable prepareDrawable(Drawable drawable) {
            a26.m302m(drawable, this.mLayoutDirection);
        ...
        public final void applyTheme(Resources.Theme theme) {
            if (theme != null) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    Drawable drawable = drawableArr[i2];
                    if (drawable != null && a26.m291b(drawable)) {
                        a26.m290a(drawableArr[i2], theme);
                        this.mChildrenChangingConfigurations |= drawableArr[i2].getChangingConfigurations();
                    }
                }
                updateDensity(C0361b.m2423c(theme));
            }
        }
        ...
        public boolean canApplyTheme() {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                if (drawable == null) {
                    ...
                    if (constantState != null && C0361b.m2421a(constantState)) {
                        return true;
                    }
                } else if (a26.m291b(drawable)) {
                    return true;
                }
            }
            return false;
        ...
        public final boolean setLayoutDirection(int i, int i2) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                if (drawable != null) {
                    boolean m302m = a26.m302m(drawable, i);
                    if (i4 == i2) {
                        z = m302m;
                    }
                }
    ...
    public static class C0361b {
        /* renamed from: a */
        public static boolean m2421a(Drawable.ConstantState constantState) {
            return constantState.canApplyTheme();
        }

        /* renamed from: b */
        public static void m2422b(Drawable drawable, Outline outline) {
            drawable.getOutline(outline);
        }

        /* renamed from: c */
        public static Resources m2423c(Resources.Theme theme) {
    ...
    private void initializeDrawableForDisplay(Drawable drawable) {
        ...
        try {
            ...
            a26.m299j(drawable, this.mDrawableContainerState.mAutoMirrored);
            Rect rect = this.mHotspotBounds;
            if (rect != null) {
                a26.m301l(drawable, rect.left, rect.top, rect.right, rect.bottom);
            }
    ...
    */
    ...
    public void getOutline(Outline outline) {
        Drawable drawable = this.mCurrDrawable;
        if (drawable != null) {
            C0361b.m2422b(drawable, outline);
        }
    }
    ...
    */
        ...
        if (i >= 0) {
            ...
            if (i < drawableContainerState.mNumChildren) {
                ...
                if (this.mEnterAnimationEnd == 0 || this.mExitAnimationEnd != 0) {
                    ...
                    if (runnable != null) {
                        this.mAnimationRunnable = new RunnableC0360a();
                    } else {
    ...
    public void setTintList(ColorStateList colorStateList) {
        ...
        if (drawableContainerState.mTintList != colorStateList) {
            ...
            a26.m304o(this.mCurrDrawable, colorStateList);
        }
    }
    ...
    public void setTintMode(PorterDuff.Mode mode) {
        ...
        if (drawableContainerState.mTintMode != mode) {
            ...
            a26.m305p(this.mCurrDrawable, mode);
        }
    }
