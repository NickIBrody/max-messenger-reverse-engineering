...
public class AppCompatDialog extends ComponentDialog implements InterfaceC4544eu {
    private AbstractC0351b mDelegate;
    private final ma9.InterfaceC7434a mKeyDispatcher;
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        context.getTheme().resolveAttribute(lif.dialogTheme, typedValue, true);
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        return ma9.m51636e(this.mKeyDispatcher, getWindow().getDecorView(), this, keyEvent);
    }
    ...
    public AppCompatDialog(Context context, int i) {
        ...
        this.mKeyDispatcher = new ma9.InterfaceC7434a() { // from class: pu
            @Override // p000.ma9.InterfaceC7434a
            public final boolean superDispatchKeyEvent(KeyEvent keyEvent) {
                return AppCompatDialog.this.superDispatchKeyEvent(keyEvent);
            }
        };
        AbstractC0351b delegate = getDelegate();
