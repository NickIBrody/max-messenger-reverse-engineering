...
class DropDownListView extends ListView {
    ...
    RunnableC0434e mResolveHoverRunnable;
    ...
    public static class C0430a {
        /* renamed from: a */
        public static void m2520a(View view, float f, float f2) {
    ...
    public static class C0431b {
        ...
        /* renamed from: a */
        public static Method f2883a;

        /* renamed from: b */
        public static Method f2884b;

        /* renamed from: c */
        public static Method f2885c;
        ...
        static {
            try {
                ...
                f2883a = declaredMethod;
                declaredMethod.setAccessible(true);
                Method declaredMethod2 = AdapterView.class.getDeclaredMethod("setSelectedPositionInt", cls);
                f2884b = declaredMethod2;
                declaredMethod2.setAccessible(true);
                Method declaredMethod3 = AdapterView.class.getDeclaredMethod("setNextSelectedPositionInt", cls);
                f2885c = declaredMethod3;
        ...
        /* renamed from: a */
        public static boolean m2521a() {
            return f2886d;
        }

        /* renamed from: b */
        public static void m2522b(DropDownListView dropDownListView, int i, View view) {
            try {
                f2883a.invoke(dropDownListView, Integer.valueOf(i), view, Boolean.FALSE, -1, -1);
                f2884b.invoke(dropDownListView, Integer.valueOf(i));
                f2885c.invoke(dropDownListView, Integer.valueOf(i));
    ...
    public static class C0432c {
        /* renamed from: a */
        public static boolean m2523a(AbsListView absListView) {
            return absListView.isSelectedChildViewEnabled();
        }

        /* renamed from: b */
        public static void m2524b(AbsListView absListView, boolean z) {
    ...
    public static class C0433d {
        ...
        /* renamed from: a */
        public static final Field f2887a;
        ...
        /* renamed from: a */
        public static boolean m2525a(AbsListView absListView) {
            Field field = f2887a;
            if (field == null) {
                return false;
            }
        ...
        /* renamed from: b */
        public static void m2526b(AbsListView absListView, boolean z) {
            Field field = f2887a;
            if (field != null) {
                try {
    ...
    public DropDownListView(Context context, boolean z) {
        super(context, null, lif.dropDownListViewStyle);
    ...
    private void positionSelectorLikeFocusCompat(int i, View view) {
        ...
        if (z) {
            ...
            a26.m300k(selector, exactCenterX, exactCenterY);
        }
    }
    ...
    private void positionSelectorLikeTouchCompat(int i, View view, float f, float f2) {
        ...
        a26.m300k(selector, f, f2);
    }

    private void setPressedItem(View view, int i, float f, float f2) {
        View childAt;
        this.mDrawsInPressedState = true;
        C0430a.m2520a(this, f, f2);
        if (!isPressed()) {
            setPressed(true);
        }
        layoutChildren();
        ...
        C0430a.m2520a(view, f - view.getLeft(), f2 - view.getTop());
        if (!view.isPressed()) {
    ...
    private boolean superIsSelectedChildViewEnabled() {
        return Build.VERSION.SDK_INT >= 33 ? C0432c.m2523a(this) : C0433d.m2525a(this);
    }

    private void superSetSelectedChildViewEnabled(boolean z) {
        if (Build.VERSION.SDK_INT >= 33) {
            C0432c.m2524b(this, z);
        } else {
            C0433d.m2526b(this, z);
        }
    }
    ...
    */
    ...
    public boolean onHoverEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 10 && this.mResolveHoverRunnable == null) {
            RunnableC0434e runnableC0434e = new RunnableC0434e();
            this.mResolveHoverRunnable = runnableC0434e;
            runnableC0434e.m2528b();
        }
        ...
        if (pointToPosition != -1 && pointToPosition != getSelectedItemPosition()) {
            ...
            if (childAt.isEnabled()) {
                requestFocus();
                if (i < 30 || !C0431b.m2521a()) {
                    setSelectionFromTop(pointToPosition, childAt.getTop() - getTop());
                } else {
                    C0431b.m2522b(this, pointToPosition, childAt);
                }
            }
            updateSelectorStateCompat();
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        RunnableC0434e runnableC0434e = this.mResolveHoverRunnable;
        if (runnableC0434e != null) {
            runnableC0434e.m2527a();
        }
