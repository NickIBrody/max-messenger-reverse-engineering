...
public class ActionBarContainer extends FrameLayout {
    ...
    public static class C0387a {
        /* renamed from: a */
        public static void m2473a(ActionBarContainer actionBarContainer) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(ilf.action_bar);
        this.mContextView = findViewById(ilf.action_context_bar);
    }
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, zuf.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(zuf.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(zuf.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(zuf.ActionBar_height, -1);
        boolean z = true;
        if (getId() == ilf.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(zuf.ActionBar_backgroundSplit);
        }
