...
public class ActivityChooserView extends ViewGroup {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                ...
                View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(jpf.abc_activity_chooser_view_list_item, viewGroup, false);
                inflate.setId(1);
                ((TextView) inflate.findViewById(ilf.title)).setText(ActivityChooserView.this.getContext().getString(rtf.abc_activity_chooser_view_see_all));
                return inflate;
            }
            if (view == null || view.getId() != ilf.list_item) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(jpf.abc_activity_chooser_view_list_item, viewGroup, false);
            }
            PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
            ImageView imageView = (ImageView) view.findViewById(ilf.icon);
            ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
            imageView.setImageDrawable(resolveInfo.loadIcon(packageManager));
            ((TextView) view.findViewById(ilf.title)).setText(resolveInfo.loadLabel(packageManager));
    ...
    public class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onDismiss() {
            ...
            AbstractC2319b9 abstractC2319b9 = ActivityChooserView.this.mProvider;
            if (abstractC2319b9 != null) {
                abstractC2319b9.subUiVisibilityChanged(false);
            }
        }
    ...
    public static class InnerLayout extends LinearLayout {
        ...
        public InnerLayout(Context context, AttributeSet attributeSet) {
            ...
            h1k m37206u = h1k.m37206u(context, attributeSet, TINT_ATTRS);
            setBackgroundDrawable(m37206u.m37214g(0));
            m37206u.m37228x();
        }
    }
    ...
    public ListPopupWindow getListPopupWindow() {
        if (this.mListPopupWindow == null) {
            ...
            this.mListPopupWindow.m2548p(this);
            this.mListPopupWindow.m2554v(true);
            this.mListPopupWindow.m2556x(this.mCallbacks);
            this.mListPopupWindow.m2555w(this.mCallbacks);
        }
    ...
    public void setProvider(AbstractC2319b9 abstractC2319b9) {
        this.mProvider = abstractC2319b9;
    }
    ...
    public void showPopupUnchecked(int i) {
        ...
        listPopupWindow.m2550r(Math.min(this.mAdapter.measureContentWidth(), this.mListPopupMaxWidth));
        listPopupWindow.show();
        AbstractC2319b9 abstractC2319b9 = this.mProvider;
        if (abstractC2319b9 != null) {
            abstractC2319b9.subUiVisibilityChanged(true);
        }
        listPopupWindow.getListView().setContentDescription(getContext().getString(rtf.abc_activitychooserview_choose_application));
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, zuf.ActivityChooserView, i, 0);
        ViewCompat.m4892l0(this, context, zuf.ActivityChooserView, attributeSet, obtainStyledAttributes, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(zuf.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(zuf.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(jpf.abc_activity_chooser_view, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View findViewById = findViewById(ilf.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(ilf.default_activity_button);
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(ilf.image);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(ilf.expand_activities_button);
        ...
        frameLayout2.setAccessibilityDelegate(new View.AccessibilityDelegate() { // from class: androidx.appcompat.widget.ActivityChooserView.3
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                C4680f4.m32045Q0(accessibilityNodeInfo).m32103g0(true);
            }
        });
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(ilf.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(ojf.abc_config_prefDialogWidth));
    }
}
