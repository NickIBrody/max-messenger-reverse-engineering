...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    /* renamed from: androidx.appcompat.widget.SuggestionsAdapter$a */
    public static final class C0466a {
        ...
        public C0466a(View view) {
            this.f2940a = (TextView) view.findViewById(R.id.text1);
            this.f2941b = (TextView) view.findViewById(R.id.text2);
            this.f2942c = (ImageView) view.findViewById(R.id.icon1);
            this.f2943d = (ImageView) view.findViewById(R.id.icon2);
            this.f2944e = (ImageView) view.findViewById(ilf.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(lif.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getDrawable(Uri uri) {
        try {
            ...
            Log.w(LOG_TAG, "Icon not found: " + uri + Extension.FIX_SPACE + e3.getMessage());
            return null;
        }
        Log.w(LOG_TAG, "Icon not found: " + uri + Extension.FIX_SPACE + e3.getMessage());
        return null;
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + CSPStore.SLASH + parseInt;
            Drawable checkIconCache = checkIconCache(str2);
            if (checkIconCache != null) {
                return checkIconCache;
            }
            Drawable m55833f = np4.m55833f(this.mProviderContext, parseInt);
            storeInIconCache(str2, m55833f);
            return m55833f;
        } catch (Resources.NotFoundException unused) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        C0466a c0466a = (C0466a) view.getTag();
        int i = this.mFlagsCol;
        int i2 = i != -1 ? cursor.getInt(i) : 0;
        if (c0466a.f2940a != null) {
            setViewText(c0466a.f2940a, getStringOrNull(cursor, this.mText1Col));
        }
        if (c0466a.f2941b != null) {
            ...
            if (TextUtils.isEmpty(formatUrl)) {
                TextView textView = c0466a.f2940a;
                if (textView != null) {
                    textView.setSingleLine(false);
                    c0466a.f2940a.setMaxLines(2);
                }
            } else {
                TextView textView2 = c0466a.f2940a;
                if (textView2 != null) {
                    textView2.setSingleLine(true);
                    c0466a.f2940a.setMaxLines(1);
                }
            }
            setViewText(c0466a.f2941b, formatUrl);
        }
        ImageView imageView = c0466a.f2942c;
        if (imageView != null) {
            setViewDrawable(imageView, getIcon1(cursor), 4);
        }
        ImageView imageView2 = c0466a.f2943d;
        if (imageView2 != null) {
            setViewDrawable(imageView2, getIcon2(cursor), 8);
        }
        int i3 = this.mQueryRefinement;
        if (i3 != 2 && (i3 != 1 || (i2 & 1) == 0)) {
            c0466a.f2944e.setVisibility(8);
            return;
        }
        c0466a.f2944e.setVisibility(0);
        c0466a.f2944e.setTag(c0466a.f2940a.getText());
        c0466a.f2944e.setOnClickListener(this);
    }
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (newDropDownView != null) {
                ((C0466a) newDropDownView.getTag()).f2940a.setText(e.toString());
            }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (newView != null) {
                ((C0466a) newView.getTag()).f2940a.setText(e.toString());
            }
            return newView;
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        newView.setTag(new C0466a(newView));
        ((ImageView) newView.findViewById(ilf.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
