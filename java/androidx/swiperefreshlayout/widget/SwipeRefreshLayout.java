...
public class SwipeRefreshLayout extends ViewGroup implements k4c {
    ...
    private InterfaceC1966a mChildScrollUpCallback;
    ...
    InterfaceC1967b mListener;
    private int mMediumAnimationDuration;
    private boolean mNestedScrollInProgress;
    private final l4c mNestedScrollingChildHelper;
    ...
    public boolean canChildScrollUp() {
        ...
        return view instanceof ListView ? tj9.m98851a((ListView) view, -1) : view.canScrollVertically(-1);
    }

    @Override // android.view.View
    public boolean dispatchNestedFling(float f, float f2, boolean z) {
        return this.mNestedScrollingChildHelper.m48845a(f, f2, z);
    }

    @Override // android.view.View
    public boolean dispatchNestedPreFling(float f, float f2) {
        return this.mNestedScrollingChildHelper.m48846b(f, f2);
    }

    @Override // android.view.View
    public boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2) {
        return this.mNestedScrollingChildHelper.m48847c(i, i2, iArr, iArr2);
    }

    @Override // android.view.View
    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return this.mNestedScrollingChildHelper.m48850f(i, i2, i3, i4, iArr);
    }
    ...
    public boolean hasNestedScrollingParent() {
        return this.mNestedScrollingChildHelper.m48855k();
    }

    @Override // android.view.View
    public boolean isNestedScrollingEnabled() {
        return this.mNestedScrollingChildHelper.m48857m();
    }
    ...
    public void onNestedScrollAccepted(View view, View view2, int i) {
        this.mNestedScrollingParentHelper.m57150b(view, view2, i);
    ...
    public void onStopNestedScroll(View view) {
        this.mNestedScrollingParentHelper.m57152d(view);
    ...
    public void requestDisallowInterceptTouchEvent(boolean z) {
        View view = this.mTarget;
        if (view == null || ViewCompat.m4862T(view)) {
    ...
    public void setColorSchemeResources(int... iArr) {
        ...
        for (int i = 0; i < iArr.length; i++) {
            iArr2[i] = np4.m55830c(context, iArr[i]);
        }
    ...
    public void setNestedScrollingEnabled(boolean z) {
        this.mNestedScrollingChildHelper.m48858n(z);
    }

    public void setOnChildScrollUpCallback(InterfaceC1966a interfaceC1966a) {
    }

    public void setOnRefreshListener(InterfaceC1967b interfaceC1967b) {
    }
    ...
    public void setProgressBackgroundColorSchemeResource(int i) {
        setProgressBackgroundColorSchemeColor(np4.m55830c(getContext(), i));
    }
    ...
    public void setTargetOffsetTopAndBottom(int i) {
        ...
        ViewCompat.m4867Y(this.mCircleView, i);
        this.mCurrentTargetOffsetTop = this.mCircleView.getTop();
    }

    @Override // android.view.View
    public boolean startNestedScroll(int i) {
        return this.mNestedScrollingChildHelper.m48860p(i);
    }
    ...
    public void stopNestedScroll() {
        this.mNestedScrollingChildHelper.m48862r();
    }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mNestedScrollingChildHelper = new l4c(this);
