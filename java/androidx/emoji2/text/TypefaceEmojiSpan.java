...
public final class TypefaceEmojiSpan extends EmojiSpan {
    ...
    public TypefaceEmojiSpan(dik dikVar) {
        super(dikVar);
    }
    ...
    private static Paint getDebugPaint() {
        if (sDebugPaint == null) {
            ...
            textPaint.setColor(C0917c.m5345c().m5350d());
    ...
    public void draw(Canvas canvas, @SuppressLint({"UnknownNullness"}) CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        if (C0917c.m5345c().m5352j()) {
            canvas.drawRect(f, i3, f + getWidth(), i5, getDebugPaint());
        }
        dik typefaceRasterizer = getTypefaceRasterizer();
        float f2 = i4;
        if (paint2 == null) {
            paint2 = paint;
        }
        typefaceRasterizer.m27515a(canvas, f, f2, paint2);
    }
