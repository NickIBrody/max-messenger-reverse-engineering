...
public class Layer extends ConstraintHelper {
    ...
    public void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == tuf.ConstraintLayout_Layout_android_visibility) {
                    this.mApplyVisibilityOnAttach = true;
                } else if (index == tuf.ConstraintLayout_Layout_android_elevation) {
    ...
    public void updatePostLayout(ConstraintLayout constraintLayout) {
        ...
        this.mComputedCenterX = Float.NaN;
        this.mComputedCenterY = Float.NaN;
        bd4 constraintWidget = ((ConstraintLayout.LayoutParams) getLayoutParams()).getConstraintWidget();
        constraintWidget.m16156o1(0);
        constraintWidget.m16094P0(0);
        calcCenters();
