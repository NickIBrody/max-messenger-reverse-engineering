...
public class MotionLabel extends View implements sb7 {
    ...
    private void setUpTheme(Context context, AttributeSet attributeSet) {
        ...
        context.getTheme().resolveAttribute(lif.colorPrimary, typedValue, true);
        TextPaint textPaint = this.mPaint;
    ...
    public void setTextSize(float f) {
        this.mTextSize = f;
        Log.v(TAG, f75.m32398a() + cl_5.f93406d + f + " / " + this.mBaseTextSize);
        TextPaint textPaint = this.mPaint;
