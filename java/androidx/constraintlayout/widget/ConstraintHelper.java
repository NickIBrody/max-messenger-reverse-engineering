...
public abstract class ConstraintHelper extends View {
    ...
    private int findId(String str) {
        ...
        if (i == 0) {
            try {
                i = pmf.class.getField(str).getInt(null);
    ...
    public void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == tuf.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = obtainStyledAttributes.getString(index);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (index == tuf.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    public void loadParameters(C0773b.a aVar, m78 m78Var, ConstraintLayout.LayoutParams layoutParams, SparseArray<bd4> sparseArray) {
        ...
        if (iArr != null) {
            ...
            if (str != null) {
                if (str.length() > 0) {
                    C0773b.b bVar2 = aVar.f4334e;
                    bVar2.f4398k0 = convertReferenceString(this, bVar2.f4400l0);
                } else {
                    aVar.f4334e.f4398k0 = null;
                }
            }
        }
        if (m78Var == null) {
        ...
        m78Var.mo46376c();
        if (aVar.f4334e.f4398k0 == null) {
            return;
        }
        int i = 0;
        while (true) {
            int[] iArr2 = aVar.f4334e.f4398k0;
            if (i >= iArr2.length) {
                return;
            }
            bd4 bd4Var = sparseArray.get(iArr2[i]);
            if (bd4Var != null) {
                m78Var.mo46375b(bd4Var);
            }
            i++;
        }
    }
    ...
    public void updatePreLayout(ConstraintLayout constraintLayout) {
        ...
        for (int i = 0; i < this.mCount; i++) {
            ...
            if (viewById != null) {
                this.mHelperWidget.mo46375b(constraintLayout.getViewWidget(viewById));
            }
        }
        this.mHelperWidget.mo35544a(constraintLayout.mLayoutWidget);
    }
    ...
    public void validateParams() {
        ...
        if (layoutParams instanceof ConstraintLayout.LayoutParams) {
            ((ConstraintLayout.LayoutParams) layoutParams).widget = (bd4) this.mHelperWidget;
        }
    }
    ...
    public void updatePreLayout(cd4 cd4Var, k78 k78Var, SparseArray<bd4> sparseArray) {
        k78Var.mo46376c();
        for (int i = 0; i < this.mCount; i++) {
            k78Var.mo46375b(sparseArray.get(this.mIds[i]));
        }
    }
}
