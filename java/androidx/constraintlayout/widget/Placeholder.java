...
public class Placeholder extends View {
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, tuf.ConstraintLayout_placeholder);
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == tuf.ConstraintLayout_placeholder_content) {
                    this.mContentId = obtainStyledAttributes.getResourceId(index, this.mContentId);
                } else if (index == tuf.ConstraintLayout_placeholder_placeholder_emptyVisibility) {
    ...
    public void updatePostMeasure(ConstraintLayout constraintLayout) {
        ...
        layoutParams2.widget.m16153n1(0);
        bd4.EnumC2370b m16067C = layoutParams.widget.m16067C();
        bd4.EnumC2370b enumC2370b = bd4.EnumC2370b.FIXED;
        if (m16067C != enumC2370b) {
            layoutParams.widget.m16156o1(layoutParams2.widget.m16111Y());
        }
        if (layoutParams.widget.m16105V() != enumC2370b) {
            layoutParams.widget.m16094P0(layoutParams2.widget.m16183z());
        }
        layoutParams2.widget.m16153n1(8);
    }
