...
.method public static a(Landroid/graphics/Rect;ZLandroid/util/Rational;IIILjava/util/Map;)Ljava/util/Map;
    ...
    invoke-virtual {v6}, Landroidx/camera/core/impl/z;->f()Landroid/util/Size;
    ...
    invoke-static/range {p0 .. p5}, Lhfl;->g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    check-cast p5, Landroidx/camera/core/g;
...
.method public static b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, Lhfl;->d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p0, p1}, Lhfl;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, Lhfl;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
...
.method public static c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {v1, p1}, Lhfl;->e(FF)F
    ...
    invoke-static {v3, p1}, Lhfl;->e(FF)F
...
.method public static d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {v2, p1}, Lhfl;->f(FF)F
    ...
    invoke-static {p0, p1}, Lhfl;->f(FF)F
...
.method public static g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p4}, Lhfl;->h(ZI)Z

    move-result p2

    invoke-static {p2, p5, p0, p1}, Lhfl;->b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
