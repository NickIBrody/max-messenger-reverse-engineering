...
.method public static final a(Landroid/hardware/camera2/CameraDevice;)V
    ...
    invoke-virtual {v3}, Le75;->g()Lgij;

    move-result-object v6

    invoke-virtual {v6}, Lgij;->a()J
    ...
    :try_start_2
    sget-object v13, Lnp9;->a:Lnp9;

    invoke-virtual {v13}, Lnp9;->d()Z

    move-result v13

    if-eqz v13, :cond_1

    const-string v13, "NPE encountered during CameraDevice.close()"

    invoke-static {v4, v13, p0}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
