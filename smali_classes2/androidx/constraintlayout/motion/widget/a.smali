...
.method public constructor <init>(Landroidx/constraintlayout/motion/widget/MotionLayout;)V
    ...
    iput-object v0, p0, Landroidx/constraintlayout/motion/widget/a;->b:Ljava/util/ArrayList;
...
.method public a(Landroidx/constraintlayout/motion/widget/ViewTransition;)V
    ...
    iget-object v0, p0, Landroidx/constraintlayout/motion/widget/a;->b:Ljava/util/ArrayList;

    invoke-virtual {v0, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    const/4 v0, 0x0

    iput-object v0, p0, Landroidx/constraintlayout/motion/widget/a;->c:Ljava/util/HashSet;
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/constraintlayout/motion/widget/a;->h(Landroidx/constraintlayout/motion/widget/ViewTransition;Z)V
...
.method public b(Landroidx/constraintlayout/motion/widget/ViewTransition$a;)V
    .locals 1
    ...
    iput-object v0, p0, Landroidx/constraintlayout/motion/widget/a;->e:Ljava/util/ArrayList;
...
.method public c()V
    ...
    check-cast v1, Landroidx/constraintlayout/motion/widget/ViewTransition$a;

    invoke-virtual {v1}, Landroidx/constraintlayout/motion/widget/ViewTransition$a;->a()V
...
.method public d(ILandroidx/constraintlayout/motion/widget/MotionController;)Z
    ...
    iget-object p1, v1, Landroidx/constraintlayout/motion/widget/ViewTransition;->f:Loa9;

    invoke-virtual {p1, p2}, Loa9;->a(Landroidx/constraintlayout/motion/widget/MotionController;)V
...
.method public e(IZ)V
    ...
    invoke-virtual {v1, p2}, Landroidx/constraintlayout/motion/widget/ViewTransition;->m(Z)V
...
.method public g(I)Z
    ...
    invoke-virtual {v1}, Landroidx/constraintlayout/motion/widget/ViewTransition;->j()Z
...
.method public final h(Landroidx/constraintlayout/motion/widget/ViewTransition;Z)V
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/constraintlayout/motion/widget/a$a;-><init>(Landroidx/constraintlayout/motion/widget/a;Landroidx/constraintlayout/motion/widget/ViewTransition;IZI)V

    invoke-virtual {v6, v7, v0}, Landroidx/constraintlayout/widget/c;->a(ILandroidx/constraintlayout/widget/c$a;)V

    return-void
.end method

.method public i(Landroidx/constraintlayout/motion/widget/ViewTransition$a;)V
    .locals 1
...
.method public j(Landroid/view/MotionEvent;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/constraintlayout/motion/widget/a;->c:Ljava/util/HashSet;
    ...
    invoke-virtual {v1, v5}, Landroidx/constraintlayout/motion/widget/ViewTransition;->k(Landroid/view/View;)Z
    ...
    iget-object v6, p0, Landroidx/constraintlayout/motion/widget/a;->c:Ljava/util/HashSet;
    ...
    check-cast v2, Landroidx/constraintlayout/motion/widget/ViewTransition$a;

    invoke-virtual {v2, p1, v0, v7}, Landroidx/constraintlayout/motion/widget/ViewTransition$a;->d(IFF)V
    ...
    invoke-virtual {v1, v4}, Landroidx/constraintlayout/motion/widget/MotionLayout;->getConstraintSet(I)Landroidx/constraintlayout/widget/b;

    move-result-object v5

    iget-object v1, p0, Landroidx/constraintlayout/motion/widget/a;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, p1}, Landroidx/constraintlayout/motion/widget/ViewTransition;->n(I)Z

    move-result v2

    if-eqz v2, :cond_6

    iget-object v2, p0, Landroidx/constraintlayout/motion/widget/a;->c:Ljava/util/HashSet;
    ...
    invoke-virtual {v1, v2}, Landroidx/constraintlayout/motion/widget/ViewTransition;->k(Landroid/view/View;)Z
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/constraintlayout/motion/widget/ViewTransition;->c(Landroidx/constraintlayout/motion/widget/a;Landroidx/constraintlayout/motion/widget/MotionLayout;ILandroidx/constraintlayout/widget/b;[Landroid/view/View;)V
...
.method public varargs k(I[Landroid/view/View;)V
    ...
    invoke-virtual {p0, v3, v2}, Landroidx/constraintlayout/motion/widget/a;->l(Landroidx/constraintlayout/motion/widget/ViewTransition;[Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/constraintlayout/motion/widget/a;->d:Ljava/lang/String;
