...
.field private final mResultFuture:Legg;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Legg;"
        }
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/graphics/Bitmap;Landroid/net/Uri;Legg;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p5, p0, Landroidx/browser/browseractions/BrowserServiceFileProvider$FileSaveTask;->mResultFuture:Legg;
...
.method private saveFileBlocking(Ljava/io/File;)V
    ...
    invoke-direct {v0, p1}, Ln50;-><init>(Ljava/io/File;)V

    :try_start_0
    invoke-virtual {v0}, Ln50;->d()Ljava/io/FileOutputStream;
    ...
    invoke-virtual {v0, p1}, Ln50;->b(Ljava/io/FileOutputStream;)V

    iget-object v1, p0, Landroidx/browser/browseractions/BrowserServiceFileProvider$FileSaveTask;->mResultFuture:Legg;

    iget-object v2, p0, Landroidx/browser/browseractions/BrowserServiceFileProvider$FileSaveTask;->mFileUri:Landroid/net/Uri;

    invoke-virtual {v1, v2}, Legg;->o(Ljava/lang/Object;)Z
    :try_end_1
    ...
    :goto_0
    invoke-virtual {v0, p1}, Ln50;->a(Ljava/io/FileOutputStream;)V

    iget-object p1, p0, Landroidx/browser/browseractions/BrowserServiceFileProvider$FileSaveTask;->mResultFuture:Legg;

    invoke-virtual {p1, v1}, Legg;->p(Ljava/lang/Throwable;)Z
...
.method private saveFileIfNeededBlocking()V
    ...
    iget-object v0, p0, Landroidx/browser/browseractions/BrowserServiceFileProvider$FileSaveTask;->mResultFuture:Legg;
    ...
    invoke-virtual {v0, v2}, Legg;->p(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {v0, v3}, Legg;->o(Ljava/lang/Object;)Z
