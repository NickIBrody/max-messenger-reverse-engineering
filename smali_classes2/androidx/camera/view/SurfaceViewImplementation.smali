...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroidx/camera/view/SurfaceViewImplementation$a;
    }
.end annotation
...
.method public static synthetic k(Landroidx/camera/view/SurfaceViewImplementation;Lqdj;Landroidx/camera/view/d$a;)V
    .locals 0

    iget-object p0, p0, Landroidx/camera/view/SurfaceViewImplementation;->f:Landroidx/camera/view/SurfaceViewImplementation$SurfaceRequestCallback;

    invoke-virtual {p0, p1, p2}, Landroidx/camera/view/SurfaceViewImplementation$SurfaceRequestCallback;->setSurfaceRequest(Lqdj;Landroidx/camera/view/d$a;)V
...
.method public static n(Landroid/view/SurfaceView;Landroid/util/Size;Lqdj;)Z
    .locals 0
...
.method public c()Landroid/graphics/Bitmap;
    ...
    invoke-direct {v6, v1}, Lgej;-><init>(Ljava/util/concurrent/Semaphore;)V

    invoke-static {v5, v2, v6, v4}, Landroidx/camera/view/SurfaceViewImplementation$a;->a(Landroid/view/SurfaceView;Landroid/graphics/Bitmap;Landroid/view/PixelCopy$OnPixelCopyFinishedListener;Landroid/os/Handler;)V
    ...
    invoke-static {v0, v4, v1}, Ler9;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
...
.method public g(Lqdj;Landroidx/camera/view/d$a;)V
    ...
    iget-object v1, p0, Landroidx/camera/view/d;->a:Landroid/util/Size;

    invoke-static {v0, v1, p1}, Landroidx/camera/view/SurfaceViewImplementation;->n(Landroid/view/SurfaceView;Landroid/util/Size;Lqdj;)Z
    ...
    invoke-direct {v1, p2}, Leej;-><init>(Landroidx/camera/view/d$a;)V

    invoke-virtual {p1, v0, v1}, Lqdj;->k(Ljava/util/concurrent/Executor;Ljava/lang/Runnable;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lfej;-><init>(Landroidx/camera/view/SurfaceViewImplementation;Lqdj;Landroidx/camera/view/d$a;)V
