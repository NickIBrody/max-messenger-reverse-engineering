...
.method public constructor <init>(Ls6k;[IILvl0;JJJIIFFLjava/util/List;Lys3;)V
    ...
    :goto_0
    iput-object p4, p0, Landroidx/media3/exoplayer/trackselection/a;->i:Lvl0;

    const-wide/16 p3, 0x3e8

    mul-long/2addr p5, p3

    iput-wide p5, p0, Landroidx/media3/exoplayer/trackselection/a;->j:J

    mul-long/2addr p7, p3

    iput-wide p7, p0, Landroidx/media3/exoplayer/trackselection/a;->k:J

    mul-long/2addr p1, p3

    iput-wide p1, p0, Landroidx/media3/exoplayer/trackselection/a;->l:J

    iput p11, p0, Landroidx/media3/exoplayer/trackselection/a;->m:I

    iput p12, p0, Landroidx/media3/exoplayer/trackselection/a;->n:I

    iput p13, p0, Landroidx/media3/exoplayer/trackselection/a;->o:F

    iput p14, p0, Landroidx/media3/exoplayer/trackselection/a;->p:F

    invoke-static {p15}, Lcom/google/common/collect/g;->q(Ljava/util/Collection;)Lcom/google/common/collect/g;

    move-result-object p1

    iput-object p1, p0, Landroidx/media3/exoplayer/trackselection/a;->q:Lcom/google/common/collect/g;

    move-object/from16 p1, p16

    iput-object p1, p0, Landroidx/media3/exoplayer/trackselection/a;->r:Lys3;
    ...
    iput-wide p1, p0, Landroidx/media3/exoplayer/trackselection/a;->v:J

    const-wide/32 p1, -0x7fffffff

    iput-wide p1, p0, Landroidx/media3/exoplayer/trackselection/a;->x:J

    return-void
.end method

.method private D([Le8a;Ljava/util/List;)J
    .locals 4
    ...
    iget p2, p0, Landroidx/media3/exoplayer/trackselection/a;->t:I
    ...
    :cond_2
    invoke-virtual {p0, p2}, Landroidx/media3/exoplayer/trackselection/a;->B(Ljava/util/List;)J
...
.method public static E([Landroidx/media3/exoplayer/trackselection/b$a;)[[J
    .locals 10
...
.method public static F([[J)Lcom/google/common/collect/g;
    .locals 14
...
.method public static synthetic v([Landroidx/media3/exoplayer/trackselection/b$a;)Lcom/google/common/collect/g;
    .locals 0

    invoke-static {p0}, Landroidx/media3/exoplayer/trackselection/a;->z([Landroidx/media3/exoplayer/trackselection/b$a;)Lcom/google/common/collect/g;
...
.method private y(JJ)I
    ...
    invoke-virtual {p0, p3, p4}, Landroidx/media3/exoplayer/trackselection/a;->A(J)J
    ...
    invoke-virtual {p0, v1, v2, p3, p4}, Landroidx/media3/exoplayer/trackselection/a;->x(Landroidx/media3/common/a;IJ)Z
...
.method public static z([Landroidx/media3/exoplayer/trackselection/b$a;)Lcom/google/common/collect/g;
    .locals 12
    ...
    :cond_1
    invoke-static {p0}, Landroidx/media3/exoplayer/trackselection/a;->E([Landroidx/media3/exoplayer/trackselection/b$a;)[[J
    ...
    :cond_3
    invoke-static {v0, v7}, Landroidx/media3/exoplayer/trackselection/a;->w(Ljava/util/List;[J)V

    invoke-static {v2}, Landroidx/media3/exoplayer/trackselection/a;->F([[J)Lcom/google/common/collect/g;
...
.method public final A(J)J
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/media3/exoplayer/trackselection/a;->G(J)J

    move-result-wide p1

    iget-object v0, p0, Landroidx/media3/exoplayer/trackselection/a;->q:Lcom/google/common/collect/g;
    ...
    :goto_0
    iget-object v2, p0, Landroidx/media3/exoplayer/trackselection/a;->q:Lcom/google/common/collect/g;
...
.method public C()J
    ...
    iget-wide v0, p0, Landroidx/media3/exoplayer/trackselection/a;->l:J
...
.method public final G(J)J
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/trackselection/a;->i:Lvl0;

    invoke-interface {v0}, Lvl0;->b()J

    move-result-wide v0

    iput-wide v0, p0, Landroidx/media3/exoplayer/trackselection/a;->x:J

    long-to-float v0, v0

    iget v1, p0, Landroidx/media3/exoplayer/trackselection/a;->o:F

    mul-float/2addr v0, v1

    float-to-long v0, v0

    iget-object v2, p0, Landroidx/media3/exoplayer/trackselection/a;->i:Lvl0;
    ...
    iget p2, p0, Landroidx/media3/exoplayer/trackselection/a;->s:F
...
.method public final H(JJ)J
    ...
    iget p2, p0, Landroidx/media3/exoplayer/trackselection/a;->p:F

    mul-float/2addr p1, p2

    float-to-long p1, p1

    iget-wide p3, p0, Landroidx/media3/exoplayer/trackselection/a;->j:J
...
.method public I(JLjava/util/List;)Z
    ...
    iget-wide v0, p0, Landroidx/media3/exoplayer/trackselection/a;->v:J
    ...
    iget-object p2, p0, Landroidx/media3/exoplayer/trackselection/a;->w:Ld8a;
...
.method public disable()V
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/trackselection/a;->w:Ld8a;
...
.method public n(JJJLjava/util/List;[Le8a;)V
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/trackselection/a;->r:Lys3;

    invoke-interface {p1}, Lys3;->e()J

    move-result-wide p1

    invoke-direct {p0, p8, p7}, Landroidx/media3/exoplayer/trackselection/a;->D([Le8a;Ljava/util/List;)J

    move-result-wide v0

    iget p8, p0, Landroidx/media3/exoplayer/trackselection/a;->u:I

    if-nez p8, :cond_0

    const/4 p3, 0x1

    iput p3, p0, Landroidx/media3/exoplayer/trackselection/a;->u:I

    invoke-direct {p0, p1, p2, v0, v1}, Landroidx/media3/exoplayer/trackselection/a;->y(JJ)I

    move-result p1

    iput p1, p0, Landroidx/media3/exoplayer/trackselection/a;->t:I

    return-void

    :cond_0
    iget v2, p0, Landroidx/media3/exoplayer/trackselection/a;->t:I
    ...
    invoke-virtual {p0, p5, p6, v0, v1}, Landroidx/media3/exoplayer/trackselection/a;->H(JJ)J
    ...
    :goto_2
    iput p8, p0, Landroidx/media3/exoplayer/trackselection/a;->u:I

    iput p7, p0, Landroidx/media3/exoplayer/trackselection/a;->t:I
...
.method public r(JLjava/util/List;)I
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/trackselection/a;->r:Lys3;

    invoke-interface {v0}, Lys3;->e()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1, p3}, Landroidx/media3/exoplayer/trackselection/a;->I(JLjava/util/List;)Z
    ...
    :goto_0
    iput-object v2, p0, Landroidx/media3/exoplayer/trackselection/a;->w:Ld8a;
    ...
    iget v6, p0, Landroidx/media3/exoplayer/trackselection/a;->s:F

    invoke-static {v4, v5, v6}, Lqwk;->p0(JF)J

    move-result-wide v4

    invoke-virtual {p0}, Landroidx/media3/exoplayer/trackselection/a;->C()J
    ...
    :cond_3
    invoke-virtual {p0, p3}, Landroidx/media3/exoplayer/trackselection/a;->B(Ljava/util/List;)J

    move-result-wide v4

    invoke-direct {p0, v0, v1, v4, v5}, Landroidx/media3/exoplayer/trackselection/a;->y(JJ)I
    ...
    iget-wide v8, v1, Lmp3;->g:J

    sub-long/2addr v8, p1

    iget v1, p0, Landroidx/media3/exoplayer/trackselection/a;->s:F

    invoke-static {v8, v9, v1}, Lqwk;->p0(JF)J
    ...
    iget v8, p0, Landroidx/media3/exoplayer/trackselection/a;->n:I
    ...
    iget v5, p0, Landroidx/media3/exoplayer/trackselection/a;->m:I
