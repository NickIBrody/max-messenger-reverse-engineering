.class public Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi26;
...
.method public constructor <init>(Landroidx/media3/session/legacy/MediaBrowserServiceCompat;)V
    ...
    iput-object p1, p0, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi26;->e:Landroidx/media3/session/legacy/MediaBrowserServiceCompat;
...
.method public a()V
    ...
    iget-object v1, p0, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi26;->e:Landroidx/media3/session/legacy/MediaBrowserServiceCompat;
    ...
    iput-object v0, p0, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi23;->b:Landroid/service/media/MediaBrowserService;
...
.method public e()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi26;->e:Landroidx/media3/session/legacy/MediaBrowserServiceCompat;
...
.method public k(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi23;->k(Ljava/lang/String;Landroid/os/Bundle;)V

    return-void
.end method

.method public p(Ljava/lang/String;Landroidx/media3/session/legacy/MediaBrowserServiceCompat$i;Landroid/os/Bundle;)V
    .locals 2

    new-instance v0, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi26$a;

    invoke-direct {v0, p0, p1, p2, p3}, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi26$a;-><init>(Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi26;Ljava/lang/Object;Landroidx/media3/session/legacy/MediaBrowserServiceCompat$i;Landroid/os/Bundle;)V

    iget-object p2, p0, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi26;->e:Landroidx/media3/session/legacy/MediaBrowserServiceCompat;
    ...
    invoke-virtual {p2, p1, v0, p3}, Landroidx/media3/session/legacy/MediaBrowserServiceCompat;->onLoadChildren(Ljava/lang/String;Landroidx/media3/session/legacy/MediaBrowserServiceCompat$h;Landroid/os/Bundle;)V

    iget-object p1, p0, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi26;->e:Landroidx/media3/session/legacy/MediaBrowserServiceCompat;
