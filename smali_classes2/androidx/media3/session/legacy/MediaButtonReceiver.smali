...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/media3/session/legacy/MediaButtonReceiver$a;,
        Landroidx/media3/session/legacy/MediaButtonReceiver$b;
    }
.end annotation
...
# virtual methods
.method public onForegroundServiceStartNotAllowedException(Landroid/app/ForegroundServiceStartNotAllowedException;)V
    .locals 2
    ...
    invoke-static {p1}, Ly7a;->a(Landroid/app/ForegroundServiceStartNotAllowedException;)Ljava/lang/String;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :try_start_0
    invoke-static {p1, p2}, Lnp4;->q(Landroid/content/Context;Landroid/content/Intent;)V
    :try_end_0
    ...
    invoke-static {p1}, Landroidx/media3/session/legacy/MediaButtonReceiver$a;->b(Ljava/lang/IllegalStateException;)Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-static {p1}, Landroidx/media3/session/legacy/MediaButtonReceiver$a;->a(Ljava/lang/IllegalStateException;)Landroid/app/ForegroundServiceStartNotAllowedException;
    ...
    new-instance v2, Landroidx/media3/session/legacy/MediaButtonReceiver$b;

    invoke-direct {v2, p1, p2, v1}, Landroidx/media3/session/legacy/MediaButtonReceiver$b;-><init>(Landroid/content/Context;Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    invoke-virtual {v2, p2}, Landroidx/media3/session/legacy/MediaButtonReceiver$b;->f(Landroidx/media3/session/legacy/MediaBrowserCompat;)V
