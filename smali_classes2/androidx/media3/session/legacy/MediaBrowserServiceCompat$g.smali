...
# instance fields
.field public final synthetic f:Landroidx/media3/session/legacy/MediaBrowserServiceCompat;
...
.method public c()Landroidx/media3/session/legacy/a$b;
    ...
    iget-object v1, p0, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$MediaBrowserServiceImplApi23;->b:Landroid/service/media/MediaBrowserService;
    ...
    invoke-static {v1}, Lx7a;->a(Landroid/service/media/MediaBrowserService;)Landroid/media/session/MediaSessionManager$RemoteUserInfo;

    move-result-object v1

    invoke-direct {v0, v1}, Landroidx/media3/session/legacy/a$b;-><init>(Landroid/media/session/MediaSessionManager$RemoteUserInfo;)V

    return-object v0

    :cond_0
    iget-object v0, v1, Landroidx/media3/session/legacy/MediaBrowserServiceCompat$ConnectionRecord;->browserInfo:Landroidx/media3/session/legacy/a$b;
