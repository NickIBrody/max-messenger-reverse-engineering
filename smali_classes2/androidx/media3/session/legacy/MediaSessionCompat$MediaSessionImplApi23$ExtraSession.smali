...
# direct methods
.method public constructor <init>(Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;)V
    .locals 1
...
.method public getPlaybackState()Landroidx/media3/session/legacy/PlaybackStateCompat;
    ...
    iget-object v1, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->h:Landroidx/media3/session/legacy/PlaybackStateCompat;

    iget-object v0, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->j:Landroidx/media3/session/legacy/MediaMetadataCompat;
...
.method public getRepeatMode()I
    ...
    iget v0, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->l:I
...
.method public getSessionInfo()Landroid/os/Bundle;
    ...
    iget-object v1, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->e:Landroid/os/Bundle;

    if-eqz v1, :cond_0

    new-instance v1, Landroid/os/Bundle;

    iget-object v0, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->e:Landroid/os/Bundle;
...
.method public getShuffleMode()I
    ...
    iget v0, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->m:I
...
.method public isCaptioningEnabled()Z
    ...
    iget-boolean v0, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->k:Z
...
.method public registerCallbackListener(Landroidx/media3/session/legacy/IMediaControllerCallback;)V
    ...
    new-instance v3, Landroidx/media3/session/legacy/a$b;

    const-string v4, "android.media.session.MediaController"

    invoke-direct {v3, v4, v1, v2}, Landroidx/media3/session/legacy/a$b;-><init>(Ljava/lang/String;II)V

    iget-object v4, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->g:Landroid/os/RemoteCallbackList;

    invoke-virtual {v4, p1, v3}, Landroid/os/RemoteCallbackList;->register(Landroid/os/IInterface;Ljava/lang/Object;)Z

    iget-object p1, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->d:Ljava/lang/Object;

    monitor-enter p1

    :try_start_0
    iget-object v0, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->o:Landroidx/media3/session/legacy/MediaSessionCompat$RegistrationCallbackHandler;
...
.method public unregisterCallbackListener(Landroidx/media3/session/legacy/IMediaControllerCallback;)V
    ...
    :cond_0
    iget-object v1, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->g:Landroid/os/RemoteCallbackList;
    ...
    iget-object v2, v0, Landroidx/media3/session/legacy/MediaSessionCompat$MediaSessionImplApi23;->d:Ljava/lang/Object;
