...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {p1}, Landroidx/media3/session/MediaSessionImpl;->D(Landroidx/media3/session/MediaSessionImpl;)Landroidx/media3/session/PlayerInfo;
    ...
    invoke-virtual {v2}, Landroidx/media3/session/MediaSessionImpl;->n0()Lvce;

    move-result-object v2

    invoke-virtual {v2}, Lvce;->a1()Lp0k;
    ...
    invoke-virtual {v3}, Landroidx/media3/session/MediaSessionImpl;->n0()Lvce;

    move-result-object v3

    invoke-virtual {v3}, Lvce;->W0()Ldlh;
    ...
    invoke-static {v4}, Landroidx/media3/session/MediaSessionImpl;->D(Landroidx/media3/session/MediaSessionImpl;)Landroidx/media3/session/PlayerInfo;

    move-result-object v4

    iget v4, v4, Landroidx/media3/session/PlayerInfo;->k:I

    invoke-virtual {v0, v2, v3, v4}, Landroidx/media3/session/PlayerInfo;->x(Lp0k;Ldlh;I)Landroidx/media3/session/PlayerInfo;

    move-result-object v0

    invoke-static {p1, v0}, Landroidx/media3/session/MediaSessionImpl;->E(Landroidx/media3/session/MediaSessionImpl;Landroidx/media3/session/PlayerInfo;)Landroidx/media3/session/PlayerInfo;
    ...
    invoke-static {p1, v0, v2, v3}, Landroidx/media3/session/MediaSessionImpl;->C(Landroidx/media3/session/MediaSessionImpl;Landroidx/media3/session/PlayerInfo;ZZ)V
