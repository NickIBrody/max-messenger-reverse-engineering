...
.field public final synthetic z:Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver;
...
.method public constructor <init>(Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver;Landroid/content/Intent;Landroid/content/Context;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver$a;->w:Landroid/content/Intent;
...
.method public run()V
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver$a;->w:Landroid/content/Intent;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver$a;->w:Landroid/content/Intent;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver$a;->w:Landroid/content/Intent;
    ...
    iget-object v4, p0, Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver$a;->w:Landroid/content/Intent;
    ...
    invoke-static {v4, v5, v0}, Llpd;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
    ...
    invoke-static {v0, v4, v1}, Llpd;->a(Landroid/content/Context;Ljava/lang/Class;Z)V

    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver$a;->x:Landroid/content/Context;

    const-class v1, Landroidx/work/impl/background/systemalarm/ConstraintProxy$StorageNotLowProxy;

    invoke-static {v0, v1, v3}, Llpd;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
