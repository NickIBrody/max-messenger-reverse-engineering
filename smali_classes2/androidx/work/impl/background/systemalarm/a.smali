...
.method public constructor <init>(Landroid/content/Context;Lsli;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/a;->w:Landroid/content/Context;

    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/a;->z:Lsli;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/a;->x:Ljava/util/Map;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/a;->y:Ljava/lang/Object;
...
.method public static b(Landroid/content/Context;Lm0m;)Landroid/content/Intent;
    .locals 2
    ...
    invoke-static {v0, p1}, Landroidx/work/impl/background/systemalarm/a;->p(Landroid/content/Intent;Lm0m;)Landroid/content/Intent;
...
.method public static c(Landroid/content/Context;Lm0m;Z)Landroid/content/Intent;
    .locals 2
...
.method public static d(Landroid/content/Context;Lm0m;)Landroid/content/Intent;
    .locals 2
...
.method public static e(Landroid/content/Context;Lm0m;)Landroid/content/Intent;
    .locals 2
...
.method public static o(Landroid/content/Intent;)Lm0m;
    .locals 4
...
.method public static p(Landroid/content/Intent;Lm0m;)Landroid/content/Intent;
    .locals 2
...
.method public final f(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/a;->w:Landroid/content/Context;
...
.method public final g(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/a;->y:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    invoke-static {p1}, Landroidx/work/impl/background/systemalarm/a;->o(Landroid/content/Intent;)Lm0m;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/a;->x:Ljava/util/Map;
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/a;->w:Landroid/content/Context;

    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/a;->z:Lsli;

    invoke-virtual {v3, p1}, Lsli;->d(Lm0m;)Lrli;

    move-result-object v3

    invoke-direct {v1, v2, p2, p3, v3}, Landroidx/work/impl/background/systemalarm/c;-><init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/d;Lrli;)V

    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/a;->x:Ljava/util/Map;
    ...
    invoke-virtual {p2, v2, p1}, Lwq9;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final h(Landroid/content/Intent;I)V
    ...
    invoke-virtual {v2, v3, p1}, Lwq9;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v0, v1}, Landroidx/work/impl/background/systemalarm/a;->onExecuted(Lm0m;Z)V
...
.method public final j(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-interface {v2, v3}, Ll1m;->g(Ljava/lang/String;)Lk1m;
    ...
    invoke-virtual {p2, v1, p1}, Lwq9;->k(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    iget-object v4, v2, Lk1m;->b:Ln0m$a;

    invoke-virtual {v4}, Ln0m$a;->h()Z
    ...
    invoke-virtual {p2, v1, p3}, Lwq9;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/a;->w:Landroid/content/Context;

    invoke-static {p2, v0, p1, v3, v4}, Lle;->c(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lm0m;J)V
    ...
    invoke-virtual {v2, v1, v5}, Lwq9;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/a;->w:Landroid/content/Context;

    invoke-static {v1, v0, p1, v3, v4}, Lle;->c(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lm0m;J)V

    iget-object p1, p0, Landroidx/work/impl/background/systemalarm/a;->w:Landroid/content/Context;
...
.method public final k(Landroid/content/Intent;Landroidx/work/impl/background/systemalarm/d;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/a;->z:Lsli;

    new-instance v3, Lm0m;

    invoke-direct {v3, v0, p1}, Lm0m;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v2, v3}, Lsli;->b(Lm0m;)Lrli;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/work/impl/background/systemalarm/a;->z:Lsli;

    invoke-virtual {p1, v0}, Lsli;->c(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v2, v3, v4}, Lwq9;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p2}, Landroidx/work/impl/background/systemalarm/d;->f()Lt0m;

    move-result-object v2

    invoke-virtual {v2, v1}, Lt0m;->F(Lrli;)V
    ...
    invoke-virtual {v3}, Lt0m;->v()Landroidx/work/impl/WorkDatabase;
    ...
    invoke-static {v2, v3, v4}, Lle;->a(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lm0m;)V
    ...
    invoke-virtual {p2, v1, v2}, Landroidx/work/impl/background/systemalarm/d;->onExecuted(Lm0m;Z)V
...
.method public n(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-static {v1, v3}, Landroidx/work/impl/background/systemalarm/a;->l(Landroid/os/Bundle;[Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, p2, p3}, Lwq9;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object p3, Landroidx/work/impl/background/systemalarm/a;->A:Ljava/lang/String;
    ...
    invoke-virtual {p2, p3, p1}, Lwq9;->k(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onExecuted(Lm0m;Z)V
    ...
    invoke-virtual {v2, p1}, Lsli;->b(Lm0m;)Lrli;
