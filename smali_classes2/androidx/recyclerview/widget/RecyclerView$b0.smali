...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->z:Landroid/view/animation/Interpolator;

    const/4 v1, 0x0

    iput-boolean v1, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->A:Z

    iput-boolean v1, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->B:Z
    ...
    iput-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->y:Landroid/widget/OverScroller;
...
.method public b(II)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->z:Landroid/view/animation/Interpolator;

    sget-object v1, Landroidx/recyclerview/widget/RecyclerView;->sQuinticInterpolator:Landroid/view/animation/Interpolator;

    if-eq v0, v1, :cond_0

    iput-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->z:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/widget/OverScroller;

    iget-object v2, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->C:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->y:Landroid/widget/OverScroller;

    :cond_0
    iget-object v3, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->y:Landroid/widget/OverScroller;
...
.method public d()V
    ...
    iget-boolean v0, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->A:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->B:Z
...
.method public e(IIILandroid/view/animation/Interpolator;)V
    ...
    :cond_1
    iget-object p3, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->z:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_2

    iput-object p4, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->z:Landroid/view/animation/Interpolator;
    ...
    iput-object p3, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->y:Landroid/widget/OverScroller;

    :cond_2
    const/4 p3, 0x0

    iput p3, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->x:I

    iput p3, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->w:I
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->y:Landroid/widget/OverScroller;
...
.method public run()V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->C:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-boolean v2, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->B:Z

    const/4 v3, 0x1

    iput-boolean v3, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->A:Z

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView;->consumePendingUpdateOperations()V

    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->y:Landroid/widget/OverScroller;
    ...
    iget v6, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->w:I

    sub-int v6, v4, v6

    iget v7, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->x:I

    sub-int v7, v5, v7

    iput v4, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->w:I

    iput v5, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->x:I

    iget-object v4, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->C:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v8, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->C:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v6, v4, Landroidx/recyclerview/widget/RecyclerView;->mAdapter:Landroidx/recyclerview/widget/RecyclerView$g;
    ...
    iget-object v4, v4, Landroidx/recyclerview/widget/RecyclerView$n;->C:Landroidx/recyclerview/widget/RecyclerView$x;
    ...
    invoke-virtual {v8}, Landroidx/recyclerview/widget/RecyclerView$y;->c()I
    ...
    invoke-virtual {v4, v8}, Landroidx/recyclerview/widget/RecyclerView$x;->p(I)V

    invoke-virtual {v4, v7, v6}, Landroidx/recyclerview/widget/RecyclerView$x;->j(II)V
    ...
    :cond_7
    iget-object v11, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->C:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :goto_6
    iget-object v6, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->C:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v6, v6, Landroidx/recyclerview/widget/RecyclerView;->mLayout:Landroidx/recyclerview/widget/RecyclerView$n;

    iget-object v6, v6, Landroidx/recyclerview/widget/RecyclerView$n;->C:Landroidx/recyclerview/widget/RecyclerView$x;
    ...
    :goto_8
    iget-object v5, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->C:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView$n;->C:Landroidx/recyclerview/widget/RecyclerView$x;
    ...
    :cond_18
    iput-boolean v2, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->A:Z

    iget-boolean v1, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->B:Z
