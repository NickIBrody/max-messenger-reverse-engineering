...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$s;->mScrap:Landroid/util/SparseArray;

    const/4 v0, 0x0

    iput v0, p0, Landroidx/recyclerview/widget/RecyclerView$s;->mAttachCountForClearing:I
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$s;->mAttachedAdaptersForPoolingContainer:Ljava/util/Set;
...
.method public attach()V
    ...
    iget v0, p0, Landroidx/recyclerview/widget/RecyclerView$s;->mAttachCountForClearing:I
...
.method public attachForPoolingContainer(Landroidx/recyclerview/widget/RecyclerView$g;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$s;->mAttachedAdaptersForPoolingContainer:Ljava/util/Set;
...
.method public clear()V
    ...
    invoke-static {v3}, Loqe;->a(Landroid/view/View;)V
...
.method public detachForPoolingContainer(Landroidx/recyclerview/widget/RecyclerView$g;Z)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p0, Landroidx/recyclerview/widget/RecyclerView$s;->mAttachedAdaptersForPoolingContainer:Ljava/util/Set;
    ...
    invoke-static {v2}, Loqe;->a(Landroid/view/View;)V
...
.method public factorInBindTime(IJ)V
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/RecyclerView$s;->getScrapDataForType(I)Landroidx/recyclerview/widget/RecyclerView$s$a;
...
.method public final getScrapDataForType(I)Landroidx/recyclerview/widget/RecyclerView$s$a;
    .locals 2
...
.method public onAdapterChanged(Landroidx/recyclerview/widget/RecyclerView$g;Landroidx/recyclerview/widget/RecyclerView$g;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$s;->detach()V

    :cond_0
    if-nez p3, :cond_1

    iget p1, p0, Landroidx/recyclerview/widget/RecyclerView$s;->mAttachCountForClearing:I

    if-nez p1, :cond_1

    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$s;->clear()V

    :cond_1
    if-eqz p2, :cond_2

    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$s;->attach()V
...
.method public putRecycledView(Landroidx/recyclerview/widget/RecyclerView$c0;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView$s;->getScrapDataForType(I)Landroidx/recyclerview/widget/RecyclerView$s$a;
    ...
    invoke-static {p1}, Loqe;->a(Landroid/view/View;)V
