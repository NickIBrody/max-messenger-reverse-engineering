...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/localbroadcastmanager/content/LocalBroadcastManager$a;,
...
.method public a()V
    ...
    :cond_1
    new-array v2, v1, [Landroidx/localbroadcastmanager/content/LocalBroadcastManager$a;
    ...
    iget-object v5, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$a;->b:Ljava/util/ArrayList;
    ...
    iget-object v7, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$a;->b:Ljava/util/ArrayList;

    invoke-virtual {v7, v6}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;

    iget-boolean v8, v7, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->d:Z

    if-nez v8, :cond_2

    iget-object v7, v7, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->b:Landroid/content/BroadcastReceiver;

    iget-object v8, p0, Landroidx/localbroadcastmanager/content/LocalBroadcastManager;->a:Landroid/content/Context;

    iget-object v9, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$a;->a:Landroid/content/Intent;
...
.method public c(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    :try_start_0
    new-instance v1, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;

    invoke-direct {v1, p2, p1}, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;-><init>(Landroid/content/IntentFilter;Landroid/content/BroadcastReceiver;)V
...
.method public d(Landroid/content/Intent;)Z
    ...
    check-cast v3, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;
    ...
    iget-object v11, v3, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->a:Landroid/content/IntentFilter;
    ...
    :cond_3
    iget-boolean v9, v3, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->c:Z
    ...
    iget-object v3, v9, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->a:Landroid/content/IntentFilter;
    ...
    iput-boolean v3, v10, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->c:Z
    ...
    check-cast v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;

    const/4 v5, 0x0

    iput-boolean v5, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->c:Z
    ...
    new-instance v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$a;

    invoke-direct {v4, v0, v14}, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$a;-><init>(Landroid/content/Intent;Ljava/util/ArrayList;)V
...
.method public e(Landroid/content/BroadcastReceiver;)V
    ...
    iput-boolean v3, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->d:Z

    const/4 v5, 0x0

    :goto_1
    iget-object v6, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->a:Landroid/content/IntentFilter;
    ...
    check-cast v9, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;

    iget-object v10, v9, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->b:Landroid/content/BroadcastReceiver;

    if-ne v10, p1, :cond_1

    iput-boolean v3, v9, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$b;->d:Z
