...
.method private p0(Lzbk;)V
    ...
    iget-object v0, p1, Lzbk;->a:Ljava/util/Map;
...
.method public N(Lzbk;Lzbk;)Z
    ...
    iget-object v1, p2, Lzbk;->a:Ljava/util/Map;
    ...
    iget-object v3, p1, Lzbk;->a:Ljava/util/Map;
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Landroidx/transition/Visibility;->r0(Lzbk;Lzbk;)Landroidx/transition/Visibility$a;
...
.method public h(Lzbk;)V
    ...
    invoke-direct {p0, p1}, Landroidx/transition/Visibility;->p0(Lzbk;)V
...
.method public o(Landroid/view/ViewGroup;Lzbk;Lzbk;)Landroid/animation/Animator;
    ...
    invoke-virtual {p0, p2, p3}, Landroidx/transition/Visibility;->r0(Lzbk;Lzbk;)Landroidx/transition/Visibility$a;
    ...
    invoke-virtual/range {v2 .. v7}, Landroidx/transition/Visibility;->s0(Landroid/view/ViewGroup;Lzbk;ILzbk;I)Landroid/animation/Animator;
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/transition/Visibility;->u0(Landroid/view/ViewGroup;Lzbk;ILzbk;I)Landroid/animation/Animator;
...
.method public final r0(Lzbk;Lzbk;)Landroidx/transition/Visibility$a;
    .locals 7
    ...
    iget-object v6, p1, Lzbk;->a:Ljava/util/Map;
    ...
    iget-object v6, p2, Lzbk;->a:Ljava/util/Map;
    ...
    iget-object v2, p2, Lzbk;->a:Ljava/util/Map;
...
.method public s0(Landroid/view/ViewGroup;Lzbk;ILzbk;I)Landroid/animation/Animator;
    .locals 2
    ...
    iget-object p3, p4, Lzbk;->b:Landroid/view/View;
    ...
    invoke-virtual {p0, p3, p5}, Landroidx/transition/Transition;->x(Landroid/view/View;Z)Lzbk;

    move-result-object v1

    invoke-virtual {p0, p3, p5}, Landroidx/transition/Transition;->K(Landroid/view/View;Z)Lzbk;

    move-result-object p3

    invoke-virtual {p0, v1, p3}, Landroidx/transition/Visibility;->r0(Lzbk;Lzbk;)Landroidx/transition/Visibility$a;
    ...
    invoke-virtual {p0, p1, p3, p2, p4}, Landroidx/transition/Visibility;->t0(Landroid/view/ViewGroup;Landroid/view/View;Lzbk;Lzbk;)Landroid/animation/Animator;
...
.method public abstract t0(Landroid/view/ViewGroup;Landroid/view/View;Lzbk;Lzbk;)Landroid/animation/Animator;
.end method

.method public u0(Landroid/view/ViewGroup;Lzbk;ILzbk;I)Landroid/animation/Animator;
    .locals 9
    ...
    :cond_1
    iget-object p3, p2, Lzbk;->b:Landroid/view/View;

    if-eqz p4, :cond_2

    iget-object v2, p4, Lzbk;->b:Landroid/view/View;
    ...
    :goto_0
    sget v3, Lelf;->save_overlay_view:I
    ...
    invoke-virtual {p0, v6, v5}, Landroidx/transition/Transition;->K(Landroid/view/View;Z)Lzbk;

    move-result-object v7

    invoke-virtual {p0, v6, v5}, Landroidx/transition/Transition;->x(Landroid/view/View;Z)Lzbk;

    move-result-object v8

    invoke-virtual {p0, v7, v8}, Landroidx/transition/Visibility;->r0(Lzbk;Lzbk;)Landroidx/transition/Visibility$a;
    ...
    iget-object p5, p2, Lzbk;->a:Ljava/util/Map;
    ...
    :cond_b
    invoke-virtual {p0, p1, v3, p2, p4}, Landroidx/transition/Visibility;->v0(Landroid/view/ViewGroup;Landroid/view/View;Lzbk;Lzbk;)Landroid/animation/Animator;
    ...
    :cond_c
    sget p4, Lelf;->save_overlay_view:I
    ...
    invoke-virtual {p1, p4}, Landroidx/transition/Transition;->c(Landroidx/transition/Transition$f;)Landroidx/transition/Transition;
    ...
    invoke-virtual {p0, p1, v2, p2, p4}, Landroidx/transition/Visibility;->v0(Landroid/view/ViewGroup;Landroid/view/View;Lzbk;Lzbk;)Landroid/animation/Animator;
    ...
    invoke-virtual {p3, p2}, Landroidx/transition/Transition;->c(Landroidx/transition/Transition$f;)Landroidx/transition/Transition;
...
.method public abstract v0(Landroid/view/ViewGroup;Landroid/view/View;Lzbk;Lzbk;)Landroid/animation/Animator;
.end method
