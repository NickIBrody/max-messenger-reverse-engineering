...
.method public static c(Lbpa;)Landroid/media/RouteDiscoveryPreference;
    .locals 3

    if-eqz p0, :cond_2

    invoke-virtual {p0}, Lbpa;->f()Z
    ...
    invoke-virtual {p0}, Lbpa;->d()Landroidx/mediarouter/media/k;
    ...
    :cond_1
    invoke-static {v1, v0}, Lqj5;->a(Ljava/util/List;Z)Landroid/media/RouteDiscoveryPreference$Builder;

    move-result-object p0

    invoke-static {p0}, Loj5;->a(Landroid/media/RouteDiscoveryPreference$Builder;)Landroid/media/RouteDiscoveryPreference;
    ...
    invoke-static {p0, v0}, Lqj5;->a(Ljava/util/List;Z)Landroid/media/RouteDiscoveryPreference$Builder;
...
.method public static e(Landroidx/mediarouter/media/g;)Landroid/media/MediaRoute2Info;
    ...
    invoke-static {v0, v1}, Lppa;->a(Ljava/lang/String;Ljava/lang/CharSequence;)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-static {v0, v1}, Lzpa;->a(Landroid/media/MediaRoute2Info$Builder;Ljava/lang/CharSequence;)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-static {v0, v1}, Ljpa;->a(Landroid/media/MediaRoute2Info$Builder;I)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-static {v0, v1}, Lkpa;->a(Landroid/media/MediaRoute2Info$Builder;I)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-static {v0, v1}, Llpa;->a(Landroid/media/MediaRoute2Info$Builder;I)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-static {v0, v1}, Lmpa;->a(Landroid/media/MediaRoute2Info$Builder;I)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-static {v0, v1}, Lnpa;->a(Landroid/media/MediaRoute2Info$Builder;Ljava/util/Collection;)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-static {v0, v1}, Lopa;->a(Landroid/media/MediaRoute2Info$Builder;Landroid/net/Uri;)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-static {v0, v1}, Lhpa;->a(Landroid/media/MediaRoute2Info$Builder;Ljava/lang/String;)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-static {v0, v1}, Lgpa;->a(Landroid/media/MediaRoute2Info$Builder;Landroid/os/Bundle;)Landroid/media/MediaRoute2Info$Builder;
    ...
    invoke-static {v0, p0}, Lhpa;->a(Landroid/media/MediaRoute2Info$Builder;Ljava/lang/String;)Landroid/media/MediaRoute2Info$Builder;

    :cond_4
    invoke-static {v0}, Lipa;->a(Landroid/media/MediaRoute2Info$Builder;)Landroid/media/MediaRoute2Info;
...
.method public static f(Landroid/media/MediaRoute2Info;)Landroidx/mediarouter/media/g;
    ...
    invoke-static {p0}, Ltna;->a(Landroid/media/MediaRoute2Info;)Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Lspa;->a(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    invoke-static {p0}, Ltpa;->a(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lupa;->a(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lvpa;->a(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lwpa;->a(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lsna;->a(Landroid/media/MediaRoute2Info;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Lxpa;->a(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    :cond_1
    invoke-static {p0}, Lypa;->a(Landroid/media/MediaRoute2Info;)Landroid/net/Uri;
...
.method public static g(Landroid/media/RouteDiscoveryPreference;)Lbpa;
    .locals 3
    ...
    invoke-static {p0}, Lfpa;->a(Landroid/media/RouteDiscoveryPreference;)Ljava/util/List;
    ...
    invoke-static {p0}, Lqpa;->a(Landroid/media/RouteDiscoveryPreference;)Z

    move-result p0

    invoke-direct {v1, v0, p0}, Lbpa;-><init>(Landroidx/mediarouter/media/k;Z)V
