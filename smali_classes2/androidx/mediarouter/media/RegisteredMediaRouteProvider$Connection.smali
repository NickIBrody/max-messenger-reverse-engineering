...
.method public binderDied()V
    ...
    new-instance v1, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection$b;

    invoke-direct {v1, p0}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection$b;-><init>(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;)V
...
.method public createDynamicGroupRouteController(Ljava/lang/String;Landroidx/mediarouter/media/MediaRouter$c;)I
    .locals 6
    ...
    iget-object p1, v0, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;->mPendingCallbacks:Landroid/util/SparseArray;
...
.method public dispose()V
    ...
    iget-object v1, v0, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;->mReceiveHandler:Landroidx/mediarouter/media/RegisteredMediaRouteProvider$ReceiveHandler;

    invoke-virtual {v1}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$ReceiveHandler;->dispose()V

    iget-object v1, v0, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;->mServiceMessenger:Landroid/os/Messenger;
    ...
    new-instance v2, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection$a;

    invoke-direct {v2, p0}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection$a;-><init>(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;)V
...
.method public failPendingCallbacks()V
    ...
    check-cast v2, Landroidx/mediarouter/media/MediaRouter$c;

    const/4 v3, 0x0

    invoke-virtual {v2, v3, v3}, Landroidx/mediarouter/media/MediaRouter$c;->a(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onControlRequestFailed(ILjava/lang/String;Landroid/os/Bundle;)Z
    ...
    check-cast v0, Landroidx/mediarouter/media/MediaRouter$c;
    ...
    invoke-virtual {v0, p2, p3}, Landroidx/mediarouter/media/MediaRouter$c;->a(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onControlRequestSucceeded(ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {v0, p2}, Landroidx/mediarouter/media/MediaRouter$c;->b(Landroid/os/Bundle;)V
...
.method public onDescriptorChanged(Landroid/os/Bundle;)Z
    ...
    invoke-static {p1}, Landroidx/mediarouter/media/h;->b(Landroid/os/Bundle;)Landroidx/mediarouter/media/h;

    move-result-object p1

    invoke-virtual {v0, p0, p1}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider;->onConnectionDescriptorChanged(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;Landroidx/mediarouter/media/h;)V
...
.method public onDynamicGroupRouteControllerCreated(ILandroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/mediarouter/media/MediaRouter$c;->a(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onDynamicRouteDescriptorsChanged(ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p2, p0, p1, v0, v1}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider;->onDynamicRouteDescriptorChanged(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;ILandroidx/mediarouter/media/g;Ljava/util/List;)V
...
.method public onGenericFailure(I)Z
    ...
    invoke-virtual {v0, p1, p1}, Landroidx/mediarouter/media/MediaRouter$c;->a(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onRegistered(IILandroid/os/Bundle;)Z
    ...
    invoke-static {p3}, Landroidx/mediarouter/media/h;->b(Landroid/os/Bundle;)Landroidx/mediarouter/media/h;

    move-result-object p3

    invoke-virtual {p2, p0, p3}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider;->onConnectionDescriptorChanged(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;Landroidx/mediarouter/media/h;)V
...
.method public sendControlRequest(ILandroid/content/Intent;Landroidx/mediarouter/media/MediaRouter$c;)Z
    .locals 6
...
.method public setDiscoveryRequest(Lbpa;)V
    .locals 6
    ...
    invoke-virtual {p1}, Lbpa;->a()Landroid/os/Bundle;
