...
# instance fields
.field final mImpl:Landroidx/mediarouter/media/MediaRouteProviderService$a;
...
.field private final mProviderCallback:Landroidx/mediarouter/media/MediaRouteProvider$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->mImpl:Landroidx/mediarouter/media/MediaRouteProviderService$a;
    ...
    :goto_0
    iget-object v0, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->mImpl:Landroidx/mediarouter/media/MediaRouteProviderService$a;

    invoke-interface {v0}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->n()Landroidx/mediarouter/media/MediaRouteProvider$a;

    move-result-object v0

    iput-object v0, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->mProviderCallback:Landroidx/mediarouter/media/MediaRouteProvider$a;

    return-void
.end method

.method public static createDescriptorBundleForClientVersion(Landroidx/mediarouter/media/h;I)Landroid/os/Bundle;
    .locals 3
    ...
    invoke-direct {v1, p0}, Landroidx/mediarouter/media/h$a;-><init>(Landroidx/mediarouter/media/h;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/mediarouter/media/h$a;->e(Z)Landroidx/mediarouter/media/h$a;

    :cond_1
    invoke-virtual {p0}, Landroidx/mediarouter/media/h;->c()Ljava/util/List;
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/g;->o()I

    move-result v2

    if-lt p1, v2, :cond_2

    invoke-virtual {v0}, Landroidx/mediarouter/media/g;->n()I

    move-result v2

    if-gt p1, v2, :cond_2

    invoke-virtual {v1, v0}, Landroidx/mediarouter/media/h$a;->a(Landroidx/mediarouter/media/g;)Landroidx/mediarouter/media/h$a;
    ...
    invoke-virtual {p0}, Landroidx/mediarouter/media/h;->a()Landroid/os/Bundle;
...
.method public ensureProvider()V
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/MediaRouteProvider;->getMetadata()Landroidx/mediarouter/media/MediaRouteProvider$c;

    move-result-object v1

    invoke-virtual {v1}, Landroidx/mediarouter/media/MediaRouteProvider$c;->b()Ljava/lang/String;
    ...
    iget-object v1, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->mProviderCallback:Landroidx/mediarouter/media/MediaRouteProvider$a;

    invoke-virtual {v0, v1}, Landroidx/mediarouter/media/MediaRouteProvider;->setCallback(Landroidx/mediarouter/media/MediaRouteProvider$a;)V
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    invoke-interface {v0, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->b(Landroid/content/Intent;)Landroid/os/IBinder;
