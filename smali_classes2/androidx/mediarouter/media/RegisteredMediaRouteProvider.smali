...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/mediarouter/media/RegisteredMediaRouteProvider$a;,
        ...
        Landroidx/mediarouter/media/RegisteredMediaRouteProvider$d;,
        Landroidx/mediarouter/media/RegisteredMediaRouteProvider$c;,
        Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;
    }
.end annotation
...
.field private mControllerCallback:Landroidx/mediarouter/media/RegisteredMediaRouteProvider$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;)V
    ...
    invoke-direct {v0, p2}, Landroidx/mediarouter/media/MediaRouteProvider$c;-><init>(Landroid/content/ComponentName;)V
...
.method private attachControllersToConnection()V
    ...
    check-cast v2, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;
    ...
    invoke-interface {v2, v3}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;->c(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;)V
...
.method private createDynamicGroupRouteController(Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$b;
    .locals 4
    ...
    new-instance v0, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$c;

    invoke-direct {v0, p0, p1}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$c;-><init>(Landroidx/mediarouter/media/RegisteredMediaRouteProvider;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;->c(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;)V
...
.method private createRouteController(Ljava/lang/String;Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$d;
    .locals 4
    ...
    new-instance v0, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$d;

    invoke-direct {v0, p0, p1, p2}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$d;-><init>(Landroidx/mediarouter/media/RegisteredMediaRouteProvider;Ljava/lang/String;Ljava/lang/String;)V
...
.method private detachControllersFromConnection()V
    ...
    invoke-interface {v2}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;->b()V
...
.method private findControllerById(I)Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;
    .locals 3
    ...
    check-cast v1, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;

    invoke-interface {v1}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;->a()I
...
.method private shouldBind()Z
    ...
    invoke-virtual {p0}, Landroidx/mediarouter/media/MediaRouteProvider;->getDiscoveryRequest()Lbpa;
...
.method public onConnectionControllerReleasedByProvider(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;I)V
    ...
    invoke-direct {p0, p2}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider;->findControllerById(I)Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;

    move-result-object p1

    iget-object p2, p0, Landroidx/mediarouter/media/RegisteredMediaRouteProvider;->mControllerCallback:Landroidx/mediarouter/media/RegisteredMediaRouteProvider$a;

    if-eqz p2, :cond_0

    instance-of v0, p1, Landroidx/mediarouter/media/MediaRouteProvider$d;
    ...
    invoke-interface {p2, v0}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$a;->a(Landroidx/mediarouter/media/MediaRouteProvider$d;)V

    :cond_0
    invoke-virtual {p0, p1}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider;->onControllerReleased(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;)V

    :cond_1
    return-void
.end method

.method public onConnectionDescriptorChanged(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;Landroidx/mediarouter/media/h;)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, p2}, Landroidx/mediarouter/media/MediaRouteProvider;->setDescriptor(Landroidx/mediarouter/media/h;)V
...
.method public onConnectionReady(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;->setDiscoveryRequest(Lbpa;)V

    :cond_0
    return-void
.end method

.method public onControllerReleased(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;)V
    .locals 1
    ...
    invoke-interface {p1}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$b;->b()V
...
.method public onCreateDynamicGroupRouteController(Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$b;
    ...
    invoke-direct {p0, p1}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider;->createDynamicGroupRouteController(Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$b;
...
.method public onCreateRouteController(Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$d;
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider;->createRouteController(Ljava/lang/String;Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$d;
...
.method public onCreateRouteController(Ljava/lang/String;Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$d;
    ...
    .line 3
    invoke-direct {p0, p1, p2}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider;->createRouteController(Ljava/lang/String;Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$d;
...
.method public onDynamicRouteDescriptorChanged(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$Connection;ILandroidx/mediarouter/media/g;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    instance-of p2, p1, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$c;

    if-eqz p2, :cond_1

    check-cast p1, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$c;

    invoke-virtual {p1, p3, p4}, Landroidx/mediarouter/media/RegisteredMediaRouteProvider$c;->r(Landroidx/mediarouter/media/g;Ljava/util/List;)V
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    :goto_0
    invoke-static {v1}, Lcpa;->a(Landroid/os/Messenger;)Z
...
.method public setControllerCallback(Landroidx/mediarouter/media/RegisteredMediaRouteProvider$a;)V
    .locals 0

    iput-object p1, p0, Landroidx/mediarouter/media/RegisteredMediaRouteProvider;->mControllerCallback:Landroidx/mediarouter/media/RegisteredMediaRouteProvider$a;
