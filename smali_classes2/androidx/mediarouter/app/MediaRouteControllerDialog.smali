...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroidx/mediarouter/app/MediaRouteControllerDialog$c;
    }
.end annotation
...
.field private final mCallback:Landroidx/mediarouter/app/MediaRouteControllerDialog$c;
...
.field final mRoute:Landroidx/mediarouter/media/MediaRouter$f;

.field mRouteInVolumeSliderTouched:Landroidx/mediarouter/media/MediaRouter$f;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    .line 6
    new-instance p2, Landroidx/mediarouter/app/MediaRouteControllerDialog$b;

    invoke-direct {p2, p0}, Landroidx/mediarouter/app/MediaRouteControllerDialog$b;-><init>(Landroidx/mediarouter/app/MediaRouteControllerDialog;)V
    ...
    invoke-static {p2}, Landroidx/mediarouter/media/MediaRouter;->h(Landroid/content/Context;)Landroidx/mediarouter/media/MediaRouter;
    ...
    iput-object v0, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mCallback:Landroidx/mediarouter/app/MediaRouteControllerDialog$c;

    .line 12
    invoke-virtual {p2}, Landroidx/mediarouter/media/MediaRouter;->l()Landroidx/mediarouter/media/MediaRouter$f;

    move-result-object v0

    iput-object v0, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mRoute:Landroidx/mediarouter/media/MediaRouter$f;

    .line 13
    invoke-virtual {p2}, Landroidx/mediarouter/media/MediaRouter;->i()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    sget v0, Lkjf;->mr_controller_volume_group_list_padding_top:I
    ...
    .line 17
    sget p2, Lyof;->mr_linear_out_slow_in:I
    ...
    .line 18
    sget p2, Lyof;->mr_fast_out_slow_in:I
...
.method private isGroup()Z
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mRoute:Landroidx/mediarouter/media/MediaRouter$f;
...
.method private rebuildVolumeGroupList(Z)V
    ...
    invoke-static {v1, v0}, Lapa;->i(Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-static {v2, v3}, Lapa;->e(Landroid/widget/ListView;Landroid/widget/ArrayAdapter;)Ljava/util/HashMap;
    ...
    invoke-static {v3, v4, v5}, Lapa;->d(Landroid/content/Context;Landroid/widget/ListView;Landroid/widget/ArrayAdapter;)Ljava/util/HashMap;
    ...
    invoke-static {v4, v0}, Lapa;->f(Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {v4, v0}, Lapa;->g(Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
...
.method private updatePlaybackControlLayout()V
    ...
    iget-object v4, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mRoute:Landroidx/mediarouter/media/MediaRouter$f;

    invoke-virtual {v4}, Landroidx/mediarouter/media/MediaRouter$f;->o()I
    ...
    sget v1, Lqsf;->mr_controller_casting_screen:I
    ...
    sget v1, Lqsf;->mr_controller_no_info_available:I
    ...
    sget v1, Lqsf;->mr_controller_no_media_selected:I
    ...
    sget v0, Lhif;->mediaRoutePauseDrawable:I

    sget v2, Lqsf;->mr_controller_pause:I
    ...
    sget v0, Lhif;->mediaRouteStopDrawable:I

    sget v2, Lqsf;->mr_controller_stop:I
    ...
    sget v0, Lhif;->mediaRoutePlayDrawable:I

    sget v2, Lqsf;->mr_controller_play:I
    ...
    invoke-static {v1, v0}, Landroidx/mediarouter/app/a;->p(Landroid/content/Context;I)I
...
.method private updateVolumeControlLayout()V
    ...
    invoke-virtual {p0, v0}, Landroidx/mediarouter/app/MediaRouteControllerDialog;->isVolumeControlAvailable(Landroidx/mediarouter/media/MediaRouter$f;)Z
    ...
    iget-object v3, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mRoute:Landroidx/mediarouter/media/MediaRouter$f;

    invoke-virtual {v3}, Landroidx/mediarouter/media/MediaRouter$f;->t()I
    ...
    invoke-virtual {v3}, Landroidx/mediarouter/media/MediaRouter$f;->r()I
...
.method public animateGroupListItemsInternal(Ljava/util/Map;Ljava/util/Map;)V
    ...
    check-cast v9, Landroidx/mediarouter/media/MediaRouter$f;
    ...
    new-instance v6, Landroidx/mediarouter/app/MediaRouteControllerDialog$a;

    invoke-direct {v6, v0, v5}, Landroidx/mediarouter/app/MediaRouteControllerDialog$a;-><init>(Landroidx/mediarouter/app/MediaRouteControllerDialog;Landroidx/mediarouter/media/MediaRouter$f;)V
...
.method public clearGroupListAnimation(Z)V
    ...
    :cond_0
    sget v4, Lalf;->volume_item_container:I
...
.method public getRoute()Landroidx/mediarouter/media/MediaRouter$f;
    .locals 1
...
.method public isVolumeControlAvailable(Landroidx/mediarouter/media/MediaRouter$f;)Z
    .locals 1
...
.method public onAttachedToWindow()V
    ...
    sget-object v1, Landroidx/mediarouter/media/k;->c:Landroidx/mediarouter/media/k;

    iget-object v2, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mCallback:Landroidx/mediarouter/app/MediaRouteControllerDialog$c;

    const/4 v3, 0x2

    invoke-virtual {v0, v1, v2, v3}, Landroidx/mediarouter/media/MediaRouter;->b(Landroidx/mediarouter/media/k;Landroidx/mediarouter/media/MediaRouter$a;I)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    sget v0, Ldpf;->mr_controller_material_dialog_b:I
    ...
    sget v2, Lalf;->mr_expandable_area:I
    ...
    invoke-static {v2}, Landroidx/mediarouter/app/a;->d(Landroid/content/Context;)I
    ...
    sget v4, Lqsf;->mr_controller_disconnect:I
    ...
    sget v4, Lqsf;->mr_controller_stop_casting:I
    ...
    sget v2, Lalf;->mr_custom_control:I
    ...
    sget v2, Lalf;->mr_default_control:I
    ...
    sget v3, Lalf;->mr_control_title_container:I
    ...
    sget v2, Lalf;->mr_media_main_control:I
    ...
    sget v2, Lalf;->mr_control_divider:I
    ...
    sget v2, Lalf;->mr_playback_control:I
    ...
    sget v2, Lalf;->mr_control_title:I
    ...
    sget v2, Lalf;->mr_control_subtitle:I
    ...
    sget v2, Lalf;->mr_control_playback_ctrl:I
    ...
    sget v0, Lalf;->mr_volume_control:I
    ...
    sget v0, Lalf;->mr_volume_slider:I
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mRoute:Landroidx/mediarouter/media/MediaRouter$f;
    ...
    sget v0, Lalf;->mr_volume_group_list:I
    ...
    invoke-static {v0, v1, v2, v3}, Landroidx/mediarouter/app/a;->u(Landroid/content/Context;Landroid/view/View;Landroid/view/View;Z)V
    ...
    invoke-static {v0, v1, v2}, Landroidx/mediarouter/app/a;->w(Landroid/content/Context;Landroidx/mediarouter/app/MediaRouteVolumeSlider;Landroid/view/View;)V
    ...
    sget v0, Lalf;->mr_group_expand_collapse:I
    ...
    sget v1, Lxof;->mr_controller_volume_group_list_animation_duration_ms:I
    ...
    sget v1, Lxof;->mr_controller_volume_group_list_fade_in_duration_ms:I
    ...
    sget v1, Lxof;->mr_controller_volume_group_list_fade_out_duration_ms:I
...
.method public onDetachedFromWindow()V
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mCallback:Landroidx/mediarouter/app/MediaRouteControllerDialog$c;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    :cond_2
    iget-object p2, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mRoute:Landroidx/mediarouter/media/MediaRouter$f;
    ...
    :goto_1
    invoke-virtual {p2, p1}, Landroidx/mediarouter/media/MediaRouter$f;->G(I)V
...
.method public update(Z)V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mRouteInVolumeSliderTouched:Landroidx/mediarouter/media/MediaRouter$f;
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mRoute:Landroidx/mediarouter/media/MediaRouter$f;

    invoke-virtual {v2}, Landroidx/mediarouter/media/MediaRouter$f;->l()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Landroidx/mediarouter/media/MediaRouter$f;->a()Z
...
.method public updateLayout()V
    ...
    invoke-static {v0}, Lapa;->b(Landroid/content/Context;)I
    ...
    sget v1, Lkjf;->mr_controller_volume_group_list_item_icon_size:I
    ...
    sget v1, Lkjf;->mr_controller_volume_group_list_item_height:I
    ...
    sget v1, Lkjf;->mr_controller_volume_group_list_max_height:I
...
.method public updateLayoutHeightInternal(Z)V
    ...
    iget-object v6, p0, Landroidx/mediarouter/app/MediaRouteControllerDialog;->mRoute:Landroidx/mediarouter/media/MediaRouter$f;

    invoke-virtual {v6}, Landroidx/mediarouter/media/MediaRouter$f;->k()Ljava/util/List;
...
.method public updateVolumeGroupItemHeight(Landroid/view/View;)V
    ...
    sget v0, Lalf;->volume_item_container:I
    ...
    sget v0, Lalf;->mr_volume_item_icon:I
