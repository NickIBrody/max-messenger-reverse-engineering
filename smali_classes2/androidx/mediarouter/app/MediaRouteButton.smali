...
.field private final mCallback:Landroidx/mediarouter/app/MediaRouteButton$a;

.field private mCheatSheetEnabled:Z

.field private mConnectionState:I

.field private mDialogFactory:Lzoa;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    sget v0, Lhif;->mediaRouteButtonStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-static {p1}, Landroidx/mediarouter/app/a;->a(Landroid/content/Context;)Landroid/content/Context;
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/MediaRouteButton;->mSelector:Landroidx/mediarouter/media/k;
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/MediaRouteButton;->mDialogFactory:Lzoa;
    ...
    .line 8
    sget-object v0, Lcuf;->MediaRouteButton:[I
    ...
    .line 9
    sget-object v2, Lcuf;->MediaRouteButton:[I
    ...
    .line 11
    iput-object p2, v0, Landroidx/mediarouter/app/MediaRouteButton;->mRouter:Landroidx/mediarouter/media/MediaRouter;

    .line 12
    iput-object p2, v0, Landroidx/mediarouter/app/MediaRouteButton;->mCallback:Landroidx/mediarouter/app/MediaRouteButton$a;

    .line 13
    sget p2, Lcuf;->MediaRouteButton_externalRouteEnabledDrawableStatic:I
    ...
    .line 14
    invoke-static {v1, p1}, Lwu;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p3, p0}, Landroidx/mediarouter/app/MediaRouteButton$a;-><init>(Landroidx/mediarouter/app/MediaRouteButton;)V

    iput-object p3, v0, Landroidx/mediarouter/app/MediaRouteButton;->mCallback:Landroidx/mediarouter/app/MediaRouteButton$a;
    ...
    .line 18
    invoke-virtual {p2}, Landroidx/mediarouter/media/MediaRouter$f;->v()Z
    ...
    .line 19
    invoke-virtual {p2}, Landroidx/mediarouter/media/MediaRouter$f;->c()I
    ...
    .line 22
    :cond_2
    sget p2, Lcuf;->MediaRouteButton_mediaRouteButtonTint:I
    ...
    .line 23
    sget p2, Lcuf;->MediaRouteButton_android_minWidth:I
    ...
    .line 24
    sget p2, Lcuf;->MediaRouteButton_android_minHeight:I

    invoke-virtual {v4, p2, p1}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p2

    iput p2, v0, Landroidx/mediarouter/app/MediaRouteButton;->mMinHeight:I
    ...
    .line 26
    sget p3, Lcuf;->MediaRouteButton_externalRouteEnabledDrawable:I

    invoke-virtual {v4, p3, p1}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result p3

    iput p3, v0, Landroidx/mediarouter/app/MediaRouteButton;->mRemoteIndicatorResIdToLoad:I

    .line 27
    invoke-virtual {v4}, Landroid/content/res/TypedArray;->recycle()V

    .line 28
    iget p3, v0, Landroidx/mediarouter/app/MediaRouteButton;->mRemoteIndicatorResIdToLoad:I
    ...
    .line 32
    :cond_3
    iget-object p3, v0, Landroidx/mediarouter/app/MediaRouteButton;->mRemoteIndicator:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p3, v0, Landroidx/mediarouter/app/MediaRouteButton;->mRemoteIndicatorLoader:Landroidx/mediarouter/app/MediaRouteButton$RemoteIndicatorLoader;
...
.method private showDialogForType(I)Z
    ...
    invoke-virtual {v1}, Landroidx/mediarouter/media/MediaRouter;->l()Landroidx/mediarouter/media/MediaRouter$f;
    ...
    :cond_0
    iget-object v3, p0, Landroidx/mediarouter/app/MediaRouteButton;->mDialogFactory:Lzoa;

    invoke-virtual {v3}, Lzoa;->b()Landroidx/mediarouter/app/MediaRouteChooserDialogFragment;

    move-result-object v3

    iget-object v4, p0, Landroidx/mediarouter/app/MediaRouteButton;->mSelector:Landroidx/mediarouter/media/k;

    invoke-virtual {v3, v4}, Landroidx/mediarouter/app/MediaRouteChooserDialogFragment;->setRouteSelector(Landroidx/mediarouter/media/k;)V
    ...
    invoke-virtual {p1, v3, v1}, Landroidx/fragment/app/d;->e(Landroidx/fragment/app/Fragment;Ljava/lang/String;)Landroidx/fragment/app/d;

    invoke-virtual {p1}, Landroidx/fragment/app/d;->j()I
    ...
    invoke-virtual {v3}, Lzoa;->c()Landroidx/mediarouter/app/MediaRouteControllerDialogFragment;

    move-result-object v3

    iget-object v4, p0, Landroidx/mediarouter/app/MediaRouteButton;->mSelector:Landroidx/mediarouter/media/k;

    invoke-virtual {v3, v4}, Landroidx/mediarouter/app/MediaRouteControllerDialogFragment;->setRouteSelector(Landroidx/mediarouter/media/k;)V
...
.method private showOutputSwitcherForAndroidR()Z
    ...
    invoke-virtual {v2}, Landroidx/mediarouter/media/MediaRouter;->i()Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method private updateContentDescription()V
    ...
    sget v0, Lqsf;->mr_cast_button_disconnected:I

    goto :goto_0

    :cond_0
    sget v0, Lqsf;->mr_cast_button_connected:I

    goto :goto_0

    :cond_1
    sget v0, Lqsf;->mr_cast_button_connecting:I
    ...
    :goto_1
    invoke-static {p0, v0}, Lx2k;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public enableDynamicGroup()V
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/MediaRouter;->j()Lcqa;

    move-result-object v0

    if-nez v0, :cond_0

    new-instance v0, Lcqa$a;

    invoke-direct {v0}, Lcqa$a;-><init>()V

    goto :goto_0

    :cond_0
    new-instance v1, Lcqa$a;

    invoke-direct {v1, v0}, Lcqa$a;-><init>(Lcqa;)V
    ...
    invoke-virtual {v0, v1}, Lcqa$a;->b(I)Lcqa$a;

    iget-object v1, p0, Landroidx/mediarouter/app/MediaRouteButton;->mRouter:Landroidx/mediarouter/media/MediaRouter;

    invoke-virtual {v0}, Lcqa$a;->a()Lcqa;

    move-result-object v0

    invoke-virtual {v1, v0}, Landroidx/mediarouter/media/MediaRouter;->s(Lcqa;)V

    return-void
.end method

.method public getDialogFactory()Lzoa;
    .locals 1

    iget-object v0, p0, Landroidx/mediarouter/app/MediaRouteButton;->mDialogFactory:Lzoa;
...
.method public getRouteSelector()Landroidx/mediarouter/media/k;
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/MediaRouteButton;->mSelector:Landroidx/mediarouter/media/k;
...
.method public onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/k;->f()Z
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/MediaRouteButton;->mSelector:Landroidx/mediarouter/media/k;

    iget-object v2, p0, Landroidx/mediarouter/app/MediaRouteButton;->mCallback:Landroidx/mediarouter/app/MediaRouteButton$a;

    invoke-virtual {v0, v1, v2}, Landroidx/mediarouter/media/MediaRouter;->a(Landroidx/mediarouter/media/k;Landroidx/mediarouter/media/MediaRouter$a;)V
...
.method public onDetachedFromWindow()V
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/MediaRouteButton;->mCallback:Landroidx/mediarouter/app/MediaRouteButton$a;
...
.method public refreshRoute()V
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/MediaRouter;->l()Landroidx/mediarouter/media/MediaRouter$f;
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/MediaRouter$f;->c()I
    ...
    invoke-virtual {v0, v1, v3}, Landroidx/mediarouter/media/MediaRouter;->o(Landroidx/mediarouter/media/k;I)Z
...
.method public setDialogFactory(Lzoa;)V
    .locals 1
...
.method public setRouteSelector(Landroidx/mediarouter/media/k;)V
    ...
    invoke-virtual {v0, p1, v1}, Landroidx/mediarouter/media/MediaRouter;->a(Landroidx/mediarouter/media/k;Landroidx/mediarouter/media/MediaRouter$a;)V
