...
.field private final mServiceBinderImpl:Landroidx/media/MediaBrowserServiceCompat$j;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/media/MediaBrowserServiceCompat;->mServiceBinderImpl:Landroidx/media/MediaBrowserServiceCompat$j;
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/media/MediaBrowserServiceCompat$ConnectionRecord;-><init>(Landroidx/media/MediaBrowserServiceCompat;Ljava/lang/String;IILandroid/os/Bundle;Landroidx/media/MediaBrowserServiceCompat$k;)V
    ...
    iput-object v0, v2, Landroidx/media/MediaBrowserServiceCompat;->mConnections:Ley;
...
.method public addSubscription(Ljava/lang/String;Landroidx/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/os/IBinder;Landroid/os/Bundle;)V
    ...
    invoke-static {p4, v2}, Lw7a;->a(Landroid/os/Bundle;Landroid/os/Bundle;)Z
...
.method public final getCurrentBrowserInfo()Luta;
    .locals 1

    iget-object v0, p0, Landroidx/media/MediaBrowserServiceCompat;->mImpl:Landroidx/media/MediaBrowserServiceCompat$f;

    invoke-interface {v0}, Landroidx/media/MediaBrowserServiceCompat$f;->c()Luta;
...
.method public handleMessageInternal(Landroid/os/Message;)V
    ...
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat;->mServiceBinderImpl:Landroidx/media/MediaBrowserServiceCompat$j;
    ...
    new-instance v4, Landroidx/media/MediaBrowserServiceCompat$l;

    iget-object p1, p1, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    invoke-direct {v4, p1}, Landroidx/media/MediaBrowserServiceCompat$l;-><init>(Landroid/os/Messenger;)V

    invoke-virtual {v2, v3, v1, v0, v4}, Landroidx/media/MediaBrowserServiceCompat$j;->h(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;Landroidx/media/MediaBrowserServiceCompat$k;)V
    ...
    invoke-virtual {v2, v3, v1, v0, v4}, Landroidx/media/MediaBrowserServiceCompat$j;->g(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;Landroidx/media/MediaBrowserServiceCompat$k;)V

    return-void

    :pswitch_2
    iget-object v0, p0, Landroidx/media/MediaBrowserServiceCompat;->mServiceBinderImpl:Landroidx/media/MediaBrowserServiceCompat$j;

    new-instance v1, Landroidx/media/MediaBrowserServiceCompat$l;

    iget-object p1, p1, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    invoke-direct {v1, p1}, Landroidx/media/MediaBrowserServiceCompat$l;-><init>(Landroid/os/Messenger;)V

    invoke-virtual {v0, v1}, Landroidx/media/MediaBrowserServiceCompat$j;->i(Landroidx/media/MediaBrowserServiceCompat$k;)V
    ...
    invoke-direct {v3, p1}, Landroidx/media/MediaBrowserServiceCompat$l;-><init>(Landroid/os/Messenger;)V
    ...
    invoke-virtual/range {v2 .. v7}, Landroidx/media/MediaBrowserServiceCompat$j;->e(Landroidx/media/MediaBrowserServiceCompat$k;Ljava/lang/String;IILandroid/os/Bundle;)V

    return-void

    :pswitch_4
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat;->mServiceBinderImpl:Landroidx/media/MediaBrowserServiceCompat$j;
    ...
    invoke-virtual {v1, v2, v0, v3}, Landroidx/media/MediaBrowserServiceCompat$j;->d(Ljava/lang/String;Landroid/support/v4/os/ResultReceiver;Landroidx/media/MediaBrowserServiceCompat$k;)V
    ...
    invoke-static {v0, v2}, Lv31;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    invoke-direct {v2, p1}, Landroidx/media/MediaBrowserServiceCompat$l;-><init>(Landroid/os/Messenger;)V

    invoke-virtual {v1, v3, v0, v2}, Landroidx/media/MediaBrowserServiceCompat$j;->f(Ljava/lang/String;Landroid/os/IBinder;Landroidx/media/MediaBrowserServiceCompat$k;)V
    ...
    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat;->mServiceBinderImpl:Landroidx/media/MediaBrowserServiceCompat$j;
    ...
    invoke-virtual {v3, v4, v0, v1, v2}, Landroidx/media/MediaBrowserServiceCompat$j;->a(Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;Landroidx/media/MediaBrowserServiceCompat$k;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/media/MediaBrowserServiceCompat$j;->c(Landroidx/media/MediaBrowserServiceCompat$k;)V
    ...
    new-instance v7, Landroidx/media/MediaBrowserServiceCompat$l;

    iget-object p1, p1, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    invoke-direct {v7, p1}, Landroidx/media/MediaBrowserServiceCompat$l;-><init>(Landroid/os/Messenger;)V

    invoke-virtual/range {v2 .. v7}, Landroidx/media/MediaBrowserServiceCompat$j;->b(Ljava/lang/String;IILandroid/os/Bundle;Landroidx/media/MediaBrowserServiceCompat$k;)V
...
.method public notifyChildrenChanged(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1, v1}, Landroidx/media/MediaBrowserServiceCompat$f;->d(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public notifyChildrenChanged(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1, p2}, Landroidx/media/MediaBrowserServiceCompat$f;->d(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public notifyChildrenChanged(Luta;Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 1
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/media/MediaBrowserServiceCompat$f;->f(Luta;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onCustomAction(Ljava/lang/String;Landroid/os/Bundle;Landroidx/media/MediaBrowserServiceCompat$h;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p3, p1}, Landroidx/media/MediaBrowserServiceCompat$h;->e(Landroid/os/Bundle;)V
...
.method public abstract onLoadChildren(Ljava/lang/String;Landroidx/media/MediaBrowserServiceCompat$h;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method public onLoadChildren(Ljava/lang/String;Landroidx/media/MediaBrowserServiceCompat$h;Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-virtual {p2, p3}, Landroidx/media/MediaBrowserServiceCompat$h;->g(I)V

    .line 2
    invoke-virtual {p0, p1, p2}, Landroidx/media/MediaBrowserServiceCompat;->onLoadChildren(Ljava/lang/String;Landroidx/media/MediaBrowserServiceCompat$h;)V
...
.method public onLoadItem(Ljava/lang/String;Landroidx/media/MediaBrowserServiceCompat$h;)V
    ...
    invoke-virtual {p2, p1}, Landroidx/media/MediaBrowserServiceCompat$h;->f(Ljava/lang/Object;)V

    return-void
.end method

.method public onSearch(Ljava/lang/String;Landroid/os/Bundle;Landroidx/media/MediaBrowserServiceCompat$h;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p3, p1}, Landroidx/media/MediaBrowserServiceCompat$h;->g(I)V

    const/4 p1, 0x0

    invoke-virtual {p3, p1}, Landroidx/media/MediaBrowserServiceCompat$h;->f(Ljava/lang/Object;)V
...
.method public performCustomAction(Ljava/lang/String;Landroid/os/Bundle;Landroidx/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/support/v4/os/ResultReceiver;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroidx/media/MediaBrowserServiceCompat;->onCustomAction(Ljava/lang/String;Landroid/os/Bundle;Landroidx/media/MediaBrowserServiceCompat$h;)V
...
.method public performLoadChildren(Ljava/lang/String;Landroidx/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v2, v0}, Landroidx/media/MediaBrowserServiceCompat;->onLoadChildren(Ljava/lang/String;Landroidx/media/MediaBrowserServiceCompat$h;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, v2, v0, v5}, Landroidx/media/MediaBrowserServiceCompat;->onLoadChildren(Ljava/lang/String;Landroidx/media/MediaBrowserServiceCompat$h;Landroid/os/Bundle;)V
...
.method public performLoadItem(Ljava/lang/String;Landroidx/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/support/v4/os/ResultReceiver;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/media/MediaBrowserServiceCompat;->onLoadItem(Ljava/lang/String;Landroidx/media/MediaBrowserServiceCompat$h;)V
...
.method public performSearch(Ljava/lang/String;Landroid/os/Bundle;Landroidx/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/support/v4/os/ResultReceiver;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroidx/media/MediaBrowserServiceCompat;->onSearch(Ljava/lang/String;Landroid/os/Bundle;Landroidx/media/MediaBrowserServiceCompat$h;)V
