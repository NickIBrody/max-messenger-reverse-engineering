.class public Landroidx/media/MediaBrowserServiceCompat$j$g;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/media/MediaBrowserServiceCompat$j;->i(Landroidx/media/MediaBrowserServiceCompat$k;)V
.end annotation
...
.method public constructor <init>(Landroidx/media/MediaBrowserServiceCompat$j;Landroidx/media/MediaBrowserServiceCompat$k;)V
    ...
    iput-object p1, p0, Landroidx/media/MediaBrowserServiceCompat$j$g;->x:Landroidx/media/MediaBrowserServiceCompat$j;

    iput-object p2, p0, Landroidx/media/MediaBrowserServiceCompat$j$g;->w:Landroidx/media/MediaBrowserServiceCompat$k;
...
.method public run()V
    ...
    iget-object v0, p0, Landroidx/media/MediaBrowserServiceCompat$j$g;->w:Landroidx/media/MediaBrowserServiceCompat$k;

    invoke-interface {v0}, Landroidx/media/MediaBrowserServiceCompat$k;->asBinder()Landroid/os/IBinder;

    move-result-object v0

    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$j$g;->x:Landroidx/media/MediaBrowserServiceCompat$j;
