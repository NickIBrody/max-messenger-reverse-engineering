...
.field mFoldingFeature:Lbj7;

.field private mFoldingFeatureObserver:Landroidx/slidingpanelayout/widget/a;
...
.field private mOnFoldingFeatureChangeListener:Landroidx/slidingpanelayout/widget/a$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mOnFoldingFeatureChangeListener:Landroidx/slidingpanelayout/widget/a$a;
    ...
    .line 17
    invoke-static {p1}, Lmxl;->a(Landroid/content/Context;)Lmxl;
    ...
    invoke-direct {p3, p2, p1}, Landroidx/slidingpanelayout/widget/a;-><init>(Lmxl;Ljava/util/concurrent/Executor;)V
...
.method private static getFoldBoundsInView(Lbj7;Landroid/view/View;)Landroid/graphics/Rect;
    .locals 8
    ...
    invoke-interface {p0}, Lmx5;->getBounds()Landroid/graphics/Rect;
...
.method private getSystemGestureInsets()Lpu8;
    .locals 1
    ...
    invoke-static {p0}, Landroidx/core/view/ViewCompat;->G(Landroid/view/View;)Landroidx/core/view/c;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Landroidx/core/view/c;->i()Lpu8;
...
.method private setFoldingFeatureObserver(Landroidx/slidingpanelayout/widget/a;)V
    ...
    iput-object p1, p0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mFoldingFeatureObserver:Landroidx/slidingpanelayout/widget/a;

    iget-object v0, p0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mOnFoldingFeatureChangeListener:Landroidx/slidingpanelayout/widget/a$a;
...
.method private splitViewPositions()Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mFoldingFeature:Lbj7;

    const/4 v1, 0x0

    if-eqz v0, :cond_3

    invoke-interface {v0}, Lbj7;->a()Z
    ...
    invoke-interface {v0}, Lmx5;->getBounds()Landroid/graphics/Rect;
    ...
    invoke-static {v0, p0}, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->getFoldBoundsInView(Lbj7;Landroid/view/View;)Landroid/graphics/Rect;
...
# virtual methods
.method public addPanelSlideListener(Landroidx/slidingpanelayout/widget/SlidingPaneLayout$d;)V
    .locals 1
...
.method public dispatchOnPanelClosed(Landroid/view/View;)V
    ...
    invoke-interface {v1, p1}, Landroidx/slidingpanelayout/widget/SlidingPaneLayout$d;->b(Landroid/view/View;)V
...
.method public dispatchOnPanelOpened(Landroid/view/View;)V
    ...
    invoke-interface {v1, p1}, Landroidx/slidingpanelayout/widget/SlidingPaneLayout$d;->a(Landroid/view/View;)V
...
.method public dispatchOnPanelSlide(Landroid/view/View;)V
    ...
    invoke-interface {v1, p1, v2}, Landroidx/slidingpanelayout/widget/SlidingPaneLayout$d;->c(Landroid/view/View;F)V
...
.method public drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-direct {p0}, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->getSystemGestureInsets()Lpu8;
...
.method public invalidateChildRegion(Landroid/view/View;)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/ViewCompat;->B0(Landroid/view/View;Landroid/graphics/Paint;)V
...
.method public onAttachedToWindow()V
    ...
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mFoldingFeatureObserver:Landroidx/slidingpanelayout/widget/a;
    ...
    iget-object v1, p0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mFoldingFeatureObserver:Landroidx/slidingpanelayout/widget/a;
...
.method public onLayout(ZIIII)V
    ...
    iget-object v7, v0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mFoldingFeature:Lbj7;

    if-eqz v7, :cond_a

    invoke-interface {v7}, Lbj7;->b()Lbj7$a;

    move-result-object v7

    sget-object v8, Lbj7$a;->c:Lbj7$a;

    if-ne v7, v8, :cond_a

    iget-object v7, v0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mFoldingFeature:Lbj7;

    invoke-interface {v7}, Lbj7;->a()Z
    ...
    invoke-interface {v7}, Lmx5;->getBounds()Landroid/graphics/Rect;
...
.method public removePanelSlideListener(Landroidx/slidingpanelayout/widget/SlidingPaneLayout$d;)V
    .locals 1
...
.method public setPanelSlideListener(Landroidx/slidingpanelayout/widget/SlidingPaneLayout$d;)V
    ...
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mPanelSlideListener:Landroidx/slidingpanelayout/widget/SlidingPaneLayout$d;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->removePanelSlideListener(Landroidx/slidingpanelayout/widget/SlidingPaneLayout$d;)V

    :cond_0
    if-eqz p1, :cond_1

    invoke-virtual {p0, p1}, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->addPanelSlideListener(Landroidx/slidingpanelayout/widget/SlidingPaneLayout$d;)V
