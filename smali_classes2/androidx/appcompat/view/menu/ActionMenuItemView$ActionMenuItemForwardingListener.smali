...
.method public getPopup()Lr5i;
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/ActionMenuItemView;->mPopupCallback:Landroidx/appcompat/view/menu/ActionMenuItemView$a;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/ActionMenuItemView$a;->a()Lr5i;
...
.method public onForwardingStarted()Z
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/ActionMenuItemView;->mItemInvoker:Landroidx/appcompat/view/menu/MenuBuilder$b;
    ...
    invoke-interface {v1, v0}, Landroidx/appcompat/view/menu/MenuBuilder$b;->invokeItem(Landroidx/appcompat/view/menu/MenuItemImpl;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/ActionMenuItemView$ActionMenuItemForwardingListener;->getPopup()Lr5i;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lr5i;->isShowing()Z
