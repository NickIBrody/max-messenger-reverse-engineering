...
.method private dispatchPresenterUpdate(Z)V
    ...
    :cond_1
    invoke-interface {v2, p1}, Landroidx/appcompat/view/menu/c;->updateMenuView(Z)V
...
.method private dispatchRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-interface {v2}, Landroidx/appcompat/view/menu/c;->getId()I
    ...
    invoke-interface {v2, v1}, Landroidx/appcompat/view/menu/c;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method private dispatchSaveInstanceState(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-interface {v3}, Landroidx/appcompat/view/menu/c;->getId()I

    move-result v2

    if-lez v2, :cond_1

    invoke-interface {v3}, Landroidx/appcompat/view/menu/c;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method private dispatchSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;Landroidx/appcompat/view/menu/c;)Z
    .locals 3
    ...
    invoke-interface {p2, p1}, Landroidx/appcompat/view/menu/c;->onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
    ...
    invoke-interface {v2, p1}, Landroidx/appcompat/view/menu/c;->onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
...
.method private setShortcutsVisibleInner(Z)V
    ...
    invoke-static {p1, v1}, Lrdl;->k(Landroid/view/ViewConfiguration;Landroid/content/Context;)Z
...
.method public addMenuPresenter(Landroidx/appcompat/view/menu/c;)V
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/appcompat/view/menu/MenuBuilder;->mContext:Landroid/content/Context;

    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/view/menu/MenuBuilder;->addMenuPresenter(Landroidx/appcompat/view/menu/c;Landroid/content/Context;)V

    return-void
.end method

.method public addMenuPresenter(Landroidx/appcompat/view/menu/c;Landroid/content/Context;)V
    .locals 2
    ...
    .line 3
    invoke-interface {p1, p2, p0}, Landroidx/appcompat/view/menu/c;->initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/MenuBuilder;)V
...
.method public final close(Z)V
    ...
    .line 6
    :cond_1
    invoke-interface {v2, p0, p1}, Landroidx/appcompat/view/menu/c;->onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
...
.method public collapseItemActionView(Landroidx/appcompat/view/menu/MenuItemImpl;)Z
    ...
    :cond_2
    invoke-interface {v3, p0, p1}, Landroidx/appcompat/view/menu/c;->collapseItemActionView(Landroidx/appcompat/view/menu/MenuBuilder;Landroidx/appcompat/view/menu/MenuItemImpl;)Z
...
.method public expandItemActionView(Landroidx/appcompat/view/menu/MenuItemImpl;)Z
    ...
    :cond_2
    invoke-interface {v3, p0, p1}, Landroidx/appcompat/view/menu/c;->expandItemActionView(Landroidx/appcompat/view/menu/MenuBuilder;Landroidx/appcompat/view/menu/MenuItemImpl;)Z
...
.method public flagActionItems()V
    ...
    :cond_1
    invoke-interface {v5}, Landroidx/appcompat/view/menu/c;->flagActionItems()Z
...
.method public performItemAction(Landroid/view/MenuItem;I)Z
    ...
    .line 1
    invoke-virtual {p0, p1, v0, p2}, Landroidx/appcompat/view/menu/MenuBuilder;->performItemAction(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/c;I)Z
...
.method public performItemAction(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/c;I)Z
    .locals 6
    ...
    .line 5
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/MenuItemImpl;->getSupportActionProvider()Lb9;
    ...
    .line 6
    invoke-virtual {v2}, Lb9;->hasSubMenu()Z
    ...
    .line 16
    invoke-virtual {v2, p1}, Lb9;->onPrepareSubMenu(Landroid/view/SubMenu;)V

    .line 17
    :cond_9
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/view/menu/MenuBuilder;->dispatchSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;Landroidx/appcompat/view/menu/c;)Z
...
.method public removeMenuPresenter(Landroidx/appcompat/view/menu/c;)V
    .locals 3
