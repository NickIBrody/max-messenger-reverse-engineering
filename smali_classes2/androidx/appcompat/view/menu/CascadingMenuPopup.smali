...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/view/menu/CascadingMenuPopup$b;
    }
.end annotation
...
.field private final mMenuItemHoverListener:Ly1b;
...
.field private mPresenterCallback:Landroidx/appcompat/view/menu/c$a;
...
.method static constructor <clinit>()V
    ...
    sget v0, Ljpf;->abc_cascading_menu_item_layout:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mMenuItemHoverListener:Ly1b;
    ...
    sget p3, Lojf;->abc_config_prefDialogWidth:I
...
.method private createPopupWindow()Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mMenuItemHoverListener:Ly1b;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/MenuPopupWindow;->G(Ly1b;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/ListPopupWindow;->x(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/ListPopupWindow;->w(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mAnchorView:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/ListPopupWindow;->p(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mDropDownGravity:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/ListPopupWindow;->s(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/ListPopupWindow;->v(Z)V
...
.method private findIndexOfAddedMenu(Landroidx/appcompat/view/menu/MenuBuilder;)I
    ...
    check-cast v2, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;

    iget-object v2, v2, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->b:Landroidx/appcompat/view/menu/MenuBuilder;
...
.method private findParentViewForSubmenu(Landroidx/appcompat/view/menu/CascadingMenuPopup$b;Landroidx/appcompat/view/menu/MenuBuilder;)Landroid/view/View;
    .locals 7

    iget-object v0, p1, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->b:Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    :cond_0
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->a()Landroid/widget/ListView;
...
.method private getNextMenuPosition(I)I
    ...
    check-cast v0, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->a()Landroid/widget/ListView;
...
.method private showMenu(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/ListPopupWindow;->s(I)V
    ...
    check-cast v1, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;

    invoke-direct {p0, v1, p1}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->findParentViewForSubmenu(Landroidx/appcompat/view/menu/CascadingMenuPopup$b;Landroidx/appcompat/view/menu/MenuBuilder;)Landroid/view/View;
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/MenuPopupWindow;->H(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/MenuPopupWindow;->E(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/ListPopupWindow;->p(Landroid/view/View;)V
    ...
    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/ListPopupWindow;->z(Z)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/ListPopupWindow;->t(Landroid/graphics/Rect;)V

    :goto_4
    new-instance v2, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;

    iget v3, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mLastPosition:I

    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;-><init>(Landroidx/appcompat/widget/MenuPopupWindow;Landroidx/appcompat/view/menu/MenuBuilder;I)V
    ...
    sget v1, Ljpf;->abc_popup_menu_header_item_layout:I
...
.method public addMenu(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    invoke-virtual {p1, p0, v0}, Landroidx/appcompat/view/menu/MenuBuilder;->addMenuPresenter(Landroidx/appcompat/view/menu/c;Landroid/content/Context;)V
...
.method public dismiss()V
    ...
    new-array v2, v0, [Landroidx/appcompat/view/menu/CascadingMenuPopup$b;
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->a:Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    iget-object v2, v2, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->a:Landroidx/appcompat/widget/MenuPopupWindow;
...
.method public isShowing()Z
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->a:Landroidx/appcompat/widget/MenuPopupWindow;
...
.method public onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
    ...
    iget-object v1, v1, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->b:Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->b:Landroidx/appcompat/view/menu/MenuBuilder;

    invoke-virtual {v1, p0}, Landroidx/appcompat/view/menu/MenuBuilder;->removeMenuPresenter(Landroidx/appcompat/view/menu/c;)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->a:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/MenuPopupWindow;->F(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->a:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/ListPopupWindow;->q(I)V
    ...
    iget v1, v1, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->c:I
    ...
    iget-object p2, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mPresenterCallback:Landroidx/appcompat/view/menu/c$a;

    if-eqz p2, :cond_4

    const/4 v0, 0x1

    invoke-interface {p2, p1, v0}, Landroidx/appcompat/view/menu/c$a;->onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
    ...
    check-cast p1, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;

    iget-object p1, p1, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->b:Landroidx/appcompat/view/menu/MenuBuilder;
...
.method public onDismiss()V
    ...
    check-cast v3, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;

    iget-object v4, v3, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->a:Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    iget-object v0, v3, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->b:Landroidx/appcompat/view/menu/MenuBuilder;
...
.method public onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
    ...
    iget-object v3, v1, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->b:Landroidx/appcompat/view/menu/MenuBuilder;

    if-ne p1, v3, :cond_0

    invoke-virtual {v1}, Landroidx/appcompat/view/menu/CascadingMenuPopup$b;->a()Landroid/widget/ListView;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mPresenterCallback:Landroidx/appcompat/view/menu/c$a;
...
.method public setCallback(Landroidx/appcompat/view/menu/c$a;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mPresenterCallback:Landroidx/appcompat/view/menu/c$a;
