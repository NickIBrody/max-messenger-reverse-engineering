...
.method private parseMenu(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    ...
    invoke-direct {v0, p0, p3}, Landroidx/appcompat/view/SupportMenuInflater$a;-><init>(Landroidx/appcompat/view/SupportMenuInflater;Landroid/view/Menu;)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/SupportMenuInflater$a;->h()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/SupportMenuInflater$a;->d()Z

    move-result p3

    if-nez p3, :cond_d

    iget-object p3, v0, Landroidx/appcompat/view/SupportMenuInflater$a;->A:Lb9;

    if-eqz p3, :cond_6

    invoke-virtual {p3}, Lb9;->hasSubMenu()Z

    move-result p3

    if-eqz p3, :cond_6

    invoke-virtual {v0}, Landroidx/appcompat/view/SupportMenuInflater$a;->b()Landroid/view/SubMenu;

    goto :goto_2

    :cond_6
    invoke-virtual {v0}, Landroidx/appcompat/view/SupportMenuInflater$a;->a()V
    ...
    invoke-virtual {v0, p2}, Landroidx/appcompat/view/SupportMenuInflater$a;->f(Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {v0, p2}, Landroidx/appcompat/view/SupportMenuInflater$a;->g(Landroid/util/AttributeSet;)V
