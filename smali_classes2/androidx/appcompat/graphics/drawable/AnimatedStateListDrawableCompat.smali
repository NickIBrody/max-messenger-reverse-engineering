...
.field private mTransition:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$e;
...
.method private parseItem(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)I
    ...
    sget-object v0, Lluf;->AnimatedStateListDrawableItem:[I

    invoke-static {p2, p5, p4, v0}, Luhk;->r(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Lluf;->AnimatedStateListDrawableItem_android_id:I
    ...
    sget v2, Lluf;->AnimatedStateListDrawableItem_android_drawable:I
    ...
    invoke-static {}, Landroidx/appcompat/widget/b;->g()Landroidx/appcompat/widget/b;

    move-result-object v3

    invoke-virtual {v3, p1, v2}, Landroidx/appcompat/widget/b;->i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-static {p2, p3, p4, p5}, Ls04;->a(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method private parseTransition(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)I
    ...
    sget-object v0, Lluf;->AnimatedStateListDrawableTransition:[I

    invoke-static {p2, p5, p4, v0}, Luhk;->r(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Lluf;->AnimatedStateListDrawableTransition_android_fromId:I
    ...
    sget v3, Lluf;->AnimatedStateListDrawableTransition_android_toId:I

    invoke-virtual {v0, v3, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v3

    sget v4, Lluf;->AnimatedStateListDrawableTransition_android_drawable:I
    ...
    invoke-virtual {v5, p1, v4}, Landroidx/appcompat/widget/b;->i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    sget v5, Lluf;->AnimatedStateListDrawableTransition_android_reversible:I
...
.method private selectTransition(I)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;->mTransition:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$e;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$e;->a()Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual {v0}, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$e;->b()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$e;->d()V
    ...
    iput-object v0, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;->mTransition:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$e;
    ...
    invoke-direct {v3, v6, v0, v7}, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$d;-><init>(Landroid/graphics/drawable/AnimationDrawable;ZZ)V
    ...
    new-instance v3, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$c;

    check-cast v6, Landroidx/vectordrawable/graphics/drawable/AnimatedVectorDrawableCompat;

    invoke-direct {v3, v6}, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$c;-><init>(Landroidx/vectordrawable/graphics/drawable/AnimatedVectorDrawableCompat;)V
    ...
    :goto_1
    invoke-virtual {v3}, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$e;->c()V

    iput-object v3, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;->mTransition:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$e;
...
.method private updateStateFromTypedArray(Landroid/content/res/TypedArray;)V
    ...
    invoke-static {p1}, Ls04;->b(Landroid/content/res/TypedArray;)I
    ...
    sget v1, Lluf;->AnimatedStateListDrawableCompat_android_variablePadding:I
    ...
    sget v1, Lluf;->AnimatedStateListDrawableCompat_android_constantSize:I
    ...
    sget v1, Lluf;->AnimatedStateListDrawableCompat_android_enterFadeDuration:I
    ...
    sget v1, Lluf;->AnimatedStateListDrawableCompat_android_exitFadeDuration:I
    ...
    sget v1, Lluf;->AnimatedStateListDrawableCompat_android_dither:I
...
.method public addState([ILandroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {p2}, Lokc;->c(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public addTransition(IILandroid/graphics/drawable/Drawable;Z)V
    ...
    invoke-static {p3}, Lokc;->c(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public inflate(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    sget-object v0, Lluf;->AnimatedStateListDrawableCompat:[I

    invoke-static {p2, p5, p4, v0}, Luhk;->r(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Lluf;->AnimatedStateListDrawableCompat_android_visible:I
...
.method public setVisible(ZZ)Z
    ...
    iget-object v1, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;->mTransition:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$e;
    ...
    invoke-virtual {v1}, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$e;->c()V
