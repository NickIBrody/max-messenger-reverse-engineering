...
.field private static final NON_EMPTY_SYSTEM_WINDOW_INSETS:Landroidx/core/view/c;
...
.field private mActionBarVisibilityCallback:Landroidx/appcompat/widget/ActionBarOverlayLayout$c;
...
.field private mBaseInnerInsets:Landroidx/core/view/c;
...
.field private mDecorToolbar:Ld95;
...
.field private mInnerInsets:Landroidx/core/view/c;

.field private final mInnerInsetsRect:Landroid/graphics/Rect;

.field private final mLastBaseContentInsets:Landroid/graphics/Rect;

.field private mLastBaseInnerInsets:Landroidx/core/view/c;

.field private final mLastBaseInnerInsetsRect:Landroid/graphics/Rect;

.field private mLastInnerInsets:Landroidx/core/view/c;
...
.field private final mParentHelper:Lo4c;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v2, v1, v2}, Lpu8;->c(IIII)Lpu8;
    ...
    sput-object v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->NON_EMPTY_SYSTEM_WINDOW_INSETS:Landroidx/core/view/c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 12
    sget-object p2, Landroidx/core/view/c;->b:Landroidx/core/view/c;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mBaseInnerInsets:Landroidx/core/view/c;

    .line 13
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mLastBaseInnerInsets:Landroidx/core/view/c;

    .line 14
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mInnerInsets:Landroidx/core/view/c;

    .line 15
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mLastInnerInsets:Landroidx/core/view/c;
    ...
    invoke-direct {p2, p0}, Lo4c;-><init>(Landroid/view/ViewGroup;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mParentHelper:Lo4c;
...
.method private decorFitsSystemWindows()Z
    ...
    sget-object v1, Landroidx/appcompat/widget/ActionBarOverlayLayout;->NON_EMPTY_SYSTEM_WINDOW_INSETS:Landroidx/core/view/c;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mTmpRect:Landroid/graphics/Rect;

    invoke-static {v0, v1, v2}, Landroidx/core/view/ViewCompat;->f(Landroid/view/View;Landroidx/core/view/c;Landroid/graphics/Rect;)Landroidx/core/view/c;
...
.method private getDecorToolbar(Landroid/view/View;)Ld95;
    .locals 3
...
.method public canShowOverflowMenu()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mDecorToolbar:Ld95;

    invoke-interface {v0}, Ld95;->canShowOverflowMenu()Z
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mParentHelper:Lo4c;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Ld95;->getTitle()Ljava/lang/CharSequence;
...
.method public initFeature(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mDecorToolbar:Ld95;

    invoke-interface {p1}, Ld95;->t()V
...
.method public isOverflowMenuShowPending()Z
    ...
    invoke-interface {v0}, Ld95;->isOverflowMenuShowPending()Z
...
.method public isOverflowMenuShowing()Z
    ...
    invoke-interface {v0}, Ld95;->isOverflowMenuShowing()Z
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p1, p0}, Landroidx/core/view/c;->A(Landroid/view/WindowInsets;Landroid/view/View;)Landroidx/core/view/c;
    ...
    invoke-static {p0, p1, v2}, Landroidx/core/view/ViewCompat;->f(Landroid/view/View;Landroidx/core/view/c;Landroid/graphics/Rect;)Landroidx/core/view/c;
    ...
    invoke-virtual {p1, v3, v4, v5, v2}, Landroidx/core/view/c;->o(IIII)Landroidx/core/view/c;

    move-result-object v2

    iput-object v2, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mBaseInnerInsets:Landroidx/core/view/c;

    iget-object v3, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mLastBaseInnerInsets:Landroidx/core/view/c;

    invoke-virtual {v3, v2}, Landroidx/core/view/c;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mBaseInnerInsets:Landroidx/core/view/c;

    iput-object v1, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mLastBaseInnerInsets:Landroidx/core/view/c;
    ...
    :cond_2
    invoke-virtual {p1}, Landroidx/core/view/c;->a()Landroidx/core/view/c;
    ...
    invoke-virtual {p1}, Landroidx/core/view/c;->b()Landroidx/core/view/c;
...
.method public onMeasure(II)V
    ...
    iget-object v7, v6, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mBaseInnerInsets:Landroidx/core/view/c;

    iput-object v7, v6, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mInnerInsets:Landroidx/core/view/c;
    ...
    iget-object v3, v6, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mInnerInsets:Landroidx/core/view/c;

    invoke-virtual {v3, v0, v5, v0, v0}, Landroidx/core/view/c;->o(IIII)Landroidx/core/view/c;

    move-result-object v0

    iput-object v0, v6, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mInnerInsets:Landroidx/core/view/c;

    goto :goto_2

    :cond_4
    iget-object v0, v6, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mInnerInsets:Landroidx/core/view/c;

    invoke-virtual {v0}, Landroidx/core/view/c;->k()I
    ...
    iget-object v5, v6, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mInnerInsets:Landroidx/core/view/c;

    invoke-virtual {v5}, Landroidx/core/view/c;->l()I

    move-result v5

    iget-object v7, v6, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mInnerInsets:Landroidx/core/view/c;

    invoke-virtual {v7}, Landroidx/core/view/c;->j()I

    move-result v7

    invoke-static {v0, v3, v5, v7}, Lpu8;->c(IIII)Lpu8;
    ...
    invoke-direct {v3, v5}, Landroidx/core/view/c$a;-><init>(Landroidx/core/view/c;)V

    invoke-virtual {v3, v0}, Landroidx/core/view/c$a;->d(Lpu8;)Landroidx/core/view/c$a;
    ...
    iget-object v0, v6, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mLastInnerInsets:Landroidx/core/view/c;

    iget-object v3, v6, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mInnerInsets:Landroidx/core/view/c;

    invoke-virtual {v0, v3}, Landroidx/core/view/c;->equals(Ljava/lang/Object;)Z
    ...
    iput-object v0, v6, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mLastInnerInsets:Landroidx/core/view/c;
    ...
    invoke-static {v3, v0}, Landroidx/core/view/ViewCompat;->g(Landroid/view/View;Landroidx/core/view/c;)Landroidx/core/view/c;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lo4c;->b(Landroid/view/View;Landroid/view/View;I)V
    ...
    .line 5
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mActionBarVisibilityCallback:Landroidx/appcompat/widget/ActionBarOverlayLayout$c;

    if-eqz p1, :cond_0

    .line 6
    invoke-interface {p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$c;->e()V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    .line 7
    invoke-interface {p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$c;->b()V
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    invoke-interface {p1, v3}, Landroidx/appcompat/widget/ActionBarOverlayLayout$c;->c(Z)V
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$c;->d()V
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$c;->a()V
...
.method public onWindowVisibilityChanged(I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mActionBarVisibilityCallback:Landroidx/appcompat/widget/ActionBarOverlayLayout$c;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$c;->onWindowVisibilityChanged(I)V
...
.method public pullChildren()V
    ...
    sget v0, Lilf;->action_bar_activity_content:I
    ...
    invoke-direct {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->getDecorToolbar(Landroid/view/View;)Ld95;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mDecorToolbar:Ld95;
...
.method public restoreToolbarHierarchyState(Landroid/util/SparseArray;)V
    ...
    invoke-interface {v0, p1}, Ld95;->q(Landroid/util/SparseArray;)V
...
.method public saveToolbarHierarchyState(Landroid/util/SparseArray;)V
    ...
    invoke-interface {v0, p1}, Ld95;->m(Landroid/util/SparseArray;)V
...
.method public setActionBarVisibilityCallback(Landroidx/appcompat/widget/ActionBarOverlayLayout$c;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->mActionBarVisibilityCallback:Landroidx/appcompat/widget/ActionBarOverlayLayout$c;
    ...
    invoke-interface {p1, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout$c;->onWindowVisibilityChanged(I)V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Ld95;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Ld95;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Ld95;->n(I)V

    return-void
.end method

.method public setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/c$a;)V
    .locals 1
    ...
    invoke-interface {v0, p1, p2}, Ld95;->setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/c$a;)V
...
.method public setMenuPrepared()V
    ...
    invoke-interface {v0}, Ld95;->setMenuPrepared()V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Ld95;->setWindowCallback(Landroid/view/Window$Callback;)V
