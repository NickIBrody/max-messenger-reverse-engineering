...
.field private mPopup:Landroidx/appcompat/widget/AppCompatSpinner$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, v0}, Lcwj;->a(Landroid/view/View;Landroid/content/Context;)V

    .line 9
    sget-object v0, Lzuf;->Spinner:[I

    const/4 v1, 0x0

    invoke-static {p1, p2, v0, p3, v1}, Lh1k;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lh1k;
    ...
    invoke-direct {v2, p0}, Lzt;-><init>(Landroid/view/View;)V

    iput-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mBackgroundTintHelper:Lzt;
    ...
    .line 12
    :cond_0
    sget p5, Lzuf;->Spinner_popupTheme:I

    invoke-virtual {v0, p5, v1}, Lh1k;->n(II)I
    ...
    sget-object v4, Lzuf;->Spinner:[I

    invoke-static {v3, p2, v4, p3, v1}, Lh1k;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lh1k;

    move-result-object v1

    .line 24
    sget v3, Lzuf;->Spinner_android_dropDownWidth:I

    const/4 v4, -0x2

    invoke-virtual {v1, v3, v4}, Lh1k;->m(II)I
    ...
    .line 25
    sget v3, Lzuf;->Spinner_android_popupBackground:I

    .line 26
    invoke-virtual {v1, v3}, Lh1k;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 28
    sget v3, Lzuf;->Spinner_android_prompt:I

    invoke-virtual {v0, v3}, Lh1k;->o(I)Ljava/lang/String;
    ...
    .line 33
    sget v1, Lzuf;->Spinner_android_prompt:I

    invoke-virtual {v0, v1}, Lh1k;->o(I)Ljava/lang/String;

    move-result-object v1

    invoke-interface {p4, v1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setPromptText(Ljava/lang/CharSequence;)V

    .line 34
    :goto_5
    sget p4, Lzuf;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, Lh1k;->q(I)[Ljava/lang/CharSequence;
    ...
    .line 36
    sget p1, Ljpf;->support_simple_spinner_dropdown_item:I
    ...
    .line 43
    :cond_8
    iget-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mBackgroundTintHelper:Lzt;
...
.method public drawableStateChanged()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mBackgroundTintHelper:Lzt;
...
.method public getDropDownHorizontalOffset()I
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->getHorizontalOffset()I
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->getVerticalOffset()I
...
.method public final getInternalPopup()Landroidx/appcompat/widget/AppCompatSpinner$b;
    .locals 1
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->getBackground()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->getHintText()Ljava/lang/CharSequence;
...
.method public onDetachedFromWindow()V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->isShowing()Z
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->dismiss()V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-interface {v1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->isShowing()Z
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-interface {v1, v2}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setHorizontalOriginalOffset(I)V

    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/AppCompatSpinner$b;

    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setHorizontalOffset(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setVerticalOffset(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setPromptText(Ljava/lang/CharSequence;)V
...
.method public showPopup()V
    ...
    invoke-interface {v0, v1, v2}, Landroidx/appcompat/widget/AppCompatSpinner$b;->show(II)V
