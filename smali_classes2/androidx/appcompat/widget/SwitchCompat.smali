...
.field private mEmojiCompatInitCallback:Landroidx/appcompat/widget/SwitchCompat$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v3}, Lcwj;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    .line 19
    sget-object v3, Lzuf;->SwitchCompat:[I

    invoke-static {p1, p2, v3, p3, v1}, Lh1k;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lh1k;

    move-result-object v3

    .line 20
    sget-object v6, Lzuf;->SwitchCompat:[I

    .line 21
    invoke-virtual {v3}, Lh1k;->r()Landroid/content/res/TypedArray;
    ...
    .line 23
    sget p1, Lzuf;->SwitchCompat_android_thumb:I

    invoke-virtual {v3, p1}, Lh1k;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 25
    :cond_0
    sget p1, Lzuf;->SwitchCompat_track:I
    ...
    .line 27
    :cond_1
    sget p1, Lzuf;->SwitchCompat_android_textOn:I

    invoke-virtual {v3, p1}, Lh1k;->p(I)Ljava/lang/CharSequence;
    ...
    .line 28
    sget p1, Lzuf;->SwitchCompat_android_textOff:I
    ...
    .line 29
    sget p1, Lzuf;->SwitchCompat_showText:I

    invoke-virtual {v3, p1, v2}, Lh1k;->a(IZ)Z
    ...
    .line 30
    sget p1, Lzuf;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v3, p1, v1}, Lh1k;->f(II)I
    ...
    .line 31
    sget p1, Lzuf;->SwitchCompat_switchMinWidth:I
    ...
    .line 32
    sget p1, Lzuf;->SwitchCompat_switchPadding:I
    ...
    .line 33
    sget p1, Lzuf;->SwitchCompat_splitTrack:I

    invoke-virtual {v3, p1, v1}, Lh1k;->a(IZ)Z
    ...
    .line 34
    sget p1, Lzuf;->SwitchCompat_thumbTint:I

    invoke-virtual {v3, p1}, Lh1k;->c(I)Landroid/content/res/ColorStateList;
    ...
    .line 37
    :cond_2
    sget p1, Lzuf;->SwitchCompat_thumbTintMode:I

    const/4 p2, -0x1

    .line 38
    invoke-virtual {v3, p1, p2}, Lh1k;->k(II)I

    move-result p1

    .line 39
    invoke-static {p1, v0}, Ln26;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 45
    :cond_5
    sget p1, Lzuf;->SwitchCompat_trackTint:I
    ...
    .line 48
    :cond_6
    sget p1, Lzuf;->SwitchCompat_trackTintMode:I
    ...
    .line 56
    :cond_9
    sget p1, Lzuf;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v3, p1, v1}, Lh1k;->n(II)I
    ...
    iput-object p1, v4, Landroidx/appcompat/widget/SwitchCompat;->mTextHelper:Lzu;

    .line 59
    invoke-virtual {p1, v7, v9}, Lzu;->m(Landroid/util/AttributeSet;I)V
    ...
    .line 64
    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lru;

    move-result-object p1

    .line 65
    invoke-virtual {p1, v7, v9}, Lru;->c(Landroid/util/AttributeSet;I)V
...
.method private doTransformForOnOffText(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v1}, Lru;->f(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method private getEmojiTextViewHelper()Lru;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Lru;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Lru;
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Ln26;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Ln26;->c:Landroid/graphics/Rect;
...
.method private setOffStateDescriptionOnRAndAbove()V
    ...
    sget v1, Lrtf;->abc_capital_off:I
...
.method private setupEmojiCompatLoadCallback()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mEmojiCompatInitCallback:Landroidx/appcompat/widget/SwitchCompat$a;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->mEmojiCompatInitCallback:Landroidx/appcompat/widget/SwitchCompat$a;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Ln26;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v6, Ln26;->c:Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1, v2, v5, v4}, La26;->l(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public drawableHotspotChanged(FF)V
    ...
    invoke-static {v0, p1, p2}, La26;->k(Landroid/graphics/drawable/Drawable;FF)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Ln26;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p4}, Ln26;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    sget p2, Lzuf;->TextAppearance_android_textColor:I

    invoke-virtual {p1, p2}, Lh1k;->c(I)Landroid/content/res/ColorStateList;
    ...
    :goto_0
    sget p2, Lzuf;->TextAppearance_android_textSize:I

    const/4 v0, 0x0

    invoke-virtual {p1, p2, v0}, Lh1k;->f(II)I
    ...
    :cond_1
    sget p2, Lzuf;->TextAppearance_android_typeface:I

    const/4 v1, -0x1

    invoke-virtual {p1, p2, v1}, Lh1k;->k(II)I

    move-result p2

    sget v2, Lzuf;->TextAppearance_android_textStyle:I

    invoke-virtual {p1, v2, v1}, Lh1k;->k(II)I

    move-result v1

    invoke-direct {p0, p2, v1}, Landroidx/appcompat/widget/SwitchCompat;->setSwitchTypefaceByIndex(II)V

    sget p2, Lzuf;->TextAppearance_textAllCaps:I

    invoke-virtual {p1, p2, v0}, Lh1k;->a(IZ)Z
