...
# instance fields
.field public G:Landroidx/appcompat/widget/ActionMenuPresenter$OverflowMenuButton;
...
.field public final Y:Landroidx/appcompat/widget/ActionMenuPresenter$e;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v0, Ljpf;->abc_action_menu_layout:I

    sget v1, Ljpf;->abc_action_menu_item_layout:I
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->Y:Landroidx/appcompat/widget/ActionMenuPresenter$e;
...
.method public static synthetic l(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/a;->y:Landroidx/appcompat/view/menu/MenuBuilder;

    return-object p0
.end method

.method public static synthetic m(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/MenuBuilder;
    .locals 0
...
.method public static synthetic q(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/MenuBuilder;
    .locals 0
...
.method public static synthetic r(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/d;
    .locals 0
...
.method public D(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->H:Landroid/graphics/drawable/Drawable;
...
.method public F()Z
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/a;->E:Landroidx/appcompat/view/menu/d;
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/a;->y:Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    invoke-direct {v0, p0, v1}, Landroidx/appcompat/widget/ActionMenuPresenter$c;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroidx/appcompat/widget/ActionMenuPresenter$d;)V

    iput-object v0, v2, Landroidx/appcompat/widget/ActionMenuPresenter;->W:Landroidx/appcompat/widget/ActionMenuPresenter$c;

    iget-object v1, v2, Landroidx/appcompat/view/menu/a;->E:Landroidx/appcompat/view/menu/d;
...
.method public a(Z)V
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/view/menu/a;->onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
...
.method public c(Landroidx/appcompat/view/menu/MenuItemImpl;Landroidx/appcompat/view/menu/d$a;)V
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p2, p1, v0}, Landroidx/appcompat/view/menu/d$a;->initialize(Landroidx/appcompat/view/menu/MenuItemImpl;I)V
...
.method public flagActionItems()Z
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/a;->y:Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    :goto_0
    iget v5, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->N:I

    iget v6, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->M:I

    invoke-static {v3, v3}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result v7

    iget-object v8, v0, Landroidx/appcompat/view/menu/a;->E:Landroidx/appcompat/view/menu/d;
    ...
    :goto_2
    iget-boolean v13, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->R:Z
    ...
    iget-boolean v10, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->P:Z

    if-eqz v10, :cond_7

    iget v10, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->S:I
    ...
    iget-boolean v3, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->P:Z
    ...
    :cond_11
    iget-boolean v4, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->P:Z
...
.method public h(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/d;
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/view/menu/a;->h(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/d;
...
.method public initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    invoke-virtual {p1}, Lu8;->c()I

    move-result v0

    iput v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->L:I
    ...
    :cond_2
    iget p1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->L:I
    ...
    iget-boolean v2, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->I:Z

    const/4 v3, 0x0

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->H:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/AppCompatImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iput-object v1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->H:Landroid/graphics/drawable/Drawable;

    iput-boolean v3, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->I:Z
...
.method public k(ILandroidx/appcompat/view/menu/MenuItemImpl;)Z
    .locals 0
...
.method public onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/a;->y:Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/ActionMenuPresenter;->t(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    iput v2, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->Z:I
...
.method public final t(Landroid/view/MenuItem;)Landroid/view/View;
    .locals 6
    ...
    instance-of v5, v4, Landroidx/appcompat/view/menu/d$a;

    if-eqz v5, :cond_1

    move-object v5, v4

    check-cast v5, Landroidx/appcompat/view/menu/d$a;

    invoke-interface {v5}, Landroidx/appcompat/view/menu/d$a;->getItemData()Landroidx/appcompat/view/menu/MenuItemImpl;
...
.method public u()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->H:Landroid/graphics/drawable/Drawable;
...
.method public updateMenuView(Z)V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/view/menu/MenuItemImpl;->getSupportActionProvider()Lb9;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3, p0}, Lb9;->setSubUiVisibilityListener(Lb9$a;)V
    ...
    :goto_1
    iget-boolean v1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->J:Z
...
.method public v()Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/a;->E:Landroidx/appcompat/view/menu/d;
