...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;Z)V
    ...
    .line 1
    sget v0, Lrtf;->abc_action_bar_up_description:I

    sget v1, Lukf;->abc_ic_ab_back_material:I
...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;ZII)V
    ...
    sget-object v0, Lzuf;->ActionBar:[I

    sget v1, Llif;->actionBarStyle:I

    const/4 v2, 0x0

    invoke-static {p1, v2, v0, v1, p4}, Lh1k;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lh1k;

    move-result-object p1

    .line 11
    sget v0, Lzuf;->ActionBar_homeAsUpIndicator:I
    ...
    .line 12
    sget p2, Lzuf;->ActionBar_title:I

    invoke-virtual {p1, p2}, Lh1k;->p(I)Ljava/lang/CharSequence;
    ...
    .line 14
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->C(Ljava/lang/CharSequence;)V

    .line 15
    :cond_1
    sget p2, Lzuf;->ActionBar_subtitle:I
    ...
    .line 18
    :cond_2
    sget p2, Lzuf;->ActionBar_logo:I

    invoke-virtual {p1, p2}, Lh1k;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 19
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->x(Landroid/graphics/drawable/Drawable;)V

    .line 20
    :cond_3
    sget p2, Lzuf;->ActionBar_icon:I
    ...
    .line 24
    :cond_5
    sget p2, Lzuf;->ActionBar_displayOptions:I

    invoke-virtual {p1, p2, p4}, Lh1k;->k(II)I

    move-result p2

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->b(I)V

    .line 25
    sget p2, Lzuf;->ActionBar_customNavigationLayout:I

    invoke-virtual {p1, p2, p4}, Lh1k;->n(II)I
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->v(Landroid/view/View;)V
    ...
    .line 28
    :cond_6
    sget p2, Lzuf;->ActionBar_height:I

    invoke-virtual {p1, p2, p4}, Lh1k;->m(II)I
    ...
    .line 32
    :cond_7
    sget p2, Lzuf;->ActionBar_contentInsetStart:I

    const/4 v0, -0x1

    invoke-virtual {p1, p2, v0}, Lh1k;->e(II)I

    move-result p2

    .line 33
    sget v1, Lzuf;->ActionBar_contentInsetEnd:I

    invoke-virtual {p1, v1, v0}, Lh1k;->e(II)I
    ...
    .line 37
    :cond_9
    sget p2, Lzuf;->ActionBar_titleTextStyle:I
    ...
    .line 39
    :cond_a
    sget p2, Lzuf;->ActionBar_subtitleTextStyle:I
    ...
    .line 41
    :cond_b
    sget p2, Lzuf;->ActionBar_popupTheme:I
    ...
    .line 43
    :cond_c
    invoke-virtual {p0}, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->u()I
    ...
    .line 45
    invoke-virtual {p0, p3}, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->w(I)V
...
.method public final D(Ljava/lang/CharSequence;)V
    ...
    invoke-static {v0, p1}, Landroidx/core/view/ViewCompat;->q0(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public e(IJ)Landroidx/core/view/ViewPropertyAnimatorCompat;
    ...
    new-instance p3, Landroidx/appcompat/widget/ToolbarWidgetWrapper$a;

    invoke-direct {p3, p0, p1}, Landroidx/appcompat/widget/ToolbarWidgetWrapper$a;-><init>(Landroidx/appcompat/widget/ToolbarWidgetWrapper;I)V

    invoke-virtual {p2, p3}, Landroidx/core/view/ViewPropertyAnimatorCompat;->g(Llfl;)Landroidx/core/view/ViewPropertyAnimatorCompat;
...
.method public n(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->x(Landroid/graphics/drawable/Drawable;)V

    return-void
.end method

.method public o(Landroidx/appcompat/view/menu/c$a;Landroidx/appcompat/view/menu/MenuBuilder$a;)V
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->a:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/Toolbar;->setMenuCallbacks(Landroidx/appcompat/view/menu/c$a;Landroidx/appcompat/view/menu/MenuBuilder$a;)V
...
.method public setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/c$a;)V
    ...
    sget v1, Lilf;->action_menu_presenter:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/a;->j(I)V

    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->n:Landroidx/appcompat/widget/ActionMenuPresenter;

    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/a;->i(Landroidx/appcompat/view/menu/c$a;)V
...
.method public w(I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->y(I)V
...
.method public y(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->z(Ljava/lang/CharSequence;)V
