...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpak;->a:Landroid/graphics/RectF;
...
.method public static b(Landroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    invoke-static {v0}, Lpak;->c(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public static c(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
    ...
    sget-object v1, Lpak;->a:Landroid/graphics/RectF;
...
.method public static d(Landroid/graphics/RectF;Landroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    invoke-static {p0, p1, p2, v0}, Lpak;->e(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public static e(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
    ...
    :cond_0
    invoke-static {p1}, Lpak;->c(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public static f(Landroid/graphics/Rect;I)Landroid/util/Size;
    ...
    invoke-static {p0}, Lpak;->m(Landroid/graphics/Rect;)Landroid/util/Size;

    move-result-object p0

    invoke-static {p0, p1}, Lpak;->r(Landroid/util/Size;I)Landroid/util/Size;
...
.method public static j(Landroid/util/Size;Landroid/util/Size;)Z
    ...
    invoke-static {p0, v0, p1, v0}, Lpak;->k(Landroid/util/Size;ZLandroid/util/Size;Z)Z
...
.method public static l(Landroid/graphics/Matrix;)Z
    ...
    invoke-static {v1, v3, v4, v0}, Lpak;->a(FFFF)F
...
.method public static p(Landroid/util/SizeF;)Landroid/util/SizeF;
    .locals 2
...
.method public static q(Landroid/graphics/RectF;I)Landroid/graphics/RectF;
    .locals 3
...
.method public static r(Landroid/util/Size;I)Landroid/util/Size;
    ...
    invoke-static {p0}, Lpak;->o(Landroid/util/Size;)Landroid/util/Size;
...
.method public static s(Landroid/util/Size;)Landroid/graphics/Rect;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0, v0}, Lpak;->t(Landroid/util/Size;II)Landroid/graphics/Rect;
...
.method public static t(Landroid/util/Size;II)Landroid/graphics/Rect;
    .locals 2
...
.method public static u(Landroid/util/Size;)Landroid/graphics/RectF;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0, v0}, Lpak;->v(Landroid/util/Size;II)Landroid/graphics/RectF;
...
.method public static v(Landroid/util/Size;II)Landroid/graphics/RectF;
    .locals 4
...
.method public static w(Landroid/graphics/Matrix;Landroid/graphics/Rect;)Landroid/graphics/Matrix;
    .locals 1
