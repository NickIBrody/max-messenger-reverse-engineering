...
.method public static a([B)Ljava/util/List;
    ...
    invoke-static {p0}, Ljkd;->f([B)I

    move-result v0

    int-to-long v0, v0

    invoke-static {v0, v1}, Ljkd;->k(J)J

    move-result-wide v0

    const-wide/16 v2, 0xf00

    invoke-static {v2, v3}, Ljkd;->k(J)J
    ...
    invoke-static {v0, v1}, Ljkd;->b(J)[B

    move-result-object p0

    invoke-interface {v4, p0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v2, v3}, Ljkd;->b(J)[B
...
.method public static e([B)J
    ...
    :cond_0
    invoke-static {v1, v0}, Ljkd;->d(BB)J
...
.method public static g(JJ)Z
    ...
    invoke-static {p2, p3}, Ljkd;->k(J)J
...
.method public static h(Ljava/nio/ByteBuffer;)I
    ...
    invoke-static {p0}, Ljkd;->i(Ljava/nio/ByteBuffer;)I
    ...
    :goto_0
    invoke-static {v0, p0}, Ljkd;->d(BB)J
