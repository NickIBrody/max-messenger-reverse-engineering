...
.method static constructor <clinit>()V
    ...
    sput-object v0, Laxk;->a:Landroid/graphics/Matrix;

    new-instance v0, Laxk$a;

    invoke-direct {v0}, Laxk$a;-><init>()V

    sput-object v0, Laxk;->b:Ljava/lang/ThreadLocal;

    new-instance v0, Laxk$b;

    invoke-direct {v0}, Laxk$b;-><init>()V

    sput-object v0, Laxk;->c:Ljava/lang/ThreadLocal;

    new-instance v0, Laxk$c;

    invoke-direct {v0}, Laxk$c;-><init>()V

    sput-object v0, Laxk;->d:Ljava/lang/ThreadLocal;

    new-instance v0, Laxk$d;

    invoke-direct {v0}, Laxk$d;-><init>()V

    sput-object v0, Laxk;->e:Ljava/lang/ThreadLocal;
...
.method public static a(Landroid/graphics/Path;FFF)V
    ...
    :cond_0
    sget-object v0, Laxk;->b:Ljava/lang/ThreadLocal;
    ...
    sget-object v2, Laxk;->c:Ljava/lang/ThreadLocal;
    ...
    sget-object v3, Laxk;->d:Ljava/lang/ThreadLocal;
    ...
    invoke-static {v5, v4}, Lksb;->f(FF)I

    move-result p2

    int-to-float v5, p2

    invoke-static {p1, v4}, Lksb;->f(FF)I
...
.method public static b(Landroid/graphics/Path;Lbdk;)V
    .locals 3

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lbdk;->l()Z
    ...
    invoke-virtual {p1}, Lbdk;->g()Lmo0;

    move-result-object v1

    check-cast v1, Lqb7;

    invoke-virtual {v1}, Lqb7;->r()F

    move-result v1

    invoke-virtual {p1}, Lbdk;->h()Lmo0;

    move-result-object p1

    check-cast p1, Lqb7;

    invoke-virtual {p1}, Lqb7;->r()F
    ...
    invoke-static {p0, v0, v1, p1}, Laxk;->a(Landroid/graphics/Path;FFF)V
...
.method public static g(Landroid/graphics/Matrix;)F
    ...
    sget-object v0, Laxk;->e:Ljava/lang/ThreadLocal;
...
.method public static n(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, v0}, Laxk;->o(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V
