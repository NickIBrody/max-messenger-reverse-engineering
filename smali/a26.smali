...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, p1}, La26$a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources$Theme;)V
...
.method public static b(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p0}, La26$a;->b(Landroid/graphics/drawable/Drawable;)Z
...
.method public static e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/ColorFilter;
    ...
    invoke-static {p0}, La26$a;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/ColorFilter;
...
.method public static f(Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-static {p0}, La26$b;->a(Landroid/graphics/drawable/Drawable;)I
...
.method public static g(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, La26$a;->d(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
...
.method public static k(Landroid/graphics/drawable/Drawable;FF)V
    ...
    invoke-static {p0, p1, p2}, La26$a;->e(Landroid/graphics/drawable/Drawable;FF)V
...
.method public static l(Landroid/graphics/drawable/Drawable;IIII)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, La26$a;->f(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public static m(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0, p1}, La26$b;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method public static n(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {p0, p1}, La26$a;->g(Landroid/graphics/drawable/Drawable;I)V
...
.method public static o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p0, p1}, La26$a;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
...
.method public static p(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, p1}, La26$a;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public static q(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    instance-of v0, p0, Lo2m;

    if-eqz v0, :cond_0

    check-cast p0, Lo2m;

    invoke-interface {p0}, Lo2m;->getWrappedDrawable()Landroid/graphics/drawable/Drawable;
