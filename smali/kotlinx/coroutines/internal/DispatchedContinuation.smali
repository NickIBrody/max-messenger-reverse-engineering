...
.method public constructor <init>(Ljv4;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-direct {p0, v0}, Lyw5;-><init>(I)V
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lcv4;

    move-result-object p1

    invoke-static {p1}, Lkotlinx/coroutines/internal/ThreadContextKt;->threadContextElements(Lcv4;)Ljava/lang/Object;
...
.method private final getReusableCancellableContinuation()Lrn2;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private final synthetic loop$atomicfu$ATOMIC_FIELD_UPDATER$Any(Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/lang/Object;Ldt7;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final claimReusableCancellableContinuation$kotlinx_coroutines_core()Lrn2;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final dispatchYield$kotlinx_coroutines_core(Lcv4;Ljava/lang/Object;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput p2, p0, Lyw5;->resumeMode:I

    iget-object p2, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Ljv4;

    invoke-virtual {p2, p1, p0}, Ljv4;->dispatchYield(Lcv4;Ljava/lang/Runnable;)V
...
.method public final release$kotlinx_coroutines_core()V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getReusableCancellableContinuation()Lrn2;
...
.method public final resumeCancellableWith$kotlinx_coroutines_core(Ljava/lang/Object;)V
    ...
    invoke-static {v1, v2}, Lkotlinx/coroutines/internal/DispatchedContinuationKt;->safeIsDispatchNeeded(Ljv4;Lcv4;)Z
    ...
    invoke-virtual {v1, p0}, Lwm6;->M0(Lyw5;)V

    goto/16 :goto_4

    :cond_1
    invoke-virtual {v1, v2}, Lwm6;->T0(Z)V
    ...
    invoke-interface {v3}, Lx29;->isActive()Z

    move-result v4

    if-nez v4, :cond_2

    invoke-interface {v3}, Lx29;->getCancellationException()Ljava/util/concurrent/CancellationException;

    move-result-object p1

    invoke-virtual {p0, v0, p1}, Lyw5;->cancelCompletedResult$kotlinx_coroutines_core(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lcv4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v4, v3}, Lgv4;->m(Lkotlin/coroutines/Continuation;Lcv4;Ljava/lang/Object;)Lzjk;
    ...
    :try_start_2
    invoke-static {v2}, Lts8;->b(I)V

    if-eqz v0, :cond_4

    invoke-virtual {v0}, Lzjk;->d0()Z
    ...
    :cond_4
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lcv4;Ljava/lang/Object;)V

    :cond_5
    invoke-static {v2}, Lts8;->a(I)V

    :cond_6
    :goto_1
    invoke-virtual {v1}, Lwm6;->F1()Z
    ...
    :goto_2
    invoke-virtual {v1, v2}, Lwm6;->D0(Z)V
    ...
    :goto_3
    :try_start_4
    invoke-virtual {p0, p1}, Lyw5;->handleFatalException$kotlinx_coroutines_core(Ljava/lang/Throwable;)V
    :try_end_4
...
.method public final resumeCancelled$kotlinx_coroutines_core(Ljava/lang/Object;)Z
    ...
    invoke-interface {v0}, Lx29;->getCancellationException()Ljava/util/concurrent/CancellationException;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lyw5;->cancelCompletedResult$kotlinx_coroutines_core(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final resumeUndispatchedWith$kotlinx_coroutines_core(Ljava/lang/Object;)V
    ...
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lcv4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v2, v1}, Lgv4;->m(Lkotlin/coroutines/Continuation;Lcv4;Ljava/lang/Object;)Lzjk;
    ...
    :cond_1
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lcv4;Ljava/lang/Object;)V

    :cond_2
    invoke-static {v3}, Lts8;->a(I)V
...
.method public resumeWith(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v0}, Lwm6;->T0(Z)V
    ...
    invoke-static {v2, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lcv4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    invoke-static {v2, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lcv4;Ljava/lang/Object;)V
    ...
    :goto_0
    invoke-virtual {v1, v0}, Lwm6;->D0(Z)V
...
.method public final tryReleaseClaimedContinuation$kotlinx_coroutines_core(Lpn2;)Ljava/lang/Throwable;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p0, v1, v3}, Lr2;->a(Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Z
