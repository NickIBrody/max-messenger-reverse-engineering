...
.field protected mConstraintLayoutSpec:Lsc4;

.field private mConstraintSet:Landroidx/constraintlayout/widget/b;

.field private mConstraintSetId:I

.field private mConstraintsChangedListener:Led4;
...
.field protected mLayoutWidget:Lcd4;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lcd4;
    ...
    .line 12
    iput-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mConstraintLayoutSpec:Lsc4;
...
.method private final getTargetWidget(I)Lbd4;
    .locals 1

    if-nez p1, :cond_0

    iget-object p1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lcd4;
    ...
    iget-object p1, p1, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->widget:Lbd4;
...
.method private init(Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {v0, p0}, Lbd4;->F0(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Lcd4;->a2(Lrr0$b;)V
    ...
    sget-object v2, Ltuf;->ConstraintLayout_Layout:[I
    ...
    sget v3, Ltuf;->ConstraintLayout_Layout_android_minWidth:I
    ...
    :cond_0
    sget v3, Ltuf;->ConstraintLayout_Layout_android_minHeight:I
    ...
    :cond_1
    sget v3, Ltuf;->ConstraintLayout_Layout_android_maxWidth:I
    ...
    :cond_2
    sget v3, Ltuf;->ConstraintLayout_Layout_android_maxHeight:I
    ...
    :cond_3
    sget v3, Ltuf;->ConstraintLayout_Layout_layout_optimizationLevel:I
    ...
    :cond_4
    sget v3, Ltuf;->ConstraintLayout_Layout_layoutDescription:I
    ...
    :cond_5
    sget v3, Ltuf;->ConstraintLayout_Layout_constraintSet:I
    ...
    invoke-virtual {v3, v4, v2}, Landroidx/constraintlayout/widget/b;->I(Landroid/content/Context;I)V
    :try_end_1
    ...
    invoke-virtual {p1, p2}, Lcd4;->b2(I)V
...
.method private setChildrenConstraints()V
    ...
    invoke-virtual {p0, v3}, Landroidx/constraintlayout/widget/ConstraintLayout;->getViewWidget(Landroid/view/View;)Lbd4;
    ...
    invoke-direct {p0, v4}, Landroidx/constraintlayout/widget/ConstraintLayout;->getTargetWidget(I)Lbd4;

    move-result-object v4

    invoke-virtual {v4, v5}, Lbd4;->G0(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_6
    iget-object v2, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lcd4;

    invoke-virtual {v2}, Luwl;->y1()V
    ...
    iget-object v3, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lcd4;
    ...
    invoke-virtual {p0, v2}, Landroidx/constraintlayout/widget/ConstraintLayout;->getViewWidget(Landroid/view/View;)Lbd4;
    ...
    invoke-virtual {v0, v3}, Luwl;->b(Lbd4;)V

    iget-object v5, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mTempMapIdToWidget:Landroid/util/SparseArray;

    move-object v0, p0

    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->applyConstraintsFromLayoutParams(ZLandroid/view/View;Lbd4;Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;Landroid/util/SparseArray;)V
...
.method private setWidgetBaseline(Lbd4;Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;Landroid/util/SparseArray;ILpc4$b;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, v0, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->widget:Lbd4;

    invoke-virtual {v0, p4}, Lbd4;->O0(Z)V

    :cond_0
    invoke-virtual {p1, v1}, Lbd4;->q(Lpc4$b;)Lpc4;

    move-result-object v0

    invoke-virtual {p3, p5}, Lbd4;->q(Lpc4$b;)Lpc4;
    ...
    invoke-virtual {v0, p3, p5, p2, p4}, Lpc4;->b(Lpc4;IIZ)Z

    invoke-virtual {p1, p4}, Lbd4;->O0(Z)V

    sget-object p2, Lpc4$b;->TOP:Lpc4$b;

    invoke-virtual {p1, p2}, Lbd4;->q(Lpc4$b;)Lpc4;

    move-result-object p2

    invoke-virtual {p2}, Lpc4;->q()V
...
# virtual methods
.method public applyConstraintsFromLayoutParams(ZLandroid/view/View;Lbd4;Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;Landroid/util/SparseArray;)V
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-virtual {v1, v2}, Lbd4;->n1(I)V
    ...
    invoke-virtual {v1, v2}, Lbd4;->X0(Z)V
    ...
    :cond_0
    invoke-virtual {v1, v0}, Lbd4;->F0(Ljava/lang/Object;)V
    ...
    invoke-virtual {v2}, Lcd4;->U1()Z

    move-result v2

    invoke-virtual {v0, v1, v2}, Landroidx/constraintlayout/widget/ConstraintHelper;->resolveRtl(Lbd4;Z)V
    ...
    invoke-virtual {p1, v2}, Ln38;->D1(F)V
    ...
    invoke-virtual {p1, v0}, Ln38;->B1(I)V
    ...
    invoke-virtual {p1, v1}, Ln38;->C1(I)V
    ...
    invoke-virtual {v1, v0, v2, v3}, Lbd4;->m(Lbd4;FI)V
    ...
    sget-object v1, Lpc4$b;->LEFT:Lpc4$b;
    ...
    sget-object v3, Lpc4$b;->RIGHT:Lpc4$b;
    ...
    sget-object v1, Lpc4$b;->TOP:Lpc4$b;
    ...
    sget-object v3, Lpc4$b;->BOTTOM:Lpc4$b;
    ...
    sget-object v5, Lpc4$b;->BASELINE:Lpc4$b;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->setWidgetBaseline(Lbd4;Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;Landroid/util/SparseArray;ILpc4$b;)V
    ...
    invoke-virtual {v0, v13}, Lbd4;->Q0(F)V
    ...
    invoke-virtual {v0, v3}, Lbd4;->h1(F)V
    ...
    invoke-virtual {v0, p1, v1}, Lbd4;->f1(II)V
    ...
    sget-object p1, Lbd4$b;->MATCH_CONSTRAINT:Lbd4$b;

    invoke-virtual {v0, p1}, Lbd4;->T0(Lbd4$b;)V

    goto :goto_7

    :cond_17
    sget-object p1, Lbd4$b;->MATCH_PARENT:Lbd4$b;
    ...
    invoke-virtual {v0, p1}, Lbd4;->q(Lpc4$b;)Lpc4;
    ...
    invoke-virtual {v0, v8}, Lbd4;->o1(I)V

    goto :goto_8

    :cond_19
    sget-object p1, Lbd4$b;->FIXED:Lbd4$b;

    invoke-virtual {v0, p1}, Lbd4;->T0(Lbd4$b;)V

    iget p1, v2, Landroid/view/ViewGroup$MarginLayoutParams;->width:I

    invoke-virtual {v0, p1}, Lbd4;->o1(I)V
    ...
    invoke-virtual {v0, p1}, Lbd4;->k1(Lbd4$b;)V
    ...
    invoke-virtual {v0, v8}, Lbd4;->P0(I)V
    ...
    invoke-virtual {v0, p1}, Lbd4;->P0(I)V
    ...
    invoke-virtual {v0, p1, v1, v3, v4}, Lbd4;->U0(IIIF)V
    ...
    invoke-virtual {v0, p1, v1, v3, v2}, Lbd4;->l1(IIIF)V
...
.method public fillMetrics(Ltpb;)V
    .locals 1

    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lcd4;

    invoke-virtual {v0, p1}, Lcd4;->M1(Ltpb;)V
...
.method public getSceneString()Ljava/lang/String;
    ...
    iget-object v1, v1, Lbd4;->o:Ljava/lang/String;
    ...
    iput-object v1, v3, Lbd4;->o:Ljava/lang/String;
    ...
    iput-object v3, v1, Lbd4;->o:Ljava/lang/String;
    ...
    iget-object v5, v1, Lbd4;->o:Ljava/lang/String;

    invoke-virtual {v1, v5}, Lbd4;->G0(Ljava/lang/String;)V
    ...
    iget-object v5, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lcd4;

    invoke-virtual {v5}, Lbd4;->v()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Luwl;->v1()Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Lbd4;->u()Ljava/lang/Object;
    ...
    iget-object v7, v5, Lbd4;->o:Ljava/lang/String;
    ...
    iput-object v6, v5, Lbd4;->o:Ljava/lang/String;
    ...
    iget-object v6, v5, Lbd4;->o:Ljava/lang/String;

    invoke-virtual {v5, v6}, Lbd4;->G0(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lcd4;->Q(Ljava/lang/StringBuilder;)V
...
.method public final getViewWidget(Landroid/view/View;)Lbd4;
    .locals 1
...
.method public loadLayoutDescription(I)V
    ...
    invoke-direct {v1, v2, p0, p1}, Lsc4;-><init>(Landroid/content/Context;Landroidx/constraintlayout/widget/ConstraintLayout;I)V

    iput-object v1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mConstraintLayoutSpec:Lsc4;
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onLayout(ZIIII)V
    ...
    iget-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->widget:Lbd4;
...
.method public onMeasure(II)V
    ...
    invoke-virtual {v0, v2}, Lcd4;->d2(Z)V
    ...
    invoke-virtual {p0, v0, v1, p1, p2}, Landroidx/constraintlayout/widget/ConstraintLayout;->resolveSystem(Lcd4;III)V
...
.method public onViewAdded(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->getViewWidget(Landroid/view/View;)Lbd4;
    ...
    invoke-direct {v1}, Ln38;-><init>()V

    iput-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->widget:Lbd4;

    iput-boolean v2, v0, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->isGuideline:Z

    iget v0, v0, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->orientation:I

    invoke-virtual {v1, v0}, Ln38;->E1(I)V
...
.method public onViewRemoved(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v0}, Luwl;->x1(Lbd4;)V
...
.method public parseLayoutDescription(I)V
    ...
    invoke-direct {v0, v1, p0, p1}, Lsc4;-><init>(Landroid/content/Context;Landroidx/constraintlayout/widget/ConstraintLayout;I)V
...
.method public resolveSystem(Lcd4;III)V
    .locals 13
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->setSelfDimensionBehaviour(Lcd4;IIII)V
    ...
    invoke-virtual/range {v0 .. v9}, Lcd4;->W1(IIIIIIIII)J
...
.method public setOnConstraintsChanged(Led4;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lsc4;->c(Led4;)V
...
.method public setOptimizationLevel(I)V
    ...
    invoke-virtual {v0, p1}, Lcd4;->b2(I)V

    return-void
.end method

.method public setSelfDimensionBehaviour(Lcd4;IIII)V
    .locals 7
    ...
    :cond_a
    invoke-virtual {p1}, Lcd4;->S1()V

    :cond_b
    invoke-virtual {p1, v5}, Lbd4;->q1(I)V

    invoke-virtual {p1, v5}, Lbd4;->r1(I)V

    iget p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mMaxWidth:I

    sub-int/2addr p4, v0

    invoke-virtual {p1, p4}, Lbd4;->b1(I)V

    iget p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mMaxHeight:I

    sub-int/2addr p4, v1

    invoke-virtual {p1, p4}, Lbd4;->a1(I)V

    invoke-virtual {p1, v5}, Lbd4;->e1(I)V

    invoke-virtual {p1, v5}, Lbd4;->d1(I)V

    invoke-virtual {p1, p2}, Lbd4;->T0(Lbd4$b;)V

    invoke-virtual {p1, p3}, Lbd4;->o1(I)V
    ...
    invoke-virtual {p1, p2}, Lbd4;->d1(I)V
