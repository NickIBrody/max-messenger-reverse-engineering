...
.method public final b(Lbd4;Lrr0$a;)V
    .locals 17
    ...
    invoke-virtual {v1}, Lbd4;->l0()Z

    move-result v3

    if-nez v3, :cond_1

    iput v5, v2, Lrr0$a;->e:I

    iput v5, v2, Lrr0$a;->f:I

    iput v5, v2, Lrr0$a;->g:I
    ...
    :cond_2
    iget-object v3, v2, Lrr0$a;->a:Lbd4$b;

    iget-object v4, v2, Lrr0$a;->b:Lbd4$b;

    iget v6, v2, Lrr0$a;->c:I

    iget v7, v2, Lrr0$a;->d:I
    ...
    invoke-static {v9, v11}, Lpjd;->b(II)Z
    ...
    invoke-virtual {v1}, Lbd4;->r()I

    move-result v9

    if-ne v8, v9, :cond_17

    invoke-virtual {v1}, Lbd4;->o0()Z

    move-result v8

    if-nez v8, :cond_17

    invoke-virtual {v1}, Lbd4;->E()I
    ...
    iput v3, v2, Lrr0$a;->e:I

    invoke-virtual {v1}, Lbd4;->z()I

    move-result v3

    iput v3, v2, Lrr0$a;->f:I

    invoke-virtual {v1}, Lbd4;->r()I

    move-result v1

    iput v1, v2, Lrr0$a;->g:I
    ...
    :goto_7
    sget-object v11, Lbd4$b;->MATCH_PARENT:Lbd4$b;

    if-eq v4, v11, :cond_1b

    sget-object v12, Lbd4$b;->FIXED:Lbd4$b;
    ...
    sget-object v11, Lbd4$b;->FIXED:Lbd4$b;
    ...
    invoke-virtual {v9, v8, v6, v7}, Landroidx/constraintlayout/widget/VirtualLayout;->onMeasure(Lghl;II)V
    ...
    :goto_10
    invoke-virtual {v1, v6, v7}, Lbd4;->Z0(II)V
    ...
    invoke-static {v3, v0}, Lpjd;->b(II)Z
    ...
    :goto_18
    iget v3, v2, Lrr0$a;->c:I

    if-ne v15, v3, :cond_30

    iget v3, v2, Lrr0$a;->d:I
    ...
    iput-boolean v1, v2, Lrr0$a;->i:Z

    :cond_32
    iput v15, v2, Lrr0$a;->e:I

    iput v5, v2, Lrr0$a;->f:I

    iput-boolean v0, v2, Lrr0$a;->h:Z

    iput v14, v2, Lrr0$a;->g:I
