...
.method public contains(Ljava/util/List;)Z
    ...
    invoke-virtual {v2}, Lv1m;->f()Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v1}, Lmv3;->j1(Ljava/lang/Iterable;)Ljava/util/HashSet;
...
.method public insert(Lv1m;)V
    ...
    invoke-interface {p0, p1}, Landroidx/work/impl/model/WorkersQueueDao;->insertOrIgnore(Lv1m;)V

    return-void

    :cond_0
    invoke-interface {p0, p1}, Landroidx/work/impl/model/WorkersQueueDao;->insertOrReplace(Lv1m;)V

    return-void
.end method

.method public abstract insertOrIgnore(Lv1m;)V
.end method

.method public abstract insertOrReplace(Lv1m;)V
.end method
