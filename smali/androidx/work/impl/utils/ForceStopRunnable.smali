...
.method public constructor <init>(Landroid/content/Context;Lt0m;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->x:Lt0m;

    invoke-virtual {p2}, Lt0m;->r()Leue;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->y:Leue;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->x:Lt0m;

    invoke-static {v0, v1}, Lthj;->i(Landroid/content/Context;Lt0m;)Z
    ...
    :try_start_0
    invoke-interface {v2}, Ll1m;->s()Ljava/util/List;
    ...
    sget-object v9, Ln0m$a;->ENQUEUED:Ln0m$a;

    iget-object v10, v8, Lk1m;->a:Ljava/lang/String;

    invoke-interface {v2, v9, v10}, Ll1m;->c(Ln0m$a;Ljava/lang/String;)I

    iget-object v8, v8, Lk1m;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v2, v8, v9, v10}, Ll1m;->n(Ljava/lang/String;J)I

    goto :goto_1

    :cond_1
    invoke-interface {v3}, Ld1m;->a()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->x:Lt0m;

    invoke-virtual {v0}, Lt0m;->A()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->x:Lt0m;

    invoke-virtual {v0}, Lt0m;->r()Leue;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Leue;->e(Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->y:Leue;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Leue;->d(J)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->x:Lt0m;

    invoke-virtual {v2}, Lt0m;->t()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-static {v1, v2, v4, v4}, Loj7;->a(Landroid/app/ActivityManager;Ljava/lang/String;II)Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->y:Leue;

    invoke-virtual {v2}, Leue;->a()J
    ...
    invoke-static {v6}, Lpj7;->a(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;

    move-result-object v6

    invoke-static {v6}, Lqj7;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {v6}, Lrj7;->a(Landroid/app/ApplicationExitInfo;)J
    ...
    invoke-virtual {v2, v3, v4, v1}, Lwq9;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public run()V
    ...
    invoke-static {v0}, Lf0m;->d(Landroid/content/Context;)V
    :try_end_1
    ...
    invoke-virtual {v2, v3, v1, v0}, Lwq9;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0}, Landroidx/work/a;->e()Lnd4;
    ...
    invoke-virtual {v1, v3, v4, v2}, Lwq9;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-interface {v0, v2}, Lnd4;->accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v6, v1, v0}, Lwq9;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, v3, v1}, Lwq9;->c(Ljava/lang/String;Ljava/lang/String;)V
