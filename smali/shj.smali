...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lshj;->b:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lshj;->a:Landroid/content/ComponentName;

    return-void
.end method

.method public static b(Ldd4$c;)Landroid/app/job/JobInfo$TriggerContentUri;
    .locals 2

    invoke-virtual {p0}, Ldd4$c;->b()Z

    move-result v0

    new-instance v1, Landroid/app/job/JobInfo$TriggerContentUri;

    invoke-virtual {p0}, Ldd4$c;->a()Landroid/net/Uri;
...
.method public static c(Lx5c;)I
    .locals 5

    sget-object v0, Lshj$a;->a:[I
    ...
    sget-object v2, Lshj;->b:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, p0}, Lwq9;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static d(Landroid/app/job/JobInfo$Builder;Lx5c;)V
    .locals 2
    ...
    invoke-static {p0, p1}, Lrhj;->a(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)Landroid/app/job/JobInfo$Builder;

    return-void

    :cond_0
    invoke-static {p1}, Lshj;->c(Lx5c;)I
...
# virtual methods
.method public a(Lk1m;I)Landroid/app/job/JobInfo;
    .locals 10

    iget-object v0, p1, Lk1m;->j:Ldd4;
    ...
    iget-object v3, p0, Lshj;->a:Landroid/content/ComponentName;
    ...
    invoke-static {p2, v1}, Lshj;->d(Landroid/app/job/JobInfo$Builder;Lx5c;)V
    ...
    iget-object v1, p1, Lk1m;->l:Lfl0;

    sget-object v4, Lfl0;->LINEAR:Lfl0;
    ...
    :cond_3
    iget-boolean v1, p1, Lk1m;->q:Z

    if-nez v1, :cond_4

    invoke-static {p2, v3}, Lphj;->a(Landroid/app/job/JobInfo$Builder;Z)Landroid/app/job/JobInfo$Builder;
    ...
    check-cast v8, Ldd4$c;

    invoke-static {v8}, Lshj;->b(Ldd4$c;)Landroid/app/job/JobInfo$TriggerContentUri;
    ...
    invoke-static {p2, v3}, Lqhj;->a(Landroid/app/job/JobInfo$Builder;Z)Landroid/app/job/JobInfo$Builder;
