...
.method public static a(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {p1, v0}, Lokc;->d(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
...
.method public static b(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {p0}, Lnp4$c;->a(Landroid/content/Context;)Landroid/content/Context;
...
.method public static c(Landroid/content/Context;I)I
    ...
    invoke-static {p0, p1}, Lnp4$b;->a(Landroid/content/Context;I)I
...
.method public static d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v0, p1, p0}, Ligg;->d(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
...
.method public static e(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {p0}, Lco9;->a(Landroid/content/Context;)Lzn9;
    ...
    invoke-static {v1, v0}, Lx64;->b(Landroid/content/res/Configuration;Lzn9;)V
...
.method public static f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1}, Lnp4$a;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public static i(Landroid/content/Context;)Ljava/util/concurrent/Executor;
    ...
    invoke-static {p0}, Lnp4$e;->a(Landroid/content/Context;)Ljava/util/concurrent/Executor;
    ...
    invoke-static {v0}, Llp6;->a(Landroid/os/Handler;)Ljava/util/concurrent/Executor;
...
.method public static k(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lnp4$b;->b(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public static l(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lgyd;->b(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {p0}, Lmp4;->a(Landroid/content/Context;)Ljava/lang/String;
...
.method public static m(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;I)Landroid/content/Intent;
    ...
    invoke-static/range {v0 .. v5}, Lnp4;->n(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
...
.method public static n(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
    ...
    invoke-static/range {v0 .. v5}, Lnp4$f;->a(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
    ...
    invoke-static/range {v0 .. v5}, Lnp4$d;->a(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
...
.method public static q(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Lnp4$d;->b(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
