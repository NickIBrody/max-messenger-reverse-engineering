...
.method public constructor <init>(Lm1m;Lqkg;)V
    ...
    iput-object p1, p0, Lm1m$f;->d:Lm1m;
...
.method public bridge synthetic j(Ltbj;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lm1m$f;->l(Ltbj;Lk1m;)V
...
.method public l(Ltbj;Lk1m;)V
    ...
    invoke-static {v8}, Ls1m;->g(Lx5c;)I

    move-result v8

    int-to-long v8, v8

    invoke-interface {p1, v6, v8, v9}, Lqbj;->i(IJ)V
    ...
    invoke-interface {p1, v5, v8, v9}, Lqbj;->i(IJ)V
    ...
    :cond_5
    invoke-interface {p1, v7, p2}, Lqbj;->j(I[B)V
