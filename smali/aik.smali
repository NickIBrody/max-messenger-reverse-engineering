...
.method public static o(Landroid/os/CancellationSignal;[Landroidx/core/provider/FontsContractCompat$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
...
.method public b(Landroid/content/Context;Lmj7$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Lmj7$d;->d()Ljava/lang/String;
    ...
    invoke-virtual {p0, p2, p4}, Laik;->n(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public d(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/FontsContractCompat$b;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p3, p1}, Laik;->o(Landroid/os/CancellationSignal;[Landroidx/core/provider/FontsContractCompat$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-virtual {p0, p1, p4}, Laik;->n(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public e(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p2, v0, p1}, Laik;->o(Landroid/os/CancellationSignal;[Landroidx/core/provider/FontsContractCompat$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    check-cast v4, [Landroidx/core/provider/FontsContractCompat$b;

    invoke-static {p2, v4, p1}, Laik;->o(Landroid/os/CancellationSignal;[Landroidx/core/provider/FontsContractCompat$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-virtual {p0, v0, p4}, Laik;->n(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final n(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    .locals 5
    ...
    invoke-static {v0, v1}, Laik;->p(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Laik;->p(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
