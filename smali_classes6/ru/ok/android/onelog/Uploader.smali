...
.method public static execute(Las;Ljava/util/Collection;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    invoke-static {p0, v0, p1}, Lru/ok/android/onelog/Uploader;->executeCollector(Las;Ljava/lang/String;Ljava/util/Collection;)V
    ...
    .line 16
    invoke-static {p0, v1, v0}, Lru/ok/android/onelog/Uploader;->executeCollector(Las;Ljava/lang/String;Ljava/util/Collection;)V
...
.method public static execute(Las;Lru/ok/android/onelog/OneLogItem;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
...
.method private static executeCollector(Las;Ljava/lang/String;Ljava/util/Collection;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1, v0}, Lru/ok/android/onelog/Uploader;->executeCollector(Las;Ljava/lang/String;Ls01;)V

    return-void
.end method

.method private static executeCollector(Las;Ljava/lang/String;Ls01;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    invoke-direct {v2, p1, v0, v1, p2}, Lru/ok/android/onelog/OneLogApiRequest;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ls01;)V

    .line 5
    invoke-interface {p0, v2}, Las;->b(Lps;)Ljava/lang/Object;
...
.method public drop()V
    ...
    invoke-static {v0, v1}, Lar9;->j(Ljava/lang/Throwable;Ljava/lang/String;)V
    :try_end_2
...
.method public upload()V
    ...
    const-string v0, "upload error %s"
    ...
    invoke-virtual {v1}, Lru/ok/android/onelog/OneLogImpl;->getApiClient()Las;

    move-result-object v1
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_4

    iget-object v2, p0, Lru/ok/android/onelog/Uploader;->file:Ljavax/inject/Provider;
    ...
    :try_start_1
    iget-object v3, p0, Lru/ok/android/onelog/Uploader;->lock:Ljava/util/concurrent/locks/Lock;
    ...
    :cond_0
    :try_start_2
    iget-object v3, p0, Lru/ok/android/onelog/Uploader;->collector:Ljava/lang/String;

    new-instance v4, Lru/ok/android/onelog/StreamingOneLogItemsApiValue;

    invoke-direct {v4, v2}, Lru/ok/android/onelog/StreamingOneLogItemsApiValue;-><init>(Ljava/io/File;)V

    invoke-static {v1, v3, v4}, Lru/ok/android/onelog/Uploader;->executeCollector(Las;Ljava/lang/String;Ls01;)V
    :try_end_2
    .catch Lru/ok/android/api/core/ApiInvocationException; {:try_start_2 .. :try_end_2} :catch_3
    .catch Lru/ok/android/api/core/ApiRequestException; {:try_start_2 .. :try_end_2} :catch_2
    ...
    invoke-static {v0, v1}, Lar9;->i(Ljava/lang/String;[Ljava/lang/Object;)V

    const-string v0, "upload failed, removing likely broken logs"

    invoke-static {v0}, Lar9;->h(Ljava/lang/String;)V
    ...
    const-string v0, "upload failed, removing possibly broken logs"

    invoke-static {v0}, Lar9;->h(Ljava/lang/String;)V

    :goto_2
    invoke-static {v2}, Lru/ok/android/onelog/Files;->delete(Ljava/io/File;)V
    :try_end_3
    ...
    invoke-static {v0}, Lar9;->o(Ljava/lang/String;)V
    ...
    .catch Lru/ok/android/api/core/ApiException; {:try_start_4 .. :try_end_4} :catch_0
