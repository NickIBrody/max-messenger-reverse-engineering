...
.method private handleAppend(Lru/ok/android/onelog/OneLogItem;)V
    ...
    const-string v0, "append file too big"
    ...
    const-string v0, "trigger | log file size exceeded %sB"

    invoke-static {v0, p1}, Lar9;->g(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v0, "trigger | log items count exceeded %s"
...
.method private handleUploadMaxTimeout()V
    ...
    :cond_0
    const-string v0, "trigger | max time since log item passed"
...
.method private handleUploadSilenceTimeout()V
    ...
    const-string v1, "trigger | time since last log item exceeded %sms"
