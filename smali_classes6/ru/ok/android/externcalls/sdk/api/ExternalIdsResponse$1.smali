...
.method private parseIds(Ljava/util/Map;Lf89;Z)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2}, Lf89;->D()V

    :goto_0
    invoke-interface {p2}, Lf89;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {p2}, Lf89;->name()Ljava/lang/String;
...
.method public bridge synthetic parse(Lf89;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse$1;->parse(Lf89;)Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse;
...
.method public parse(Lf89;)Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .line 7
    invoke-direct {p0, v0, p1, v1}, Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse$1;->parseIds(Ljava/util/Map;Lf89;Z)V
