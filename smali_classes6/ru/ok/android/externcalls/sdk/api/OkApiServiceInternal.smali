...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeProvider",
        "<init>",
        "(Lbsg;Lru/ok/android/externcalls/sdk/api/OkApiService;Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Lnvf;Lxzj;)V",
        "",
        "cid",
        "",
        "peerId",
        ...
        "joinToConversation",
        "(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Liai;",
        "anonToken",
        "",
        "isFastRetryEnabled",
        "Lru/ok/android/externcalls/sdk/api/ConversationParams;",
        "getConversationParams",
        "(Ljava/lang/String;ZLjava/lang/String;)Liai;",
        "initialJoinLink",
        "joinConversationByLink",
        "(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Liai;",
        "servers",
        "createLink",
        ...
        "startConversation",
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Liai;",
        "Lqpk;",
        "type",
        "Lby7;",
        "requestUploadUrl",
        "(Ljava/lang/String;Lqpk;Ljava/lang/String;)Liai;",
        "",
        "keys",
        "",
        "getSettingsBlocking",
        ...
        "(Lorg/json/JSONObject;)Liai;",
        "cId",
        "Ld58;",
        "reason",
        "Lru/ok/android/externcalls/sdk/api/request/HangupConversation$Response;",
        "hangupConversation",
        "(Ljava/lang/String;Ld58;Ljava/lang/String;)Liai;",
        "",
        "Lhs1$a;",
...
.field private rtcLog:Lnvf;

.field private final rxApiClient:Lbsg;

.field private timeProvider:Lxzj;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal$Companion;-><init>(Lxd5;)V
...
.method public constructor <init>(Lbsg;Lru/ok/android/externcalls/sdk/api/OkApiService;Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Lnvf;Lxzj;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lbsg;
    ...
    .line 5
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rtcLog:Lnvf;

    .line 6
    iput-object p5, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->timeProvider:Lxzj;

    return-void
.end method

.method public synthetic constructor <init>(Lbsg;Lru/ok/android/externcalls/sdk/api/OkApiService;Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Lnvf;Lxzj;ILxd5;)V
    .locals 6
    ...
    .line 8
    sget-object p4, Lnvf$a;->b:Lnvf$a;
    ...
    .line 9
    sget-object p2, Lxzj;->a:Lxzj$a;

    invoke-static {p2}, Lzzj;->c(Lxzj$a;)Lxzj;
...
.method public static synthetic getConversationParams$default(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Ljava/lang/String;ZLjava/lang/String;ILjava/lang/Object;)Liai;
    .locals 1
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->getConversationParams(Ljava/lang/String;ZLjava/lang/String;)Liai;
...
# virtual methods
.method public final getConversationParams(Ljava/lang/String;ZLjava/lang/String;)Liai;
    .locals 2
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lbsg;
    ...
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rtcLog:Lnvf;

    invoke-static {p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForFastWorkRequired(Liai;Lnvf;)Liai;
...
.method public final getExternalIdsByOkIds(Ljava/util/Collection;)Liai;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0}, Lmv3;->h0(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    :cond_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lbsg;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/api/request/BatchRequestKt;->toBatchRequest(Ljava/util/List;)Lps;

    move-result-object v1

    invoke-virtual {p1, v1}, Lbsg;->b(Lps;)Liai;

    move-result-object p1

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->timeProvider:Lxzj;
    ...
    invoke-static {p1, v1, v2}, Lzzj;->a(Liai;Lxzj;Ldt7;)Liai;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rtcLog:Lnvf;

    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForFastWorkRequired(Liai;Lnvf;)Liai;
...
.method public final getOkIdByExternalId(Ljava/lang/String;)Liai;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1, v4, v2, v3}, Lru/ok/android/externcalls/sdk/api/request/GetOkIdByExternalId$Request;-><init>(Ljava/lang/String;ZILxd5;)V
...
.method public final getOkIdsByExternalIds(Ljava/util/Collection;)Liai;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final getSettings(Ljava/util/Set;)Liai;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final getSettingsBlocking(Ljava/util/Set;)Ljava/util/Map;
    ...
    invoke-virtual {v0, v1}, Lbsg;->d(Lps;)Ljava/lang/Object;
...
.method public final hangupConversation(Ljava/lang/String;Ld58;Ljava/lang/String;)Liai;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1, p2, p3}, Lru/ok/android/externcalls/sdk/api/request/HangupConversation$Request;-><init>(Ljava/lang/String;Ld58;Ljava/lang/String;)V
...
.method public final joinConversationByLink(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Liai;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForJoining(Liai;Lnvf;)Liai;
...
.method public final joinToConversation(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Liai;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/api/request/JoinConversation$Request;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lrt7;)V

    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lbsg;

    invoke-virtual {p1, v0}, Lbsg;->b(Lps;)Liai;
...
.method public final requestUploadUrl(Ljava/lang/String;Lqpk;Ljava/lang/String;)Liai;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1, p2, p3}, Lzx7;-><init>(Ljava/lang/String;Lqpk;Ljava/lang/String;)V
...
.method public final sendSupportedCodecsStatistics(Lorg/json/JSONObject;)Liai;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForBackgroundWork(Liai;Lnvf;)Liai;
...
.method public final startConversation(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Liai;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v7}, Lru/ok/android/externcalls/sdk/api/request/StartConversation$Request;-><init>(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lwt7;)V
    ...
    invoke-static {p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForOutgoing(Liai;Lnvf;)Liai;
