...
.method public static synthetic a(Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;Ljava/util/List;Ljava/util/List;)V
    .locals 0
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;Ljava/util/List;)V
    .locals 0
...
.method private final processFeedbackForResolvedInternalIds(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Lhs1$a;
    ...
    invoke-direct/range {v4 .. v11}, Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedback;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedbackSource;ILxd5;)V
...
.method private final scheduleRemoving()V
    ...
    invoke-static {v0}, Liv3;->P(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-direct {v5, p0, v0, v1}, Lj27;-><init>(Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;J)V
...
.method private final unrollReceivedFeedback(Lhh1$a;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lhh1$a;->a()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lgh1;->b()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lgh1;->a()Ljava/lang/String;
    ...
    invoke-direct {v6, v4, v5}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;-><init>(Lhs1$a;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {v0, v3}, Liv3;->I(Ljava/util/Collection;Ljava/lang/Iterable;)Z
...
.method public onFeedback(Lhh1$a;)V
    .locals 5

    invoke-virtual {p1}, Lhh1$a;->b()Lamh;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lamh;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->unrollReceivedFeedback(Lhh1$a;)Ljava/util/List;
    ...
    invoke-virtual {v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Lhs1$a;
    ...
    invoke-direct {v3, p0, p1, v0}, Lk27;-><init>(Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;Ljava/util/List;Ljava/util/List;)V

    new-instance p1, Ll27;

    invoke-direct {p1, p0, v0}, Ll27;-><init>(Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;Ljava/util/List;)V
