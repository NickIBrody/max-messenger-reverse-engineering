...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "listener",
        "notifyNewListener",
        "(Lah1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V",
        "addFeatureListener",
        ...
        "(Lah1;)Z",
        "getFeatureRoles",
        "(Lah1;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;",
        "Leh1;",
        "onFeatureSetChanged",
        "(Leh1;)V",
...
.method private final getFeaturesRolesMap(Lfh1;)Ljava/util/Map;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lfh1;->a()Ljava/util/Map;
...
.method private final notifyListenersWithNewEnabledFeatures(Ljava/util/Set;Ljava/util/Set;)V
    ...
    invoke-interface {v3, v1, v4}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Lah1;Z)V
    ...
    invoke-interface {v1, p2, v2}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Lah1;Z)V
...
.method private final notifyListenersWithNewFeaturesRoles(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-interface {v3, v1, v5}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureRolesChanged(Lah1;Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;)V
...
.method private final notifyNewListener(Lah1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 1

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->isFeatureEnabled(Lah1;)Z

    move-result v0

    invoke-interface {p2, p1, v0}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Lah1;Z)V

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->getFeatureRoles(Lah1;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;

    move-result-object v0

    invoke-interface {p2, p1, v0}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureRolesChanged(Lah1;Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;)V
...
# virtual methods
.method public addFeatureListener(Lah1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->notifyNewListener(Lah1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V

    return-void
.end method

.method public getFeatureRoles(Lah1;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;
    .locals 2
...
.method public isFeatureEnabled(Lah1;)Z
    .locals 1
...
.method public final onFeatureSetChanged(Leh1;)V
    .locals 1

    invoke-virtual {p1}, Leh1;->a()Ljava/util/Set;
...
.method public final onFeaturesPerRoleChanged(Lfh1;)V
    .locals 1

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->getFeaturesRolesMap(Lfh1;)Ljava/util/Map;
...
.method public removeFeatureListener(Lah1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 1
