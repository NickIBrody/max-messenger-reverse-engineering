...
.field private badNetworkIndicatorConfig:Lql0;

.field private bitrates:Lgs1$a;
...
.field protected final experiments:Ll0c;

.field private fastRecoverEnabled:Z

.field private forceRelayPolicy:Z

.field private groupCallMediaAdaptationConfig:Li6a;
...
.field joinConversationDelegate:Lq39;

.field protected log:Lnvf;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Long;

    const-string v1, "sdk-0.1.18"
    ...
    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Lgs1$a;
    ...
    sget-object v2, Lql0;->f:Lql0;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lql0;

    iput-boolean v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->logExperimentChanges:Z

    sget-object v0, Lnvf$a;->b:Lnvf$a;
    ...
    invoke-direct {v2, p0}, Lus4;-><init>(Lru/ok/android/externcalls/sdk/ConversationFactoryParams;)V

    invoke-direct {v0, v2}, Ll0c;-><init>(Ldt7;)V

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->experiments:Ll0c;
...
.method public static synthetic a(Lru/ok/android/externcalls/sdk/ConversationFactoryParams;Lbt7;)Lpkk;
    .locals 1
...
.method public getBaseBuilder(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->experiments:Ll0c;

    invoke-direct {v1, p1, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Ll0c;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Lgs1$a;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBitrates(Lgs1$a;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Long;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setRotationProvider(Long;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->p2pCallMediaAdaptationConfig:Li6a;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setP2PCallMediaAdaptationConfig(Li6a;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->groupCallMediaAdaptationConfig:Li6a;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setGroupCallMediaAdaptationConfig(Li6a;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lql0;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBadNetworkIndicatorConfig(Lql0;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object p1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->screenCapturePermissionProvider:Lf0h;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setScreenCapturePermissionProvider(Lf0h;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
...
.method public setBadNetworkIndicatorConfig(Lql0;)V
    .locals 0

    if-nez p1, :cond_0

    sget-object p1, Lql0;->f:Lql0;

    :cond_0
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lql0;

    return-void
.end method

.method public setBitrates(Lgs1$a;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Lgs1$a;
...
.method public setGroupCallMediaAdaptationConfig(Li6a;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->groupCallMediaAdaptationConfig:Li6a;
...
.method public setJoinConversationDelegate(Lq39;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->joinConversationDelegate:Lq39;
...
.method public setP2PCallMediaAdaptationConfig(Li6a;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->p2pCallMediaAdaptationConfig:Li6a;
...
.method public setRotationProvider(Long;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Long;
...
.method public setScreenCapturePermissionProvider(Lf0h;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->screenCapturePermissionProvider:Lf0h;
