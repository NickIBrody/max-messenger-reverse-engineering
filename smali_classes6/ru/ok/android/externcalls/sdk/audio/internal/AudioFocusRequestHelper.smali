...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "onFocusGained",
        "<init>",
        "(Landroid/media/AudioManager;Lru/ok/android/externcalls/sdk/audio/CallsAudioManager$OnMuteListener;Landroid/os/Handler;Landroid/os/Handler;Lbt7;Lru/ok/android/externcalls/sdk/audio/Logger;Lbt7;Lbt7;)V",
        "T",
        "context",
        "",
        "requestResult",
...
.field private final isDestroyed:Lbt7;
...
.field private final onFocusGained:Lbt7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lbt7;"
        }
...
.field private final onFocusLost:Lbt7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lbt7;"
        }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper$Companion;-><init>(Lxd5;)V
...
.method public constructor <init>(Landroid/media/AudioManager;Lru/ok/android/externcalls/sdk/audio/CallsAudioManager$OnMuteListener;Landroid/os/Handler;Landroid/os/Handler;Lbt7;Lru/ok/android/externcalls/sdk/audio/Logger;Lbt7;Lbt7;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    iput-object p5, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->isDestroyed:Lbt7;
    ...
    .line 8
    iput-object p7, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->onFocusLost:Lbt7;

    .line 9
    iput-object p8, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->onFocusGained:Lbt7;

    return-void
.end method

.method public synthetic constructor <init>(Landroid/media/AudioManager;Lru/ok/android/externcalls/sdk/audio/CallsAudioManager$OnMuteListener;Landroid/os/Handler;Landroid/os/Handler;Lbt7;Lru/ok/android/externcalls/sdk/audio/Logger;Lbt7;Lbt7;ILxd5;)V
    .locals 11
    ...
    .line 12
    :goto_2
    invoke-direct/range {v2 .. v10}, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;-><init>(Landroid/media/AudioManager;Lru/ok/android/externcalls/sdk/audio/CallsAudioManager$OnMuteListener;Landroid/os/Handler;Landroid/os/Handler;Lbt7;Lru/ok/android/externcalls/sdk/audio/Logger;Lbt7;Lbt7;)V
...
.method private final handleAudioFocusRequestResult(Ljava/lang/Object;I)Ljava/lang/Object;
    ...
    invoke-direct {p2, p0}, Lt90;-><init>(Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;)V
...
.method private final handleFocusUpdate(ZZ)V
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->onFocusGained:Lbt7;
    ...
    :cond_1
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->onFocusLost:Lbt7;
...
.method private final mute()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;->isDestroyed:Lbt7;
    ...
    invoke-direct {v1, p0}, Lq90;-><init>(Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;)V
...
.method private final muteForever()V
    ...
    invoke-direct {v1, p0}, Lp90;-><init>(Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;)V
...
.method private final unmute()V
    ...
    invoke-direct {v1, p0}, Ls90;-><init>(Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;)V
...
.method public final requestFocus()V
    ...
    invoke-direct {v0, p0}, Lr90;-><init>(Lru/ok/android/externcalls/sdk/audio/internal/AudioFocusRequestHelper;)V
