...
# instance fields
.field private final conversation:Lbt7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lbt7;"
        }
...
.field private final factory:Ldt7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ldt7;"
        }
...
.field private final onOwnCameraRendererSet:Lbt7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lbt7;"
        }
...
.method public constructor <init>(Lbt7;Ldt7;Lbt7;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->conversation:Lbt7;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->factory:Ldt7;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->onOwnCameraRendererSet:Lbt7;
...
.method public createVideoViewInstance(Landroid/content/Context;)Landroid/view/View;
    ...
    .line 2
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->factory:Ldt7;
...
.method public getOwnVideoTrack()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->conversation:Lbt7;
...
.method public setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Landroid/view/View;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    sget-object v2, Lkcl;->VIDEO:Lkcl;

    if-ne v1, v2, :cond_3

    .line 10
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->onOwnCameraRendererSet:Lbt7;
    ...
    invoke-interface {p1}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Lru/ok/android/webrtc/opengl/a;
    ...
    invoke-interface {p2, p1, v0, p3}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init(Lru/ok/android/webrtc/opengl/a;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)Z
