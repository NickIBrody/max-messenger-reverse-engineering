...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "store",
        "<init>",
        "(Lbt7;Lx91;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V",
        "Lo42;",
        "key",
        "",
...
.field private final state:Lbt7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lbt7;"
        }
...
# direct methods
.method public constructor <init>(Lbt7;Lx91;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lbt7;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lx91;
...
.method private final setRenderers(Lo42;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final setRenderersForMe(Lo42;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lx91;

    invoke-virtual {p1, p2}, Lx91;->j2(Ljava/util/List;)V

    return-void

    :cond_1
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderers(Lo42;Ljava/util/List;)V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lx91;

    invoke-virtual {v0, p1, p2}, Lx91;->p2(Lo42;Ljava/util/List;)V
    ...
    :goto_1
    invoke-virtual {p1, p2}, Lx91;->k2(Lorg/webrtc/VideoSink;)V

    return-void
.end method

.method private final setRenderersForOthers(Lo42;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getCallRenderer()Lru/ok/android/webrtc/opengl/a;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lbt7;
    ...
    iget-object v0, v0, Lx91;->s:Lru/ok/android/webrtc/opengl/a;
...
.method public getEglBaseContext()Lorg/webrtc/EglBase$Context;
    ...
    iget-object v0, v0, Lx91;->r:Lorg/webrtc/EglBase;
...
.method public getRemoteVideoRenderers(Lhs1$a;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public setRenderers(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Ljava/util/List;)V
    ...
    invoke-direct {v1}, Lo42$a;-><init>()V
    ...
    invoke-virtual {v1, v2}, Lo42$a;->d(Lkcl;)Lo42$a;
    ...
    invoke-virtual {v1, v2}, Lo42$a;->c(Lhs1$a;)Lo42$a;

    move-result-object v1

    .line 6
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Lbub;

    move-result-object v2

    invoke-virtual {v1, v2}, Lo42$a;->b(Lbub;)Lo42$a;

    move-result-object v1

    .line 7
    invoke-virtual {v1}, Lo42$a;->a()Lo42;
    ...
    .line 10
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForMe(Lo42;Ljava/util/List;)V

    return-void

    .line 11
    :cond_1
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForOthers(Lo42;Ljava/util/List;)V
