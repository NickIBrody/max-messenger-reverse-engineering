...
.field private final sender:Ldt7;
...
.field private final store:Ldt7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ldt7;"
        }
...
# direct methods
.method public constructor <init>(Ldt7;Ldt7;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Ldt7;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Ldt7;
...
.method public sendDisplayLayouts(Ljava/util/Collection;)V
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Ldt7;
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lkcl;
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Ldt7;
    ...
    invoke-virtual {v4, v3}, Lo42$a;->c(Lhs1$a;)Lo42$a;

    move-result-object v3

    invoke-virtual {v3, v2}, Lo42$a;->d(Lkcl;)Lo42$a;
    ...
    invoke-virtual {v3}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Lbub;

    move-result-object v3

    invoke-virtual {v2, v3}, Lo42$a;->b(Lbub;)Lo42$a;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationDisplayLayoutItem;->getLayout()Lr3l;

    move-result-object v1

    invoke-direct {v3, v2, v1}, Lrf1;-><init>(Lo42;Lr3l;)V
