...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "logger",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lnvf;)V",
        "Lamh;",
        "roomId",
        "Le8i;",
        "info",
        ...
        "(Lamh;Lru/ok/android/externcalls/sdk/id/ParticipantId;Ljava/lang/String;)V",
        "reportForActiveRoom",
        "()V",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl$Companion;-><init>(Lxd5;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lnvf;)V
    .locals 0
    ...
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->logger:Lnvf;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->activeRoomId:Lamh;
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;Le8i;Lamh;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->saveUrlSharing$lambda$0(Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;Le8i;Lamh;)V
...
.method private final reportForActiveRoom()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->activeRoomId:Lamh;
...
.method private final saveUrlSharing(Lamh;Le8i;)V
    .locals 3
    ...
    invoke-virtual {p2}, Le8i;->a()Lhs1$a;
    ...
    invoke-virtual {p2}, Le8i;->b()Ljava/lang/String;

    move-result-object p2

    invoke-direct {p0, p1, v0, p2}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->saveUrlSharingWithId(Lamh;Lru/ok/android/externcalls/sdk/id/ParticipantId;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0, p2, p1}, Lvrk;-><init>(Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;Le8i;Lamh;)V

    new-instance p1, Lwrk;

    invoke-direct {p1, p0}, Lwrk;-><init>(Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;)V
...
.method private static final saveUrlSharing$lambda$0(Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;Le8i;Lamh;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->idMappingWrapper:Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;

    invoke-virtual {p1}, Le8i;->a()Lhs1$a;
    ...
    :cond_0
    invoke-virtual {p1}, Le8i;->b()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p2, v0, p1}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->saveUrlSharingWithId(Lamh;Lru/ok/android/externcalls/sdk/id/ParticipantId;Ljava/lang/String;)V
...
.method private static final saveUrlSharing$lambda$1(Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->logger:Lnvf;
...
.method private final saveUrlSharingWithId(Lamh;Lru/ok/android/externcalls/sdk/id/ParticipantId;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->activeRoomId:Lamh;
...
.method public onCurrentParticipantActiveRoomChanged(Lby1$a;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->activeRoomId:Lamh;
...
.method public onUrlSharingInfoUpdated(Lq12$a;)V
    .locals 3

    invoke-virtual {p1}, Lq12$a;->a()Le8i;
    ...
    invoke-virtual {p1}, Lq12$a;->b()Lamh;
    ...
    invoke-direct {p0, p1, v0}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/listener/UrlSharingListenerManagerImpl;->saveUrlSharing(Lamh;Le8i;)V
