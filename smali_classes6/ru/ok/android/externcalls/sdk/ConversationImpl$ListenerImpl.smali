...
.method private handleCallAccepted(Lhs1;)V
    .locals 3
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lhs1;
...
.method private handleHangup(Lx91;Ljava/lang/Object;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    iget-object v1, p1, Lx91;->K:Ld58;

    invoke-static {v0, v1, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->C0(Lru/ok/android/externcalls/sdk/ConversationImpl;Ld58;Ljava/lang/Object;)Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;
    ...
    iget-object v1, p1, Lx91;->i1:Ltf1;

    invoke-virtual {v1}, Ltf1;->a()Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;
...
.method private handleMuteParticipant(Lt1c;)V
    .locals 2

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->shouldNotifyLegacyListener(Lt1c;)Z
    ...
    invoke-virtual {p1}, Lt1c;->a()Ls1c;

    move-result-object v1

    invoke-interface {v0, v1}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteChanged(Ls1c;)V
    ...
    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteChanged(Ls1c;)V

    return-void
.end method

.method private handleMuteStateInitialized(Lt1c;)V
    .locals 2

    invoke-virtual {p1}, Lt1c;->b()Z
    ...
    invoke-interface {v0, v1}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteStateInitialized(Ls1c;)V
    ...
    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteStateInitialized(Ls1c;)V

    return-void
.end method

.method private handleRolesChanged(Lhs1;)V
    .locals 2
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lhs1;
    ...
    invoke-virtual {v0, p1, v1}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lhs1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    invoke-virtual {v1, p1}, Lhs1$a;->equals(Ljava/lang/Object;)Z
...
.method private maybeInitP2PRelaySwitchTrigger()V
    ...
    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->h0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lau6;

    move-result-object v0

    invoke-interface {v0}, Lau6;->V()Z
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->p0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lnvf;

    move-result-object v1

    invoke-direct {v7, v0, v1}, Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfigProviderImpl;-><init>(Lru/ok/android/externcalls/sdk/api/RemoteSettings;Lnvf;)V
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->b0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lx91;
    ...
    invoke-direct {v5, v1}, Lyt4;-><init>(Lx91;)V
    ...
    invoke-direct/range {v2 .. v7}, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;-><init>(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitor;Lnvf;Lbt7;Lru/ok/android/externcalls/sdk/stat/ConversationStats;Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfigProvider;)V
...
.method private shouldNotifyLegacyListener(Lt1c;)Z
    .locals 5
    ...
    :cond_1
    invoke-virtual {p1}, Ls1c;->b()Ljava/util/Set;
    ...
    :cond_3
    sget-object v4, Ltla;->UNMUTED:Ltla;
...
.method public onCallParticipantFingerprint(Lhs1;J)V
    .locals 2
    ...
    invoke-virtual {v0}, Lx91;->M0()Lhs1;
...
.method public onCallParticipantNetworkStatusChanged(Ljava/util/List;)V
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lhs1$a;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {v2, v1, v3}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lhs1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    invoke-virtual {v1, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lamh;
    ...
    invoke-virtual {v3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lamh;
...
.method public onCustomData(Lhs1$a;Lorg/json/JSONObject;)V
    .locals 0
...
.method public onEvent(Lx91;Ldg1;Ljava/lang/Object;)V
    .locals 4

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->p0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lnvf;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->onFeaturesPerRoleChanged(Lfh1;)V

    return-void

    :pswitch_3
    instance-of p1, p3, Leh1;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->onFeatureSetChanged(Leh1;)V

    return-void

    :pswitch_4
    instance-of p1, p3, Llub;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStopped(Llub;)V

    return-void

    :pswitch_5
    instance-of p1, p3, Lkub;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStatesUpdatedChanged(Lkub;)V

    return-void

    :pswitch_6
    instance-of p1, p3, Liub;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStarted(Liub;)V
    ...
    :pswitch_9
    instance-of p1, p3, Lt1c;

    if-eqz p1, :cond_4

    check-cast p3, Lt1c;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteStateInitialized(Lt1c;)V
    ...
    :pswitch_c
    instance-of p1, p3, Lhs1$a;

    if-eqz p1, :cond_0

    check-cast p3, Lhs1$a;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lhs1$a;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    sget-object p3, Ldg1;->PIN_PARTICIPANT_INITIATOR:Ldg1;
    ...
    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteParticipant(Lt1c;)V
    ...
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lhs1;)V

    goto :goto_1

    :pswitch_f
    instance-of p1, p3, Lhs1;

    if-eqz p1, :cond_4

    check-cast p3, Lhs1;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lhs1;)V
    ...
    :pswitch_11
    invoke-virtual {p1, v1}, Lx91;->l2(Z)V
    ...
    :pswitch_12
    invoke-virtual {p1, v2}, Lx91;->l2(Z)V
    ...
    iget-object v0, p1, Lx91;->i1:Ltf1;
    ...
    invoke-static {p2, v2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->A0(Lru/ok/android/externcalls/sdk/ConversationImpl;Z)V
    ...
    invoke-static {p3}, Lru/ok/android/externcalls/sdk/ConversationImpl;->Y(Lru/ok/android/externcalls/sdk/ConversationImpl;)I

    move-result p3

    int-to-long v0, p3

    invoke-virtual {p1, p2, v0, v1}, Lx91;->R1(Lvpb;J)V
    ...
    :cond_3
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleCallAccepted(Lhs1;)V
    ...
    sget-object v0, Ld58;->CANCELED:Ld58;

    sget-object v1, Ljava/util/Collections;->EMPTY_SET:Ljava/util/Set;

    invoke-direct {p3, v0, v1, v3}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;-><init>(Ld58;Ljava/util/Set;Ljava/lang/String;)V
    ...
    iget-object p2, p1, Lx91;->i1:Ltf1;
    ...
    invoke-virtual {p2, p3}, Ltf1;->b(Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;)V
    ...
    :pswitch_1e
    invoke-direct {p0, p1, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleHangup(Lx91;Ljava/lang/Object;)V
...
.method public onStateChanged(Lhs1$a;Lhs1$b;)V
    .locals 2
    ...
    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->fromInternal(Lhs1$a;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-interface {v1, v0, p2}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onStateChanged(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lhs1$b;)V
    ...
    invoke-virtual {v0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/state/internal/ParticipantStatesManagerImpl;->onStateChanged(Lhs1$a;Lhs1$b;)V
