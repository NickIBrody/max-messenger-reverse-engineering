...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sessionRoomId",
        "withSessionRoomId",
        "(Lamh;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;",
        "",
        "name",
        "withName",
        ...
        "onSuccess",
        "withCallOnSuccess",
        "(Ldt7;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;",
        "",
        "onError",
        "withCallOnError",
...
.field private sessionRoomId:Lamh;
...
.method public final build()Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->sessionRoomId:Lamh;
    ...
    iget-object v9, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onSuccess:Ldt7;

    iget-object v10, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onError:Ldt7;

    new-instance v0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;

    const/4 v11, 0x0

    invoke-direct/range {v0 .. v11}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;-><init>(ZLjava/lang/Long;Ljava/lang/String;Lamh;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Long;Ljava/lang/String;Ldt7;Ldt7;Lxd5;)V
...
.method public final withCallOnError(Ldt7;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onError:Ldt7;

    return-object p0
.end method

.method public final withCallOnSuccess(Ldt7;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onSuccess:Ldt7;
...
.method public final withSessionRoomId(Lamh;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->sessionRoomId:Lamh;
