...
# instance fields
.field private final lossCalc:Lyv9;
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$LossCalculator;->lossCalc:Lyv9;
...
.method private final calculateLoss(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$LossCalculator;->lossCalc:Lyv9;
    ...
    invoke-virtual {v0, v1, v2, p1, p2}, Lyv9;->d(JJ)D
...
.method private final synthetic findSender(Ljava/util/List;)Lnji$h;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {v2, v3}, Ljy8;->i(ILjava/lang/String;)V
    ...
    iget-object v1, v1, Lnji$h;->n:Ljava/lang/Boolean;
...
.method public final synthetic getLoss(Ljava/util/List;)Ljava/lang/Float;
    ...
    iget-object p1, v0, Lnji$h;->i:Ljava/math/BigInteger;

    iget-object v0, v0, Lnji$h;->h:Ljava/math/BigInteger;
