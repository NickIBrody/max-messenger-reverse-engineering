...
.method public constructor <init>(Lbt7;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidateAddFailedStat;->getEventualStatSender:Lbt7;
...
# virtual methods
.method public final report(Luf8;)V
    .locals 5

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidateAddFailedStat;->getEventualStatSender:Lbt7;
    ...
    invoke-virtual {p1}, Luf8;->b()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Luf8;->c()Ljava/lang/String;
