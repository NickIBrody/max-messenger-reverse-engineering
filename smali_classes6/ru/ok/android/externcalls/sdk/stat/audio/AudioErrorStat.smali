...
.method public constructor <init>(Lbt7;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/stat/audio/AudioErrorStat;->getEventualStatSender:Lbt7;
...
# virtual methods
.method public final report(Ld90;)V
    .locals 4

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/audio/AudioErrorStat;->getEventualStatSender:Lbt7;
    ...
    invoke-virtual {p1}, Ld90;->b()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Ld90;->a()Ljava/lang/String;
