...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lpkk;",
        "tryToReport",
        "(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Liue;Lnvf;)V",
...
.method static constructor <clinit>()V
    ...
    filled-new-array/range {v2 .. v8}, [Lxpd;
...
.method public static synthetic b(Liue;)Ljava/lang/Long;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/stat/supportedcodecs/SupportedCodecsStatistics;->tryToReport$lambda$0(Liue;)Ljava/lang/Long;
...
.method private final buildCodecLists()Lorg/json/JSONObject;
    ...
    invoke-static {v6}, Ly8a;->a(Landroid/media/MediaCodecInfo;)Z
...
.method public static final tryToReport(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Liue;Lnvf;)V
    .locals 7
    ...
    invoke-direct {v0, p1}, Lubj;-><init>(Liue;)V
    ...
    invoke-direct/range {v1 .. v6}, Lru/ok/android/externcalls/sdk/stat/supportedcodecs/SupportedCodecsStatistics$tryToReport$2;-><init>(JLnvf;Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Liue;)V

    invoke-virtual {v0, v1}, Liai;->q(Lxt7;)Ly14;
    ...
    invoke-virtual {p0, p1}, Ly14;->l(Lzyg;)Ly14;

    move-result-object p0

    new-instance p1, Lvbj;

    invoke-direct {p1}, Lvbj;-><init>()V

    new-instance p2, Lru/ok/android/externcalls/sdk/stat/supportedcodecs/SupportedCodecsStatistics$tryToReport$4;

    invoke-direct {p2, v4}, Lru/ok/android/externcalls/sdk/stat/supportedcodecs/SupportedCodecsStatistics$tryToReport$4;-><init>(Lnvf;)V

    invoke-virtual {p0, p1, p2}, Ly14;->j(Lt8;Lkd4;)Ltx5;

    return-void
.end method

.method private static final tryToReport$lambda$0(Liue;)Ljava/lang/Long;
    .locals 2

    const-string v0, "supportedCodecsLastUpdate"

    invoke-virtual {p0, v0}, Liue;->f(Ljava/lang/String;)J
