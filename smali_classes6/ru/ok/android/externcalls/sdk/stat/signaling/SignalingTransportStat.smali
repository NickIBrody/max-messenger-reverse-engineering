...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat$Companion;-><init>(Lxd5;)V
...
.method public constructor <init>(Lbt7;Lxzj;Lnvf;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->getEventualStatSender:Lbt7;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->timeProvider:Lxzj;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->log:Lnvf;
    ...
    invoke-direct {p3, p2}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTracker;-><init>(Lxzj;)V
    ...
    invoke-direct {p1, p2}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTracker;-><init>(Lxzj;)V
...
.method private final addCommonStats(Lru/ok/android/externcalls/analytics/events/EventItemsMap;Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTracker$StatisticsInfo;)V
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->log:Lnvf;

    const-string v4, "SignalingTransportStat"

    const-string v5, "issue with OnlineQuantilesApproximator"

    invoke-interface {v3, v4, v5, v2}, Lnvf;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private final onFailed()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->timeProvider:Lxzj;
...
.method private final report(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    .line 1
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->getEventualStatSender:Lbt7;
...
.method private final reportCommandSummary()V
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->getEventualStatSender:Lbt7;
    ...
    invoke-static/range {v3 .. v8}, Log1;->a(Log1;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;ILjava/lang/Object;)V
...
.method private final reportPingSummary()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->getEventualStatSender:Lbt7;
...
.method public onCommandSent(Lu7i$b;Ljava/lang/String;Z)V
    .locals 0
...
.method public onConnect(Lu7i$b;)V
    .locals 2

    iget-object p1, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->timeProvider:Lxzj;
...
.method public onConnected(Lu7i$b;)V
    .locals 4
    ...
    sget-object v2, Lu7i$a;->RECONNECTED:Lu7i$a;

    invoke-virtual {p1, v2}, Lu7i$b;->a(Lu7i$a;)Ljava/lang/String;
    ...
    sget-object v2, Lu7i$a;->CONNECTED:Lu7i$a;
...
.method public onDisconnectedSuccessfully(Lu7i$b;)V
    .locals 0
...
.method public onFailedByException(Lu7i$b;Ljava/lang/Throwable;)V
    .locals 2
    ...
    invoke-static {v0, p2}, Lf6j;->F1(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object p2

    sget-object v0, Lu7i$a;->FAILED_BY_EXCEPTION:Lu7i$a;

    invoke-virtual {p1, v0}, Lu7i$b;->a(Lu7i$a;)Ljava/lang/String;
...
.method public onFailedByPings(Lu7i$b;)V
    .locals 4
    ...
    sget-object v2, Lu7i$a;->FAILED_BY_PINGS:Lu7i$a;
...
.method public onMessageReceived(Lu7i$b;Ljava/lang/String;Z)V
    .locals 2
...
.method public onRestart(Lu7i$b;)V
    .locals 2

    sget-object v0, Lu7i$a;->RESTART:Lu7i$a;
...
.method public onTimeout(Lu7i$b;)V
    .locals 4
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->timeProvider:Lxzj;
    ...
    :goto_0
    sget-object v1, Lu7i$a;->TIMEOUT:Lu7i$a;

    invoke-virtual {p1, v1}, Lu7i$b;->a(Lu7i$a;)Ljava/lang/String;
