...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lamh;

    move-result-object p1

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/asr/internal/listeners/AsrListenerManagerImpl;->activeRoomId:Lamh;
...
.method public final getAsrInfo()Lru/ok/android/externcalls/sdk/asr/AsrInfo;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/asr/internal/listeners/AsrListenerManagerImpl;->activeRoomId:Lamh;
...
.method public onAsrRecordStarted(Lub1$a;)V
    .locals 3

    invoke-virtual {p1}, Lub1$a;->a()Ltb1;

    move-result-object v0

    invoke-virtual {v0}, Ltb1;->a()Lhs1$a;

    move-result-object v0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/asr/internal/listeners/AsrListenerManagerImpl;->store:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;
    ...
    :cond_0
    new-instance v1, Lru/ok/android/externcalls/sdk/asr/AsrInfo;

    invoke-virtual {p1}, Lub1$a;->a()Ltb1;

    move-result-object v2

    invoke-virtual {v2}, Ltb1;->b()Ljava/lang/Long;

    move-result-object v2

    invoke-direct {v1, v0, v2}, Lru/ok/android/externcalls/sdk/asr/AsrInfo;-><init>(Lru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/lang/Long;)V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/asr/internal/listeners/AsrListenerManagerImpl;->sessionRoomToAsrInfo:Ljava/util/HashMap;

    invoke-virtual {p1}, Lub1$a;->b()Lamh;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/asr/internal/listeners/AsrListenerManagerImpl;->activeRoomId:Lamh;
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/asr/internal/listeners/AsrListenerManagerImpl;->notifyAsrRecordStarted(Lru/ok/android/externcalls/sdk/asr/AsrInfo;)V
...
.method public onAsrRecordStopped(Lub1$b;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/asr/internal/listeners/AsrListenerManagerImpl;->sessionRoomToAsrInfo:Ljava/util/HashMap;

    invoke-virtual {p1}, Lub1$b;->a()Lamh;
