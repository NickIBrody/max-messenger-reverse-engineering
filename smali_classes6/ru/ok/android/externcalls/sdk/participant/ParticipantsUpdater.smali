...
.method public onActiveParticipantUpdated(Lba1$e;)V
    ...
    invoke-virtual {p1}, Lba1$e;->d()Lamh;

    move-result-object v1

    invoke-virtual {p1}, Lba1$e;->c()Lhlh;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setActiveSessionRoom(Lamh;Lhlh;)V
    ...
    invoke-static {p1}, Lrhk;->a(Ljava/lang/Object;)Ljava/util/Collection;
...
.method public onCallParticipantsAdded(Los1$a;)V
    ...
    invoke-virtual {v3}, Lhs1;->k()Lhs1$a;
    ...
    :cond_0
    invoke-virtual {v4, v5}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lhs1$a;)Lru/ok/android/externcalls/sdk/ConversationParticipant;

    move-result-object v4

    invoke-virtual {v3}, Lhs1;->h()Lqg1;

    move-result-object v5

    invoke-static {v5}, Lru/ok/android/externcalls/sdk/id/CallExternalIdConverter;->convert(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-virtual {v6, v5, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lhs1$a;)V
    ...
    invoke-virtual {v5}, Lhs1;->k()Lhs1$a;
    ...
    invoke-static {v3, v2}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->createConversationParticipantFromInternal(Lhs1$a;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-static {v2, v5, v3}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->setCallParticipantExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lhs1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/participant/ParticipantsUpdater;->store:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    invoke-virtual {p1}, Los1$a;->b()Lamh;

    move-result-object v5

    invoke-virtual {v3, v2, v5}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lamh;)V
    ...
    invoke-static {v3, v5, v4}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->setCallParticipantExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lhs1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
...
.method public onCallParticipantsChanged(Los1$b;)V
    ...
    invoke-static {v2, v1, v3}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->setCallParticipantExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lhs1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    :cond_3
    invoke-virtual {v1}, Lhs1;->h()Lqg1;

    move-result-object v2

    invoke-static {v2}, Lru/ok/android/externcalls/sdk/id/CallExternalIdConverter;->convert(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method public onCallParticipantsDeAnonimized(Los1$c;)V
    ...
    :cond_1
    invoke-virtual {v3, v4}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lhs1$a;)Lru/ok/android/externcalls/sdk/ConversationParticipant;

    move-result-object v3

    invoke-virtual {v2}, Lhs1;->h()Lqg1;
    ...
    invoke-virtual {v4}, Lqg1;->b()Ljava/lang/String;
    ...
    invoke-static {v4}, Lru/ok/android/externcalls/sdk/id/CallExternalIdConverter;->convert(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method public onCallParticipantsRemoved(Los1$d;)V
    ...
    invoke-virtual {v4, v3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lhs1$a;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-static {v4, v2, v5}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->setCallParticipantExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lhs1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
...
.method public onCurrentParticipantActiveRoomChanged(Lby1$a;)V
    ...
    invoke-virtual {v0, v1, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setActiveSessionRoom(Lamh;Lhlh;)V
...
.method public onCurrentParticipantInvitedToRoom(Lby1$b;)V
    ...
    invoke-virtual {v0, v1, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setProposedSessionRoom(Lamh;Lhlh;)V
...
.method public onRoomRemoved(Lby1$c;)V
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getProposedRoomId()Lamh;
    ...
    invoke-virtual {v0, v2, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setProposedSessionRoom(Lamh;Lhlh;)V
    ...
    sget-object v0, Lamh$a;->a:Lamh$a;

    invoke-virtual {p1, v0, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setActiveSessionRoom(Lamh;Lhlh;)V
...
.method public onRoomUpdated(Lby1$d;)V
    ...
    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->maybeUpdateRoom(Lhlh;)V
