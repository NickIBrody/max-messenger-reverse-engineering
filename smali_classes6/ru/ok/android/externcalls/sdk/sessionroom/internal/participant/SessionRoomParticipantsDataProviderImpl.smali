...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lamh;Ljava/util/Collection;)Ljava/util/Collection;",
        "internalId",
        "mapInternalIdToSessionRoomParticipant",
        "(Lhs1$a;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;",
        ...
        "(Ljava/util/Collection;Lbt7;Ldt7;)V",
        "getRoomParticipants",
        "(Lamh;Ldt7;Ldt7;)V",
...
.method public static synthetic a(Ldt7;)V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds$lambda$9(Ldt7;)V
...
.method public static final synthetic access$getRoomParticipantIds(Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lamh$b;)Ljava/util/Collection;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getRoomParticipantIds(Lamh$b;)Ljava/util/Collection;
...
.method public static final synthetic access$mapInternalIdsToSessionRoomParticipants(Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lamh;Ljava/util/Collection;)Ljava/util/Collection;
    .locals 0

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->mapInternalIdsToSessionRoomParticipants(Lamh;Ljava/util/Collection;)Ljava/util/Collection;
...
.method public static synthetic b(Ldt7;Ldt7;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lhs1$a;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal$lambda$0(Ldt7;Ldt7;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lhs1$a;)V

    return-void
.end method

.method public static synthetic c(Ldt7;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal$lambda$1(Ldt7;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
...
.method public static synthetic d(Lbt7;)V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds$lambda$8(Lbt7;)V
...
.method private final getAllRoomParticipantIds()Ljava/util/Collection;
    ...
    invoke-virtual {v2}, Lhlh;->b()Ljava/util/List;
...
.method private final getMainCallParticipantIds(Ldt7;Ldt7;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lamh;)Ljava/util/Collection;
    ...
    invoke-direct {v0, v1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants;-><init>(Lamh;Ljava/util/Collection;)V
...
.method private final getRoomParticipantIds(Lamh$b;)Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lhlh;->b()Ljava/util/List;
...
.method private final getUnresolvedExternalIds(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lhs1$a;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final mapConversationParticipantToSessionRoomParticipant(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    ...
    invoke-virtual {v2, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lamh;

    move-result-object v2

    invoke-direct {v0, v1, v2, p1}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lamh;Lru/ok/android/externcalls/sdk/ConversationParticipant;)V

    return-object v0
.end method

.method private final mapInternalIdToSessionRoomParticipant(Lhs1$a;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    .locals 2
    ...
    invoke-direct {v1, p1, v0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lamh;Lru/ok/android/externcalls/sdk/ConversationParticipant;)V
...
.method private final mapInternalIdsToSessionRoomParticipants(Lamh;Ljava/util/Collection;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->mapInternalIdToSessionRoomParticipant(Lhs1$a;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    ...
    invoke-virtual {p2, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lamh;)Ljava/util/Collection;
...
.method private static final resolveInternalIdByExternal$lambda$0(Ldt7;Ldt7;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lhs1$a;)V
    .locals 1
...
.method private static final resolveInternalIdByExternal$lambda$1(Ldt7;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
    .locals 3
...
.method private final resolveParticipantIds(Ljava/util/Collection;Lbt7;Ldt7;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2}, Lhmh;-><init>(Lbt7;)V

    new-instance p2, Limh;

    invoke-direct {p2, p3}, Limh;-><init>(Ldt7;)V
...
.method private static final resolveParticipantIds$lambda$8(Lbt7;)V
    .locals 0
...
.method private static final resolveParticipantIds$lambda$9(Ldt7;)V
    .locals 2
...
# virtual methods
.method public getAllInRoomParticipants(Ldt7;Ldt7;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, v0, p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl$getAllInRoomParticipants$1;-><init>(Ljava/util/Set;Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Ldt7;)V

    invoke-direct {p0, v1, v2, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds(Ljava/util/Collection;Lbt7;Ldt7;)V
...
.method public final getInternalIdsByExternal(Ljava/util/Collection;)Ljava/util/Map;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lhs1$a;
...
.method public getParticipantRoomId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ldt7;Ldt7;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lamh;
...
.method public getRoomParticipants(Lamh;Ldt7;Ldt7;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    instance-of v0, p1, Lamh$a;

    if-eqz v0, :cond_0

    invoke-direct {p0, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getMainCallParticipantIds(Ldt7;Ldt7;)V
    ...
    check-cast v0, Lamh$b;

    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getRoomParticipantIds(Lamh$b;)Ljava/util/Collection;
    ...
    invoke-direct {v1, p2, p1, p0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl$getRoomParticipants$1;-><init>(Ldt7;Lamh;Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Ljava/util/Collection;)V

    invoke-direct {p0, v0, v1, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds(Ljava/util/Collection;Lbt7;Ldt7;)V

    :cond_1
    return-void
.end method

.method public final resolveInternalIdByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ldt7;Ldt7;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2, p3, p1}, Ljmh;-><init>(Ldt7;Ldt7;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V

    new-instance p2, Lkmh;

    invoke-direct {p2, p3, p1}, Lkmh;-><init>(Ldt7;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V

    invoke-interface {v0, p1, v1, p2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lld4;Ljava/lang/Runnable;)V
