...
.method private constructor <init>(Landroid/content/Context;Lnvf;)V
    .locals 1
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lnvf;
...
.method private declared-synchronized ensureMappingNotOutdated(Lhs1$a;)V
    .locals 1
...
.method public static get(Landroid/content/Context;Lnvf;)Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;
    .locals 2
    ...
    invoke-direct {v1, p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;-><init>(Landroid/content/Context;Lnvf;)V
...
.method private getFile(Z)Ljava/io/File;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lnvf;
...
.method private declared-synchronized read()V
    ...
    :catch_0
    :try_start_4
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lnvf;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lnvf;

    const-string v1, "IdMappingWrapper"

    const-string v3, "empty mapping"

    invoke-interface {v0, v1, v3}, Lnvf;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_4
...
.method private declared-synchronized write()V
    ...
    invoke-virtual {v3}, Lhs1$a;->c()Ljava/lang/String;
...
# virtual methods
.method public declared-synchronized addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lhs1$a;)V
    .locals 2
...
.method public declared-synchronized getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lhs1$a;
    .locals 1
...
.method public declared-synchronized getByInternal(Lhs1$a;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    .locals 1
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->ensureMappingNotOutdated(Lhs1$a;)V
...
.method public scheduleReadCacheFromDisk()V
    ...
    invoke-direct {v1, p0}, Lxg8;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)V
...
.method public scheduleWriteCacheToDisk()V
    ...
    invoke-direct {v1, p0}, Lwg8;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)V
