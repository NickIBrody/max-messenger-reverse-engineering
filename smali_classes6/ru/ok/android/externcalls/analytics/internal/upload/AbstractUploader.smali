...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Las;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;",
        "Lpkk;",
        "drop",
        "()V",
...
.method private final uploadFileWithContent(Las;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    .locals 8
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader;->uploadHelper:Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;
    ...
    invoke-static {p2}, Ly77;->e(Ljava/io/File;)Z
    ...
    invoke-virtual {v4, p1, v5, v6}, Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;->executeApiMethod$calls_sdk_analytics_release(Las;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Ls01;)V
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader;->channel:Lru/ok/android/externcalls/analytics/internal/event/EventChannel;
...
.method public drop()V
    ...
    :try_start_0
    iget-object v1, p0, Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader;->storage:Ljavax/inject/Provider;
    ...
    const-string v5, "don\'t drop storage "
    ...
    :cond_0
    invoke-static {v1}, Ly77;->b(Ljava/io/File;)V
    ...
    const-string v5, "storage dropped:  "
    ...
    const-string v6, "storage drop failed "
    ...
    invoke-interface {v3, v4, v1, v2}, Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final uploadFile(Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader;->logTag:Ljava/lang/String;

    const-string v2, "api not initialized, will retry"

    invoke-interface {p1, v1, v2}, Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-virtual {v1}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->getOkApi()Linc;

    move-result-object v1

    invoke-virtual {v1}, Linc;->b()Las;

    move-result-object v1

    invoke-direct {p0, v1, p1}, Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader;->uploadFileWithContent(Las;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    ...
    const-string v5, "can\'t delete empty file "
    ...
    invoke-interface {v2, v3, p1, v1}, Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v2, v3, p1}, Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
