...
.field private final multiUploadHelper$delegate:Lqd9;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader$Companion;-><init>(Lxd5;)V
...
.method public constructor <init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljava/util/concurrent/locks/Lock;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;ILjava/lang/Long;)V
    ...
    iput-object p3, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->multiUploadHelper$delegate:Lqd9;
    ...
    invoke-direct {p1, p2, p0}, Lt65;-><init>(Ljavax/inject/Provider;Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;)V
...
.method private static final _init_$lambda$0(Ljavax/inject/Provider;Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;)V
    ...
    invoke-static {p0}, Ly77;->b(Ljava/io/File;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static final synthetic access$uploadImpl(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Las;Ljava/util/Iterator;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->uploadImpl(Las;Ljava/util/Iterator;)V
...
.method private final getMultiUploadHelper()Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->multiUploadHelper$delegate:Lqd9;
...
.method private final uploadImpl(Las;Ljava/util/Iterator;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v5, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->uploadHelper:Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;
    ...
    new-instance v7, Lru/ok/android/externcalls/analytics/internal/api/IterableItemsApiValue;

    invoke-direct {v7, p2}, Lru/ok/android/externcalls/analytics/internal/api/IterableItemsApiValue;-><init>(Ljava/util/Iterator;)V

    invoke-virtual {v5, p1, v6, v7}, Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;->executeApiMethod$calls_sdk_analytics_release(Las;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Ls01;)V
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->logger:Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;

    iget-object v4, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->channel:Lru/ok/android/externcalls/analytics/internal/event/EventChannel;
    ...
    invoke-virtual {v5}, Lru/ok/android/externcalls/analytics/internal/event/EventChannel;->getCollector()Ljava/lang/String;
    ...
    invoke-interface {v3, v2, p1}, Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public upload()V
    ...
    iget-wide v3, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->lastUploadTime:J

    invoke-virtual {v2, v3, v4}, Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;->isNowGoodTimeToUploadNext(J)Z
    ...
    const-string v2, "it\'s not a time to upload next. do it a bit later"
    ...
    invoke-virtual {v0, v4, v3}, Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;->scheduleNextUpload(ZI)V

    return-void

    :cond_2
    iget-object v2, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->lock:Ljava/util/concurrent/locks/Lock;
    ...
    iget v5, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->recordToUploadCount:I

    new-instance v6, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader$upload$1$1;

    invoke-direct {v6, p0, v0}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader$upload$1$1;-><init>(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;)V

    invoke-virtual {v1, v5, v6}, Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;->grab(ILdt7;)V
    ...
    const-string v7, "not enough items to start upload: "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v6, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v5, ". At least one required"
    ...
    invoke-interface {v0, v1, v5}, Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;->d(Ljava/lang/String;Ljava/lang/String;)V
