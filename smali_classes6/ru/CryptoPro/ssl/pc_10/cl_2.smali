.class public final Lru/CryptoPro/ssl/pc_10/cl_2;
...
.field private final x:Ljava/security/cert/PKIXBuilderParameters;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lru/CryptoPro/ssl/pc_0/cl_0;

    const-string v1, "ru.CryptoPro.ssl.checkRevocation"

    invoke-direct {v0, v1}, Lru/CryptoPro/ssl/pc_0/cl_0;-><init>(Ljava/lang/String;)V
    ...
    sput-boolean v0, Lru/CryptoPro/ssl/pc_10/cl_2;->a:Z
    ...
    sput-boolean v0, Lru/CryptoPro/ssl/pc_10/cl_2;->b:Z
    ...
    sput-boolean v0, Lru/CryptoPro/ssl/pc_10/cl_2;->c:Z
    ...
    sput-boolean v0, Lru/CryptoPro/ssl/pc_10/cl_2;->d:Z
    ...
    sput-object v0, Lru/CryptoPro/ssl/pc_10/cl_2;->e:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/ssl/pc_10/cl_2;->f:Ljava/lang/String;
...
.method public constructor <init>(Ljava/lang/String;Ljava/security/cert/PKIXBuilderParameters;)V
    ...
    invoke-direct {p0, v1, p1}, Lru/CryptoPro/ssl/pc_10/cl_5;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v1, -0x1

    iput v1, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->y:I

    new-instance v1, Ljava/util/HashSet;

    invoke-direct {v1}, Ljava/util/HashSet;-><init>()V

    iput-object v1, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->w:Ljava/util/Set;

    new-instance v1, Ljava/util/HashSet;

    invoke-direct {v1}, Ljava/util/HashSet;-><init>()V

    iput-object v1, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->v:Ljava/util/Set;
    ...
    invoke-static {v3, v1}, Lru/CryptoPro/ssl/pc_10/cl_2;->a(Ljava/security/cert/X509Certificate;Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_1

    iget-object v4, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->v:Ljava/util/Set;

    invoke-interface {v4, v3}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    :cond_1
    iget-object v4, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->w:Ljava/util/Set;
    ...
    iput-object p2, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->x:Ljava/security/cert/PKIXBuilderParameters;

    const/4 p2, 0x1

    iput-boolean p2, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->z:Z

    new-instance p2, Ljava/util/HashMap;

    invoke-direct {p2}, Ljava/util/HashMap;-><init>()V

    iput-object p2, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->A:Ljava/util/Map;

    iget-object p2, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->v:Ljava/util/Set;
    ...
    iget-object v3, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->A:Ljava/util/Map;
    ...
    iget-object v4, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->A:Ljava/util/Map;
    ...
    iput-boolean p1, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->B:Z

    new-instance p1, Ljava/security/cert/CollectionCertStoreParameters;

    iget-object p2, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->w:Ljava/util/Set;
    ...
    iget-object p2, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->x:Ljava/security/cert/PKIXBuilderParameters;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/Collection;)V
    ...
    invoke-direct {v5, v3, v4}, Ljava/security/cert/TrustAnchor;-><init>(Ljava/security/cert/X509Certificate;[B)V
    ...
    invoke-direct {p2, v2, v4}, Ljava/security/cert/PKIXBuilderParameters;-><init>(Ljava/util/Set;Ljava/security/cert/CertSelector;)V

    iput-object p2, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->x:Ljava/security/cert/PKIXBuilderParameters;
    :try_end_0
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_0 .. :try_end_0} :catch_2

    invoke-direct {p0, p1}, Lru/CryptoPro/ssl/pc_10/cl_2;->a(Ljava/lang/String;)V
...
.method private a(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object p1, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->x:Ljava/security/cert/PKIXBuilderParameters;
    ...
    sget-boolean v0, Lru/CryptoPro/ssl/pc_10/cl_2;->a:Z
...
.method private a(Ljava/security/cert/PKIXBuilderParameters;)V
    ...
    .line 3
    iget-object v0, p0, Lru/CryptoPro/ssl/pc_10/cl_5;->t:Ljava/util/Date;
...
.method public static a(Ljava/security/PublicKey;)Z
    ...
    .line 4
    sget-boolean v0, Lru/CryptoPro/ssl/pc_10/cl_2;->d:Z
...
.method public static a(Ljava/security/cert/X509Certificate;Ljava/lang/String;)Z
    ...
    .line 6
    invoke-static {p0}, Lru/CryptoPro/ssl/pc_10/cl_2;->a(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-static {v0}, Lru/CryptoPro/ssl/pc_10/cl_2;->a(Ljava/security/PublicKey;)Z
...
.method private a(Ljava/util/List;Ljava/security/cert/X509Certificate;)Z
    ...
    .line 7
    iget-boolean v0, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->B:Z
...
.method public static a(Ljava/security/cert/CertPath;Ljava/security/cert/TrustAnchor;)[Ljava/security/cert/X509Certificate;
    ...
    :cond_0
    new-instance p0, Lru/CryptoPro/ssl/pc_10/cl_6;

    const-string p1, "TrustAnchor must be specified as certificate"

    invoke-direct {p0, p1}, Lru/CryptoPro/ssl/pc_10/cl_6;-><init>(Ljava/lang/String;)V
...
.method private a([Ljava/security/cert/X509Certificate;Ljava/security/cert/PKIXBuilderParameters;Ljava/lang/Object;)[Ljava/security/cert/X509Certificate;
    ...
    sget-boolean v1, Lru/CryptoPro/ssl/pc_10/cl_2;->a:Z
    ...
    sget-boolean v1, Lru/CryptoPro/ssl/pc_10/cl_2;->b:Z
    ...
    sget-boolean v2, Lru/CryptoPro/ssl/pc_10/cl_2;->c:Z
    ...
    iget-boolean v3, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->z:Z
    ...
    iget-boolean v0, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->z:Z
    ...
    :goto_3
    invoke-direct {p0, p2}, Lru/CryptoPro/ssl/pc_10/cl_2;->a(Ljava/security/cert/PKIXBuilderParameters;)V

    invoke-static {p3, p2}, Lvkm;->a(Ljava/lang/Object;Ljava/security/cert/PKIXBuilderParameters;)Lvkm;

    move-result-object p3

    iget-object v0, p3, Lvkm;->a:Ljava/lang/String;

    if-eqz v0, :cond_5

    iget-object p3, p3, Lvkm;->b:Ljava/lang/String;
    ...
    :goto_4
    sget-object v0, Lru/CryptoPro/ssl/pc_10/cl_5;->s:Ljava/security/cert/CertificateFactory;
    ...
    iput p1, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->y:I
    ...
    invoke-static {v0, p1}, Lru/CryptoPro/ssl/pc_10/cl_2;->a(Ljava/security/cert/CertPath;Ljava/security/cert/TrustAnchor;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-direct {p2, p3, p1}, Lru/CryptoPro/ssl/pc_10/cl_6;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private a([Ljava/security/cert/X509Certificate;Ljava/util/Collection;Ljava/security/cert/PKIXBuilderParameters;Ljava/lang/Object;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-static {v1}, Lru/CryptoPro/ssl/pc_10/cl_2;->a(Ljava/security/PublicKey;)Z
    ...
    :cond_0
    :goto_0
    invoke-direct {p0, p3}, Lru/CryptoPro/ssl/pc_10/cl_2;->a(Ljava/security/cert/PKIXBuilderParameters;)V
    ...
    invoke-static {p4, p3}, Lvkm;->a(Ljava/lang/Object;Ljava/security/cert/PKIXBuilderParameters;)Lvkm;

    move-result-object p1

    iget-object p2, p1, Lvkm;->a:Ljava/lang/String;

    if-eqz p2, :cond_2

    iget-object p1, p1, Lvkm;->b:Ljava/lang/String;
    ...
    invoke-static {p2, p1}, Lru/CryptoPro/ssl/pc_10/cl_2;->a(Ljava/security/cert/CertPath;Ljava/security/cert/TrustAnchor;)[Ljava/security/cert/X509Certificate;
...
.method public static synthetic d()Ljava/lang/String;
    ...
    sget-object v0, Lru/CryptoPro/ssl/pc_10/cl_2;->e:Ljava/lang/String;
...
.method public static synthetic e()Ljava/lang/String;
    ...
    sget-object v0, Lru/CryptoPro/ssl/pc_10/cl_2;->f:Ljava/lang/String;
...
.method public a()Ljava/util/Collection;
    ...
    .line 1
    iget-object v0, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->v:Ljava/util/Set;
...
.method public a([Ljava/security/cert/X509Certificate;Ljava/util/Collection;Ljava/security/AlgorithmConstraints;Ljava/lang/Object;)[Ljava/security/cert/X509Certificate;
    ...
    iget-object v0, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->x:Ljava/security/cert/PKIXBuilderParameters;
    ...
    new-instance v2, Lru/CryptoPro/ssl/pc_1/cl_0;

    iget-object v3, p0, Lru/CryptoPro/ssl/pc_10/cl_5;->r:Ljava/lang/String;

    invoke-direct {v2, p3, v1, v3}, Lru/CryptoPro/ssl/pc_1/cl_0;-><init>(Ljava/security/AlgorithmConstraints;Ljava/security/Timestamp;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0, p4}, Lru/CryptoPro/ssl/pc_10/cl_2;->a([Ljava/security/cert/X509Certificate;Ljava/util/Collection;Ljava/security/cert/PKIXBuilderParameters;Ljava/lang/Object;)[Ljava/security/cert/X509Certificate;
    ...
    :cond_1
    iget-object v3, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->v:Ljava/util/Set;
    ...
    invoke-direct {p0, p2, v0, p4}, Lru/CryptoPro/ssl/pc_10/cl_2;->a([Ljava/security/cert/X509Certificate;Ljava/security/cert/PKIXBuilderParameters;Ljava/lang/Object;)[Ljava/security/cert/X509Certificate;
    ...
    iget-object v5, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->A:Ljava/util/Map;
    ...
    invoke-direct {p0, v4, v2}, Lru/CryptoPro/ssl/pc_10/cl_2;->a(Ljava/util/List;Ljava/security/cert/X509Certificate;)Z

    move-result v2

    if-eqz v2, :cond_6

    invoke-direct {p0, p1, v0, p4}, Lru/CryptoPro/ssl/pc_10/cl_2;->a([Ljava/security/cert/X509Certificate;Ljava/security/cert/PKIXBuilderParameters;Ljava/lang/Object;)[Ljava/security/cert/X509Certificate;
    ...
    :cond_6
    iget-boolean v2, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->B:Z
    ...
    invoke-direct {p0, v2, v0, p4}, Lru/CryptoPro/ssl/pc_10/cl_2;->a([Ljava/security/cert/X509Certificate;Ljava/security/cert/PKIXBuilderParameters;Ljava/lang/Object;)[Ljava/security/cert/X509Certificate;
    ...
    sget-object p2, Lru/CryptoPro/ssl/pc_10/cl_6;->a:Ljava/lang/Object;

    invoke-direct {p1, p2}, Lru/CryptoPro/ssl/pc_10/cl_6;-><init>(Ljava/lang/Object;)V
...
.method public b()I
    ...
    iget v0, p0, Lru/CryptoPro/ssl/pc_10/cl_2;->y:I
