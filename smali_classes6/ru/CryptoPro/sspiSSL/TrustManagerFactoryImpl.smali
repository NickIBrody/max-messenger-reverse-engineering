.class abstract Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->a:Ljavax/net/ssl/X509TrustManager;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->b:Z
...
.method public static a(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    invoke-direct {v0, p0}, Lgkm;-><init>(Ljava/io/File;)V
...
.method public static a(Ljava/lang/String;)Ljava/security/KeyStore;
    ...
    invoke-static {p0}, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->a(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    invoke-static {v5}, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->a(Ljava/io/File;)Ljava/io/FileInputStream;
...
.method public engineGetTrustManagers()[Ljavax/net/ssl/TrustManager;
    ...
    iget-boolean v0, p0, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->b:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->a:Ljavax/net/ssl/X509TrustManager;
...
.method public engineInit(Ljava/security/KeyStore;)V
    ...
    invoke-static {v1}, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->a(Ljava/lang/String;)Ljava/security/KeyStore;
    ...
    :cond_0
    :goto_4
    invoke-virtual {p0, p1}, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->a(Ljava/security/KeyStore;)Ljavax/net/ssl/X509TrustManager;

    move-result-object p1

    iput-object p1, p0, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->a:Ljavax/net/ssl/X509TrustManager;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->b:Z
...
.method public engineInit(Ljavax/net/ssl/ManagerFactoryParameters;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lru/CryptoPro/sspiSSL/TrustManagerFactoryImpl;->a(Ljavax/net/ssl/ManagerFactoryParameters;)Ljavax/net/ssl/X509TrustManager;
