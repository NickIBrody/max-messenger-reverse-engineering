...
.method public static final b(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;)Z
    ...
    invoke-static {p0}, Lyf;->a(Ljava/lang/String;)Z
...
.method public static final c(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    :try_start_1
    invoke-static {p0, v1}, Lyf;->b(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;)Z
    ...
    const-string v2, "Probably readSymbolicLink not supported. Uri: "
    ...
    const-string v2, "Lack for read file permission. Uri: "
    ...
    const-string v2, "Check for internal uri failed. Uri: "
...
.method public static final d(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p1}, Lyf;->f(Landroid/content/Context;Landroid/net/Uri;)Z
...
.method public static final e(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    :cond_2
    :goto_0
    invoke-static {p0, p1}, Lyf;->d(Landroid/content/Context;Landroid/net/Uri;)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {p0, p1}, Lyf;->c(Landroid/content/Context;Landroid/net/Uri;)Z
...
.method public static final f(Landroid/content/Context;Landroid/net/Uri;)Z
    .locals 3
