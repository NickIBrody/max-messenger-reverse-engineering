...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqim;->d:Ljava/security/AlgorithmConstraints;
    ...
    invoke-direct {v1, v2}, Lyim;-><init>(Z)V

    const-string v2, "jdk.certpath.disabledAlgorithms"

    invoke-direct {v0, v2, v1}, Lru/CryptoPro/ssl/util/DisabledAlgorithmConstraints;-><init>(Ljava/lang/String;Lru/CryptoPro/ssl/util/AlgorithmDecomposer;)V

    sput-object v0, Lqim;->e:Ljava/security/AlgorithmConstraints;

    new-instance v0, Lqim;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lqim;-><init>(Ljava/security/AlgorithmConstraints;)V

    sput-object v0, Lqim;->f:Ljava/security/AlgorithmConstraints;

    new-instance v0, Lqim;

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lqim;-><init>(Ljavax/net/ssl/SSLSocket;Z)V

    sput-object v0, Lqim;->g:Ljava/security/AlgorithmConstraints;
...
.method public constructor <init>(Ljava/security/AlgorithmConstraints;)V
    ...
    iput-object v0, p0, Lqim;->b:Ljava/security/AlgorithmConstraints;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lqim;->c:Z

    iput-object p1, p0, Lqim;->a:Ljava/security/AlgorithmConstraints;
...
.method public constructor <init>(Ljavax/net/ssl/SSLEngine;Z)V
    ...
    iput-object v0, p0, Lqim;->a:Ljava/security/AlgorithmConstraints;
...
.method public constructor <init>(Ljavax/net/ssl/SSLEngine;[Ljava/lang/String;Z)V
    ...
    invoke-direct {p1, p2}, Lvim;-><init>([Ljava/lang/String;)V

    iput-object p1, p0, Lqim;->b:Ljava/security/AlgorithmConstraints;
...
.method public permits(Ljava/util/Set;Ljava/lang/String;Ljava/security/AlgorithmParameters;)Z
    ...
    .line 1
    iget-object v0, p0, Lqim;->b:Ljava/security/AlgorithmConstraints;
    ...
    iget-object v1, p0, Lqim;->a:Ljava/security/AlgorithmConstraints;
    ...
    sget-object v0, Lqim;->d:Ljava/security/AlgorithmConstraints;
    ...
    sget-object v0, Lqim;->e:Ljava/security/AlgorithmConstraints;
