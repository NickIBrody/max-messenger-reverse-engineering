...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Lmvm;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lmvm;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v0, v1}, Lfwm;->e(Ljava/lang/String;I)I
    ...
    invoke-static {p1, v1}, Lfwm;->e(Ljava/lang/String;I)I
    ...
    iput v0, p0, Lmvm;->aVertexCoordLoc:I

    invoke-static {p1, v0}, Lfwm;->d(Ljava/lang/String;I)V
    ...
    iput v2, p0, Lmvm;->aTextureCoordLoc:I

    invoke-static {p1, v2}, Lfwm;->d(Ljava/lang/String;I)V
    ...
    iput v3, p0, Lmvm;->mvpMatrixLoc:I

    invoke-static {p1, v3}, Lfwm;->d(Ljava/lang/String;I)V
    ...
    iput v3, p0, Lmvm;->texMatrixLoc:I
    ...
    iput v3, p0, Lmvm;->textureLocation:I
    ...
    iput v1, p0, Lmvm;->alphaLocation:I

    invoke-static {p1, v3}, Lfwm;->d(Ljava/lang/String;I)V

    new-instance p1, Lcum;

    invoke-direct {p1, v0, v2}, Lcum;-><init>(II)V

    iput-object p1, p0, Lmvm;->frame:Lcum;
...
.method public getTextureCoordLoc()I
    ...
    iget v0, p0, Lmvm;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget v0, p0, Lmvm;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lmvm;->firstFreeTexture:I
    ...
    invoke-static {p1}, Lfwm;->c(Ljava/lang/String;)V

    iget p1, p0, Lmvm;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Lmvm;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Lmvm;->frame:Lcum;

    iget-object v0, v0, Lqum;->a:Lbvm;

    invoke-interface {v0}, Lbvm;->a()V

    iget v0, p0, Lmvm;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Lmvm;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    .line 2
    iget-object v0, p0, Lmvm;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Lmvm;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Lmvm;->texMat:[F
...
.method public use()V
    ...
    iput v0, p0, Lmvm;->firstFreeTexture:I

    iget-object v1, p0, Lmvm;->mvpMat:[F
    ...
    iput-object v1, p0, Lmvm;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Lmvm;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Lmvm;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Lmvm;->programId:I
    ...
    iget v1, p0, Lmvm;->mvpMatrixLoc:I

    iget-object v2, p0, Lmvm;->mvpMat:[F
    ...
    iget v2, p0, Lmvm;->texMatrixLoc:I

    iget-object v4, p0, Lmvm;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Lfwm;->c(Ljava/lang/String;)V

    iget v0, p0, Lmvm;->textureLocation:I

    invoke-virtual {p0}, Lmvm;->getTarget()I

    move-result v1

    iget v2, p0, Lmvm;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Lmvm;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lmvm;->alphaLocation:I

    iget v1, p0, Lmvm;->alpha:F
    ...
    iget-object v3, p0, Lmvm;->customParams:Ljava/util/HashMap;
