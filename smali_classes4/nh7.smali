...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lnh7$a;-><init>(Lxd5;)V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lnh7;->w:Landroid/content/Context;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lnh7;->x:Landroid/graphics/Rect;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    iput-object v0, p0, Lnh7;->y:Landroid/text/TextPaint;
    ...
    invoke-virtual {p0, p1}, Lnh7;->onThemeChanged(Lccd;)V

    new-instance p1, Le19;

    invoke-direct {p1}, Le19;-><init>()V

    iput-object p1, p0, Lnh7;->z:Le19;
...
.method public g(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    invoke-direct {p0, p3, v0}, Lnh7;->l(Landroidx/recyclerview/widget/RecyclerView;I)Z
...
.method public i(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    invoke-direct {p0, p2, v1}, Lnh7;->l(Landroidx/recyclerview/widget/RecyclerView;I)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v2, p0, Lnh7;->w:Landroid/content/Context;
    ...
    iget-object v3, p0, Lnh7;->z:Le19;

    iget-object v4, p0, Lnh7;->x:Landroid/graphics/Rect;

    invoke-virtual {v3, v4, v0, v1}, Le19;->c(Landroid/graphics/Rect;Landroid/view/View;I)V

    iget-object v0, p0, Lnh7;->x:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lnh7;->x:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Lnh7;->y:Landroid/text/TextPaint;
...
.method public onThemeChanged(Lccd;)V
    ...
    iget-object v2, p0, Lnh7;->y:Landroid/text/TextPaint;
    ...
    iget-object v1, p0, Lnh7;->w:Landroid/content/Context;
