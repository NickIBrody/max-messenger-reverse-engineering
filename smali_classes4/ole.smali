...
# static fields
.field public static final G:Lole$a;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lole$a;-><init>(Lxd5;)V

    sput-object v0, Lole;->G:Lole$a;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lole;->w:Landroid/content/Context;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lole;->x:Landroid/graphics/Rect;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    iput-object v0, p0, Lole;->y:Landroid/text/TextPaint;
    ...
    iput-object v0, p0, Lole;->C:Lqd9;

    new-instance v0, Lmle;

    invoke-direct {v0, p0}, Lmle;-><init>(Lole;)V

    invoke-static {v0}, Lae9;->a(Lbt7;)Lqd9;

    move-result-object v0

    iput-object v0, p0, Lole;->D:Lqd9;
    ...
    invoke-virtual {p0, p1}, Lole;->onThemeChanged(Lccd;)V

    new-instance p1, Le19;

    invoke-direct {p1}, Le19;-><init>()V

    iput-object p1, p0, Lole;->F:Le19;
...
.method public static final B(Lole;)Ljava/lang/String;
    .locals 1

    iget-object p0, p0, Lole;->w:Landroid/content/Context;
...
.method public static synthetic l(Lole;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Lole;->B(Lole;)Ljava/lang/String;
...
.method public static synthetic o(Lole;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Lole;->s(Lole;)Ljava/lang/String;
...
.method public static final s(Lole;)Ljava/lang/String;
    .locals 1
...
.method public g(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    invoke-direct {p0, p3, v0}, Lole;->A(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    invoke-virtual {p0, v1, v0}, Lole;->D(ILjava/lang/Integer;)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {p0}, Lole;->t()I
    ...
    :cond_0
    invoke-virtual {p0, v1, v0}, Lole;->E(ILjava/lang/Integer;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lole;->x()I
...
.method public i(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    invoke-virtual {p0, p2, v1}, Lole;->v(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/String;
    ...
    :cond_1
    iget-object v3, p0, Lole;->F:Le19;

    iget-object v4, p0, Lole;->x:Landroid/graphics/Rect;

    invoke-virtual {v3, v4, v0, v1}, Le19;->c(Landroid/graphics/Rect;Landroid/view/View;I)V

    iget-object v0, p0, Lole;->x:Landroid/graphics/Rect;

    iget v0, v0, Landroid/graphics/Rect;->left:I

    int-to-float v0, v0

    invoke-direct {p0}, Lole;->y()I
    ...
    iget-object v1, p0, Lole;->x:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->bottom:I

    int-to-float v1, v1

    invoke-direct {p0}, Lole;->z()I
    ...
    iget-object v3, p0, Lole;->y:Landroid/text/TextPaint;
...
.method public onThemeChanged(Lccd;)V
    ...
    iget-object v2, p0, Lole;->y:Landroid/text/TextPaint;
    ...
    iget-object v1, p0, Lole;->w:Landroid/content/Context;
...
.method public final v(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2}, Lole;->A(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    invoke-virtual {p0, v0, p1}, Lole;->D(ILjava/lang/Integer;)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {p0}, Lole;->u()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0, v0, p1}, Lole;->E(ILjava/lang/Integer;)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-virtual {p0}, Lole;->w()Ljava/lang/String;
